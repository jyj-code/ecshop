...
{
	[ParseChildren(true)]
	public class M_VideoComment : BaseMemberWebControl
	{
		private string string_0 = "M_VideoComment.ascx";
		...
		public static string GetVideo(string guid)
		{
			...
			DataTable titleByGuid = shopNum1_Vedio_List_Action.GetTitleByGuid(guid);
		...
		private void method_0()
		{
			...
			DataTable dataTable = shopNum1_VedioCommentChecked_Action.Select_List(commonPageModel);
			...
			DataTable dataTable2 = shopNum1_VedioCommentChecked_Action.Select_List(commonPageModel);
