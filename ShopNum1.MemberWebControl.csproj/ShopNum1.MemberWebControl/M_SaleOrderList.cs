...
namespace ShopNum1.MemberWebControl
{
	...
	{
		private string string_0 = "M_SaleOrderList.ascx";
		...
		{
			if (ShopNum1.Common.Common.ReqStr("sing") == "del" && ShopNum1.Common.Common.ReqStr("del") != "")
			{
		...
		private string method_1()
		{
			...
			stringBuilder.Append(" and memloginId='" + this.MemLoginID + "' and Ordertype!=0 and isdeleted=0");
		...
		private void method_2()
		{
			...
			PageListBll pageListBll = new PageListBll("main/member/M_SaleOrderList.aspx", true);
			...
			M_SaleOrderList.dt_OrderList = shopNum1_OrderInfo_Action.SelectOrderList(this.PageSize.ToString(), pageID.ToString(), this.method_1(), "2", HttpUtility.HtmlDecode(ShopNum1.Common.Common.ReqStr("pn")));
			if (M_SaleOrderList.dt_OrderList.Rows.Count == 0)
			{
				M_SaleOrderList.dt_OrderList = null;
			}
		}
