...
namespace ShopNum1.MemberWebControl
{
	...
	{
		private string string_0 = "M_MemberProductCollect.ascx";
		...
		private void method_0()
		{
			...
			commonPageModel.Condition = " and IsDeleted=0      AND  MemLoginID='" + this.MemLoginID + "'  ";
			...
			DataTable dataTable = shop_Collect_Action.Select_ListMemberProductCollect(commonPageModel);
			...
			DataTable dataTable2 = shop_Collect_Action.Select_ListMemberProductCollect(commonPageModel);
