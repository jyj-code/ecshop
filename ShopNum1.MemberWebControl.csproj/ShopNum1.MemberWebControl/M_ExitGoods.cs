...
namespace ShopNum1.MemberWebControl
{
	...
	{
		private string string_0 = "M_ExitGoods.ascx";
		...
		{
			StringBuilder stringBuilder = new StringBuilder(" and memloginid='" + this.MemLoginID + "' And refundtype=1 ");
		...
		private void method_1()
		{
			...
			PageListBll pageListBll = new PageListBll("main/member/M_ExitGoods.aspx", true);
