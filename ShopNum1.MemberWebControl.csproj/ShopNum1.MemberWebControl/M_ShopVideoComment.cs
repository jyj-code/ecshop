...
{
	[ParseChildren(true)]
	public class M_ShopVideoComment : BaseMemberWebControl
	{
		private string string_0 = "M_ShopVideoComment.ascx";
		...
		public static string GetVideo(string guid)
		{
			...
			DataTable titleByGuid = shop_VideoComment_Action.GetTitleByGuid(guid);
		...
		public static string PJ(string fenshu)
		{
			string result;
			if (fenshu == "0")
			{
		...
		{
			string nameById = ShopNum1.Common.Common.GetNameById("ShopName", "ShopNum1_ShopInfo", "   AND   ShopID='" + shopid + "'");
			string result;
		...
		private void method_0()
		{
			...
			DataTable dataTable = shop_VideoComment_Action.Select_List(commonPageModel);
			...
			DataTable dataTable2 = shop_VideoComment_Action.Select_List(commonPageModel);
