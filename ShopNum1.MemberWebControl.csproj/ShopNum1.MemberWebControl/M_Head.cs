...
namespace ShopNum1.MemberWebControl
{
	...
	{
		private string string_0 = "M_Head.ascx";
		...
		{
			this.label_1.Text = ShopNum1.Common.Common.GetNameById("COUNT(Guid)", "ShopNum1_UserMessage", " and IsDeleted=0 and IsRead=0  AND  ReceiveID='" + this.MemLoginID + "' ");
