...
namespace ShopNum1.MemberWebControl
{
	...
	{
		private string string_0 = "M_ShopCollect.ascx";
		...
		private void method_0()
		{
			...
			commonPageModel.Condition = "   AND  MemLoginID='" + this.MemLoginID + "'  ";
			...
			DataTable dataTable = shop_Collect_Action.Select_List(commonPageModel);
			...
			PageListBll pageListBll = new PageListBll("main/member/M_MyCollect.aspx", true);
			this.htmlGenericControl_0.InnerHtml = pageListBll.GetPageListNew(pageList);
			commonPageModel.Resultnum = "1";
			DataTable dataTable2 = shop_Collect_Action.Select_List(commonPageModel);
