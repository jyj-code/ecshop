...
{
	[ParseChildren(true)]
	public class M_LifeOrderList : BaseMemberWebControl
	{
		private string string_0 = "M_LifeOrderList.ascx";
		...
		private string method_1()
		{
			...
			stringBuilder.Append(" and memloginId='" + this.MemLoginID + "' and FeeType =2 ");
		...
		private void method_2()
		{
			...
			PageListBll pageListBll = new PageListBll("main/member/M_LifeOrderList.aspx", true);
			...
			M_LifeOrderList.dt_OrderList = shopNum1_OrderInfo_Action.SelectOrderList(this.PageSize.ToString(), pageID.ToString(), this.method_1(), "2", HttpUtility.HtmlDecode(ShopNum1.Common.Common.ReqStr("pn")));
			if (M_LifeOrderList.dt_OrderList.Rows.Count == 0)
			{
				M_LifeOrderList.dt_OrderList = null;
			}
		}
