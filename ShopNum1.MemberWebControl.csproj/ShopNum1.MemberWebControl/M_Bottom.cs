...
{
	[ParseChildren(true)]
	public class M_Bottom : BaseMemberWebControl
	{
		private string string_0 = "M_Bottom.ascx";
		...
		{
			DataTable tableById = ShopNum1.Common.Common.GetTableById("*", "ShopNum1_UserDefinedColumn", "  AND    ShowLocation=1 AND    IsMember =1 and ifshow=1  and    SubstationID='all'   ORDER  BY   OrderID  DESC   ");
			if (tableById != null)
			{
