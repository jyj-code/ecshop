...
{
	[ParseChildren(true)]
	public class M_ScoreModifyLog : BaseMemberWebControl
	{
		private string string_0 = "M_ScoreModifyLog.ascx";
		...
		private void method_0()
		{
			...
			DataTable dataTable = shopNum1_ScoreModifyLog_Action.Select_List(commonPageModel);
			...
			DataTable dataTable2 = shopNum1_ScoreModifyLog_Action.Select_List(commonPageModel);
