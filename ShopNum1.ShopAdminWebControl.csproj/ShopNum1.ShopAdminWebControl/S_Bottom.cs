...
namespace ShopNum1.ShopAdminWebControl
{
	...
	{
		private string string_0 = "S_Bottom.ascx";
		...
		private void method_0()
		{
			...
			DataTable tableById = ShopNum1.Common.Common.GetTableById("*", "ShopNum1_UserDefinedColumn", "  AND    ShowLocation=1 AND    IsMember =1 and ifshow=1 and SubstationID='" + nameById + "'  ORDER  BY   OrderID  DESC     ");
			if (tableById != null)
			{
