...
{
	[ParseChildren(true)]
	public class S_ExitGoods : BaseShopWebControl
	{
		private string string_0 = "S_ExitGoods.ascx";
		...
		{
			StringBuilder stringBuilder = new StringBuilder(" and shopid='" + this.MemLoginID + "' And refundtype=1  ");
