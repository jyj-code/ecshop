...
namespace ShopNum1.ShopAdminWebControl
{
	...
	{
		private string string_0 = "S_StoreProduct.ascx";
		...
		private string method_1()
		{
			...
			stringBuilder.Append(" and memloginid='" + this.MemLoginID + "' and issell=0 and isdeleted=0 and isaudit=1 and issaled=1 ");
			if (this.string_5 != "")
			{
		...
		private void method_2()
		{
			...
			PageListBll pageListBll = new PageListBll("shop/ShopAdmin/S_StoreProduct.aspx", true);
			this.htmlGenericControl_0.InnerHtml = pageListBll.GetPageListNew(pageList);
			S_StoreProducts.dt_ShowStoreProduct = shop_Product_Action.GetProductList(this.PageSize.ToString(), text, this.method_1(), "1");
			if (S_StoreProducts.dt_ShowStoreProduct.Rows.Count == 0)
			{
				S_StoreProducts.dt_ShowStoreProduct = null;
			}
		}
	}
}
