...
{
	[ParseChildren(true)]
	public class S_SellProduct : BaseShopWebControl
	{
		private string string_0 = "S_SellProduct.ascx";
		...
		private string method_1()
		{
			...
			stringBuilder.Append(" and memloginid='" + this.MemLoginID + "' and issell=1 and isdeleted=0 and isaudit=1 and issaled=1 ");
			if (this.string_5 != "")
			{
		...
		private void method_2()
		{
			...
			S_SellProduct.dt_ShowProduct = shop_Product_Action.GetProductList(this.PageSize.ToString(), text, this.method_1(), "1");
			if (S_SellProduct.dt_ShowProduct.Rows.Count == 0)
			{
				S_SellProduct.dt_ShowProduct = null;
			}
		}
	}
}
