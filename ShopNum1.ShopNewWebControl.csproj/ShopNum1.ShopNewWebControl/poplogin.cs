...
namespace ShopNum1.ShopNewWebControl
{
	...
	public class poplogin : BaseWebControl
	{
		...
		private void button_1_Click(object sender, EventArgs e)
		{
			...
			if (ShopSettings.GetValue("RegVerifyCode") == "1" && (this.Page.Session["code"] == null || this.textBox_7.Text.ToLower() != this.Page.Session["code"].ToString().ToLower()))
			{
				...
				if (shopNum1_Member_Action.Add(shopNum1_Member) == 1)
				{
					...
					if (value2 == "1")
					{
						...
						try
						{
							...
							regIsActivationEmail.Name = this.textBox_3.Text.Trim();
							...
							text4 = text4.Replace("{$PassWord}", this.textBox_5.Text);
							...
							this.SendMailForRegister(this.textBox_3.Text.Trim(), this.textBox_4.Text.Trim(), text3, "", text5, text6, emailBody);
						}
						catch (Exception ex)
						{
					...
					if (value == "1" && value2 == "0")
					{
						...
						register.Name = this.textBox_3.Text.Trim();
						register.Password = this.textBox_5.Text.Trim();
						...
						sendEmail.Emails(this.textBox_4.Text.Trim(), this.textBox_3.Text.Trim(), text5, text6, emailBody);
					}
					this.AddScroll();
					if (value2 == "0")
					{
		...
		private void button_0_Click(object sender, EventArgs e)
		{
			if (ShopSettings.GetValue("MemLoginVerifyCode") == "1")
			{
				...
				if (this.textBox_2.Text.ToLower() != this.Page.Session["code"].ToString().ToLower())
				{
