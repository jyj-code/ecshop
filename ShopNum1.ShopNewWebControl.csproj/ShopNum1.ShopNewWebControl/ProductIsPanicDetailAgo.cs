...
namespace ShopNum1.ShopNewWebControl
{
	...
	public class ProductIsPanicDetailAgo : BaseWebControl
	{
		...
		protected override void InitializeSkin(Control skin)
		{
			...
			ProductIsPanicDetailAgo.MemLoginID = shopNum1_ShopInfoList_Action.GetShopMemLoginIdByShopID(memloginId).ToString();
			...
			DataTable memLoginInfo = shop_ShopInfo_Action.GetMemLoginInfo(ProductIsPanicDetailAgo.MemLoginID);
