...
{
	[ParseChildren(true)]
	public class ProductProp_V82 : BaseWebControl
	{
		private string string_0 = "ProductProp_V82.ascx";
		...
		private void method_0()
		{
			...
			ProductProp_V82.dt_Prop = shopNum1_ShopProductProp_Action.SelectProByProductGuid(this.guid);
