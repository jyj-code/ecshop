...
{
	[ParseChildren(true)]
	public class ProductListIndexShowMore : BaseWebControl
	{
		private string string_0 = "ProductListIndexShowMore.ascx";
		...
		public ProductListIndexShowMore()
		{
		...
		{
			this.string_2 = ((this.Page.Request.QueryString["type"] == null) ? "1" : this.Page.Request.QueryString["type"].ToString());
			...
			this.string_1 = GetPageName.AgentGetPage("?type=" + this.string_2);
			this.int_1 = 1;
			try
			{
				...
				if (!(text == "1"))
				{
					if (!(text == "2"))
					{
						if (!(text == "3"))
						{
							...
							{
								this.string_5 = "1";
								this.dropDownList_0.SelectedValue = "4";
							}
						}
						else
						{
							this.string_6 = "1";
							this.dropDownList_0.SelectedValue = "3";
						}
					}
					else
					{
						this.string_3 = "1";
						this.dropDownList_0.SelectedValue = "2";
					}
				}
				else
				{
			...
			this.method_1(this.string_3, this.string_4, this.string_6, this.string_5);
		...
		private void dropDownList_0_SelectedIndexChanged(object sender, EventArgs e)
		{
			this.Page.Response.Redirect(string.Concat(new string[]
			{
				...
				"?type=",
				this.dropDownList_0.SelectedValue.ToString(),
				"&select=1&soft=",
				this.soft,
				"&ordername=",
				this.ordername
		...
		private void method_1(string string_10, string string_11, string string_12, string string_13)
		{
			...
			DataSet isProductNewAndRecommend = shop_Product_Action.GetIsProductNewAndRecommend(string_10, string_11, string_12, string_13, this.ordername, this.MemLoginID, this.soft, this.ShowCount.ToString(), this.int_1.ToString(), "1");
			...
			PageListBll pageListBll = new PageListBll("ProductListIndexShowMore", true);
			...
			DataSet isProductNewAndRecommend2 = shop_Product_Action.GetIsProductNewAndRecommend(string_10, string_11, string_12, string_13, this.ordername, this.MemLoginID, this.soft, this.ShowCount.ToString(), this.int_1.ToString(), "0");
