...
{
	[ParseChildren(true)]
	public class ProductListIsNewMore : BaseWebControl
	{
		private string string_0 = "ProductListIsNewMore.ascx";
		...
		private void method_1()
		{
			...
			PageListBll pageListBll = new PageListBll("ProductListNew", true);
