...
{
	[ParseChildren(true)]
	public class ProductListIsPromotionMore : BaseWebControl
	{
		private string string_0 = "ProductListIsPromotionMoreNew.ascx";
		...
		public ProductListIsPromotionMore()
		{
		...
		protected override void InitializeSkin(Control skin)
		{
			...
			this.ViewState["SortStyle"] = "IsPromotion";
			this.method_1();
