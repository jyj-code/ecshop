...
namespace ShopNum1.ShopAdminWebControl
{
	...
	{
		private string string_0 = "W_ShopReplyImgTxtList.ascx";
		...
		private void method_0()
		{
			...
			DataSet dataSet = shopNum1_Weixin_ReplyRule_Active.SelectReplyRule(this.MemLoginID, 1);
			if (dataSet.Tables.Count != 0)
			{
				...
				foreach (DataRow dataRow in dataTable.Rows)
				{
					...
					string text = (array2.Length != 0) ? array2[0]["Title"].ToString() : string.Empty;
					if (text.Length > 20)
					{
