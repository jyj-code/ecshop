namespace ShopNum1MultiEntity
{
    ...
    [Table(Name="dbo.ShopNum1_MMSType")]
    public class ShopNum1_MMSType : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Column(Storage="_Guid", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
        public string Guid
        {
            get
            {
