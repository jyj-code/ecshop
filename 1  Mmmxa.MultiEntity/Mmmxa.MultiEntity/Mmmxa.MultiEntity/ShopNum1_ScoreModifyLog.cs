namespace ShopNum1MultiEntity
{
    ...
    [Table(Name="dbo.ShopNum1_ScoreModifyLog")]
    public class ShopNum1_ScoreModifyLog : INotifyPropertyChanging, INotifyPropertyChanged
    {
        private DateTime? _CreateTime;
        private string _CreateUser;
        private int _CurrentScore;
        private DateTime _Date;
        private string _EnteMemLoginID;
        ...
        [Column(Storage="_EnteMemLoginID", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
        public string EnteMemLoginID
        {
            get
            {
                return this._EnteMemLoginID;
            }
            set
            {
                if (this._EnteMemLoginID != value)
                {
                    this.SendPropertyChanging();
                    this._EnteMemLoginID = value;
                    this.SendPropertyChanged("EnteMemLoginID");
                }
            }
        }
