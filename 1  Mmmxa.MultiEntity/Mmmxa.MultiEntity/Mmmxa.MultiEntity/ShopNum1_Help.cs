namespace ShopNum1MultiEntity
{
    ...
    [Table(Name="dbo.ShopNum1_Help")]
    public class ShopNum1_Help : INotifyPropertyChanging, INotifyPropertyChanged
    {
        private DateTime _CreateTime;
        private string _CreateUser;
        private System.Guid _Guid;
        private System.Guid _HelpTypeGuid;
        ...
        [Column(Storage="_HelpTypeGuid", DbType="UniqueIdentifier NOT NULL")]
        public System.Guid HelpTypeGuid
        {
            get
            {
                return this._HelpTypeGuid;
            }
            set
            {
                if (this._HelpTypeGuid != value)
                {
                    this.SendPropertyChanging();
                    this._HelpTypeGuid = value;
                    this.SendPropertyChanged("HelpTypeGuid");
                }
            }
        }
