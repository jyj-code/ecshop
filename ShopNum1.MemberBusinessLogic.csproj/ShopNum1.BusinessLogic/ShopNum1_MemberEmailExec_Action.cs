namespace ShopNum1.BusinessLogic
{
    ...
    public class ShopNum1_MemberEmailExec_Action : IShopNum1_MemberEmailExec_Action
    {
        ...
        {
            return DatabaseExcetue.ReturnDataTable((((string.Empty + " select * from  ShopNum1_MemberEmailExec ") + " where Type=" + type) + "   and Emailkey='" + Emailkey + "'") + "   and extireTime>'" + DateTime.Now.ToString() + "'");
        }
