...
public class FileManager : IHttpHandler
{
	public void ProcessRequest(HttpContext context)
	{
		...
		//根目录路径，相对路径
        String rootPath = "/ImgUpload/kindeditor/";
		//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
        String rootUrl ="/ImgUpload/kindeditor/";
		//图片扩展名
		...
		if (!String.IsNullOrEmpty(dirName)) {
            ...
            dirPath += dirName + "/"; rootUrl += dirName + "/";
            if (dirName == "image")
            {
                ...
                dirPath =context.Server.MapPath("/ImgUpload/shopImage/" + Convert.ToDateTime(strOpenTime).ToString("yyyy") + "/shop"+strShopId+"/");
                rootUrl = "http://"+ShopSettings.siteDomain+"/ImgUpload/shopImage/" + Convert.ToDateTime(strOpenTime).ToString("yyyy") + "/shop" + strShopId + "/";
            }
