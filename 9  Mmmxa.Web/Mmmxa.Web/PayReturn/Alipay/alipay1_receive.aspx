<%@ Page Language="C#" AutoEventWireup="true" Inherits="PayReturn_Alipay_alipay1_receive" Codebehind="alipay1_receive.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <title>支付宝担保交易付款——支付完成跳转返回页面文件（页面跳转同步通知页面）</title>
    <style type="text/css">
.font_content{
    font-family:"宋体";
    font-size:14px;
        ...
        <table align="center" width="350" cellpadding="5" cellspacing="0">
            ...
            <tr>
                <td class="font_content" align="right">
                    收货人邮编：</td>
                <td class="font_content" align="left">
                    <asp:Label ID="LbZip" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="font_content" align="right">
                    收货人电话：</td>
