<%@ page language="C#" autoeventwireup="true" inherits="PayReturn_bankonline_BankSend, ShopNum1.Deploy" %>
...
<!--以下几项项为网上支付完成后，随支付反馈信息一同传给信息接收页-->
  ...
  <input type="hidden"  name="remark2" value="[url:=http://www.brl9.com/PayReturn/bankonline/AutoReceive.aspx]" />
