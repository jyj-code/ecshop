...
<head id="Head1" runat="server">
    <title>淘宝数据包导入 Jely20130712</title>
...
<body>
    ...
    <div class="dpsc_mian">
        <p class="ptitle">
            <a href="S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">淘宝数据包批量导入</span></p>

        <script type="text/javascript" src="js/Page_ClientValidate.js"></script>

        <asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
        <ShopNum1ShopAdmin:S_Import ID="S_Import" runat="server" SkinFilename="skin/S_Import.ascx" />
    </div>
    </form>
</body>
</html>
