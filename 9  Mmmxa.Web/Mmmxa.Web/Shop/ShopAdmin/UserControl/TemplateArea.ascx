...
<div id="alldiv" class="ks-ext-mask" style="width: 100%; height: 100%; margin: 0;
    position: absolute; display: none; z-index: 99; background: #FFF; filter: alpha(opacity=50);
    -moz-opacity: 0.5; opacity: 0.5;">
</div>
<div style="left: 104.5px; top: 200.5px; z-index: 9999; display: none; position: absolute;"
                ...
                <li>
                    <div class=" dcity clearfix">
                        ...
                        <div class="province-list">
                            ...
                            <div class="ecity"><span class="gareas"><input type="checkbox" value="006" id="J_Province_006" class="J_Province"><label for="J_Province_006">辽宁省</label><span class="check_num"></span><em class="zt trigger"></em><div class="citys"><span class="areas"><input type="checkbox" value="006001" id="my_City_006001" class="J_City"><label for="J_City_006001">沈阳市</label></span><span class="areas"><input type="checkbox" value="006002" id="my_City_006002" class="J_City"><label for="J_City_006002">大连市</label></span><span class="areas"><input type="checkbox" value="006003" id="my_City_006003" class="J_City"><label for="J_City_006003">鞍山市</label></span><span class="areas"><input type="checkbox" value="006004" id="my_City_006004" class="J_City"><label for="J_City_006004">抚顺市</label></span><span class="areas"><input type="checkbox" value="006005" id="my_City_006005" class="J_City"><label for="J_City_006005">本溪市</label></span><span class="areas"><input type="checkbox" value="006006" id="my_City_006006" class="J_City"><label for="J_City_006006">丹东市</label></span><span class="areas"><input type="checkbox" value="006007" id="my_City_006007" class="J_City"><label for="J_City_006007">锦州市</label></span><span class="areas"><input type="checkbox" value="006008" id="my_City_006008" class="J_City"><label for="J_City_006008">营口市</label></span><span class="areas"><input type="checkbox" value="006009" id="my_City_006009" class="J_City"><label for="J_City_006009">阜新市</label></span><span class="areas"><input type="checkbox" value="006010" id="my_City_006010" class="J_City"><label for="J_City_006010">辽阳市</label></span><span class="areas"><input type="checkbox" value="006011" id="my_City_006011" class="J_City"><label for="J_City_006011">盘锦市</label></span><span class="areas"><input type="checkbox" value="006012" id="my_City_006012" class="J_City"><label for="J_City_006012">铁岭市</label></span><span class="areas"><input type="checkbox" value="006013" id="my_City_006013" class="J_City"><label for="J_City_006013">朝阳市</label></span><span class="areas"><input type="checkbox" value="006014" id="my_City_006014" class="J_City"><label for="J_City_006014">葫芦岛市</label></span><p style="text-align: right;"><input type="button" value="关闭" class="close_button"></p></div></span></div>
                        </div>
                    </div>
                </li>
                <li class="even">
