        ...
        <p class="ptitle">
            <span class="spanrig"><a href="S_SellGoods_One.aspx?op=add&step=one" class="tianjiafl lmf_btn"
                target="_blank">添加商品</a> </span><a href="S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><span
                    class="breadcrume_text">库存预警商品</span></p>
        <ShopNum1ShopAdmin:S_RepertoryAlertProduct ID="S_RepertoryAlertProduct" PageSize="10" runat="server"
            SkinFilename="skin/S_RepertoryAlertProduct.ascx" />
    </div>
    </form>
</body>
</html>
