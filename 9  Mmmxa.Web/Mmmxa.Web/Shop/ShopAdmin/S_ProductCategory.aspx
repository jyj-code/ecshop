...
//        }else{}
    ...
    $(function(){
            ...
            $(".shanchu").click(function(){
                    ...
                    var varry=new Array();var bflag=true;
                    $(".vcheck").each(function(){
                            if($(this).is(":checked")){varry.push($(this).val());bflag=false;}
                    });
                    if(bflag)
                    {
                       alert("请选中一条数据！");return false;
                    }
                     if(confirm("是否批量删除？")){
...
<body>
    <form id="form1" runat="server">
      <div class="dpsc_mian">
     <p class="ptitle"><span class="spanrig"> <a class="tianjiafl lmf_btn" href="S_ProductCategory_Operate.aspx?op=add&id=0">添加分类</a></span>
<a href="S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">店铺商品分类</span></p>
