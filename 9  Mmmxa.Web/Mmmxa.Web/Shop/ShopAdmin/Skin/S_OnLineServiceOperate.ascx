<div class="pad">
    <table id="Table1" width="100%" border="0" cellspacing="0" cellpadding="0" class="tabbiao">
        ...
        <tr>
            ...
            <td>
                <input name="input" type="text" class="textwb" id="txt_OnlineServiceName" runat="server"  maxlength="20"   onblur="CheckNull(this,'客服名称不能为空')"  />
        ...
        <tr>
            ...
            <td>
                <input type="text" class="textwb" id="txt_OnlineServiceID" runat="server" maxlength="30"  onblur="CheckNull(this,'客服名称不能为空');CheckQQCommon(this,'QQ格式错误')"  />
                <span class="gray1" style="color:Red">&nbsp;*</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" class="textwb" id="txt_OrderID" runat="server"  readonly="readonly" />
                <span class="gray1">&nbsp;</span>
            </td>
        </tr>
        <tr>
