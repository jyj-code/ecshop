    ...
    <p class="ptitle">
        <span class="spanrig">
            <%if (lblState.Text != "已发布" && lblState.Text != "已结束" && lblState.Text != "已取消")
              {%>
            <a class="tianjiafl lmf_btn" href="S_Limit_AddProduct.aspx?act=add&lid=<%=Common.ReqStr("lid")%>">
                添加商品</a>
            <%} %>
        ...
        <div id="list_main">
            ...
            <div id="content">
                <div style="padding-left: 10px;">
                    ...
                    <div class="limit_notes" style="border: 1px solid #ffd3a8; background: #ffffcc; margin-right: 10px;
                      ...
                      %>
                        ...
                        <tr>
                            <td class="th_le1" style="text-align: left;">
                                <a rel="<%=stroriginalImage%>" target="_blank" href="<%=ShopUrlOperate.shopHrefNew(strGuid,strMemloginId)%>"
                                    title="<%=strName %>">
...
<script type="text/javascript" language="javascript">
      ...
      {
         if(confirm('确定发布该活动吗？')){
                 if($("#publisactivity td").size()<5){alert("请添加限时折扣商品！");return false;
                 };return true;}
                 else{return false;}
      }
</script>
