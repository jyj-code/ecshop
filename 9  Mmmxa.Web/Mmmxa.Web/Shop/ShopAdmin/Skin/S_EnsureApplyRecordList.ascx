                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0" class="baoz">
                    <tr>
                        <td rowspan="3" width="30" valign="top">
                            <img src='<%#ShopNum1.ShopAdminWebControl.S_EnsureApplyRecordList.GetImg(DataBinder.Eval(Container.DataItem, "ImagePath"))%>' width="20" height="23"  />
                            
                                
                        </td>
                        <td class="tdtit">
                            <span style="float: right;" class="orange">保证金额度：<%# DataBinder.Eval(Container.DataItem, "EnsureMoney")%>元
                                </span><span class="tit"><%# DataBinder.Eval(Container.DataItem, "Name")%></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <ItemTemplate>
               <div>
                <table width="95%" border="0" cellspacing="0" cellpadding="0" class="baoz">
                    <tr>
                        <td rowspan="3" width="30" valign="top">
                            <img src='<%#ShopNum1.ShopAdminWebControl.S_EnsureApplyRecordList.GetImg(DataBinder.Eval(Container.DataItem, "ImagePath"))%>' width="21" height="25"    />
                        </td>
                        <td class="tdtit">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btn_Open"  runat="server" Text='<%#ShopNum1.ShopAdminWebControl.S_EnsureApplyRecordList.GetStatus(Eval("IsAudit").ToString(),Eval("IsPayMent").ToString(),Eval("ID").ToString(),Eval("ShopID").ToString(),"0")%>'  CssClass="sqjdbzj" CommandName="open" />
