...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="gridview_m blue_tbw1">
        <tr>
             <th width="430" class="th_le" style="text-align:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分类排序&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分类名称</th>
            <th>是否在前台显示</th>
            <th class="th_ri" style="text-align:center;">操作</th>
        </tr>
              ...
              {%>
                   <tr class="one lmf_huaguo" id='parent_<%=dataRow["ID"]%>'>
                      <td align="left" valign="middle" class="th_le">
                        ...
                        <%} %>
                        </div><div class="lmf_xuanze fl">
                        <%if (dataRow["v"].ToString() == "")
                          {%>
                        <input type="checkbox" class="checkboxsn vcheck" onclick="checksub(this,'<%=dataRow["ID"]%>')"  value='<%=dataRow["ID"]%>'/><%} %></div>
                        <div class="lmf_paixu fl"><input type="text" name="orderby" lang='<%=dataRow["ID"]%>' value='<%=dataRow["orderid"]%>' style="width:65px;" /></div>
                    ...
                    <td class="th_ri" style="width:300px;">
                        ...
                        <a href="S_ProductCategory_Operate.aspx?op=edit&id=<%=dataRow["ID"]%>&width=810&height=500" style="color: #4482b4;">编辑</a>&nbsp;
                        <%if (dataRow["v"].ToString() == "")
                          { %>
                            <a href="javascript:void(0)" style="color: #4482b4;" lang='<%=dataRow["ID"]%>' class="delv" onclick="treelist_delete(this)">删除</a>&nbsp;
                        <%}%>
                        <a href='S_ProductCategory_Operate.aspx?op=add&id=<%=dataRow["ID"]%>&parentid=<%=dataRow["ID"]%>&width=810&height=500' style="color: #4482b4;">添加子分类</a>
                    </td>
                  </tr>
