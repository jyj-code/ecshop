...
<script  type="text/javascript">
    ...
    {
        var Evidence=$("#S_ComplaintOrderComplaint_ctl00_TextBoxEvidence").val();
        if(Evidence!="")
        {
            $("#errEvidence").html("*");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top:15px;" >
  <tr>
    <th colspan="2" scope="col">我要投诉</th>
    </tr>
    <tr>
    <td class="bordleft" colspan="2" style=" text-align:left">&nbsp;&nbsp;&nbsp;投诉信息</td>
  </tr>
    <asp:Repeater ID="RepeaterShow" runat="server">
    <ItemTemplate>
          <tr>
    <td class="bordleft" width="130">投诉编号：</td>
    <td class="bordrig" >
      <%#Eval("ID") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">投诉人：</td>
    <td class="bordrig" >
      <%#Eval("MemLoginID") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">投诉订单编号：</td>
    <td class="bordrig" >
      <%#Eval("OrderID") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">投诉类型：</td>
    <td class="bordrig" >
      <%#Eval("ComplaintType") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">投诉证据：</td>
    <td class="bordrig" >
       <%#Eval("Evidence") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">证据图片：</td>
    <td class="bordrig" >
  ...
  <tr>
    <td class="bordleft" colspan="2" style=" text-align:left">&nbsp;&nbsp;&nbsp;申诉信息</td>
  </tr>
  <tr>
    <td class="bordleft">申诉证据：</td>
    <td class="bordrig" style="padding-top:8px;">
        <asp:TextBox ID="TextBoxEvidence" runat="server" TextMode="MultiLine" onblur="funCheckEvidence()" CssClass="op_area"></asp:TextBox>
        <span class="red" id="errEvidence">*</span>
    </td>
  </tr>

  <tr>
    <td class="bordleft" style=" border-bottom:solid 1px #c6dfff;" >申诉图片：</td>
  ...
  <tr runat="server" id="trResult" visible="false">
    <td colspan="2" style=" color:Red; font-size:16px; font-weight:bold; text-align:center" >平台已经处理,处理结果请查看详细！</td>
  </tr>
</table>
