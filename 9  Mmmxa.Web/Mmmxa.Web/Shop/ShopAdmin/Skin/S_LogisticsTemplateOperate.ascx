  ...
  <div id="list_main">
    ...
    <div class="TabbedPanelsContentVisible" style="display: block;">
       <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tabbiao">
            <tr>
                <td align="right" style="width:130px;">模板名称：</td>
                <td>
                <input type="text" onchange="CheckTemplateName()" class="textwb" maxlength="50" id="texttemplateName"    runat="server" />
              ...
              <tr>
                ...
                <td>除指定地区外，其余地区的运费采用"默认运费"  </td>
              </tr>
              <tr>
                <td align="right"></td>
                <td style="width:700px">
                <input type="checkbox" name="tplType" onclick="ExpressCheckBox(this)" value="-4"  id="checkboxExpress" class="J_Delivery" runat="server" />  快递
                  </td>
              </tr>
                 ...
                 <table width="95%" cellspacing="0" cellpadding="0" border="0" class="yunf">
                  <tr>
                    <td style="padding-left:10px;" class="yunfbg" id="postExpress"  colspan="6" runat="server">
                            默认邮费：<input type="text" disabled="disabled" value="1" name="express_start_0" style="background: #EEE;width: 72px; border: 1px solid  #7F9DB9;" />
                            件内，<input type="text" name="express_postage_0" value="10" id="express_postage_0" style="background: #fff; width: 72px; border: 1px solid  #7F9DB9;" runat="server" />
                            元， 每增加
                            <input type="text" value="1" name="express_plus_0" style="background: #EEE;width: 72px; border: 1px solid  #7F9DB9;" />
                            件， 增加邮费
                            <input type="text" id="express_postageplus_0" name="express_postageplus_0" value="0" style="background: #fff; width: 72px;border: 1px solid  #7F9DB9;" runat="server"/>
                            元
                  ...
                  <tr>    
                    <td style="padding-left:10px;">
                       <table width="95%" cellspacing="0" cellpadding="0" border="0" class="yunftab" id="ExpressRows">
                          <tr>
                            <th scope="col" style="width:150px;">运送到</th>
                            <th scope="col">首件(件)</th>
                            <th scope="col">首费(元)</th>
                            <th scope="col">续件(件)</th>
                            <th scope="col">续费(元)</th>
                            ...
                            <ItemTemplate>
                                <tr runat="server" id="trExpress">
                                    <td style="text-align:center;">
                                            <span><%# ((DataRowView)Container.DataItem).Row["groupregionnames"]%></span>
                                    ...
                                    <td style="text-align: center;">
                                        <input type="text" disabled="disabled" value="1" name="express_start_<%#RepeaterExpress.Items.Count%>" style="background: #EEE;
                                            width: 72px;   border: 1px solid  #7F9DB9;" />
                                    </td>
                                    <td style="text-align: center;">
                                        <input type="text" name="express_postagevalue_<%#RepeaterExpress.Items.Count%>" value='<%# ((DataRowView)Container.DataItem).Row["fee"]%>'
                                            style="background: #fff; width: 72px; border: 1px solid  #7F9DB9;" />
                                    </td>
                                    <td style="text-align: center;">
                                        <input type="text"  value="1" name="express_plus_<%#RepeaterExpress.Items.Count%>" style="background: #EEE;
                                            width: 72px; border: 1px solid  #7F9DB9;" />
                                    </td>
                                    <td style="text-align: center;">
                  ...
                  <tr>
                    <td style="padding-left:10px;"><a href="javascript:void(0)" onclick="AddAdress(this,'express','ExpressRows')">为指定地区城市设置邮费</a></td>
                  </tr>
                    </table>
                  </td>
              </tr>
             <tr>
                <td class="tab_r"></td>
                <td  style="width:700px">
               <input id="checkboxEMS" runat="server" class="J_Delivery" type="checkbox" onclick="EmsCheckBox(this)" name="checkboxEMS" />  EMS 
                  </td>
              </tr>
                 ...
                 <table width="95%" cellspacing="0" cellpadding="0" border="0" class="yunf">
                  <tr>
                    <td style="padding-left:10px;" class="yunfbg" id="postEms"  colspan="6" runat="server">
                     默认邮费：
<input type="text" style="background: #EEE; width: 72px; border: 1px solid #7F9DB9;" name="ems_start_0" disabled="disabled" value="1">
件内，
<input id="ems_postage_0" runat="server" type="text" style="background: #fff; width: 72px; border: 1px solid #7F9DB9;" value="10" name="ems_postage_0" />
元， 每增加
<input type="text" style="background: #EEE; width: 72px; border: 1px solid #7F9DB9;" name="ems_plus_0" value="1">
件， 增加邮费
<input id="ems_postageplus_0" type="text" style="background: #fff; width: 72px; border: 1px solid #7F9DB9;" value="0" name="ems_postageplus_0" runat="server" />
元
<input id="hiddenemsNum" type="hidden" value="0" name="hiddenemsNum">
                            ...
                            <ItemTemplate>
                                <tr runat="server" id="trEMS">
                                   <td style="text-align:center;">
                                    ...
                                    <td style="text-align: center;">
                                        <input disabled="disabled" value="1" type="text" name="ems_start_<%#RepeaterEMS.Items.Count%>" style="background: #EEE;
                                            width: 72px; border: 1px solid  #7F9DB9;" />
                                    </td>
                                    <td style="text-align: center;">
                  ...
                  <tr>
                    <td style="padding-left:10px;"> 
                    <a href="javascript:void(0)" onclick="AddAdress(this,'ems','EmsRows')">为指定地区城市设置邮费</a></td>
                  </tr>
                    </table>
                  </td>
              </tr>
              <tr>
                <td class="tab_r"></td>
                <td  style="width:700px">
                    <input id="checkboxPost" runat="server" class="J_Delivery" type="checkbox" onclick="PostCheckBox(this)" name="checkboxPost" />  平邮 
                  </td>
              </tr>
                 ...
                 <table width="95%" cellspacing="0" cellpadding="0" border="0" class="yunf">
                  <tr>
                    <td style="padding-left:10px;" class="yunfbg" id="postPost"  colspan="6" runat="server">
                     默认邮费：
<input type="text" style="background: #EEE; width: 72px; border: 1px solid #7F9DB9;" name="post_start_0" disabled="disabled" value="1">
件内，
<input id="post_postage_0" runat="server" type="text" style="background: #fff; width: 72px; border: 1px solid #7F9DB9;" value="10" name="post_postage_0">
元， 每增加
<input type="text" style="background: #EEE; width: 72px; border: 1px solid #7F9DB9;" name="post_plus_0" value="1">
件， 增加邮费
<input id="post_postageplus_0" runat="server" type="text" style="background: #fff; width: 72px; border: 1px solid #7F9DB9;" value="0" name="post_postageplus_0">
元
<input id="hiddenpostNum" type="hidden" value="0" name="hiddenpostNum">
                          ...
                          <asp:Repeater ID="RepeaterPost" runat="server">
                           <ItemTemplate>
                                 <tr runat="server" id="trPost">
                                    ...
                                    <td style="text-align: center;">
                                        <input disabled="disabled" value="1" type="text" name="post_start_<%#RepeaterPost.Items.Count%>" style="background: #EEE;
                                            width: 72px; border: 1px solid  #7F9DB9;" />
                                    </td>
                                    <td style="text-align: center;">
                  ...
                  <tr>
                    <td style="padding-left:10px;">
                    <a href="javascript:void(0)" onclick="AddAdress(this,'post','PostRows')">为指定地区城市设置邮费</a></td>
                  </tr>
                    </table>
                  </td>
              </tr>
...
//]]>
    ...
    <div id="feeTemplateDiv" runat="server" visible="false">
        默认邮费：<input type="text" value="1" disabled="disabled" name="S_LogisticsTemplateOperate_ctl00_{delivery}_start_0" style="background: #EEE;
            width: 72px; border: 1px solid  #7F9DB9;" />
        件内，<input type="text" name="S_LogisticsTemplateOperate_ctl00_{delivery}_postage_0" id="S_LogisticsTemplateOperate_ctl00_{delivery}_postage_0" value="{value}"
            style="background: #fff; width: 72px; border: 1px solid  #7F9DB9;" />
        元， 每增加
        <input type="text"  value="1" name="S_LogisticsTemplateOperate_ctl00_{delivery}_plus_0" style="background: #EEE;
            width: 72px; border: 1px solid  #7F9DB9;" />
        件， 增加邮费
        <input type="text" name="S_LogisticsTemplateOperate_ctl00_{delivery}_postageplus_0" id="S_LogisticsTemplateOperate_ctl00_{delivery}_postageplus_0"
            value="{plusvalue}"  style="background: #fff; width: 72px; border: 1px solid  #7F9DB9;" />
        元
        <input id="hidden{delivery}Num" name="S_LogisticsTemplateOperate_ctl00_hidden{delivery}Num" value="{postnumvalue}" type="hidden" />
    </div>
