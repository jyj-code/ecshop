    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod">
        ...
        <tr>
            ...
            <td class="bordrig">
                ...
                <asp:TextBox ID="TextBoxOrganizImg" runat="server" CssClass="textwb"></asp:TextBox>
                ...
                <input id="bt2" class="selpic" style="position: relative; bottom: -5px;" type="button"
                    value="选择图片" onclick="showDialog()" />
                <div class="gray">(可更改)</div>
            </td>
        </tr>
        <tr>
            <td class="bordleft">
        ...
        <tr>
            <td class="bordleft">
                <asp:Label ID="Label1" runat="server" Text="剩余预存款："></asp:Label>
            </td>
            <td class="bordrig">
