        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="blue_tb2">
            ...
            <%if (dt != null)
              {
                  for (int i = 0; i < dt.Rows.Count; i++)
                  {
                      ...
                      switch (strState)
                      {
                          case "0": strState = "未开始"; break;
                          case "1": strState = "进行中";
                              if (Convert.ToDateTime(strEndTime) <= System.DateTime.Now)
                              {

                                  strState = "已结束"; strUrlEnd = "&close=true";
                              }
                              break;
                          case "2": strState = "已关闭"; break;
                      }
            ...
            <tr>
                <td style="text-align: left;">
                    ...
                    <a href="S_ThemeProductList.aspx?ThemeGuid=<%=strId %>" style="float: left; display: block;
                        padding-left: 10px; width: 210px;">
                        <%=strName%></a>
                </td>
                <td>
                    <p mode="wrap" style="width:220px;text-align: left; white-space: normal;"><%=strDescription.Length > 100 ? strDescription.Substring(1, 100) : strDescription%></p>
                </td>
                <td>
                    <%=strCount%>
                </td>
                ...
                <td>
                    ...
                    <a style="color: #015FA7;" class="join">参与活动</a> <span style="display: none;">
                        <%=strId%></span>
                    <%} %>
                    <a href="S_ThemeProductList.aspx?ThemeGuid=<%=strId %>" style="color: #015FA7; ">
                        查看</a>
                </td>
            </tr>
            <%}
...
<script type="text/javascript">
    $(function(){
        $(".join").click(function(){
            $("#loadProduct").html("");
            $("#S_ThemeList_ctl00_txtKeyWord").val("");$("#checkAll").attr("checked",false);
...
<div class="sp_dialog sp_dialog_out" style="display: none;" id="sp_dialog_outDiv">
    <div class="sp_dialog_cont" style="display: none;" id="sp_dialog_contDiv">
        ...
        <div class="sp_dialog_info" style="padding-bottom: 18px;">
            <br />
            <p class="sp_general">
                <label class="sp_lable">商品名称：</label>
                ...
                <span style="float: left; font-size: 12px; color: Red; display: none" id="showLoading">
            ...
            <p class="sp_general" style="height: 160px; display: none;">
                <label class="sp_lable">
                    选择商品：</label>
                <select id="selectproduct" style="width: 300px; height: 150px; display: none;" class="textwb"
                    size="10">
                </select>
            </p>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod biaod1" style="margin-top: 15px;margin-left: 20px;border-left:1px solid #e3e3e3;" id="showProuct">
                <thead>
                    <tr>
                        <th align="center" style="width:30px;">
                            <input type="checkbox" id="checkAll" style="position:relative;left:-3px;" />
                        </th>
                        <th style="width: 450px; border-left: none; text-align:center;">
                            商品名称
                        </th>
                        <th style="width: 20%; border-left: none; text-align:center;">
                            价格
                        </th>
                        <th style="width: 10%; border-left: none; text-align:center;">
                            库存
                        </th>
                    </tr>
                </thead>
            ...
            <p class="sp_general" style="text-align:center; margin-top:10px;">
                <span class="sp_lable"></span>
