...
<script type="text/javascript">
    ...
    //限制上传图片    
     function showDialog()
    {
        $("#showiframe").attr("src","/Shop/ShopAdmin/S_ShowShopPhoto.aspx?txtid=<%=HiddenFieldImgPath.ClientID %>&imgid=<%=InputImgPath.ClientID %>");
        funOpen();
    }
    
    
    $(function(){
            if($("#S_ShopVideoEdit_ctl00_InputImgPath").attr("src")=="")
            {
                $("#showImg").attr("style","display:none");
            }
    });
</script>
...
<div class="dpsc_mian">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top: 15px;">
        ...
        <tr>
                ...
                <td class="bordrig" style="padding-top: 8px;">
                    <asp:HiddenField ID="HiddenFieldImgPath" runat="server" />
                    <input id="FileUploadImgPath" name="" type="button" class="selpic" onclick="showDialog()" value="选择图片" />
                </td>
            </tr>
            <asp:Panel ID="PanelShow" runat="server" Visible="false"></asp:Panel>
                <tr id="showImg">
                    <td class="bordleft">
                        视频图片预览：
                    </td>
        ...
        <tr>
            ...
            <td class="bordrig" style="padding-top: 8px;">
                <asp:TextBox ID="TextBoxDescription" runat="server" TextMode="MultiLine" CssClass="op_area" onblur="funCheckDescription()"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="bordrig" style="padding-top: 8px;">
                <asp:TextBox ID="TextBoxContent" runat="server" TextMode="MultiLine" CssClass="op_area" onblur="funCheckContent()"></asp:TextBox>
