    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top: 15px;">
        ...
        <tr>
            ...
            <td class="bordrig" style="border-bottom: 1px solid #C6DFFF;">
                <textarea id="txtContent" runat="server"  CssClass="op_area" TextMode="MultiLine" style="width:400px;border:1px solid #CCCCCC;" MaxLength="200"></textarea>
            </td>
        </tr>
        <tr>
            <td class="bordleft">
        ...
        <tr>
            ...
            <td class="bordrig" style="border-bottom: 1px solid #C6DFFF;">
                <asp:TextBox ID="TextBoxReplyContent" runat="server" CssClass="op_area" TextMode="MultiLine" MaxLength="200"></asp:TextBox>
            </td>
        </tr>
    </table>
    <div class="op_btn">
