...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top:15px;" >
  <tr>
    <th colspan="2" scope="col">我要申诉</th>
    </tr>
    <tr>
    <td class="bordleft" colspan="2" style=" text-align:left">&nbsp;&nbsp;&nbsp;举报信息：</td>
  </tr>
    <asp:Repeater ID="RepeaterShow" runat="server">
    <ItemTemplate>
          <tr>
    <td class="bordleft" width="130">举报编号：</td>
    <td class="bordrig" >
      <%#Eval("ID") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">举报人：</td>
    <td class="bordrig" >
      <%#Eval("MemLoginID") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">举报类型：</td>
    <td class="bordrig" >
      <%#Eval("ReportType") %>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">举报证据：</td>
    <td class="bordrig" >
       <%#Eval("Evidence") %>
    </td>
  </tr>
