...
<script type="text/javascript" language="javascript">
            $(function(){
                    ...
                    if($("#S_OrderDetail_ctl00_hidlifetype").val()=="2"&&state=="1")
                    {
                       $("#select2").addClass("settab"+state);
                    }
                    else if(state=="1")
                    {
                        $("#select2").addClass("settab"+state);
                    ...
                    {
                        $("#payupdate1").show();$("#isshowpayupdate1").hide();$("#S_OrderDetail_ctl00_butFahuo").hide();
                    ...
                    if(hidrefundstatus=="2"&&state=="2"&&hidRefundType=="1")
                    {
                        ...
                        if($("#S_OrderDetail_ctl00_hidlifetype").val()=="2")
                        {
                            ...
                            $("#hideAddress").hide();
                             $("#IsFahuo").hide();$("#S_OrderDetail_ctl00_hidislogistic").val("0");
...
$.get("/Api/getdate.ashx?r="+Math.random(),null,function(data){
    ...
    seconds=Math.floor((e_minsold-minsold)*60);  
      if(daysold<0)
        {
         document.getElementById(element).innerHTML="0天0小时0分0秒"; $("#S_OrderDetail_ctl00_btnSureConfirm").show();
        } else{
    document.getElementById(element).innerHTML=daysold+"天"+hrsold+"小时"+minsold+"分"+seconds+"秒" ;
            ...
            function getfahuo(obj)
            {
                ...
                {
                    $("#S_OrderDetail_ctl00_hidlogisticCompany").val($("#showInputLogistic").val()+"|"+$("#selectlogistic").find("option:selected").val());$("#S_OrderDetail_ctl00_hidisOther").val("1");
                }
                else
                {
            ...
            function sureConfirm()
            {
                ...
                $("input[name='checksub']").each(function(){xarrid.push(""+$(this).val()+""); xprice.push($(this).attr("v_price")); xnum.push($(this).attr("v_num"));  });
                ...
                if(confirm("是否代替买家执行确认收货操作！")){return true;}else{return false;}
            }
            //检测验证码是否正确
            function CheckCode()
            {
...
<div id="content_bg"> 
            ...
            <tr style="height: 30px;">
                <td class="arrow_1" valign="top">
                    ...
                    <div id="payupdate0" class="payupdate" style="display: none;">
                        ...
                        <div class="orderxx">
                            <ul>
                                <li class="ordul1" style="margin-top: 30px; margin-bottom: 5px;">当前订单状态：宝贝未付款，请通知买家尽快付款。</li>
                                 <li>支付方式：<%=hidPayMentName.Value%>。</li>
                                  <li><%if (hidPayMentName.Value != "货到付款"){%> 请通知买家尽快付款。<%} %></li>
                            </ul>
                        </div>
                    </div>
                </td>
                <td class="arrow_2" valign="top">
                    ...
                    <div id="payupdate1" class="payupdate1" style="display: none">
                        ...
                        <div class="orderxx">
                            <ul>
                                <li class="ordul1" style="margin-top: 30px; margin-bottom: 5px;">当前订单状态：<span id="showstatetxt">买家已付款，请尽快发货。</span></li>
                ...
                <td class="arrow_3" valign="top">
                    ...
                    <div id="payupdate2" class="payupdate2" style="display: none; padding-top:20px;">
                        ...
                        <div class="orderxx">
                            <ul>
                                <li class="ordul1" style="margin:20px 0 5px 0;">当前订单状态：等待<span id="showlifetxt">卖家发货</span><span class="showlife">，请查看上面物流信息了解宝贝寄送情况</span></li>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" id="IsFahuo" style="padding: 10px 20px;">
                                        <tr>
                                            ...
                                            <td class="hidfahuo">
                                                ...
                                                </select><input type="text" id="showInputLogistic" maxlength="8" style="margin-left:5px;display:none;border:1px solid #CCCCCC; color:#464646; width:100px; height:22px; line-height:22px;"/>
                                            </td>
                                            <td align="right" class="ss_nr_spac hidfahuo">
                                                物流单号：
                                            </td>
                                            ...
                                            <td>
                                                <asp:LinkButton ID="butFahuo" runat="server" Text="发货" OnClientClick="return getfahuo(this);"
                                                    CssClass="fasong" style="display:block; color:#ffffff;" />
                                ...
                                <li>
                                    <table cellpadding="0" cellspacing="0" border="0" id="showlifesend" style="padding: 10px 20px; display:none;">
                                        <tr>
                                            <td align="right">
                                        消费码：
                                        <input id="txtlifeCode" type="text" onkeyup="NumTxt_Int(this)" runat="server" class="ss_nr1" value="" maxlength="10" /></td>
                                        <td><asp:LinkButton ID="btnLifeFahuo"  runat="server" Text="消费" OnClientClick="return CheckCode()" style="display:block; color:#ffffff;"  CssClass="fasong"></asp:LinkButton></td>
                                       </tr>
                                   </table>
                                </li>
                            </ul>
                ...
                <td class="arrow_4" valign="top">
                    <div>
                        ...
                        <div class="orderxx">
                            <ul>
                                <li class="ordul1" style="margin-top: 30px; margin-bottom: 5px;">当前订单状态：<span id="showgoodstate">等待买家确认收货</span></li>
                                 <li class="ordul1" id="exitgoods" style="margin-top: 30px; margin-bottom: 5px;">如果买家在<asp:Label ID="lblSureDays" runat="server"></asp:Label>天内未确认收货,
                                 您可以在<span id="suretime" style="color:Red"></span>后可以执行确认收货操作<asp:LinkButton ID="btnSureConfirm" runat="server" Text="【确认收货】" OnClientClick="return sureConfirm();"  CssClass="orang_a" style="display:none;width:60px;" />
                                 </li>
                            </ul>
                        </div>
                    </div>
                    <div id="payupdate4" class="payupdate3" style="display: none; padding-top:10px;">
                        ...
                        <div class="orderxx">
                            <ul>
                                <li class="ordul1" style="margin-top: 30px; margin-bottom: 5px;">当前订单状态：<span id="spanleftend">交易已成功</span></li>
                            </ul>
                        </div>
                    </div>
                </td>
    ...
    <div class="ddtitle" style="width: 950px; margin: 0 auto;">
         <span style="float: left;">订单信息</span> <span style="float: right;"><a target="_blank"
            href="S_PrintOrder.aspx?guid=<%=Common.ReqStr("guid") %>&ordertype=<%=Common.ReqStr("ordertype") %>">
            <img src="images/print.jpg" /></a> </span>
            <%if (Convert.ToInt32(hidOrderState.Value) > 1 && hidlogisticCompany.Value.ToString() != "000" && lbllogisticType.Text.ToString()!="不需要物流")
              { %>
            <span style="float: right;"><a target="_blank"
                id="printorder" style="color: #ffffff;" class="fasong" href="S_PrintSingOrder.aspx?guid=<%=Common.ReqStr("guid") %>">
                打印快递单</a></span><%} %>
    </div>
    <div class="dingdnr" style="width: 950px; margin: 0 auto;">
        <div class="dingdx">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style="width: 200px;">
                        会员ID：<asp:Label ID="lblMemLoginId" runat="server"></asp:Label><a class="fasong" style="color:#ffffff;"  href="/Main/Member/M_index.aspx?tomurl=M_SendMsg.aspx?ordernumber=<%=lblOrderNumber.Text %>|shop&" target="_blank">发送消息</a>
                    </td>
                    <td>
        ...
        <div class="dingdx">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="orderta">
                <tr style="height: 30px; line-height: 30px;">
                    ...
                    <th scope="col" style="width: 390px; border-left: solid 1px #dddddd;">
                        商品
                    </th>
                    <th scope="col">
                        商品规格
                ...
                %>
                <tr>
                    <td style=" height: 60px;border-left: solid 1px #dddddd;display:none;">
