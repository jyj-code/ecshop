        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5" class="blue_tbw1">
                ...
                <asp:Repeater ID="RepeaterShow" runat="server">
                    <ItemTemplate>
                        <tr height="45">
                            <td class="th_le1">
                                <a target="_blank" href='http://<%#ShopNum1.ShopAdminWebControl.S_ShopURLManage.GetLongUrl(Eval("DoMain").ToString(), Eval("MemLoginID").ToString())%>'>
                                    http://<%#ShopNum1.ShopAdminWebControl.S_ShopURLManage.GetLongUrl(Eval("DoMain").ToString(), Eval("MemLoginID").ToString())%>
                                </a>
                            </td>
                            <td>
                                <%#Eval("AddTime")%>
