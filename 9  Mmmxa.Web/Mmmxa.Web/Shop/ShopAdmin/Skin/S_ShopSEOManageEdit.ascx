...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top:15px;" >
  <tr>
    <th colspan="2" scope="col">SEO设置</th>
  <tr>
    <td class="bordleft" style=" width:100">页面名：</td>
  ...
  <tr>
    ...
    <tr>
    <td class="bordleft">说明：</td>
    <td class="bordrig" style="padding-top:8px;">
        <asp:TextBox ID="TextBoxEsec" runat="server"  CssClass="textwb" onblur="funCheckEsec()"  Width="300" Height="90" TextMode="MultiLine"></asp:TextBox>
