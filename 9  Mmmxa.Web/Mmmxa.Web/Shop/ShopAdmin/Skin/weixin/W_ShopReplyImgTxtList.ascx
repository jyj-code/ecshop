...
<div class="tjsp_mian">
    <p class="ptitle">
        <a href="S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">图文回复列表</span></p>
    <div class="box_content">
        <div class="box_content1">
            <a class="icon_plus1" href="W_ShopReplyImgTxt.aspx">添加</a> <a class="icon_refresh"
                    ...
                    <asp:Repeater ID="rep_rule" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="label_sat">
                                    <%#System.Web.HttpUtility.UrlDecode(Eval("content").ToString(), Encoding.GetEncoding("utf-8"))%>
                                </td>
                                <td>
                                ...
                                <td><div style="width:50px;  margin:0 auto;">
                                    <a href="W_ShopReplyImgTxt.aspx?ruleid=<%#Eval("ID") %>" class="with_hidden2"></a>
                                    <a href="javascript:void(0);" class="with_hidden3"></a></div>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
