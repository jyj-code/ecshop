...
<script type="text/javascript" language="javascript">
        $(function(){
               ...
               $("#btnOpen,#btnDelay").click(function(){
                      funOpen();$("#titleDiv").text($(this).attr("lang"));
               });
        });
...
<div id="J_showTip" class="come_wx" style="display:none;">
        ...
        <div class="sp_dialog sp_dialog_out" style="display: none;" id="sp_dialog_outDiv">
            <div class="sp_dialog_cont" style="display: none;" id="sp_dialog_contDiv">
                    <div class="sp_tan">
                        <h4>[<span id="titleDiv"></span>]预存款支付</h4>
                        <div class="sp_close"><a href="javascript:void(0)" onclick="funClose()"></a></div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <table>
                        <tr>
                            <td colspan="2" style="line-height: 36px;">
                                <div>您当前的预存款余额为：￥<%=hidMyShouldPay.Value%></div>
                                <div><asp:Label ID="lblIsHavePayPwd" runat="server" Text="您当前没有设置支付密码，请点击" Visible="false"></asp:Label>
                                    <a id="Apaypwdalink" href='/main/account/A_Index.aspx?tomurl=A_PwdSer.aspx' style=" color:red" visible="false" target="_parent" runat="server">设置支付密码</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="line-height: 36px;">
                                <div>您需要支付：￥<%=hidWxPayMoney.Value %> 元/<%=hidPayTime.Value%></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <span style="color: red" id="errPwd" lang="0">
                        </span>
                            </td>
                        </tr>
                        <tr>
