    ...
    <div class="box_content">
        <div class="control_group">
            ...
            <div class="controls">
                ...
                <br />
                <span class="maroon">*</span><span class="help_inline">必填, 多个关键词请用空格格开：例如: 美丽 漂亮
                好看</span>
            </div>
        </div>
        <div class="control_group">
        ...
        <div class="control_group" id="textreply">
            ...
            <div class="controls">
                <div class="txtArea">
                    ...
                    <div class="editArea">
                        <asp:TextBox ID="txt_content" name="txt_content" Style="display: none; word-break:break-all;" title="first tooltip"
                            runat="server" TextMode="MultiLine" MaxLength="300"></asp:TextBox>
                        <div id="div_content" contenteditable="true" style="overflow-y: auto; overflow-x: hidden;
                            width: 450px; height: 100px;word-break:break-all;">
                        </div>
                    </div>
                </div>
   ...
   return ret;
    ...
    $(function() {
        ...
        if (data_content.length > 0) {
            $("#<%=txt_content.ClientID %>").val(UrlDecode(data_content));
            $contentDiv.html(Emotion.replaceEmoji(UrlDecode(data_content)));
        }
