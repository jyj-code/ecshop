    ...
    <div class="box_content">
        <div class="control_group">
            <label class="control_label">
                默认关注回复：</label>
            <div class="controls">
               <div> <asp:TextBox value="" ID="default_new" name="default_reply" class="textwb" runat="server"></asp:TextBox>
                </div><span class="help_in">此处填写您已定义的关键词,当用户添加关注时自动回复内容!</span><span class="help_block">
        ...
        <div class="control_group">
            <label class="control_label">
                默认无匹配回复：</label>
            <div class="controls">
               <div> <asp:TextBox value="" ID="default_reply" name="default_reply" class="textwb" runat="server"></asp:TextBox>
               </div> <span class="help_in">此处填写您已定义的关键词,当用户触发的关键词无匹配时自动回复内容!</span>  <span class="help_block">
                    <label class="checkbox">
    ...
    $(function() {
        ...
        $("#reg-btn").click(function() {
            ...
            $.ajax({
                ...
                data: {
                    attenrepkeys:escape(attenrepkeys),
                    notfindkeys: escape(notfindkeys),
