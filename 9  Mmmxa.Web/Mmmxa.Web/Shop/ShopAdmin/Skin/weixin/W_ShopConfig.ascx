    ...
    <div class="box_content">
        ...
        <div class="control_group">
            <label for="title" class="config_label">
                Logo：</label>
            <div class="controls">
                <asp:Image ID="img_logo" Style="width: 100px; height: 50px;" runat="server" ImageUrl="/ImgUpload/noimg.jpg_160x160.jpg"  onerror="javascript:this.src='/ImgUpload/noImg.jpg_160x160.jpg'"/>
        ...
        <div class="row_fluid1">
            <table id="listTable" class="row_fluid2" cellpadding="0" cellspacing="0">
                <tr>
                    <th style="width: 354px; height: 24px;">
                        图片地址
                    </th>
                    <th style="width: 122px; height: 24px;">
                    </th>
                    <th style="width: 198px; height: 24px;">
                        URL
                    </th>
