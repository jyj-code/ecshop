...
<div class="tjsp_mian">
    ...
    <div class="box_content">
        <div class="box_content1">
            <a class="icon_plus1" href="W_ShopReplyText.aspx">添加</a> <a class="icon_refresh" href="javascript:location.reload();">
            </a><a class="icon_delete" style="display: none;" href="javascript:void(0);"></a>
        </div>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><div style="width:50px;  margin:0 auto;">
                                    <a href="W_ShopReplyText.aspx?ruleid=<%#Eval("ID") %>" class="with_hidden2">
                                        </a>
