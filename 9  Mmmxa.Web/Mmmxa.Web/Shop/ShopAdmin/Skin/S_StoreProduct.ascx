...
//           });
           ...
           $(".shanchu").click(function(){
                    ...
                    var arryid=new Array();var bflag=false;
                     ...
                     alert("删除成功！");$("input[name='subcheck']").removeAttr("checked");window.location.href="S_StoreProduct.aspx";
          ...
          $(".shangj").click(function(){
                    var arryid=new Array();var bflag=true;
                     ...
                     if(bflag)
                     {
                        alert("请勾选一条数据进行上架操作！");return false;
                     }
                     if(confirm("是否执行上架操作？")){
                           $.get("/Api/ShopAdmin/S_SellProduct.ashx?type=4&sale=1&ids="+arryid.join(","),null,function(data){
                            ...
                            alert("上架成功!");$("input[name='subcheck']").removeAttr("checked");
                            $("#tipmsg").show().find("font").text("上架成功！");window.location.href="S_StoreProduct.aspx";
                      }
           });
           //搜索
...
<div id="list_main">
    <div class="ordmain1" id="content">
        ...
        %>
        <!--循环标签代码-->
        <table width="100%" id="Maintab_<%=dr["id"]%>" cellspacing="0" cellpadding="0" border="0"
