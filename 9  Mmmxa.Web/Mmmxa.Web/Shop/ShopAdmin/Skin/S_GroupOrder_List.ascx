...
<% DataTable dt = S_GroupOrder_List.dt_GroupOrderList; DataTable dt_sub = null; %>
...
<div id="list_main">
    ...
    <div id="content" class="ordmain">
                            ...
                            <tr>
                                <td>
                                    <input value='<%=Common.ReqStr("sd") %>' name="startdate" type="text" id="txtstartdate"
                                        style="width: 98px;" class="ss_nrduan Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
                                </td>
                                <td class="line_spac">
                                    -
                                </td>
        ...
        <div class="shangpinkj">
            ...
            <%if (dt != null)
              {
                  ...
                  for (int i = 0; i < dt.Rows.Count; i++)
                  {
                      ...
                      DataRow[] drr = dt_sub.Select("OrderInfoGuid='" + dr["guid"] + "'"); if (drr.Length != 0)
                      {
            %>
            <table width="100%" border="0" cellspacing="0" cellpadding="5" class="blue_tb1" id="Table1" style="margin:0; border-left:1px solid #e3e3e3; border-right:1px solid #e3e3e3; border-top:1px solid #e3e3e3;">
            <tr>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="5" class="blue_tb1" id="ord_<%=i%>" style="margin-top: 0;">
                ...
                <tr>
                    ...
                    <td rowspan="<%=drr.Length+1 %>" style="width: 70px;">
                        邮费：<%=strDispatchprice%>
                        <span class="redbold">
                           <br /> <%=strShouldPayPrice%></span>
                    </td>
                    <td rowspan="<%=drr.Length+1 %>">
                        <a href="javascript:void(0)" onclick="if(confirm('是否删除？')){location.href='?del=<%=strOrderNumber %>&sign=del'}"
                            class="alink_blue">删除</a>&nbsp;<a href="S_OrderDetail.aspx?guid=<%=strGuId %>&ordertype=<%=strOrderType %>" class="alink_blue"
                                target="_parent">查看</a><br />
                    </td>
                    <%} %>
                </tr>
                <% }%>
            ...
            <%}
              ...
              { %><div class="no_datas"><div class="no_data">没有查询到相关数据</div></div>
            <%} %>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="btntable_b"
                ...
                <tr>
                   ...
                   <td style="border-right: none;border-left: none; padding-left:10px; text-align:left;width:50px;">
                        <label for="checktop2">
                            全选</label>
                    </td>
