    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod">
        ...
        <tr>
            ...
            <td class="bordrig">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        ...
                                        <img style="width: 20px; height: 20px;" src='<%#Eval("SmallImage") %>'>
                                        <%#ShopNum1.Common.Utils.GetUnicodeSubString(Eval("name").ToString(),20,"..") %>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input id="btnAdd" class="packremove addpack_<%#Eval("ID") %>" type="button" lang="2" value="移除">
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                ...
                <table border="0" cellspacing="0" cellpadding="0" id="search_Pro"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top: 15px;
                    display: none; border-left:1px solid #e3e3e3;" id="showProuct">
                    <thead>
                        <tr>
                            <th style="width: 450px; border-left:none;">
                                商品名称
                            </th>
                            <th style="width:20%; border-left:none;">
                                价格
                            </th>
                            <th style="width:10%; border-left:none;">
                                库存
                            </th>
                            <th style="width:20%; border-left:none;">
                                操作
