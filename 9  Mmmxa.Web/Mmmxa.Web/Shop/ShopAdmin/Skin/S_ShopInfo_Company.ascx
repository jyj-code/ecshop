    ...
    { 
        ...
        { 
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabbiao">
              <tr>
                <td class="tab_r" width="160">企业名称：</td>
                <td>
              ...
              <tr>
                <td  class="tab_r">营业范围：</td>
                <td>
                  <asp:TextBox ID="TextBoxBusinessScope" runat="server" CssClass="textwb" TextMode="MultiLine" Width="450" Height="90" onblur="funBusinessScope()"></asp:TextBox>
                 <span class="red" id="errBusinessScope">*</span>
                </td>
              </tr>
              <tr>
                <td  class="tab_r">上传营业执照：</td>
                <td>
                <div>
