<div class="pad">
    <table id="Table1" width="100%" border="0" cellspacing="0" cellpadding="0" class="tabbiao">
        <tr>
            ...
            <td>
                <input name="input" type="text" class="op_text" id="txt_MenuName" runat="server" onblur="CheckNull(this,'请填写栏目名称')"   maxlength="50" /><span class="star" >*</span>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <input type="text" class="op_text" id="txt_AdLink" runat="server"  onblur="CheckNull(this,'请填写链接地址')" maxlength="250" /><span class="star" >*</span>
            </td>
        </tr>
        <tr>
            <td align="right">
