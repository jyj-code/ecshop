...
<script type="text/javascript" language="javascript">
    $(function(){
     ...
     if(confirm("是否删除勾选项？"))
     {
        $.get("/Api/ShopAdmin/S_DeleteOp.ashx?type=Shop_NewsCategory&delid="+val,null,function(data){
...
<div id="content" class="ordmain1">
    <div class="biaogenr">
        <div class="btntable_tbg">
            ...
            <div class="shanc">
                <a href="S_ShopNewsCategoryEdit.aspx" class="tianjiafl lmf_btn">添加分类</a>
            </div>
        </div>
            ...
            <asp:Repeater ID="RepeaterShow" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="th_ri1">
                            <a href='S_ShopNewsCategoryEdit.aspx?guid=<%#Eval("Guid")%>'>编辑</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
