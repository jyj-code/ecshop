    ...
    if(lock==0)
     {
      lock=1;
        ...
        if(k != null) 
        {
            ...
            imgvalue = k.split(",");
            if(fckName.indexOf("Instruction")==-1)
                editor.insertHtml("<img src='" + imgvalue[1] + "'>");
            else
                editor2.insertHtml("<img src='" + imgvalue[1] + "'>");
        }
      }
      lock=0;
    }
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabbiao">
        ...
        <tr>
            ...
            <td>
                <ShopNum1:TextBox ID="TextBoxName" runat="server" CssClass="textwb" CanBeNull="必填"
                    HintInfo="请填写该商品的名称,该项必填" HintTitle="请填写该商品的名称,该项必填" Width="405px"></ShopNum1:TextBox>
        ...
        <tr>
            ...
            <td align="left">
                <ShopNum1:TextBox ID="TextBoxMarketPrice" runat="server" CssClass="textwb" CanBeNull="必填"
                    ...
                    MaxLength="10" Width="69" Text="0.00"></ShopNum1:TextBox>（元）
            </td>
        </tr>
        <tr>
            <td style="text-align: right">
            ...
            <td align="left">
                <ShopNum1:TextBox ID="TextBoxIntegral" runat="server" CssClass="textwb" CanBeNull="必填"
                    HintInfo="请填写该商品的兑换积分,该项必填" RequiredFieldType="金额" HintTitle="请填写该商品的兑换积分,该项必填"
                    MaxLength="10"></ShopNum1:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right">
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input id="bt2" class="sqjdbzj1" style="position: relative; bottom: -5px;" type="button"
        ...
        <tr>
            ...
            <td align="left">
                <ShopNum1:TextBox ID="TextBoxDescription" runat="server" Height="120px" Width="500px"
                    ...
                    MaxLength="200" HintTitle="商品描述,此功能是为了方便百度等搜索引擎,搜索到您的商品"></ShopNum1:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="2">
