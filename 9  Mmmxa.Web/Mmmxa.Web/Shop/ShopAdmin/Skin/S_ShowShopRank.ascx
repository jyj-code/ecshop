    ...
    <asp:Repeater ID="RepeaterShow" runat="server">
        <ItemTemplate>
            <table border="0" cellspacing="0" cellpadding="0" class="buzlb">
                <tr>
                    <td rowspan="4" style="font-weight: bold; width: 100px; line-height: 20px" runat="server"
                        id="TdName">
                        <%#Eval("Name")%>
                    </td>
                ...
                <tr>
                    <td>
                        收费标准：<%#Eval("price").ToString()=="0.00"?"免费":Eval("price").ToString()+"元/年"%>
                    </td>
                </tr>
                <tr>
                    <td>
...
<div class="sp_dialog sp_dialog_out" style="display: none;" id="sp_dialog_outDiv">
    ...
    <div class="sp_dialog_cont" style="display: none;" id="sp_dialog_contDiv">
            ...
            <div class="sp_tan">
                <h4>
                    [<span id="titleDiv"></span>]预存款支付</h4>
                <div class="sp_close">
            ...
            <tr>
                    ...
                    <div><asp:Label ID="LabelYue" runat="server" Text="您当前的预存款余额为：￥0.00"></asp:Label></div>
                    <div><asp:Label ID="LabelIsHavePayPwd" runat="server" Text="您当前没有设置支付密码，请点击" Visible="false"></asp:Label>
                    <a id="paypwdalink" href='/main/account/A_Index.aspx?tomurl=A_PwdSer.aspx' style=" color:red" visible="false" target="_parent" runat="server">设置支付密码</a>
                    </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <span style="color: red" id="errPwd">
