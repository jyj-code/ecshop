    ...
    <div class="pad">
        <table border="0" cellspacing="0" cellpadding="0" class="lineh">
            <tr class="up_spac">
                ...
                <td>
                    <input id="exitnumber" type="text" class="ss_nr1" value='<%=Common.ReqStr("rid") %>' />
                </td>
                <td align="right" class="ss_nr_spac">
                    订单编号：
                </td>
                <td>
                    <input id="ordernumber" type="text" class="ss_nr1" value='<%=Common.ReqStr("oid") %>' />
                </td>
            </tr>
            <tr class="up_spac">
                <td align="right">
                ...
                <td colspan="3">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                <input id="shopmemloginid" type="text" class="ss_nr1" value='<%=Common.ReqStr("sid") %>' />
                            </td>
                            <td>
       ...
       <div style="width: 100%; height:500px;" class="showpopone">
            <table cellspacing="0" cellpadding="0" border="0" style="padding-top: 10px; margin: 10px 0 20px 120px;">
                ...
                <tr class="up_spac">
                    ...
                    <td style="width:270px; padding-bottom:20px;">
