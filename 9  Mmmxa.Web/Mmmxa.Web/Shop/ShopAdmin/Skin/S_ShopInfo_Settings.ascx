...
<div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabbiao">
        <tr>
            ...
            <td>
                <input type="text" id="TextBoxShopName"  runat="server"  class="textwb" onblur="funTextBoxShopName()" style="width:219px;" />
        ...
        <tr>
            ...
            <td>
                <input type="text" id="TextBoxName" runat="server" class="textwb"  style="width:219px;"/>
            </td>
        </tr>
        <tr>
            <td align="right" valign="top">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="TextBoxMainGoods" runat="server" class="textwb"  style="width:450px; height:90px;" />
                <div class="gray1">
        ...
        <tr>
            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="330" style="padding-top: 6px; padding-bottom: 6px;">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="TextBoxIdentityCard" runat="server" class="textwb"  onblur="funCheckIdentityCard()"  disabled="disabled" style="width:219px;"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="TextBoxPhone" runat="server" class="textwb" style="width:219px;" onblur="funPhone()" />
        ...
        <tr>
            ...
            <td>
                  <input type="text" id="TextBoxTel" runat="server" class="textwb" style="width:219px;" onblur="funCheckTel()" />
        ...
        <tr>
            ...
            <td>
                  <input type="text" id="TextBoxAdress" runat="server" class="textwb" style="width:219px;" />
            </td>
        </tr>
        <tr>
            <td align="right" valign="top">
            ...
            <td>
                <textarea id="TextBoxMemo" runat="server" class="textwb" style="width:450px; height:90px;"></textarea>
            </td>
        </tr>
        <tr>
            <td align="right" valign="top">
            ...
            <td>
                 <textarea id="TextBoxShopIntroduce" runat="server" class="Texteditor" style="width:450px; height:90px;"></textarea>
            </td>
        </tr>
        <tr>
            <td align="right" valign="top">
