...
<script type="text/javascript">
    ...
    {
        //选中
        var productguid=$("#selectproduct").val()
        //var v=productguid.split(',').length;
        //alert(productguid);
        if(productguid!=null)
        {
    ...
    function funGetOrderMoney()
    {
        ...
        if(textMoney!="" && textMoney!="0")
        {
            if(parseFloat(textMoney)<parseFloat(money))
            {
                ...
                url: "/api/ZtcProduct.ashx",
                async:false,
                data: "Money="+textMoney+"&type=Money&subid="+$("S_ZtcApply_Edit_ctl00_DropDownListSubstationID").find("option:selected").val()+"",
                dataType: "html",
                success: function (ajaxData) 
                {
//                    alert(ajaxData);
...
<div class="biaogenr">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top: 15px;">
        ...
        <tr>
            ...
            <td class="bordrig">
                <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tselect" Width="100px">
                <asp:ListItem Value="0">本城市分站</asp:ListItem>
                <asp:ListItem Value="1">全国站</asp:ListItem>
                </asp:DropDownList>
                <div class="gray">("本城市分站"指发布到店铺所在的城市分站平台，"全国站"指发布到全国站平台)</div>
            </td>
        </tr>
        <tr>
            <td class="bordleft">
        ...
        <tr>
            ...
            <td class="bordrig" style="padding-top: 8px;">
                ...
                <div class="gray">
                    <asp:Label ID="LabelMoney" runat="server" Text="当前拥有预存款"></asp:Label>
                </div>
