...
<div id="list_main">
    <div class="ordmain1" id="content">
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="lineh">
                <tbody>
                    <tr class="up_spac">
                        ...
                        <td>
                            <input type="text" class="ss_nr1" name="ProductName" value="<%=Common.ReqStr("pn") %>" />
                        </td>
                    ...
                    <tr class="up_spac">
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        <input type="text" class="ss_nr1" name="Number" value="<%=Common.ReqStr("no") %>" />
                                    </td>
                                    <td>
        ...
        <%DataTable dt = S_RepertoryAlertProduct.dt_ShowProduct;
          if (dt != null)
          {
        ...
        <table width="100%" cellspacing="0" id="Maintab_<%=dr["id"]%>" cellpadding="5" border="0"
            ...
            <tr>
                <th style="border-left: solid 1px #e3e3e3; width: 48px; text-align: right;">
                    <div class="ord_check" style="padding-top: 0; display:none;">
            ...
            <tbody>
                <tr>
                    <td style="border-left: solid 1px #e3e3e3;" colspan="2">
                        <a href="<%=ShopUrlOperate.shopHrefNew(dr["guid"].ToString(),dr["memloginid"].ToString()) %>"
                            class="alink_blue" target="_blank">
                            <img width="65" height="66" src="<%=dr["smallimage"]%>_60x60.jpg" width="60" height="60"
