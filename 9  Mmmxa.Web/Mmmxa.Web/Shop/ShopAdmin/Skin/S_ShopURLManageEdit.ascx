...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top:15px;" >
  <tr> 
    <th colspan="2" scope="col">店铺域名</th>
    </tr>
  <tr>
    <td class="bordleft">域名：</td>
    <td class="bordrig" style="padding-top:8px;">
        ...
        <asp:Label ID="LabelDomain" runat="server" Text=""></asp:Label><span class="star" id="errDoMain">*</span>
        <div style="color: #bbbbbb; height: 15px; line-height: 15px; padding: 0 0 8px 0;">店铺为二级域名，只需填写二级域名头部即可！</div>
    </td>
  </tr>
