...
<%@ Import Namespace="ShopNum1.Common" %>
  ...
  <div id="list_main">
      <ul class="sidebar" style="margin:0 6px; padding-top:20px; width:750px;">
           <li id="Li1" class='<%=Common.ReqStr("type")=="0"?"TabbedPanelsTab TabbedPanelsTabSelected":"TabbedPanelsTab" %>'><a href="?type=0">店铺设置</a></li>
           <li id="Li2" class='<%=Common.ReqStr("type")=="3"?"TabbedPanelsTab TabbedPanelsTabSelected":"TabbedPanelsTab" %>'><a href="?type=3">地理位置</a></li>
