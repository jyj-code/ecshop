    ...
    $(function(){
            ...
            if($("#S_Album_2_ctl00_hidTxt_potisiton").val()!="")
            {
             ...
             $("input[name='r_water']").click(function(){
                    ...
                    if($(this).val()=="1")
                    {
                         $(".ablum_font").show();$(".ablum_pic").hide(); 
                    }else if($(this).val()=="2"){
                        $(".ablum_pic").show();$(".ablum_font").hide();
                    }
            });
...
<div class="sp_dialog sp_dialog_out" style="display:none;"  id="sp_dialog_outDiv2">
    <div class="sp_dialog_cont" id="sp_dialog_contDiv2">
        ...
        <div class="sp_tan_content">
            <iframe src="" id="showiframe" width="100%" height="470" frameborder="0"    scrolling="no"></iframe>
        </div>
    </div>
</div>
<style type="text/css">
    .ablum_font,.ablum_pic{display:none;}
    .ablum_sy{ background:#ffffff; border:1px solid #c6dffe; padding:5px; width:200px; height:145px;}
.wm_pos { width: 180px; height: 125px;position: relative; z-index: 1; background:#f5fafe; padding:10px;}
.wm_pos li { float: left; width: 48px; height:30px; display: block; border:1px dotted #c6dffe; margin:5px}
.wm_pos label {line-height: 30px; color: #A2CAE9;text-align: center;vertical-align: middle; display: block;cursor:pointer; font-weight:bold;}
.wm_pos .over { color: #FFF;}
#wm_text_pos li label.checked , #wm_img_pos li label.checked { background:#c6dffe; color:#ffffff;}
</style>
    <!--弹出层-->
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabbiaoduo">
              <tr>
                <td class="tab_r" style="border-left:none;">水印开启设置：</td>
                <td>
              ...
              <tr  class="ablum_pic">
                <td  class="tab_r" style="border-left:none;">图片水印透明度：</td>
                <td>
              ...
              <tr class="ablum_font">
                <td  class="tab_r" style="border-left:none;">水印文字：</td>
                <td>
              ...
              <tr  class="ablum_font">
                <td  class="tab_r" style="border-left:none;">水印文字字体：</td>
                <td>
                    <select id="selectfont" runat="server"></select>
                 <span class="red">&nbsp;</span>
                </td>
              </tr>
              <tr  class="ablum_font">
                <td  class="tab_r" style="border-left:none;">水印文字字体大小：</td>
                <td>
              ...
              <tr  class="ablum_font">
                <td  class="tab_r" style="border-left:none;">水印文字字体颜色：</td>
                <td>
                 <input name="input" type="text" id="txtColor" runat="server" class="textwb" style="float:left;" /> <input type="button" id="colorpicker" value="打开取色器" class="selpic" />
                </td>
              </tr>
              <tr  class="ablum_font">
                <td  class="tab_r" style="border-left:none;">文字水印位置：</td>
                <td>
                <div class="ablum_sy">
                   <ul id="wm_text_pos" class="wm_pos">
                      <li>
                        <input type="radio" id="wm_text_pos_1" value="1" name="wm_text_pos" checked="checked" style="display: none;">
                        <label class="checked" for="wm_text_pos_1">左上</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_2" value="2" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_2">正上</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_3" checked="" value="3" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_3">右上</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_4" value="4" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_4">左中</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_5" value="5" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_5">中间</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_6" value="6" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_6">右中</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_7" value="7" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_7">左下</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_8" value="8" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_8">中下</label>
                      </li>
                      <li>
                        <input type="radio" id="wm_text_pos_9" value="9" name="wm_text_pos" style="display: none;">
                        <label class="" for="wm_text_pos_9">右下 </label>
                      </li>
                    </ul>
                    </div>
                </td>
              ...
              <tr>
                <td  class="tab_r" style="border-left:none;">&nbsp;</td>
                <td style="padding:10px 0px 10px 0px;">
                    <asp:Button ID="btnSave" runat="server" OnClientClick="return subCheck()" CssClass="baocbtn" Text="确定"/>
                </td>
              </tr>
            </table>
