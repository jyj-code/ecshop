...
function popTips() {
 ...
 <div id="top">
            ...
            <div class="fl_left">
             ...
             <asp:LinkButton ID="ButtonOut" runat="server" Text="退出" Visible="true"></asp:LinkButton>
            </div>
            <div class="top_list">
                ...
                <div class="top_hert allsort fl">
                    ...
                    <div class="sub_customer">
                        ...
                        <a  href="http://kehubaomall.nrqiang.com/shopadmin/login.aspx" class="lo2" target="_blank">客户宝CRM</a> 
                    </div>
                </div>
                <div class="top_mer fl">
            ...
            <div id="nav">
                ...
                <ul style="float: left;">
                    <li><a href="/main/member/m_index.aspx">我是买家</a></li>
                       <li><a href="/shop/ShopAdmin/s_index.aspx" class="zh">我是卖家</a></li>
                    <li><a href="/main/account/A_Index.aspx">账户管理</a></li>
                </ul>
                <!--消息提醒-->
                <div class="xiaoxi">
                     <a   href="/main/member/m_index.aspx?tomurl=M_Msg.aspx?isread=0&pageid=1" >
                ...
                <div id="gwc">
                    ...
                    购物车 <span class="red"><asp:Label ID="LabelGouWuChe" runat="server" Text="0"></asp:Label></span> 件
                    </a>
                </div>
            </div>
        </div>
