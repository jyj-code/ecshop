...
<div class="biaogenr">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod">
        ...
        <tr>
            ...
            <td class="bordrig">
                <select class="op_select" style="width: 300px;" id="SubstationIDName" runat="server">
                <option value="city">本站</option>
                <option value="all">主站</option>
                </select><span class="star">*</span>
                <div class="gray">
                    主站指参与主站发布的团购活动，本站指参与店铺所在城市分站发布的团购活动</div>
            </td>
        </tr>
        <tr>
            <td class="bordleft" width="130">
        ...
        <tr>
            ...
            <td class="bordrig">
                <asp:Image ID="ImageGroup" runat="server" Width="100" Height="100" />
                <asp:HiddenField ID="HiddenFieldGroup" runat="server" />
        ...
        <tr>
            ...
            <td class="bordrig">
                ...
                <div class="gray">
                团购商品总数应等于或小于该商品库存数量 请提前确认要参与活动的商品库存数量足够充足
            </td>
        </tr>
    ...
    <div class="sp_dialog_cont" style="display: none;" id="sp_dialog_contDiv">
        ...
        <div class="sp_dialog_info" style="padding-bottom:18px;">
            ...
            <p class="sp_general" style="height: 160px;">
                <label class="sp_lable">
                    选择商品：</label>
                <select id="selectproduct" style="width: 300px; height: 150px;" class="textwb" size="10">
                </select>
            </p>
            <p class="sp_general">
...
<script language="javascript" type="text/javascript">
    ...
    {
        funOpenx();  
        $("#showiframe").attr("src","/Shop/ShopAdmin/S_ShowShopPhoto.aspx?txtid=<%=HiddenFieldGroup.ClientID %>&imgid=<%=ImageGroup.ClientID %>");    
       
    }
    function  funOpenx()
    {
        $("#showpop1").css("display","block");
        $("#showpop2").css("display","block");
        $("#sp_overlayDiv2").css("display","block");
    }
</script>
<div class="sp_dialog sp_dialog_out" style="display: none;" id="showpop1">
    <div class="sp_dialog_cont" style="display: none;" id="showpop2">
        <div class="sp_tan">
            <h4>
                选择图片</h4>
            <div class="sp_close">
