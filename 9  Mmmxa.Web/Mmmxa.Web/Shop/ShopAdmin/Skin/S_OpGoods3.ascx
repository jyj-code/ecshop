<%@ Control Language="C#" %>
 <script type="text/javascript" language="javascript">
        ...
        function funsub()
        {
            ...
            $('#Spec_body tr').find("input").each(function(){
                   if($(this).attr("name")=="spec[sp_value]"){strV=null;bflag2=true;
                        ...
                        if(bflag2){
                            ...
                            strV=spec_stock.join("|")+"*"+strV;spec_stock=new Array();bflag=true;bflag2=false;
                        }
                        if($(this).attr("data_type")=="goods_price"){
                        if($(this).val()==""){alert("价格不能为空！");objthis=$(this);bflag3=false;return false;}
                        strV+=","+$(this).val();}
                        if($(this).attr("data_type")=="goods_stock"){
                        if($(this).val()==""){alert("库存不能为空！");objthis=$(this);bflag3=false;return false;}
                        strV+=","+$(this).val();}
            ...
            if(!bflag3)
            {
                 objthis.focus();objthis.addClass("errortxt");
                 return bflag3;
            }
...
<li id="nav_shop_cat">
		<span>
				...
				<ul class="J_ShopCatList">
				     <li>
					   <input type="checkbox" value="420697339" name="shopCat" id="shopCatId420697339" class="checkbox">
								<label for="shopCatId420697339">test</label>
					</li>
					<li>
							品牌
							<ul>
							<li><input type="checkbox" value="276460712" name="shopCat" id="shopCatId276460712" class="checkbox"><label for="shopCatId276460712">Tommy</label></li>     
							<li><input type="checkbox" value="276460713" name="shopCat" id="shopCatId276460713" class="checkbox"><label for="shopCatId276460713">CK</label></li>
							</ul>
					</li>
					<li>
							女装
						    <ul>
							<li><input type="checkbox" value="276460958" name="shopCat" id="shopCatId276460958" class="checkbox"><label for="shopCatId276460958">毛衣</label></li>
							<li><input type="checkbox" value="276460959" name="shopCat" id="shopCatId276460959" class="checkbox"><label for="shopCatId276460959">牛仔裤</label></li>
							</ul>
					</li>
					<li>
							手机通讯
							<ul>
								<li><input type="checkbox" value="721961060" name="shopCat" id="shopCatId721961060" class="checkbox"><label for="shopCatId721961060">双模手机</label></li>
						  </ul>
					</li>
				</ul>
			</div>
			<!-- shop-cat-list -->
                      ...
                      <tr>
                        <td colspan="2"><span class="gray1">店铺分类可以由 "用户中心 -> 卖家 -> 商品管理 -> 分类管理" 中自定义</span></td>
                      </tr>
                    </table>
                  </dd>
                </dl>
                <dl class="tibxxbg">
                  ...
                  <dd>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="xiangxsp_nr">
                      <tr>
                        <td width="15%"><input name="5" type="radio" value="" checked="checked" />
                          立即发布 </td>
                        <td rowspan="3"><div class="fudong">
                          ...
                          <div class="fudong">
                            ...
                            &nbsp; </div>
                          <div class="fudong"> 分 </div></td>
                      </tr>
                      <tr>
                        <td><input name="5" type="radio" value="" checked="checked" />
                          发布时间 </td>
                      </tr>
                      <tr>
                        <td><input name="5" type="radio" value="" checked="checked" />
                ...
                <dl class="tibxxbg">
                  <dt>描述：</dt>
                  <dd>
                    <textarea name="textarea" cols="" rows="" class="textwb" style="width:450px; height:120px;"></textarea>
                  </dd>
                </dl>
                <dl class="tibxxbg">
                  <dt></dt>
                  <dd>
                    ...
                    同意接受<a href="#" class="alink_blue">《产品发布规则》</a> </dd>
                </dl>
