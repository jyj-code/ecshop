    ...
    <script type="text/javascript" language="javascript">
         $(function(){  
               ...
               $("#sidebar li").click(function(){
                    location.href="?type="+$(this).attr("id")+"&sort="+'<%=Common.ReqStr("sort")%>';
               });
         });
...
<div class="dpsc_mian1">
   <p class="ptitle" ><a href="S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><span class="breadcrume_text"><%if (Common.ReqStr("type") == "1")
                                                                                                                              { %>水印管理<%}
                                                                                                                              else
                                                                                                                              { %>我的相册<%} %></span></p>
  <div id="list_main" style="overflow:hidden;">
      <ul id="sidebar">
           <li id="0" class='<%=Common.ReqStr("type")==""||Common.ReqStr("type")=="0"?"TabbedPanelsTab TabbedPanelsTabSelected":"TabbedPanelsTab" %>'>我的相册</li>
           <li id="1" class='<%=Common.ReqStr("type")=="1"?"TabbedPanelsTab TabbedPanelsTabSelected":"TabbedPanelsTab" %>'>水印管理</li>
      </ul>
    <div id="content">
          <div class="pad" style="display:<%=Common.ReqStr("type")==""||Common.ReqStr("type")=="0"?"block":"none" %>">
               <ShopNum1ShopAdmin:S_Album_1 ID="S_Album_1" runat="server" SkinFilename="skin/S_Album_1.ascx" />
          </div>
          <div class="pad" style="display:<%=Common.ReqStr("type")=="1"?"block":"none" %>">
