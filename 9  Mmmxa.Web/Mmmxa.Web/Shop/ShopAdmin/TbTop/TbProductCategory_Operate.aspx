<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="TbProductCategory_Operate" Codebehind="TbProductCategory_Operate.aspx.cs" %>

<%@ Register Src="../UserControl/MessageShowTb.ascx" TagName="MessageShowTb" TagPrefix="uc1" %>
...
<body >
    <form id="form1" runat="server">
        ...
        <div class="tjsp_mian">
 <p class="ptitle" ><a href="S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><a href="TbProductCategory_List.aspx">本地商品分类</a><span class="breadcrume_icon">>></span> <span class="breadcrume_text">商品分类操作</span></p>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top:15px;" >
  <tr>
    <th colspan="2" scope="col"><asp:Label ID="LabelTitle" runat="server" Text="添加商品分类"></asp:Label></th>
    </tr>
  <tr>
    <td class="bordleft" width="130"><asp:Localize ID="Localize1" runat="server" Text="分类名称："></asp:Localize></td>
    <td class="bordrig">
  ...
  <tr>
    ...
    <td class="bordrig" style="padding-top:10px; padding-bottom:10px;">
      
        <asp:TextBox ID="TextBoxDescription" runat="server" TextMode="MultiLine" Width="550px"  Height="120px"
                                CssClass="ss_nr1"></asp:TextBox>
  ...
  <tr>
    ...
    <td class="bordrig">
      <asp:CheckBox ID="CheckBoxTb" runat="server" Checked="false" Text="是否同步淘宝" AutoPostBack="true" oncheckedchanged="CheckBoxTb_CheckedChanged"/>
