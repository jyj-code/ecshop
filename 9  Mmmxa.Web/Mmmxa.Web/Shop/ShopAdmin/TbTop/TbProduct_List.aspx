<%@ Page Language="C#" AutoEventWireup="true" Inherits="TbProduct_List" Codebehind="TbProduct_List.aspx.cs" %>
...
<body class="right_body">
    ...
    <div class="main">
                                ...
                                <td style="text-align: center">
                                    <a href='<%#ShopUrlOperate.shopDetailHrefByShopID(Eval("Guid").ToString(),Eval("ShopID").ToString(),"ProductDetail") %>'
                                        target="_blank"><span title='<%# DataBinder.Eval(Container.DataItem, "Name")%>'>
                                            <%# ShopNum1.Common.Utils.GetUnicodeSubString(DataBinder.Eval(Container.DataItem, "Name").ToString(),40,"")%></span></a>
                                </td>
                                <td style="text-align: center">
        ...
        <asp:Button ID="ButtonAdd" runat="server" Text="添加" CssClass="bt2 bt3" CausesValidation="false" OnClick="ButtonAdd_Click" />
