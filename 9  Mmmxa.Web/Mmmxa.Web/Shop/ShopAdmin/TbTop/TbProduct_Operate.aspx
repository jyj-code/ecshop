<%@ Page Language="C#" AutoEventWireup="true" Inherits="TbProduct_Operate"  Codebehind="TbProduct_Operate.aspx.cs" %>
                ...
                <tr>
                    ...
                    <td>
                        <ShopNum1:TextBox ID="TextBoxName" runat="server" CssClass="allinput1" CanBeNull="必填"
                            HintInfo="请填写该商品的名称,该项必填" HintTitle="请填写该商品的名称,该项必填"></ShopNum1:TextBox>
                ...
                <tr>
                    ...
                    <td align="left">
                        <ShopNum1:TextBox ID="TextBoxShopPrice" runat="server" MaxLength="6" CssClass="allinput1"
                            CanBeNull="必填" HintInfo="请填写该商品的本店价,该项必填" RequiredFieldType="金额" HintTitle="请填写该商品的本店价,该项必填"></ShopNum1:TextBox>￥
                    </td>
                </tr>
	<tr>
                    <td style="text-align: right">
                    ...
                    <td align="left">
                        <ShopNum1:TextBox ID="TextBoxGroupPrice" runat="server" MaxLength="6" CssClass="allinput1"
                            CanBeNull="必填" HintInfo="请填写该商品的利润分成,该项必填" RequiredFieldType="金额" HintTitle="请填写该商品的利润分成,该项必填"></ShopNum1:TextBox>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <div style="color: Red; width: 5px; float: left;">
                            *</div>
                    </td>
                </tr>
                <tr id="isvisible" runat="server">
                    ...
                    <td>
                        <ul  id="shopfeetemplateUl">
                            <li >
                                <asp:RadioButton ID="RadioButtonFeeYou" Checked="true" runat="server" GroupName="RadioButtonFee" onclick="FeeRadioClick()" />
                                平邮:
                                <ShopNum1:TextBox ID="TextBoxPost_fee" MaxLength="9" Width="70px" runat="server" 
                                    CanBeNull="必填" RequiredFieldType="金额" MinimumValue="0.00"></ShopNum1:TextBox>元
                                快递:
                                ...
                                <ShopNum1:TextBox ID="TextBoxEms_fee" MaxLength="9" Width="70px" runat="server" CanBeNull="必填" 
                                    RequiredFieldType="金额" MinimumValue="0.00"></ShopNum1:TextBox>元 </li>
                            <li>
                                <asp:RadioButton ID="RadioButtonFeeTemplate" runat="server" GroupName="RadioButtonFee" onclick="FeeRadioClick()" />
                                使用运费模板
                                <div>
                                <input type="hidden" id="posttemplateHidden" value="" runat="server" />
                                    <asp:Label ID="LabelPostTemplateName" runat="server" Text=""></asp:Label><input type="button" value="使用店铺模板" onclick="SelectShopPostage()" id="btnShopPostage"   class="bt2" disabled="disabled"/>
                ...
                <tr id="TRMinusFee" style="display:none" runat="server">
                    ...
                    <td>
                        <ShopNum1:TextBox ID="TextBoxMinusFee" MaxLength="9" CssClass="allinput1" runat="server" CanBeNull="必填" RequiredFieldType="金额" MinimumValue="0.00">0.00</ShopNum1:TextBox>元
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right">
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <input id="bt2" class="bt2" style="position: relative; bottom: -5px;" type="button"
                ...
                <tr>
                    ...
                    <td align="left">
                        <ShopNum1:TextBox ID="TextBoxTitle" runat="server" CssClass="allinput1" MaxLength="50"
                            HintInfo="商品标题,此功能是为了方便百度等搜索引擎,搜索到您的商品" HintTitle="商品标题,此功能,是为了方便百度等搜索引擎,搜索到您的商品"></ShopNum1:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right">
                    ...
                    <td style="left">
                        <ShopNum1:TextBox ID="TextBoxDescription" runat="server" CssClass="allinput1" HintInfo="可以添加多个关键字,请用空格隔开"
                            HintTitle="可以添加多个关键字,请用空格隔开" MaxLength="50"></ShopNum1:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right">
                    ...
                    <td align="left">
                        <ShopNum1:TextBox ID="TextBoxKeywords" runat="server" Height="120px" Width="304px"
                            ...
                            HintTitle="商品描述,此功能是为了方便百度等搜索引擎,搜索到您的商品"></ShopNum1:TextBox>
                    </td>
                </tr>
                 <tr>
                    <td style="text-align: right">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <ShopNum1:TextBox ID="TextBoxPanicPrice" runat="server" CssClass="allinput1" CanBeNull="必填"
                                HintInfo="请填写该商品的抢购价,该项必填" HintTitle="请填写该商品的抢购价,该项必填" RequiredFieldType="金额"></ShopNum1:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right">
