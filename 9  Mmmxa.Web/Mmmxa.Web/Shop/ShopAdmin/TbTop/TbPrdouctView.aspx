<%@ Page Language="C#" AutoEventWireup="true" Inherits="TbPrdouctView" Codebehind="TbPrdouctView.aspx.cs" %>
...
<body>
    ...
    <div style="left: -1000px; top: 377px; display: none; position: absolute;" id="dhtmltooltip">
        ...
        <div id="content" class="ordmain1">
            <div class="pad">
                ...
                <div class="btntable_tbg">
                    <a class="tjbtn1" onclick="if (DownTaobaoProducts()) { ShopPop(600, 300) }">批量同步</a>
                </div>
                <div id="productDiv">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="blue_tb2" id="DataListProduct">
                        <tr>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="border-bottom: 1px solid #e3e3e3; border-left: 1px solid #e3e3e3; border-right: 1px solid #e3e3e3;">
                                            <img style="width: 50px; height: 50px; top: 2px;" src='<%#((TbItem)Container.DataItem).pic_url %>'
                                                onmouseout="hideddrivetip()" alt="<%#((TbItem)Container.DataItem).title %>" onmouseover="ddrivetip(this)" />
                                        </td>
                                        <td style="border-right: 1px solid #e3e3e3; border-bottom: 1px solid #e3e3e3;">
                                            <a target="_blank" href="<%#GetProductUrl(((TbItem)Container.DataItem).num_iid)%>">
                                                <%# ShopNum1.Common.Utils.GetUnicodeSubString(((TbItem)Container.DataItem).title, 50, "")%>
                                            </a>
                                        </td>
                                        <td align="center" style="border-right: 1px solid #e3e3e3; border-bottom: 1px solid #e3e3e3;">
                            ...
                            <tr style="display: none;" id="showtr">
                                <td colspan="9" style="height: 16px; border-left: solid 1px #e3e3e3; border-right: solid 1px #e3e3e3;">
                                <div class="no_datas">
                                    <div class="no_data">
                                        暂无数据</div>
                                        </div>
