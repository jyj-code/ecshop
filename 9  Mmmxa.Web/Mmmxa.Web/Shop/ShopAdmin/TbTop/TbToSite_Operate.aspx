<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="TbTop_TbToSite_Operate" Codebehind="TbToSite_Operate.aspx.cs" %>
    ...
    function GetSelectValue()
    {
            ...
            for(var i = 0; i < radioButton.length; i ++)
      {
                  ...
                  selectvalue.value=radioButton[i].value;
                    this.disabled='disabled';document.getElementById('imgSpan').style.display='inline';
                  return true ;
...
<body>
 ...
 <div class="dpsc_mian">
  <p class="ptitle" ><a href="../S_Welcome.aspx">我是卖家</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">淘宝店铺批量操作</span></p>
     <div  style=" width: 740px; padding-top: 8px;  padding-left: 8px; line-height: 30px;">
        <table style="text-align: center; width: 300px; margin: 10px 5px;">
            <tr>
                <td>
                ...
                <td>
                    <asp:RadioButton ID="radUpdateCount" runat="server" Text="批量更新店铺商品库存" GroupName="radTtS" Visible="false" />
                </td>
                <td>
                    <asp:RadioButton ID="radDownNew" runat="server" Text="下载淘宝新上架的商品" GroupName="radTtS" />
                </td>
                <td>
                    <asp:RadioButton ID="radUpdate" runat="server" Text="更新本地淘宝商品" GroupName="radTtS" Visible="false" />
                </td>
            </tr>
        </table>
        ...
        <div style="padding-left: 13px; height: 30px; line-height: 30px; ">
            ...
            <span style="color: #f00; height: 30px; line-height: 30px; padding-left: 5px;">(操作期间请不要刷新)</span>
      ...
      <div id="editDiv" runat="server" onmousedown='down(event)' onmouseup='up()' style="display: none;background: url(images/20120903dr.jpg) top left no-repeat;width:254px;height:160px;">
        <table cellpadding="0" cellspacing="0" border="0" style="padding:50px 0 0 0px;">
            ...
            <tr>
             <td align="left" style="padding-top:10px;padding-left:40px;">
            ...
            <tr align=center>
                ...
                <td style="padding-left:40px;">
                    <asp:Button ID="Button1" runat="server" Text="确定" CssClass="bt2_tan"  OnClientClick="return GetSelectValue();"
                        OnClick="Button1_Click" style="background: url(images/20120903botton.jpg) top left no-repeat; 
color:#79797a; font-size:12px;width:60px; height:21px; line-height:21px;margin-top:10px;" />
          
                    <asp:Button ID="Button2" runat="server" OnClientClick="QxButton()" CssClass="bt2_tan"  Text="取消" style="background: url(images/20120903botton.jpg) top left no-repeat; color:#79797a; font-size:12px;width:60px; 

height:21px; line-height:21px;margin-left:40px;margin-top:10px;" />
                </td>
            </tr>
        </table>
    </div>
