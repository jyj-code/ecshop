...
public partial class TbProduct_Operate : System.Web.UI.Page
{
    ////两个空格
    ...
    //    dataRow["CreateTime"] = System.DateTime.Now;
    ...
    //        product.PresentScore = Convert.ToInt32(this.TextBoxPresentScore.Text); //赠送消费积分
    //        product.PresentRankScore = Convert.ToInt32(this.TextBoxPresentRankScore.Text); //赠送等级积分
    //        product.SocreIntegral = Convert.ToInt32(this.TextBoxSocreIntegral.Text); //积分购买额度
    ...
    //        product.CreateTime = DateTime.Now; //添加时间
    //        product.ModifyUser = "admin"; //最后修改人
    //        product.ModifyTime = DateTime.Now; //最后修改时间
    ...
    //            operateLog.Date = System.DateTime.Now;
