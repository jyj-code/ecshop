<%@ Page Language="C#" AutoEventWireup="true" Inherits="TbSendGood" Codebehind="TbSendGood.aspx.cs" %>
...
<body>
    ...
    <div class="btconfig">
        ...
        <asp:Button ID="btnCancel" runat="server" Text="返回订单列表" CssClass="bt2" OnClick="btnCancel_Click" CausesValidation="false" />
    </div>
