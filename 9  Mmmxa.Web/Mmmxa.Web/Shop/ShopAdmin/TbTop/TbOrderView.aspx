<%@ Page Language="C#" AutoEventWireup="true" Inherits="TbOrderView" Codebehind="TbOrderView.aspx.cs" %>
...
<body>
    ...
    <%---------------弹出内容------------%>
    <div id="dwindow" style="position: absolute; background-color: #FFFFFF; cursor: hand;
        left: 0px; top: 0px; display: none; border: 2px solid #6A9500;" onmousedown="initializedrag(event)"
                    ...
                    <ItemTemplate>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="blue_tb1" style="margin-top: -1px;">
                            <tr>
                                    ...
                                    <ItemTemplate>
                                        <td valign="top" width="10%">
                                            <a href='<%# GetUrl(Eval("oid"))%>' target="_blank">
                                                <img src='<%#((TbOrder)Container.DataItem).pic_path%>' style="width: 50px; height: 50px;" /></a>
                                        </td>
                                ...
                                <td style="border-bottom: 1px solid #e6e6e6; border-right: 1px solid #e6e6e6; padding-right: 2px;
                                    display: none">
