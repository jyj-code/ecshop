                ...
                success: function (ajaxData) 
                {
                    ...
                    if(ajaxData!="0|")
                    {
                       ...
                       $.each(data,function(m,n){
                            ...
                            xhtml.push("<td style=\"text-align:center;\"><a href=\"javascript:void(0)\" title=\""+n.name+"\">"+n.name.substring(0,25) +"</a></td>");
       ...
       function SelectSubmit()
       {
            ...
            if(strValues!="")
            {
                $.ajax({
                    ...
                    url: "/Api/ShopAdmin/S_ThemeProductOperate.ashx",
                    async: false,
                    data: "ThemeGuid="+ThemeGuid+"&type=AddThemeProduct&strValues="+escape(strValues),
                    dataType: "html",
                    success: function (ajaxData) 
                    {
                        if(ajaxData=="OK")
