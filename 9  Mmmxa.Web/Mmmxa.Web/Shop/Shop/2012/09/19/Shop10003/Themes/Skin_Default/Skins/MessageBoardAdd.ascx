            ...
            <div class="accretion">
                <table width="100%" border="0" cellpadding="10">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left">
                            <asp:Button ID="ButtonConfrim" ValidationGroup="MessageBoard" OnClientClick="return funButonCheck()" runat="server" Text="我要留言" CssClass="bntonts" />
                        </td>
                    </tr>
                </table>
            </div>
