...
<div class="bBoxnt">
    <h2>
        <span class="dyspa"><asp:Label ID="LabelTitle" Text="" runat="server"></asp:Label>商品</span> 
        <asp:LinkButton ID="LinkButtonURL" runat=server class="more" ></asp:LinkButton>
<%--        <a href='ProductListIndexShowMore?type=1' class="more">更多&gt&gt</a>--%>
    </h2>
