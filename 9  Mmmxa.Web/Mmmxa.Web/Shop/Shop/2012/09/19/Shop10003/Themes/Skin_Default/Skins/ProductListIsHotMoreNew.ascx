            ...
            <asp:Repeater ID="RepeaterDataGrid" runat="server">
                <ItemTemplate>
                    ...
                    <div class="pruct_zs">
                        ...
                        <p class="pdt_name">
                            <a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>' target="_blank">
                                <%# Utils.GetUnicodeSubString(Eval("Name").ToString(), 100, "")%>
                            </a>
                            ...
                            <tr>
                                <td align="left" width="18%">
                                    <div class="small_pict">
                                        <a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>' target="_blank"
                                            title='<%# Eval("Name")%>'>
                                            <asp:Image ID="ImageProduct" runat="server" ImageUrl='<%# Eval("OriginalImage")+"_100x100.jpg" %>'
                                               onerror="javascript:this.src='/ImgUpload/noimg.jpg_100x100.jpg'" />
                                        </a>
                                    </div>
                                </td>
                                    ...
                                    <p class="pdt_name">
                                        <span runat="server" visible="false" id="guid">
                                            <%# Eval("Guid") %></span><a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>'
                                                ...
                                                <%# Utils.GetUnicodeSubString(Eval("Name").ToString(), 100, "")%></a>
                                    </p>
                                </td>
                                <td width="17%">
                                    <p class="pdtsele_out">
