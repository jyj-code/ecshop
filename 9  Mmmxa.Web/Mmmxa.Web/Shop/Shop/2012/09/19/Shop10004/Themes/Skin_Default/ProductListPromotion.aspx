    ...
    <div id="content">
        ...
        <div class="warp clearfix">
            ...
            <div class="sidebar leftn_hot">
                ...
                <!-- 宝贝排行-->
                <h3 class="penis">商品排行<a href="/ProductSearchList.html">更多>></a></h3>
                <div class="ks_panel">
            ...
            <div class="main">
                ...
                <!--热销商品列表-->
                <ShopNum1ShopNew:ProductListIsPromotionMore ID="ProductListIsPromotionMore" runat="server" SkinFilename="ProductListIsPromotionMoreNew.ascx" ShowCount="12" />
            </div>
        </div>
    </div>
