...
<div class="bBoxnt">
    <h2 class="litpoet">
        <span class="dyspa">最新商品</span>
        <a href='<%= GetPageName.RetUrl("ProductListNew")%>' class="more">更多>></a>
    </h2>
    <div class="content contain clearfix">
                ...
                <div class="pruct_zs">
                    ...
                    <p class="pdt_name">
                        <a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>' target="_blank" title='<%# Eval("Name")%>'>
                            <asp:Literal ID="LiteralProductName" runat="server" Text='<%# Utils.GetUnicodeSubString(Eval("Name").ToString(),100,"") %>'></asp:Literal>
                        </a>
                    </p>
                    <p class="pdt_price">
