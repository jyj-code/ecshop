...
<head id="Head1" runat="server">
    ...
    <link type="text/css" rel="Stylesheet" href="Themes/Skin_Default/Style/index-blue.css" />
...
xmlHttp.open("GET", "/Api/newtime.txt?date=<%=System.DateTime.Now.ToLocalTime() %>", false);
...
seconds=Math.floor((e_minsold-minsold)*60);  
  ...
  if(document.getElementById(element).innerHTML=="0天0小时0分0秒"){$("#ProductIsSpellDetail_ctl00_RepeaterData_ctl00_ButtonShopCar").val("已结束");$("#ProductIsSpellDetail_ctl00_RepeaterData_ctl00_ButtonShopCar").attr("disabled","disabled");}
}
