...
<!--店铺信息-->
        <asp:Repeater ID="RepeaterShow" runat="server">
            <ItemTemplate>
            <h2 class="penis penis1"><%#((DataRowView)Container.DataItem).Row["ShopName"]%></h2>
            <div class="ks_panel">
                    ...
                    <td>
                        <div class="shop_detail">
                            ...
                            <dl class="clearfix">
                                ...
                                <dt>店铺保障：</dt><dd><ShopNum1Shop:ShopEnsure ID="ShopEnsure1" runat="server" SkinFilename="ShopEnsure1.ascx" /></dd>
                            </dl>
                        </div>
                    </td>
                </tr>
