            ...
            <div class="accretion">
                <table width="100%" border="0" cellpadding="10">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="TextBoxTitle" ValidationGroup="MessageBoard" CssClass="inpt_cont" runat="server" MaxLength="50"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="TextBoxContent" CssClass="inpt_cont" runat="server" Height="60px" TextMode="MultiLine" Width="440px" MaxLength="500"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="VerifyCode" runat="server">
                        <td align="right">
                            <label class="spenel"><asp:Localize ID="LocalizeCode" runat="server" Text="验证码："></asp:Localize></label>
                        </td>
                        <td align="left">
                            ...
                            <img src="imagecode.aspx?javascript:Math.random()" id="Img1" border="0" onclick="reloadcode()" alt="看不清?点一下" style="cursor: pointer;vertical-align: middle;" />
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left">
                            <asp:Button ID="ButtonConfrim" ValidationGroup="MessageBoard"  OnClientClick="return funButonCheck()"  runat="server" Text="" CssClass="bntonts" />
                        </td>
                    </tr>
                </table>
            </div>
