...
<div class="detail">
    ...
    <!-- 分页部分-->
<div class="pager" style="background:#1a1511;border:1px solid #28231d;">
...
<script language="javascript" type="text/javascript">
    for(var i=1;i<6;i++) {
        ...
        if(i<=document.getElementById("ProductIsPanicDetail_ctl00_RepeaterData_ctl00_lblCharactervg").innerText) {
