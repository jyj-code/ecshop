    ...
    <div class="coupon_cont clearfix">
        <div class="coupon_imgs">
            ...
            <div class="coupon_gods">
                <img id="CouponImg" runat="server" src="" onerror="javascript:this.src='Themes/Skin_Default/Images/noImage.gif'" />
            </div>
        </div>
    ...
    <asp:Repeater ID="RepeaterDetail" runat="server">
        <ItemTemplate>
            <div class="hd_de_lr">
                ...
                <br />
                <span class="font_b pigst" style="text-align: right">活&nbsp;动&nbsp;详&nbsp;情&nbsp;：</span><br />
                <div class="hdjs pigst">
