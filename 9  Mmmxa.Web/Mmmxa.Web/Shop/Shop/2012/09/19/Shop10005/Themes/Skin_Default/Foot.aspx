<div id="footer">
    ...
    <div style="width:100%;height:80px; padding-top:17px; background:url(Themes/Skin_Default/Images/goldenfoot.jpg) repeat-x center top">
        <div class="copyright">
...
<div id="fixed-weixin" class="weixin">
    ...
    <div class="erwei">
        <p><img src='<%=ShopNum1.Common.ShopSettings.GetValue("MicroEWM").Replace("~/","/") %>' width="150" height="150" /></p>
        <p>扫一扫，加我为微信好友吧!</p>
    </div>
    <div class="ShouJi_erwei">
        <p><img src='<%=ShopNum1.Common.ShopSettings.GetValue("PhoneEWM").Replace("~/","/") %>' width="150" height="150" /></p>
        <p>扫一扫，快速进入商城!</p>
    </div>
</div>
<!--微信、建议、返回顶部 end-->
