    ...
    <div class="content voide_conts" style="padding: 0px;">
        <table width="100%" border="0" cellpadding="3">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="TextBoxTitle" Height="20" runat="server" CssClass="inpt_cont" TextMode="MultiLine"></asp:TextBox>
            ...
            <tr id="VerifyCode" runat="server">
                ...
                <td align="left">
                    <p class="yanzma">
                        ...
                        <a style="cursor: pointer; float:left; display:block; padding-left:4px; padding-top:12px;color:#a09579;" onclick="reloadcode()">看不清楚?点一下</a>
                    </p>
                </td>
            </tr>
            <tr>
