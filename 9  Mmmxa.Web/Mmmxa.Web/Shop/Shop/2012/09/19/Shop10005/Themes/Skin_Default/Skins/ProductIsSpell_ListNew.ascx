                    ...
                    <div class="integ_cont">
                        <div class="integrate">
                            <div class="pdt_img">
                                <p class="ncs_img">
                                    <a href='<%# GetPageName.RetUrl("ProductIsSpell_Detail",Eval("id"))%>' target="_blank"
                                        title='<%# Eval("Name")%>'>
                                        <asp:Image ID="ImageProduct" runat="server" BorderWidth="0px" Height="150px" ImageUrl='<%# Eval("GroupImg") %>'
                            ...
                            <p class="pdt_price">
                                ...
                                <span class="fr">
                                <a href='<%# GetPageName.RetUrl("ProductIsSpell_Detail",Eval("id"))%>' target="_blank">
                                    <img src="Themes/Skin_Default/Images/qukankan.png" /></a></span>
                            </p>
                        </div>
                    </div>
                </ItemTemplate>
                        ...
                        <tr>
                            <td align="left" class="vote" width="10%">
                                <div class="ProductImg">
                                    <a href='<%# GetPageName.RetUrl("ProductIsSpell_Detail",Eval("id"))%>' target="_blank" title='<%# Eval("Name")%>'>
                                        <asp:Image ID="ImageProduct" runat="server" Height="52px" ImageUrl='<%# Eval("GroupImg") %>'
