...
<h2 class="crysta"><b>在线留言</b></h2>
<div class="dwarfe">
    <table width="100%" border="0" cellpadding="0" cellspacing="5">
        <tr>
            <td align="right" width="15%"><label>留言人：</label></td>
            <td width="85%">
                <asp:TextBox ID="TextBoxMemLoginID" runat="server" CssClass="fqt_input" ValidationGroup="vaConsult" readonly="true"></asp:TextBox>
        ...
        <tr style="display:none">
            <td align="right" width="15%"><label>留言标题：</label></td>
            <td width="85%">
                <asp:TextBox ID="TextBoxTitle" CssClass="fqt_input" runat="server" TextMode="SingleLine"  ValidationGroup="vaConsult" ></asp:TextBox>
...
<%--                <asp:RequiredFieldValidator ID="RequiredFieldValidatorTitle" runat="server" ControlToValidate="TextBoxTitle"
        ...
        <tr>
            <td align="right" width="15%" valign="middle"><label>留言内容：</label></td>
            <td width="85%">
                <asp:TextBox ID="TextBoxContent" CssClass="fqt_input" runat="server" Height="60px" TextMode="MultiLine"
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="ButtonConfirm" Text="确定" runat="server" class="fl bnt1" ValidationGroup="vaConsult"
