...
<div class="bBox bBoxnt">
    <h2 class="crysta"><b>我要评论</b></h2>
    <div class="content">
        <div class="accretion">
            <table width="100%" border="0" cellpadding="10">
                <tr>
                    <td align="right">
                        <label class="spenel">用户名：</label>
                    </td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBoxMemLoginID" ValidationGroup="comment" runat="server" ReadOnly="true" CssClass="inpt_cont"></asp:TextBox>
                ...
                <tr>
                    <td align="right">
                        <label class="spenel">评论内容：</label>
                    </td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBoxContent" runat="server" Height="60px" TextMode="MultiLine" Width="440px" CssClass="inpt_cont"></asp:TextBox>
                ...
                <tr id="VerifyCode" runat="server">
                    ...
                    <td align="left">
                        <asp:TextBox ID="TextBoxCode" runat="server" CssClass="inpt_cont"
                        ...
                        <img src="imagecode.aspx?javascript:Math.random()" id="Img1" border="0" onclick="reloadcode()"
                            alt="看不清?点一下" style="vertical-align:middle;" />
