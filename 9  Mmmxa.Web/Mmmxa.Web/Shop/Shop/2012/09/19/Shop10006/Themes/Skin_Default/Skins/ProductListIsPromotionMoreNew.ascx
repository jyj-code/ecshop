                            ...
                            <p class="ncs_img">
                                <a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>' target="_blank"
                                    ...
                                    <asp:Image ID="ImageProduct" runat="server" ImageUrl='<%# Eval("OriginalImage")+"_160x160.jpg"  %>'
                                        onerror="javascript:this.src='Themes/Skin_Default/Images/noImage.gif'" />
                                </a>
                            </p>
                        </div>
                        <p class="pdt_name">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width: 220px;">
                                    <p class="pdt_name">
                                        <span runat="server" visible="false" id="guid"><%# Eval("Guid") %></span><a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>'
