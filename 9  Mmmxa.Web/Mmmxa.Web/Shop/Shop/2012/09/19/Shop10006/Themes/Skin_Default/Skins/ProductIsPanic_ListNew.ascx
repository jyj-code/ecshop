                            ...
                            <div class="pdt_img">
                                <p class="ncs_img">
                                    <a href='<%# GetPageName.RetUrl("ProductIsPanic_Detail",Eval("guid"))%>' target="_blank"
                                        title='<%# Eval("Name")%>'>
                                        <asp:Image ID="ImageProduct" runat="server" BorderWidth="0px" Height="164px" ImageUrl='<%# Eval("OriginalImage") %>'
                                            onerror="javascript:this.src='Themes/Skin_Default/Images/noImage.gif'" Width="164px" />
                                    </a>
                                </p>
                            </div>
                            <p class="pdt_name">
