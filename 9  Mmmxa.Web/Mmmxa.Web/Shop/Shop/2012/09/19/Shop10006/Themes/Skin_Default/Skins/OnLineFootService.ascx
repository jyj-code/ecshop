                            ...
                            <div class="kefu_info_list">
                                ...
                                <div id="tr1" style="display:none">
                                    <asp:Repeater EnableViewState="False" ID="RepeaterQQ" runat="server">
                                        <ItemTemplate>
                                            <p class="onsever">
                                                <a href="http://wpa.qq.com/msgrd?V=1&uin=<%#((DataRowView)Container.DataItem).Row["ServiceAccount"] %>&site=qq&menu=yes" target="_blank">
...
<!--[if lte IE 6]>
    <script type="text/javascript" src='<%=ResolveUrl(Globals.SkinPath+"/js/footonlineserviceIE6.js") %>'></script>
<![endif]-->
</asp:Panel>
