...
<script type="text/javascript" language="javascript">
    ...
    var locurl='http://<%=Request.Url.Host %>/poplogin.html?vj=shopcar&backurl='+encodeURIComponent('http://<%=Request.Url.Host %>/ProductIntegral.aspx?guid=<%=Request.QueryString["guid"] %>');
</script>
