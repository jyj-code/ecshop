...
function Sethtml(n)
{
   var xhtml=new Array();
    ...
    if(n.pic=="")
    {
    xhtml.push('                    <p><img class="photo" src="/ImgUpload/noimg.jpg_60x60.jpg" style="width:60px;height:60px;" /></p>');
   }
   else
   {
    xhtml.push('                    <p><img class="photo" src="'+n.pic+'" onerror="javascript:this.src=/ImgUpload/noimg.jpg_60x60.jpg" style="width:60px;height:60px;" /></p>');
   }
...
<!-- 分页部分-->
<%-- <div class="pager">
        <span id="OtherPageNum" class="num"><span>上一页</span></span>
</div>--%>
