        ...
        <asp:Repeater ID="RepeaterShow" runat="server">
            ...
            <li>
                <div class="mes-lists">
                    ...
                    <div class="mes_h3">
                        <a href='<%# GetPageName.RetUrl("NewsDetail",Eval("guid"))%>' target="_blank">
                            <h5>
                                <%# Eval("Title")%></h5>
                        </a>
                        <div class="mes_content">
                            <%# Server.HtmlDecode(((DataRowView)Container.DataItem).Row["Content"].ToString()).Replace("alt","width='100px' height='100px'")%><a
                             href='<%# GetPageName.RetUrl("NewsDetail",Eval("guid"))%>'>[详细]</a></div>
