...
<div class="bBox bBoxnt clearfix">
               ...
               <ul>
                    ...
                    <li>
                        <asp:DropDownList ID="DropDownListType" runat="server" AutoPostBack="true" >
                            <asp:ListItem Text="全部商品" Value="0"></asp:ListItem>
                            <asp:ListItem Text="热销商品" Value="1"></asp:ListItem>
                            <asp:ListItem Text="最新商品" Value="2"></asp:ListItem>
                            <asp:ListItem Text="促销商品" Value="3"></asp:ListItem>
                            <asp:ListItem Text="推荐商品" Value="4"></asp:ListItem>
                        </asp:DropDownList>
                    </li>
               </ul>
        </div>
                    ...
                    <div class="prdct_entry">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width: 220px;">
                                    <p class="pdt_name">
                                        <span runat="server" visible="false" id="guid">
                                            <%# Eval("Guid") %></span><a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>'
                                ...
                                <td width="17%">
                                    <p class="pdtsele_out">
                                        已售出：<span class="span"><%# Eval("SaleNumber")%></span>件</p>
                                </td>
                                <td width="18%">
                                    <p class="pdt_price">
                                        <strong>￥<%# Eval("ShopPrice")%></strong></p>
                                </td>
                                <td width="17%">
                                    <a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>' target="_blank">
    ...
    <div class="lambert">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxIndex" runat="server" CssClass="pro_input"></asp:TextBox>
                </td>
                <td class="fenye_td1">
