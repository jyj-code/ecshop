...
<div class="sp_dialog_info">
            ...
            <p class="sp_general">
                <label class="sp_lable">
                    验证码：</label><asp:TextBox ID="TextBoxCode" onkeydown="if(event.keyCode==13){document.getElementById('buttonCreate').focus();document.getElementById('buttonCreate').click();}"   onblur="funCheckYzm()"
