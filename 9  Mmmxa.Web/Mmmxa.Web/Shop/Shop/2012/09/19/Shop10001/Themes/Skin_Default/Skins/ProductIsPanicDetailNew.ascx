    ...
    function Sethtml(n)
{
    ...
    xhtml.push('                    <p><img src="'+n.pic+'" onerror="javascript:this.src=/ImgUpload/noImage.jpg" style="width:100px;height:120px;" /></p>');
        ...
        <ItemTemplate>
                ...
                <div class="content">
                    <div class="ProductImg fl">
                        <div id="preview">
                            <div id="spec-n1" class="jqzoom">
                                <img id="ProductImgurl" runat="server" src='<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["OriginalImage"].ToString())%>'
                                    width="300" height="300" onerror="javascript:this.src='Themes/Skin_Default/Images/noImage.gif'"
                        ...
                        <div style="position: absolute; z-index: 109; top: 15px; left: 0px; display:none;">
                            <asp:Image ID="Image2" runat="server" src="Themes/Skin_Default/Images/qianggou.gif" Width="55" Height="53" />
                        </div>
                    </div>
                    <div class="BuyInfo BuyInfo1 fl">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td class="tassle">
                                    <span class="flohost">市场价： </span><span class="clenew">￥<asp:Label ID="Label2" runat="server" Text='<%# Eval("marketPrice")%>'></asp:Label></span>
                                </td>
                            </tr>
                            <tr>
                                <td class="tassle">
                                    <span class="flohost">抢购价：</span><span class="ntsig"> ￥<%# Eval("ShopPrice")%></span>
                                </td>
                            </tr>
                            <tr>
                                <td class="tassle">
                                    <span class="flohost">抢购数：</span><span style="font-weight: bold;"><%#Eval("repertorycount")%></span>
                                </td>
                            </tr>
                            <tr>
            ...
            <div> 
                ...
                <div class="hd_de diagram">
                    <div class="hd_de_top">
                        <h2 class="hd_de_topli">商品详细</h2>
                    </div>
                    <div class="hd_de_lr" style="line-height: 22px;">
                        <%#  Server.HtmlDecode(Eval("Detail").ToString().Replace("&nbsp;",""))%>
                    </div>
                </div>
                <div class="hd_de diagram">
                    <div class="hd_de_top">
                        <h2 class="hd_de_topli">抢购须知</h2>
                    </div>
                    <div class="hd_de_lr" style="line-height: 22px;">
                        <%# Server.HtmlDecode(Eval("Instruction").ToString().Replace("&nbsp;",""))%>
                    </div>
                </div>
                <div class="hd_de diagram">
                    <div class="hd_de_top">
                        <h2 class="hd_de_topli">商品评价</h2>
                    </div>
