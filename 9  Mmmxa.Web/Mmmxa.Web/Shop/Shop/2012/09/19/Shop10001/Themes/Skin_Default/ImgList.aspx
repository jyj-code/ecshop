        ...
        <div class="warp clearfix">
            ...
            <div class="sidebar leftn_hot">
               ...
               <!-- 宝贝排行-->
                <div class="ks_panel">
                    <div class="storn_hd">
                        <h3>商品排行</h3><p class="gd_more" style="display:none;"><a href="/ProductSearchList.html"></a></p>
                    </div>
                    <ul class="sellor">
            ...
            <div class="main">
                ...
                <!--团购商品-->
                <shopNum1ShopNew:ImgList ID="ImgCategoryList" runat="server" SkinFilename="ImgList.ascx" ShowCount="12" PageCount="40"/>
            </div>
            <!--is the end-->
        </div>
    </div>
