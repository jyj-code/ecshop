...
<div class="detail">
    <div class="DetailImage">
        ...
        <div class="content">
                                    ...
                                    <ItemTemplate>
                                        <li class="tb_diply">
                                            <div class="tb-pic tb-stn">
                                                <a><img id="Img1" height="56" width="56" runat="server" src='<%# Eval("imgurl")+"_60x60.jpg" %>' onerror="javascript:this.src='/ImgUpload/noImg.jpg_60x60.jpg'" lang='<%# Eval("imgurl")%>' /></a>  
                                            </div>
                                        </li>
                                    </ItemTemplate>
                                </asp:Repeater>
            ...
            <!--购买详情-->
            <div class="BuyInfo fr"><input type="hidden" runat="server" id="Hidden1" value="0"/>
...
<!--搭配套餐-->  
    <div class="combination" id="divCombin" runat="server">
        <div class="data">
            <h3>搭配套餐32</h3>
            <div style="width:713px;height:131px;">
                         ...
                         %>
                                  ...
                                  <li class="data-main">
                                    <div class="tb-pic tb-s80">
                                        <a href="<%=strUrl %>"><img src="<%=strProductPic %>_60x60.jpg"
                                             onerror="javascript:this.src='/ImgUpload/noimg.jpg_60x60.jpg'" alt="<%=strPname %>" /></a>
                                    </div>
...
var TextBoxBuyNum='#<%=TextBoxBuyNum.ClientID %>';
