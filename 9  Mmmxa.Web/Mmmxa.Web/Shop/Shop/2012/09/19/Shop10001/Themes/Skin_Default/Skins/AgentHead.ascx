        ...
        <div class="sn_container">
            <div class="sn_login_info">
                <div id="islogin" runat="server">
                    欢迎光临！<asp:Label ID="LabelMemLoginID" runat="server"></asp:Label>，您可以登录<a href="http://<%=ShopSettings.siteDomain %>/main/member/m_index.aspx">【个人中心】</a>      
                    <a href="http://<%=ShopSettings.siteDomain %>/main/loginOut.aspx">【退出】</a>
                </div>
