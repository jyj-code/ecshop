                ...
                <asp:Repeater ID="RepeaterDataGrid" runat="server">
                    <ItemTemplate>
                        <div class="pruct_zs">
                            ...
                            <p class="pdt_name">
                                <a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>' target="_blank" title='<%# Eval("Name")%>'>
                                    <asp:Literal ID="LiteralProductName" runat="server" Text='<%# ShopNum1.Common.Utils.GetUnicodeSubString(Eval("Name").ToString(),100,"") %>'></asp:Literal>
                                </a>
                            </p>
                            <p class="pdt_price">
                                    ...
                                    <td style="width: 220px;">
                                        <p class="pdt_name">
                                            <a href='<%# GetPageName.RetUrl("ProductDetail",Eval("guid"))%>' target="_blank" title='<%# Eval("Name")%>'>
                                                ...
                                                Text='<%#ShopNum1.Common.Utils.GetUnicodeSubString(Eval("Name").ToString(),100,"") %>'></asp:Literal>
                                            </a>
                                        </p>
                                    </td>
                                    <td width="17%">
