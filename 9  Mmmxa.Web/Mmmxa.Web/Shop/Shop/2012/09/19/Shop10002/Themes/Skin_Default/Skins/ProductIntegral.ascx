...
//            alert(code);
    ...
    function checkSubmitMobil(){
       if($("#ScoreOrder_ctl00_TextBoxTel").val()=="")
        ...
        if(!$("#ScoreOrder_ctl00_TextBoxTel").val().match(/^1[3|4|5|8][0-9]\d{4,8}$/)){
...
//                return false;
    ...
    {
        if($("#ScoreOrder_ctl00_DropDownListAddress3").val()=="-1")
        {
//              alert("收货地址必须全选！");
            $("#SpanAdressErr").html("请选择三级！");
            $("#SpanAdressRight").css("display","none");
            return false;
        }
        $("#SpanAdressErr").html("");
...
//        funCheckNum();
        ...
        funCheckYzm();
        //检查登录
        if(funCheckName()&& $("#ScoreOrder_ctl00_HiddenFieldCode").val()!="0" && funCheckAdress() && checkSubmitMobil()&&funCheckEmail()&& funCheckPostalcode()&&$("#SpanCodeRight").is(":visible"))
        {
//            alert("test");
            ...
            var name=escape($("#ScoreOrder_ctl00_TextBoxMemLoginID").val());
                    ...
                    <tr>
                        ...
                        <td class="rtrict_cont">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        <span style="color: #404040; width: 150px;">产品型号：</span><asp:Label
                                            ID="Label6" runat="server" Text='<%# ((DataRowView)Container.DataItem).Row["RepertoryNumber"]%>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <span style="width: 150px;color: #404040;">市场价：</span><span style="font-size: 14px;"><b class="jg_mark" style="color:#666666;">￥<asp:Label
                                ...
                                <tr>
                                    <td>
                                        <span style="width: 150px;color: #404040;">兑换积分：</span><strong><b class="jg_store"><%# ((DataRowView)Container.DataItem).Row["Score"]%></b></strong>
                                ...
                                <tr>
                                    <td class="stock">
                                        <span class="rerve">浏览次数：</span><asp:Label ID="Label1" CssClass="storage" runat="server" Text='<%# ((DataRowView)Container.DataItem).Row["ClickCount"]%>' style="color:#009B00;"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="stock">
                                        <span class="rerve">已兑换数：</span>
                                         <%#Eval("HaveSale").ToString() == "" ? "0" : Eval("HaveSale").ToString()%>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="stock">
                                        <span class="rerve">兑换数量：</span>
...
<script type="text/javascript" language="javascript">
    ...
    var locurl='http://<%=ShopNum1.Common.ShopSettings.siteDomain %>/poplogin.html?vj=shopcar&backurl='+encodeURIComponent('http://<%=Request.Url.Host %>/ProductIntegral.aspx?guid=<%=Request.QueryString["guid"] %>');
</script>
<div id="loginbox" style="display:none;">
    ...
    <div class="box_area">
        <h3>
            <span class="b_dl">您尚未登录</span> <span class="b_colse" onclick="funClose()">close</span>
        </h3>
...
//        $('#mylogingo').attr('src','http://" + ShopSettings.siteDomain + "/poplogin.html?vj=shopcar&backurl=" + strurl + "');
     }
</script>
