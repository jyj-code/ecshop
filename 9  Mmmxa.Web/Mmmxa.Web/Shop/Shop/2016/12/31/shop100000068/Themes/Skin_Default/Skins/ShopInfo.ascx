                ...
                <ItemTemplate>
                    ...
                    <tr>
                        <td class="shopkperInfo">
                            <dl>
                                <dt class="ncs_infn">
                                    <img id="Img1" width="64" height="64" src='<%# ((DataRowView)Container.DataItem).Row["Banner"]%>'
                                        runat="server" />
                                </dt>
                                <dd class="ncs_name">
                                    <a class="shopkps">
                        ...
                        <td>
                            <div class="shop_detail">
                                <h4>
                                    店铺信息</h4>
                                <dl>
                                    <dt>店铺名称：</dt><dd><%#((DataRowView)Container.DataItem).Row["ShopName"]%><input type="hidden"
                                        id="hfShopName" value='<%#((DataRowView)Container.DataItem).Row["ShopName"]%>' /></dd>
                                    ...
                                    <dt>店铺地址：</dt><dd class="shop_addre"><%#((DataRowView)Container.DataItem).Row["Address"]%><input
                                        type="hidden" id="hfAddress" value='<%#((DataRowView)Container.DataItem).Row["Address"]%>' /></dd>
                                    ...
                                    <dd>
                                        <p>
                                            <a href="javascript:void(0)" title="实名认证">
                                                <asp:Image ID="ImageIdentity" ImageUrl="/Main/Themes/Skin_Default/Images/rz1.jpg"
                                                    runat="server" /></a> <a href="javascript:void(0)" title="公司认证">
                    ...
                    <input type="hidden" value='<%#((DataRowView)Container.DataItem).Row["Longitude"]%>'
                        id="hdLongitude" />
                    <input type="hidden" value='<%#((DataRowView)Container.DataItem).Row["Latitude"]%>'
                        id="hdLatitude" />
                </ItemTemplate>
            </asp:Repeater>
        </table>
        <div style="display: none;">
            <asp:Button ID="ButtonBooking" runat="server" Text="" CssClass="shopbtn" /></div>
    </div>
</div>
<div class="ks_panels">
    <ul>
        <li id="dz1" onmouseover="changes(1)" onmouseout="showsearch()" class="ncs_map"><a href="javascript:void(0)" ><span>
            店铺地图</span></a></li>
        <li id="dz2" onmouseover="changes(2)" onmouseout="showsearch()" class="ncs_cord"><a>
            <span>店铺二维码</span></a></li>
    </ul>
    <div class="ristn">
        <!--百度地图-->
        <div id="map1" class="ncs_ctain">
        </div>
        <!--手机扫描二维码-->
        <div id="map2" class="ncs_ctain">
            <p style="text-align: center;">
                <img src="Themes/Skin_Default/Images/qrcode.png" /></p>
            <p class="ncs_cord_word">
                手机扫描二维码</p>
        </div>
    </div>
</div>
