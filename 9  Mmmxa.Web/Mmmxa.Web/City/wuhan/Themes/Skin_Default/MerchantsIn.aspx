    ...
    <div class="warp clearfix">
        ...
        <div class="main clearfix">
            <div class="m_head">
                ...
                <div class="m_btn">
                    <div class="m_ruzhu">
                        <p class="s_rzhu"><a href="#"><img src="/main/Themes/Skin_Default/images/s_rzhu.12gif" /></a></p>
                        <div class="m_p">
                            <p>入驻前咨询：400-691-8851</p>
                            <p>(周一至周五 09：00-18：00)</p>
                        </div>
                        <div class="m_chax"><a href="#" class="chxun">查询入驻进度</a></div>
                    </div>
                </div>
            </div>            
            <a name="know"></a>
            <!--项目介绍-->
            <div class="box_xm">
                <div class="titi"><span class="xm">项目介绍</span></div>
                <div class="jieshao">
                    <p>
                    ...
                    <p>
                        ·群翔软件有限公司是电子商务专业服务商，是一家拥有核心知识产权的纯互联网企业，运营多个领先的行业网站，拥有每日极大的访问量。公司先后通过通过多 年努力，迅速发展壮大，现已成功服务过一万多家企业，提供从电子商务网站建设、推广到在线零售的完整电子商务解决方案，不断为用户创造新的商业价值。
                    </p>
                </div>
            </div>
            <a name="need"></a>
            <!--招商要求-->
            <div class="box_xm">
                <div class="titi"><span class="xm">招商要求</span></div>
                <div class="jieshao zhaos">
                    <div class="font_title">每天极大的访问量，怎可能错失商机？</div>
                    <div class="box_mod">
                        <div class="mod1">
                            <p> 您属于</p>
                            <dl>
                                ...
                                <dd>·现有的网上S2C商城</dd>
                                <dt>B、独立招商类</dt>
                                <dd>·生产型厂商，拥有自己注册商标；</dd>
                                <dd>·授权代理商，获得国内或国际知名品牌厂商的授权；</dd>
                                <dd>·经销商，专业品类专卖店；</dd>
                                <dd>·具有民事行为能力的个人，获得授权代理书。</dd>
                            </dl>
                        </div>
                        <div class="mod1">
                            <p>您只需</p>
            ...
            <!--招商范围-->
            <div class="box_xm">
                <div class="titi"><span class="xm">招商范围</span></div>
            ...
            <div class="step">
                ...
                <div class="step_cont">
                    <div class="step1">
                        <p class="title">签署在线入驻协议</p>
                        <div class="step_red">签署在线入驻协议</div>
                    </div>
                    <div class="step2">
                        <p class="sjmess">商家信息提交</p>
                        <ul class="sjul">
                            <li>1)提交公司经营信息</li>
                            <li>2)提交入驻预经营信息</li>
                            <li>3)提交公司资质信息</li>
                    ...
                    <div class="cont_tab">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td>平台合作</td>
                                <td>王先生</td>
                                <td>sale001@shopnum1.com</td>
                                <td><span class="icon"></span>shopnum1_sale001@hotmail.com</td>
                                <td><span class="icon1"></span>2448429145</td>
                            </tr>
                            <tr>
                                <td>开店咨询</td>
                                <td>谢先生</td>
                            ...
                            <tr>
                                <td>运动、休闲、鞋类、箱包、 珠宝配饰、化妆品、男装、女装</td>
                                <td>刘先生</td>
                                <td>sale001@shopnum1.com</td>
                                <td><span class="icon"></span>shopnum1_sale001@hotmail.com</td>
                                <td><span class="icon1"></span>2448429145</td>
                            ...
                            <tr>
                                <td>孕童、食品特产、家居家纺、 大小家电、手机、数码、电脑</td>
                                <td>李先生</td>
                                <td>sale001@shopnum1.com</td>
                                <td><span class="icon"></span>shopnum1_sale001@hotmail.com</td>
                                <td><span class="icon1"></span>2448429145</td>
        ...
        <!--foot Start-->
        <div class="foot">
            <p>Copyright 2009-2012 群翔软件 All Rights Reserved ICP备11009662号</p>
            <p>客服工作时间：8:30-21:00 Email：groupfly2009@hotmail.com</p>
            <p>程序开发商：群翔软件有限公司</p>
        </div>
        <!--//foot End-->
    </div>
