...
<body>
    ...
    <div class="FlowCat_cont">
        <div class="position">所在位置:<a href="Default.aspx">首页</a> > 邮箱验证</div>
        <div class="findpwd">
            <h1>找回密码</h1>
            <div class="findcont">
                <p class="findimg"><img src="Themes/Skin_Default/Images/findpwd1.jpg" width="866" height="30" /></p>
                <div class="findtable">
        ...
        <div class="findpwd">
            <h1>找回密码</h1>
            <div class="findcont">
                <p class="findimg"><img src="Themes/Skin_Default/Images/findpwd2.jpg" width="866" height="30" /></p>
                <div class="findtable">
                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                        <tr class="trsrucee">
                            <td align="right"><img src="Themes/Skin_Default/Images/ban_prompt.gif" /></td>
                            <td align="left">
                                <p class="yellow1">证邮件已发送，请<a href="#">登录邮箱</a>邮箱完成验证！</p>
                            </td>
                        </tr>
                    </table>
                </div>
