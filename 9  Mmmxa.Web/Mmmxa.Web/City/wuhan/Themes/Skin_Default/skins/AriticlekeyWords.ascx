    ...
    <div class="new_title fl"><span id="AriticlekeyWords_ctl00_Labeltitle">
     ...
     <div class="new_class fl">
        <asp:Repeater ID="RepeaterShow" runat="server">
            <ItemTemplate>
                <a href='<%# ShopUrlOperate.RetUrlNew("ArticleListSearch",((DataRowView)Container.DataItem).Row["ID"]) %>' target="_self">
                <%# ((DataRowView)Container.DataItem).Row["Name"]%></a>|
            </ItemTemplate>
        </asp:Repeater>
    </div>
     <div class="new_more fr">
        <a href='<%= ShopUrlOperate.RetUrlNew("ArticleListSearch") %>' target="_self">
