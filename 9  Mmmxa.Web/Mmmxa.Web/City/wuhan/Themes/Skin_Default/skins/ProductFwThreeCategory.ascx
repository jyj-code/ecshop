                ...
                <div class="attrValues">
                                        ...
                                        <div class="entity">
                                            <ul class="items">
                                                <li class="arit_bcategory">
                                                    ...
                                                    <a href='<%#ShopUrlOperate.RetShopUrl("Search_productlist",((DataRowView)Container.DataItem).Row["Code"].ToString(),"Code")%>'><%# Eval("Name")%></a> 
                                                </li>
                                                <li class="cagethree">
                    ...
                    <div class="av_options">
                        <a class="more_drop_l" id="shouqi1">
                            <div id="wenzi1" class="wenzi1">更多</div>
                            <i id="Qiantou1" class="more_drop_allow"></i>
                        </a>
                    </div>
                </div>
            </div>
