...
<div class="searchpro">
    ...
    <div class="order_dateil clearfix">
        <div class="cart-thead clearfix">
            <div class="clearfix">
                <div class="thead-bg1 fl"></div>
                <div class="thead-bg2 fl"></div>
                <div class="thead-bg3 fl"></div>
                <div class="thead-bg4 fl"></div>
                <div class="thead-bg5 fl"></div>
            </div>
            <div class="clearfix">
                <div class="column order-goods">店铺宝贝</div>
                <div class="column order-price">单价(元)</div>
                <div class="column order-num">数量</div>
                <div class="column order-total"><asp:Label ID="lblTotal" runat="server" Text="小计"></asp:Label>(元)</div>
            ...
            <tr>
                        ...
                        <ItemTemplate>
                            <div class="cart-tbody cart_bottom">
                                <div class="order_cl order-goods">
                                   <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>" class="or_img"  title='<%#Eval("Name") %>'  target="_blank">
                                        <asp:Image ID="ImageProductPic" runat="server" onerror="javascript:this.src='../../ImgUpload/noImage.gif'"
                                            ImageUrl='<%# ((DataRowView)Container.DataItem).Row["ThumbImage"] %>' Width="53" Height="53" />
                                    </a>
                                    <div class="or_name">
                                        <p>
                                         <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>" title='<%#Eval("Name") %>'  target="_blank">   
                                         <asp:Label ID="lbProductName" runat="server" Text='<%#Eval("Name") %>'></asp:Label>&nbsp;<%=hidSaleType.Value!="0"?"<font color=red>【促销商品】</font>":"" %>
                                         </a>
                                        </p>
                                        <div class="orimgs">
                                ...
                                <div class="HiddenField" style="display: none;">
                                    ...
                                    <asp:HiddenField ID="HiddenFieldGuid" Value='<%#Eval("Guid")%>'
                                        runat="server" />
                                    <asp:HiddenField ID="HiddenFieldMinusFee" Value='<%#Eval("MinusFee")%>'
                                        runat="server" />
                                    <!--1表示卖家承担，0表示买家承担-->
                                    <asp:HiddenField ID="HiddenFieldFeeType" Value='<%#Eval("FeeType")%>'
                                        runat="server" />
                                    <!--平邮费用-->
                                    <asp:HiddenField ID="HiddenFieldPost_fee" Value='<%#Eval("Post_fee")%>'
                                        runat="server" />
                                    <!--快递费用-->
                                    <asp:HiddenField ID="HiddenFieldExpress_fee" Value='<%#Eval("Express_fee")%>'
                                        runat="server" />
                                    <!--Ems费用-->
                                    <asp:HiddenField ID="HiddenFieldEms_fee" Value='<%#Eval("Ems_fee")%>'
                                        runat="server" />
                                    <asp:HiddenField ID="HiddenFieldProductGuid" Value='<%#Eval("Guid")%>'
                                        runat="server" />
                                </div>
                                <div class="clear"></div>
                            </div>
                ...
                <td align="center" valign="middle">
                         <div class="cartcolumn order-total cart-tbody">
                                    <b><asp:Label ID="labelAll" runat="server" CssClass="labelAll" Text=""/></b>
                                </div>
                </td>
                <td align="center" valign="middle">
                    <!--邮费-->
        ...
        <div class="consignee clearfix">
            <div class="conmess">
                ...
                <span style="display:none"> 
                    <asp:Button ID="ButtonAddReceivAddress" runat="server" OnClientClick="return checkSub(this);" Text="确定添加" CssClass="shiyong"/>
                </span>
            </div>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="contable">
                        <tr>
                            ...
                            <td align="left" valign="middle">
                                <div id="localshow" style="float:left; padding-right:80px;"></div>
                                ...
                                邮政编码：<asp:TextBox ID="TextBoxPostalcode" runat="server" onkeyup="NumTxt_Int(this)" MaxLength="6"></asp:TextBox><font id="postcode" color="red"></font>
                            </td>
                        </tr>
                        <tr class="xiangxiadd">
                            <td align="right" valign="middle">收货地址：<span class="red">*</span></td>
                            <td align="left" valign="middle">
                                <asp:TextBox ID="TextBoxAddress" runat="server" TextMode="MultiLine" MaxLength="50"></asp:TextBox>
                                <font id="address" color="red"></font>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">收货人姓名：<span class="red">*</span></td>
                            <td align="left">
                                <asp:TextBox ID="TextBoxName" runat="server" CssClass="select1" MaxLength="20"></asp:TextBox>
                                电子邮件：<asp:TextBox ID="TextBoxEmail" runat="server" CssClass="select1" MaxLength="50"></asp:TextBox>
                                <font id="email" color="red"></font><font id="name" color="red"></font>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">电话号码：<span class="red">&nbsp;</span></td>
                            <td align="left">
                               <asp:TextBox ID="TextBoxTel" runat="server" onkeyup="NumTxt_Int(this)" MaxLength="11"></asp:TextBox> 
                            </td>
                        </tr>
                        <tr><td style="color:#bbbbbb; height:15px; line-height:15px; padding:0;"></td><td style="color:#bbbbbb; height:15px; line-height:15px; padding:0;">区号 + 电话号码 (xxxxxxxxxx)</td></tr>

                        <tr>
                            <td align="right">手机号码：<span class="red">*</span></td>
                            <td align="left">
                                <asp:TextBox ID="TextBoxMobile" runat="server"  onkeyup="NumTxt_Int(this)" MaxLength="11"></asp:TextBox>
    ...
    <!--支付方式-->
    <div class="pay">
        <div class="commom xzzf">选择支付方式</div>
        <div class="paycon">
