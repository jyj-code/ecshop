...
<style type="text/css">
.FormBox{background:url(Themes/Skin_Default/Images/lmf_search.png) no-repeat left top; width:482px; height:32px; margin-top:-3px;}
.switchover{ position:relative; z-index:22;}
#mq, .txtinput{ border:none; background:none;}
.mallSearch_input{ background:none;}
#mallSearch button, .search_buttom{ width:96px; height:26px; margin-top:3px; margin-right:3px;}
#mq, .txtinput{padding-top:6px; font-size:12px; font-weight:normal; color:#666666;}
.search_buttom:hover{background:url(Themes/Skin_Default/Images/sear_bt_hov.png) no-repeat left top;}
.mallSearch{margin-left:105px;}
</style>
...
<div class="mallSearch" id="mallSearch">
    ...
    <div class="FormBox">
        <div class="mallSearch_input clearfix">
            ...
            <input class="txtinput" type="text" name="textfield" id="textfield" maxlength="50" style="width:368px!important; border:none!important;outline:none;resize:none;" />
