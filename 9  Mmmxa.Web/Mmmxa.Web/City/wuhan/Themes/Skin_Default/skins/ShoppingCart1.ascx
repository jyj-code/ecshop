...
<div class="message" id="showMsg" runat="server" visible="false">
      <p>购物车内暂时没有商品，您可以<a href="/Default.html?tag=0">去首页</a>挑选喜欢的商品<!-- ，或<a href="###" class="btn-takeout">取出之前寄存的商品</a> --></p>
</div>
                        ...
                        <div class="cart-tbody">
                            ...
                            <div class="or_num t-num">
                                ...
                                <asp:TextBox ID="TextBoxBuyNumber" runat="server" Text='<%# ((DataRowView)Container.DataItem).Row["BuyNumber"]%>'
                                    ...
                                    <div class="J_AmountMsg" style="color:Red;display:none;"><em class="error-msg">最多只能购买<span><%#Eval("specCount").ToString() == "" ? Eval("repertorycount").ToString() : Eval("specCount").ToString()%></span>件</em></div>
                            </div>
