...
<div class="ser_brand ser_dash clearfix" id="BrandBorder" runat="server">
    <div class="att_key">品牌</div>
    <div class="att_values">
        <ul class="att_ul">
            <asp:Repeater ID="RepeaterPtoudctBrand" runat="server">
                <ItemTemplate>
                    <li><a href='<%# ShopUrlOperate.RetMultiUrlNew("Search_productlist",((DataRowView)Container.DataItem).Row["linkurl"])%>'>
        ...
        <div class="att_more"><a>更多<i></i></a></div>
    </div>
</div>
                ...
                <div class="att_values">
                    <ul class="att_ul">
                        <asp:Repeater ID="RepeaterShopProductPropValue" runat="server">
                            <ItemTemplate>
                                <li><a title='<%# ((DataRowView)Container.DataItem).Row["Name"] %>' href='<%# ShopUrlOperate.RetMultiUrlNew("Search_productlist",((DataRowView)Container.DataItem).Row["linkurl"])%>'>
