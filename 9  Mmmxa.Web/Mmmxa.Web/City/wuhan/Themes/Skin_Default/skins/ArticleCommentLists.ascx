...
<div class="CommentsAdd">
    <h1 class="CommentsAdd_title"><span>用户评论</span></h1>
    <div class="desc_cont">
            ...
            <ItemTemplate>
                <div class="desc_list">
                    ...
                    <div class="desc_list_pl">
                        <div class="yhpl"><%# ((DataRowView)Container.DataItem).Row["Content"]%></div>
                        <div class="glyhf">
                            <p><span class="red">管理员回复：</span><%# ((DataRowView)Container.DataItem).Row["ReplyContent"]%></p>
                            <p><%# ((DataRowView)Container.DataItem).Row["ReplyTime"]%></p>
                        </div>
                    </div>
                </div>
            </ItemTemplate>
