...
<div class="moka_city clearfix">
    <div class="flw_city_head">
        ...
        <div class="select_city">
            按省份选择:
            <asp:DropDownList ID="dropdownlistProvince" runat="server" onchange="document.getElementById('HiddenRegion1').value=this.options[this.selectedIndex].text;BindDropDownShopCategory2(this);" CssClass="selected">
