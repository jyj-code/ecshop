    ...
    <ItemTemplate>
         <div class="new_headline_bj">
             <div class="new_headline_title">
                <a target="_blank" href='<%# ShopUrlOperate.RetUrlNew("ArticleDetail",((DataRowView)Container.DataItem).Row["Guid"]) %>' title='<%# ((DataRowView)Container.DataItem).Row["Title"]%>' >
                ...
                <ItemTemplate>
                   <div style="height: 25px; overflow: hidden;">
                       <span class="new_titletag">[<a target="_blank" href='<%# ShopUrlOperate.RetUrl("ArticleListSearch",((DataRowView)Container.DataItem).Row["ID"],"ID") %>' >
                        ...
                        </a>]</span> <a target="_blank" href='<%# ShopUrlOperate.RetUrlNew("ArticleDetail",((DataRowView)Container.DataItem).Row["Guid"]) %>'
