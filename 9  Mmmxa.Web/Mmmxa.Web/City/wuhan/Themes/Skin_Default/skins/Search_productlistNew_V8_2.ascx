...
$(function(){
    ...
    //设置促销图片
     var saleType='<%=Common.ReqStr("sale")%>';
    switch(saleType)
    {
        case "1":
         $("input[name='tg_sale']").parent().find(".tg_sale").show();break;
         case "2":
        $("input[name='zk_sale']").parent().find(".zk_sale").show();break;
         case "3":
        $("input[name='qg_sale']").parent().find(".qg_sale").show();break;
         case "4":
       $("input[name='zh_sale']").parent().find(".zh_sale").show();break;
    }
    $("input[name='tg_sale']").each(function(){
            if($(this).val()!="0"&&$(this).val()!=""&&saleType=="")
            {
                $(this).parent().find(".tg_sale").show();
            }
    });
    $("input[name='qg_sale']").each(function(){
            if($(this).val()!="0"&&$(this).val()!=""&&$(this).val()=="1"&&saleType=="")
            {
...
<style type="text/css">
#tooltip { position:absolute; z-index:1000; max-width:100px;width:100px; background:#ffffff; border:#FEFFD4 solid 1px; text-align:left; padding:3px;}
#tooltip p { padding:0px;color:#000000;font:12px verdana,arial,sans-serif; line-height:180%;}
</style>
<div class="pro_area">
    <!--排序条件-->
    <div class="paixu">
        ...
        <div class="comArea">
            <b class="comArea-text"><span id="spanAddress">所有地区</span></b>
            <%if (Common.ReqStr("addcode") != "" && Common.ReqStr("addcode") != "-1" && Common.ReqStr("addcode") != "000")
              { %>
            ...
            <div id="souzaidi-list" class="souzaidi-list">
                <div class="citysearch">
                    <a value="000;所有地区" href="<%=ShopUrlOperate.RetUrlForSearch("Search_productlist","000","addcode")%>">所有地区</a>
                </div>
                <div class="citysearch">
                ...
                <!--热门城市-->
                <div id="DivCity" class="CityPart"></div>
                <!--省-->
        ...
        <asp:LinkButton ID="LinkButtonRenqi" runat="server" CssClass="comSort comSort1" EnableViewState="false">人气<i id="IRenqi" runat="server"   class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonSales" runat="server" CssClass="comSort" EnableViewState="false">销量<i id="ISales" runat="server"   class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonXinyong" runat="server" CssClass="comSort" EnableViewState="false">信用<i id="IXinyong" runat="server"  class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonPrice" runat="server" CssClass="comSort" EnableViewState="false">价格<i id="IPrice" runat="server"  class="comSort-u"></i></asp:LinkButton>
         ...
         <div class="comRange">
            ...
            <div class="moren-list">
                <asp:LinkButton ID="LinkButtonAll" runat="server" title="不限">不限</asp:LinkButton>
        ...
        <div class="comprice">
            <div class="price-box">
                <b class="price-item"><i class="ui-price-plain">¥</i>
                   <asp:TextBox ID="TextBoxStartPrice" runat="server" onkeyup="NumTxt_Int(this)"   MaxLength="8" CssClass="priceInput"></asp:TextBox>
                </b><i class="price-split"></i><b class="price-item"><i class="ui-price-plain">¥</i>
                    <asp:TextBox ID="TextBoxEndPrice" runat="server" onkeyup="NumTxt_Int(this)"  MaxLength="8" CssClass="priceInput"></asp:TextBox>
                </b>
            </div>
    ...
    <asp:Panel ID="PanelNoFind" runat="server" Visible="false">
        <p class="nofind_search">没有找到符合条件的商品！</p>
    </asp:Panel>
    <!--大图-->
    <div id="divGrid" runat="server" class="pro_list">
        <asp:Repeater ID="RepeaterGrid" runat="server" EnableViewState="false">
            <ItemTemplate>
                ...
                <div class="tg_sale"><img alt="" src="/Main/Themes/Skin_Default/images/tg.png"></div>
                <div class="qg_sale"><img alt="" src="/Main/Themes/Skin_Default/images/qg.png"></div>
                <div class="zk_sale"><img alt="" src="/Main/Themes/Skin_Default/images/zk.png"></div>
                <div class="zh_sale"><img alt="" src="/Main/Themes/Skin_Default/images/zh.png"></div>
                        <a target="_blank" href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>">
                            <img src="<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["originalimage"].ToString())+"_160x160.jpg"%>" onerror="javascript:this.src='../ImgUpload/noimg.jpg_160x160.jpg'" /></a>
                    </div>
                    <div class="pro_name">
                        <a href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>"  title="<%#((DataRowView)Container.DataItem).Row["Name"].ToString() %>" class="pname">
                    ...
                    <div class="pro_price">
                        <b>
                            ...
                            </b> 最近成交：<font color="green"><%#((DataRowView)Container.DataItem).Row["SaleNumber"]%></font>
                    </div>
                     <div class="pro_price">
                     <b style="font-weight:normal; color:#666666; font-size:12px;">
                         ...
                         收藏量：<font color="green"><%#((DataRowView)Container.DataItem).Row["collectcount"]%></font>
                    </div>
                    <div class="pro_price">  
                        <a href="<%#ShopUrlOperate.shopHrefNew(((DataRowView)Container.DataItem).Row["MemloginId"].ToString())%>" target="_blank" class="showensure">
                            <%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["shopName"].ToString(),32,"") %></a>
                            <span><%#Search_productlistNew_V8_2.GetArea(((DataRowView)Container.DataItem).Row["AddressValue"])%></span>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td width="130" class="showbigImg">
                                    <div class="area_imgs">
                                        <a href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>">
                                ...
                                <td width="260">
                                    <div class="area_name">
                                        <p>
                                            <a href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>" title="<%#((DataRowView)Container.DataItem).Row["Name"].ToString() %>"
                                                class="pname">
                                                <%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["Name"].ToString(),100,"") %>
                                            </a>
                                        </p>
                                        <p>
                                            <a href="<%#ShopUrlOperate.shopHrefNew(((DataRowView)Container.DataItem).Row["MemloginId"].ToString())%>"
                                                class="pshop">
                                ...
                                <td width="150">
                                    <div class="area_price">
                                        <b>
                                            ...
                                            收藏人气：<font color="green"><%#((DataRowView)Container.DataItem).Row["collectcount"]%></font>
                                    </div>
                                </td>
                                ...
                                <td align="left" width="112">
                                    ...
                                    <!--店铺担保-->
                                        ...
                                        <asp:Repeater ID="RepeaterShopEnsure" runat="server" EnableViewState="false">
                                            ...
                                            <td>
                                            <div>
                                                <img src="<%#((DataRowView)Container.DataItem).Row["ImagePath"]%>" onerror="javascript:this.src='/ImgUpload/noimg.jpg_25x25.jpg'" style="height:15px; width:15px" />
                                            </div>
                                            </td><td><%#((DataRowView)Container.DataItem).Row["name"] %></td>
                                            </tr>
                                            </table>
                                              </ItemTemplate>
                                        </asp:Repeater>
    ...
    <div class="fenye">
        ...
        <!--//分页跳转 End-->
        <!--分页排序 Start-->
        <div id="pageDiv" runat="server" class="page_sort"></div>
        <!--//分页排序 End-->
        <div class="clear"></div>
    </div>
    <!--//分页 End-->
