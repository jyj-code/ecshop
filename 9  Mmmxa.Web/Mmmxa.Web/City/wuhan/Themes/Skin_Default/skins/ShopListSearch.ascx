...
var lodding="<img  src='/Main/Themes/Skin_Default/Images/lodding.gif'/>";
	$(document).ready(function(){
		$(".taob").click (
			function()
			{
			    $(".relatedBaby").hide();$(this).attr("value","0")
                ...
                <div class="shopdateil clearfix">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" value="<%#Container.ItemIndex+1%>">
                        <tr value="2">
                            <td width="500">
                                <div class="shoppics">
                                    <a href="<%#ShopUrlOperate.GetShopUrlNew(((DataRowView)Container.DataItem).Row["ShopID"].ToString())%>" target="_blank">
                                            ...
                                            <asp:Repeater ID="RepeaterShopEnsure" runat="server" EnableViewState="false">
                                                <ItemTemplate>
                                                    <asp:Image ID="Image2" runat="server" Height="15" Width="15" ImageUrl='<%#((DataRowView)Container.DataItem).Row["ImagePath"]%>'
                                                        onerror="javascript:this.src='../ImgUpload/noImage.gif'" ToolTip='<%#((DataRowView)Container.DataItem).Row["Name"]%>' />
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </span>
                                    </div>
                            ...
                            <td width="100">
                                  <div class="salesdateil" value="1">
                                    <p>
                                        共<b><%#((DataRowView)Container.DataItem).Row["ProductNum"].ToString() == "" ? "0" : ((DataRowView)Container.DataItem).Row["ProductNum"].ToString()%></b>件宝贝</p>
                                    <p>
                                        最近成交<b><%#((DataRowView)Container.DataItem).Row["SaleSum"].ToString() == "" ? "0" : ((DataRowView)Container.DataItem).Row["SaleSum"].ToString()%></b>笔</p>
        ...
        <div class="page_skip">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxIndex" runat="server" CssClass="page_input" autocomplete="off"></asp:TextBox>
                    </td>
