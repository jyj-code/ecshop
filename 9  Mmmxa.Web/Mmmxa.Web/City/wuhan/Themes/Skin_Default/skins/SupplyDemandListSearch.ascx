            ...
            <ItemTemplate>
                <div class="cityod" js="addshowevent" id="cityod" cityid='<%#Eval("Code")%>'>
                    ...
                    <div id="city_area" js="addhideevent" class="cluetip hidden">
                        ...
                        <div class="city">
                            <ul id="city<%# Eval("Code")%>"></ul>
                            <ul id="_city<%# Eval("Code")%>" style="text-align: center"></ul>
                        </div>
...
<div class="SearchResultsArea">
    <!--排序-->
    <div class="paixu">
        <div class="att_key"><asp:Label ID="LabelShowCategory" runat="server" Text="全部信息"></asp:Label></div>
        <div class="fr">
            <span class="paispan">地区：</span>
            <div class="comArea">
                <b class="comArea-text"><span id="spanAddress"><asp:Label ID="LabelAdress" runat="server" Text="所在地"></asp:Label></span></b>
    ...
    <div class="SearchResultsList">
                        ...
                        <tr>
                            <td width="500">
                                ...
                                <div class="describe fl">
                                    ...
                                    <p class="promulgator">
                                        发布者：<b><%# ((DataRowView)Container.DataItem).Row["MemberID"]%></b> 
                                        <span class="gongqiutime">
        ...
        </asp:Repeater>        <asp:Panel ID="Panel1" runat="server" Visible="false">  </asp:Panel>
        <%if (RepeaterData.Items.Count == 0)
          { %>
            <p class="nofind_search">没有查询到符合条件的供求信息！</p>
      <%} %>
    </div>
    <div class="clear">
    </div>
