        ...
        <asp:Repeater ID="RepeaterGrid" runat="server" EnableViewState="false">
            <ItemTemplate>
                <div class="product-wrap">
                    <div class="pro_img">
                        <a target="_blank" href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["ProductGuid"].ToString(),((DataRowView)Container.DataItem).Row["MemberID"].ToString(),"ProductDetail")%>">
                            <img src="<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["ZtcImg"].ToString())+"_160x160.jpg"%>" onerror="javascript:this.src='../ImgUpload/noimg.jpg_160x160.jpg'" /></a></div>
                    <div class="pro_name">
                        <a target="_blank" href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["ProductGuid"].ToString(),((DataRowView)Container.DataItem).Row["MemberID"].ToString(),"ProductDetail")%>"  title="<%#((DataRowView)Container.DataItem).Row["ZtcName"].ToString() %>"
                            class="pname">
                            <%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["ZtcName"].ToString(), 100, "")%>
                        </a>
                    </div>
                    <div class="pro_price">
                        <b>
                            <%#((DataRowView)Container.DataItem).Row["SellPrice"].ToString() == "0.00" ? "面议" : "￥" + ((DataRowView)Container.DataItem).Row["SellPrice"].ToString()%></b>
                        已销售：<%#Eval("SellCount") %></div>
                    <div class="pro_price">
                            <%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["ShopName"].ToString(), 32, "")%></div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
    </div>
