    ...
    <div class="search_box_detail">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownListShopCategoryCode1" CssClass="areCarge" runat="server" AutoPostBack="true">
                    </asp:DropDownList>
                </td>
                <td>
                    店铺二级：
                ...
                <td>
                    <asp:DropDownList ID="DropDownListShopCategoryCode2" CssClass="areCarge" runat="server" AutoPostBack="true">
                    </asp:DropDownList>
                </td>
                <td>
                    店铺三级：
