...
<div class="SearchResultBox">
    <h3><asp:Label ID="LabelArticleProductName" runat="server" Text="-全部-"></asp:Label></h3>
    ...
    <div class="page">
        ...
        <asp:TextBox ID="TextBoxPageNum" CssClass="page_input" MaxLength="4" runat="server" onfocus="this.select();"></asp:TextBox>
        <asp:Button ID="ButtonGo" runat="server" Text="" OnClientClick="return Ispost()" CssClass="page_btn" />
    </div>
</div>
