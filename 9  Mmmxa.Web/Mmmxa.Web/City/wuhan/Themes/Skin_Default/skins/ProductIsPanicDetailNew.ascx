        ...
        <ItemTemplate>
            <div class="DetailImage snap">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    ...
                    <tr>
                        <td class="tassle">
                            <span class="flohost">商品货号：</span> <span><%# Eval("productnum")%></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="tassle">
                            <span class="flohost">商品品牌：</span> <span><%# Eval("brandname")%></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="tassle">
                    ...
                    <tr>
                        <td class="tassle">
                            <span class="flohost">
                                <asp:Label ID="LabelTime" runat="server" Text=""></asp:Label></span> <span class="cotunse" id='panic'>
