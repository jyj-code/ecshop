    ...
    <div class="sn_bd">
        ...
        <div class="sn_container">
            <div class="sn_login_info" style="display: inline;">
                ...
                <span id="unlogin" runat="server"><span class="sog">欢迎光临！请<a href='<%= ShopUrlOperate.GetShopLoginGoBack() %>'>登录</a></span><span><a
                    href='<%= AgentHead.SetUrl("MemberRegister") %>' class="register">免费注册</a></span>
                </span>
            </div>
                    ...
                    <div id="headtest2" class="menu_hd menu_hd1" style="_zoom: 1;">
                        ...
                        <div class="wdsc fl" style="height: 135px; width: 224px; padding-top: 2px; z-index: 999999;">
                            ...
                            <div style="padding: 0 10px;">
                                您好，<a style="background: none; color: #333333; display: inline-block; position:relative; top:1px; width: 50px;
                                    overflow: hidden;" href='<%= ShopUrlOperate.RetUrl("Index") %>'>
                                    <asp:Label ID="LabelMemLoginIDTwo" runat="server" /></a>，欢迎来到多用户商城！
                                <a href="loginOut.aspx" style="display: inline; color: #ffffff; display: none">退出</a>
                            </div>
