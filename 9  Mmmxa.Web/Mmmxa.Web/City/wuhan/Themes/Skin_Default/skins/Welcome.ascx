...
<div class="sn_container">
    ...
    <div class="sn_login_info" style="display: inline;">
        ...
        <div runat="server" visible="true" id="loginOut">
            您好！
            <a href="<%= ShopUrlOperate.RetMemberUrl("M_index") %>"><asp:Label ID="MemLoginID" runat="server" Style="font-weight: bold; color: #A30001;" /></a>&nbsp;欢迎来到本商城!&nbsp;
            <a href="loginOut.aspx">[退出]</a>
             <span Style="font-weight: bold; color: #A30001; font-family:Times New Roman; font-size:18px;" >400-186-0538</span>
        </div>
        <!--//已经登录状态 End-->
        ...
        <div runat="server" visible="true" id="login">
            ...
            <span>
                <a href='<%= ShopUrlOperate.RetUrl("MemberRegister") %>'>免费注册</a>
            </span> &nbsp;
             <span Style="font-weight: bold; color: #A30001; font-family:Times New Roman; font-size:18px;" >400-186-0538</span>
    ...
    <ul class="sn_quick_menu">
        <li class="sn_mytaobao menu_item">
            <div id="headtest" class="menu_hd menu_hd1 ie6top">
                ...
                <div class="sub_huaguo1">
                    <a href='<%= ShopUrlOperate.RetShopadminUrl("s_index") %>?tosurl=S_Order_List.aspx'>已售出的商品</a>
                    <a href='<%= ShopUrlOperate.RetShopadminUrl("s_index") %>?tosurl=S_SellProduct.aspx'>销售中的商品</a>
                </div>
            </div>
        </li>
        <li class="sn_mytaobao menu_item">
                ...
                <div class="wdsc">
                    ...
                    <div class="sub_wdsc" runat="server" visible="true" id="loginTwo">
                        <div class="qd_bg">
                            ...
                            <div class="wdjf">
                                <a href='<%= ShopUrlOperate.RetMemberUrl("M_index") %>?tomurl=M_CreditDetails.aspx?type=0&pageid=1'>我的积分</a>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
                    ...
                    <div runat="server" visible="true" id="loginOutTwo" class="lambert_sub">
                        <div class="qd_bg">
                           <div class="cldd" style="display:none">
                            ...
                            <div class="zxhf">
                                <a href='<%= ShopUrlOperate.RetMemberUrl("M_index") %>?tomurl=M_MyMessageBoard.aspx'>咨询回复</a>
                            </div>
                            <div class="wddd">
                                <a href='<%= ShopUrlOperate.RetMemberUrl("M_index") %>?tomurl=M_OrderList.aspx'>我的订单</a>
                            </div>
        ...
        <li class="sn_mytaobao menu_item">
            <div id="headtest3" class="menu_hd menu_hd2 ie6top">
                <a href="<%= ShopUrlOperate.RetUrlNew("ShoppingCart1") %>">我的购物车</a>
                <div class="wdgwc fr">
                    <div>
                        <div class="sub_wdsc1">
                            <a class="cartenet" href="<%= ShopUrlOperate.RetUrlNew("ShoppingCart1") %>">
                                <span class="qdl1" id="shopcart1" runat="server">
                                    购物车中还没有商品，赶紧选购吧！
                                </span>
                                <span class="qdl1" id="shopcart2" runat="server">
                                    购物车共<asp:Literal ID="LiteralCartCount" runat="server" Text="0"></asp:Literal>件商品
                                </span>
                            </a>
                        </div>
                    </div>
        ...
        <li class="sn_mytaobao menu_item">
            <div id="headtest1" class="menu_hd menu_hd1 ie6top">
                ...
                <div class="sub_huaguo1">
                    <a href='<%= ShopUrlOperate.RetMemberUrl("m_index") %>?tomurl=M_MyCollect.aspx?type=0&pageid=1'>收藏的商品</a>
                    <a href='<%= ShopUrlOperate.RetMemberUrl("m_index") %>?tomurl=M_MyCollect.aspx?type=1&pageid=1'>收藏的店铺</a>
                </div>
            </div>
        </li>
        <li class="sn_mytaobao menu_item">
            <div class="menu_hd">
                <a href='<%= ShopUrlOperate.RetUrlNew("MerchantsIn") %>' target="_blank">招商加盟</a>
            </div>
        </li>
        <li class="sn_mytaobao menu_item" style="background: none;">
            <div class="menu_hd">
                <a href="<%= ShopUrlOperate.RetUrlNew("HelpListIndex") %>">帮助中心</a>
            </div>
        </li>
        <li style="display: none;">
            <a onclick="javascript:SecondLogin('cartClick','')" href="javascript:void(0)" rel="nofollow" onclick="">
