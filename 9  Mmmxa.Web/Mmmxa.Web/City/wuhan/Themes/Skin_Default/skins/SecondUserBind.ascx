...
<div class="bind_title" style="display:none;">
    <asp:Literal ID="LiteralUserName" runat="server"></asp:Literal> 您好！您已经用<asp:Literal
        ID="LiteralAccountType" runat="server"></asp:Literal>成功登录Shopnum1商城系统</div>
<div class="bind_detail">
    <div class="content1" id="Divcontent1" runat="server" visible="false">
        <div class="bind_re bind_re1">
            <input type="radio" name="signuped" value="1" autocomplete="off" class="f-radio"
                 checked="checked"/>已经注册过Shopnum1商城系统（绑定<asp:Literal
        ID="LiteralAccount" runat="server"></asp:Literal>和Shopnum1商城账户）
        </div>
        <div class="regesiterd regesiterd1">
            <table class="enter-account">
                <tr>
                    ...
                    <td>
                        <input type="text" id="seconduserBind_userName" name="seconduserBind_userName" class="f-text" value=""  />
                        <span style="color: red">*</span>
                         <span id="spanErruserBind_userName" style="color:Red"></span>未注册Shopnum1账号，请点击<asp:LinkButton ID="LinkButton2"
                            runat="server" Text="这里">这里</asp:LinkButton>绑定
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="seconduserBind_password" name="seconduserBind_password" class="f-text" />
                            <span style="color: red">*</span>
                        <span id="spanErruserBind_password" style="color:Red"></span>
                ...
                <tr>
                 <td></td>
                 <td><span id="spanContent"  style="color:Red;"></span></td>
                </tr>
            </table>
        </div>
    </div>
    <div class="content2" id="Divcontent2" runat="server">
        <div class="bind_re bind_re2">
            <input type="radio" name="signuped" value="0" autocomplete="off" class="f-radio" id="otherRadio"   checked="checked" />未注册过的用户由此登录
        </div>
            ...
            <table class="enter-account">
                    ...
                    <td>
                        <input type="text" id="seconduserBind_userName_c" name="seconduserBind_userName_c"
                            class="f-text" value="" onblur="CheckMemLogin1(this)" />
                             <span style="color: red">*</span>
                            <span id="spanErrUserName" style="color: Red"></span>
                        <span id="spanContent1" style="color: Red"></span>已经注册Shopnum1账号，请点击<asp:LinkButton ID="LinkButton1"
                            runat="server" Text="这里">这里</asp:LinkButton>绑定
                    </td>
                ...
                <tr>
                  <td style="width: 100px;">
                    ...
                    <td>
                        <input type="text" id="email" name="seconduserBind_email" class="f-text" value="" onblur="existemail(this)" />
                         <span style="color: red">*</span>
                        <span id="spanErrEmail" style="color:Red"></span>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="Newpassword" name="seconduserBind_Newpassword" class="f-text"  />
                         <span style="color: red">*</span>
                        <span style=" color:Red" id="spanErrPwd"></span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="password" id="NewRepassword" name="seconduserBind_NewRepassword" class="f-text"  />
                         <span style="color: red">*</span>
                        <span id="spanErrRePwd" style=" color:Red"></span>
                    </td>
                </tr>
                <tr>
                    <td>
