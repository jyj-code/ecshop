                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td rowspan="4" width="80" valign="top" style="border-right: 1px dashed #e1e1e1;
                            background: #fcfcfc;">
                            <img  src='<%# ((DataRowView)Container.DataItem).Row["Banner"]%>' runat="server"
                                alt="图片" width="90" height="90" />
                        </td>
                        <td class="las_t">
                    ...
                    <tr>
                        <td>
                            主营宝贝：<asp:Repeater ID="RepeaterProduct" runat="server">
                                <ItemTemplate>
                                    <a href='<%#ShopUrlOperate.shopHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString() )%>'><%#((DataRowView)Container.DataItem).Row["Name"]%></a> 
                                </ItemTemplate>
                            </asp:Repeater>
                        </td>
                    </tr>
