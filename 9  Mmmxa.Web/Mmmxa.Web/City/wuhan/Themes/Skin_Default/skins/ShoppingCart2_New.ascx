                                ...
                                <ItemTemplate>
                                    <div class="cart-tbody cart_bottom">
                                        <div class="order_cl order-goods">
                                            <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["ProductGuid"].ToString(),((DataRowView)Container.DataItem).Row["shopid"].ToString(),"ProductDetail")%>"  class="or_img"  title='<%# ((DataRowView)Container.DataItem).Row["Name"] %>' target="_blank">
                                            ...
                                            <div class="or_name">
                                                <p> 
                                                 <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["ProductGuid"].ToString(),((DataRowView)Container.DataItem).Row["shopid"].ToString(),"ProductDetail")%>" title='<%# ((DataRowView)Container.DataItem).Row["Name"] %>' target="_blank">
    ...
    <div class="bg_lic">
        <div class="consignee clearfix">
            <div class="conmess">
                ...
                <span style="display:none"> <asp:Button ID="ButtonAddReceivAddress" runat="server" OnClientClick="return checkSub();" Text="确定添加" CssClass="shiyong"/></span>
            </div>
                     <!--手填收货地址-->
