    ...
    <asp:Repeater ID="RepeaterOnAndNext" runat="server">
        <ItemTemplate>
            <div class="pageupdown">
                <%# ((DataRowView)Container.DataItem).Row["Name"]%><a href='<%# ShopUrlOperate.RetUrlNew("ArticleDetail",((DataRowView)Container.DataItem).Row["guid"]) %>'><%# ((DataRowView)Container.DataItem).Row["Title"]%></a>
            </div>
        </ItemTemplate>
    </asp:Repeater>
