...
<div class="shop_ano">
    ...
    <ul>
        <asp:Repeater ID="RepeaterData" runat="server">
            <ItemTemplate>
                <li><img src="Themes/Skin_Default/Images/ico_quote.gif" /> <a href='<%# ShopUrlOperate.RetUrl("AnnouncementDetail",((DataRowView)Container.DataItem).Row["guid"]) %> ' title='<%# ((DataRowView)Container.DataItem).Row["Title"] %>'>
