...
function Show()
{
    document.getElementById("divShowHidden").style.display="block";
}
function Hiddend()
{
...
<div class="pro_area">
    ...
    <div class="paixu">
        ...
        <div class="comRange">
            ...
            <asp:DropDownList ID="DropDownListSort" runat="server" AutoPostBack="true" EnableViewState="true"   Visible="false">
            </asp:DropDownList>
            ...
            <div class="price-box">
                <b class="price-item"><i class="ui-price-plain">¥</i>
                    <asp:TextBox ID="TextBoxStartPrice" runat="server" onkeyup="Show();this.value=this.value.replace(/\D/g,'')"
                        onafterpaste="Show();this.value=this.value.replace(/\D/g,'')" MaxLength="8" CssClass="priceInput"></asp:TextBox>
                ...
                <div class="product-wrap">
                    ...
                    <div class="pro_price">
                        <a href="<%#ShopUrlOperate.shopHref(((DataRowView)Container.DataItem).Row["MemloginId"].ToString())%>" >
                            <%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["shopName"].ToString(),32,"") %></a>                            <%# ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["AddressValue"].ToString(),5,"")%></div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
    </div>
                            ...
                            <tr>
                                ...
                                <td width="260">
                                    <div class="area_name">
                                        ...
                                        <p>
                                     <a href="<%#ShopUrlOperate.shopHref(((DataRowView)Container.DataItem).Row["MemloginId"].ToString())%>" class="pshop">
