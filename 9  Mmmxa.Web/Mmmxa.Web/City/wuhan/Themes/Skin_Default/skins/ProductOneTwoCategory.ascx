...
<div class="searchcate">
    <asp:Repeater ID="RepeaterData" runat="server">
        <ItemTemplate>
            <dl>
                <dt class="shangsearch_product"><%# ((DataRowView)Container.DataItem).Row["Name"]%></dt>
                <dd style="display:none">
                    <asp:Repeater ID="RepeaterChild" runat="server">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.RetUrl("Search_product",((DataRowView)Container.DataItem).Row["Code"])%>'><%# ((DataRowView)Container.DataItem).Row["Name"]%></a>
                        </ItemTemplate>
                    </asp:Repeater>
                </dd>
            </dl>
