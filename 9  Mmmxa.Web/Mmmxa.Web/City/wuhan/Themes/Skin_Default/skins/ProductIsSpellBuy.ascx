            ...
            <ItemTemplate>
                <div class="pro_det">
                    ...
                    <a href='<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductIsSpell_Detail" )%>'>
                        <asp:Image ImageUrl='<%# ((DataRowView)Container.DataItem).Row["OriginalImage"]%>' runat="server"
                            Style="border: 1px solid #dedede;" Width="166px" Height="125px" onerror="javascript:this.src='../ImgUpload/noImage.gif'" /></a><br />
                    <a href='<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductIsSpell_Detail")%>'>
