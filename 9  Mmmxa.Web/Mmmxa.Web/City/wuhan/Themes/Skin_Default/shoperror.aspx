        ...
        <div class="ignore">
            <dl>
                ...
                <dd class="warrior snipe">
                    <h4>对不起，您访问的店铺可能已被关闭......</h4>
                   现在，您可以进行如下操作：
                    <p class="courtday">
                        1.<span id="spanTime" class="redtwo">60</span> 秒后跳转到 <a href="/">商城首页</a><br />                        2.进入 <a href='<%= ShopUrlOperate.RetUrl("ShopListSearch") %>'>店铺城</a>                         搜索店铺，那里有很多买家寻找的好店铺<br />                        3.<a href="javascript:void(0)" onclick="window.history.go(-1)">后退</a> 检查刚才的输入</p>
                    <p>
                    </p>
                </dd>
            </dl>
