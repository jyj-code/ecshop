    ...
    function test(c_type,c_name)
    {
        var type=$("#HiddenSwitchType").val();
          ...
          if(type=="1"||c_type=="1")
	     {
	        ...
	        //商品搜索
	        var a='<%=GetPageName.RetUrl("Search_productlist")%>'+"?search="+name+"&pv="+type;
	        location.href=a;          
	     }
                        ...
                        <div class="FormBox">
                            <div class="mallSearch_input clearfix">
                                ...
                                <input class="txtinput" type="text" name="textfield" id="textfield" maxlength="50"
                                    onkeyup="showHint(this.value)" autocomplete="off" accesskey="s"  autocomplete="off" autofocus="true" x-webkit-speech="" x-webkit-grammar="builtin:search"  />
    ...
    <div class="mallNav_con">
        <div id="mallTextNav" class="clearfix">
            <div class="mallNav_main nall_hid">
                <ul>
                    <li><a href="<%=ShopUrlOperate.RetUrlNew("Default") %>">首页</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrlNew("ArticleListSearch","tag=1&guid=154&Category=电子优惠券") %>">电子优惠券</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrlNew("ArticleListSearch","tag=2&guid=106&Category=网商社区") %>">网商社区</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrlNew("ArticleListSearch","tag=3&guid=103&Category=官网活动") %>">官网活动</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrlNew("ArticleListSearch","tag=4&guid=100&Category=积分商城") %>">积分商城</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrlNew("ArticleListSearch","tag=5&guid=97&Category=商城促销") %>">商城促销</a></li>
                </ul>
            </div>
        </div>
    </div>
