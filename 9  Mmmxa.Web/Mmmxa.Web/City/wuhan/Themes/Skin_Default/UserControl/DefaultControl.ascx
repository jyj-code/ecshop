        ...
        <div class="tsBottom clearfix">
            ...
            <div class="tsBottom_right fr">
                ...
                <div class="dropdown" id="dropdown">
                    <dl id="drop1" class="">
                        <dt><a href="javascript:void(0)"  id="q0" class=""><b id="d0"></b><strong class="sh">品牌担保</strong></a></dt>
                        <dd id="w0" class="d0">
                            <strong>品牌担保</strong>
                            <p>在本多用户商城所购物品不仅有本公司进行全程监管，同时所支付的方式也可采用支付宝担保交易。</p>
                            <div class="extra"></div>
                        </dd>
                    </dl>
                    <dl id="drop2">
                        <dt><a href="javascript:void(0)" id="q1" class="dd"><b id="d1"></b><strong class="sh">市区免费送</strong></a></dt>
                        <dd id="w1">
                            <strong>市区免费送</strong>
                            <p>凡是本多用户商城会员均可享受，但部分较偏远的地区除外，详见网站公示规则或与在线客服咨询。</p>
                            <div class="extra"></div>
                        </dd>
                    </dl>
                    <dl id="drop3">
                        <dt><a href="javascript:void(0)" id="q2" class="ee"><b id="d2"></b><strong class="sh">200%包赔</strong> </a></dt>
                        <dd id="w2">
                            <strong>200%包赔</strong>
                            <p>客户按时支付成功，我们没有做任何处理，我们将100%全额退款，退回至客户指定帐户，或存入客户会员余额(可随时订购抵扣)，同时，和客户另协商配送时间，我们免费重新派送原订单。属于200%退赔。</p>
                            <div class="extra"></div>
                        </dd>
                    </dl>
                    <div class="clear"></div>
                ...
                <div class="newstw">
                    ...
                    <div class="newstw_con">
                        <div class="newcontain" id="b0" style="display: block;">
                            <ShopNum1:AnnouncementNewList ID="AnnouncementNewList" runat="server" ShowCount="17" SkinFilename="AnnouncementNewList.ascx" />
                        </div>
                        <div class="newcontain" id="b1" style="display: none;">
                            <ShopNum1:ArticleNewList ID="ArticleNewList" runat="server" ShowCount="17" SkinFilename="ArticleNewList.ascx" />
                        </div>
                    </div>
                </div>
                <!-- //最新公告 End-->
                ...
                <div class="menber">
                    <div class="menber_top">
                        <span class="huy">推荐品牌</span>
                        <a href="BrandDetail.aspx" class="more">更多</a>
                    </div>
                    <div class="login1">
