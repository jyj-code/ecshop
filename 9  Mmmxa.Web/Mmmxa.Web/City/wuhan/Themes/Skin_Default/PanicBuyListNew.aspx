  ...
  //分页
        ...
        function separatePage1() {
            $.ajax("Api/PanicProductOpreate.ashx", {
                type: "get", data: "categoryCode=004&type=g&pageIndex=" + pageIndex1, dataType: "json",
            ...
            $.ajax("Api/PanicProductOpreate.ashx", {
                type: "get", data: "categoryCode=002&type=g&pageIndex=" + pageIndex2, dataType: "json",
                cache: false, success: function (jsObj) {
                    if (jsObj.statu == "ok") {
         ...
         function separatePage3() {
            $.ajax("Api/PanicProductOpreate.ashx", {
                type: "get", data: "categoryCode=003&type=g&pageIndex=" + pageIndex3, dataType: "json",
                cache: false, success: function (jsObj) {
                    if (jsObj.statu == "ok") {
           ...
           function separatePage4() {
            $.ajax("Api/PanicProductOpreate.ashx", {
                type: "get", data: "categoryCode=009&type=g&pageIndex=" + pageIndex4, dataType: "json",
                cache: false, success: function (jsObj) {
                    if (jsObj.statu == "ok") {
          ...
          function separatePage5() {
            $.ajax("Api/PanicProductOpreate.ashx", {
                type: "get", data: "categoryCode=008&type=g&pageIndex=" + pageIndex5, dataType: "json",
                cache: false, success: function (jsObj) {
                    if (jsObj.statu == "ok") {
          ...
          function separatePage6() {
            $.ajax("Api/PanicProductOpreate.ashx", {
                type: "get", data: "categoryCode=007&type=g&pageIndex=" + pageIndex6, dataType: "json",
                cache: false, success: function (jsObj) {
                    if (jsObj.statu == "ok") {
                ...
                <div class="panic_se">
                    <div class="panic_se_left_top">
                        ...
                        <div class="psl_right" id="divPageBar1">
                            ...
                            </b><a class="page_up_true" onclick="prevPage('004')">上一页</a> <a class="page_down_true"
                                onclick="nextPage('004')">下一页</a>
                        </div>
                    </div>
                ...
                <div class="panic_se">
                    <div class="panic_se_left_top">
                        ...
                        <div class="psl_right" id="divPageBar2">
                            ...
                            </b><a class="page_up_true" onclick="prevPage('002')">上一页</a> <a class="page_down_true"
                                onclick="nextPage('002')">下一页</a>
                        </div>
                    </div>
                    <div class="panic_cont">
                        <div class="panic_se_right">
            ...
            <div class="panic_se">
                <div class="panic_se_left_top">
                    ...
                    <div class="psl_right" id="divPageBar3">
                        ...
                        </b><a class="page_up_true" onclick="prevPage('003')">上一页</a> <a class="page_down_true"
                            onclick="nextPage('003')">下一页</a>
                    </div>
                </div>
                <div class="panic_cont">
                    <div class="panic_se_right">
            ...
            <div class="panic_se">
                <div class="panic_se_left_top">
                    ...
                    <div class="psl_right" id="divPageBar4">
                        ...
                        </b><a class="page_up_true" onclick="prevPage('009')">上一页</a> <a class="page_down_true"
                            onclick="nextPage('009')">下一页</a>
                    </div>
                </div>
                <div class="panic_cont">
                    <div class="panic_se_right">
            ...
            <div class="panic_se">
                <div class="panic_se_left_top">
                    ...
                    <div class="psl_right" id="divPageBar5">
                        ...
                        </b><a class="page_up_true" onclick="prevPage('008')">上一页</a> <a class="page_down_true"
                            onclick="nextPage('008')">下一页</a>
                    </div>
                </div>
                <div class="panic_cont">
                    <div class="panic_se_right">
            ...
            <div class="panic_se">
                <div class="panic_se_left_top">
                    ...
                    <div class="psl_right" id="divPageBar6">
                        ...
                        </b><a class="page_up_true" onclick="prevPage('007')">上一页</a> <a class="page_down_true"
                            onclick="nextPage('007')">下一页</a>
                    </div>
                </div>
                <div class="panic_cont">
                    <div class="panic_se_right">
