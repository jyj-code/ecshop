...
<body>
    ...
    <div class="FlowCat_cont clearfix">
        <div class="warp_site">首页 》<a>优惠券</a></div>
        ...
        <div class="list_right fr">
           ...
           <div id="focus" class="yh_focus">
                <div id="Rleft">
                   ...
                   <ShopNum1:AdvertisementPPTStyle ID="AdvertisementPPTStyle" runat="server" SkinFilename="AdvertisementPPT.ascx"  AdID="ad7" AdType="2"/>
