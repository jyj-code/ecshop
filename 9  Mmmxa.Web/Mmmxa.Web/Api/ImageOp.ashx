            ...
            if (Common.ReqStr("albumid") != "")
            {
                ...
                if (!File.Exists(uploadPath))
                {
                    try
                    {
                        ...
                        {
                            string o_webFilePath = HttpContext.Current.Server.MapPath("~/ImgUpload/Main/" + System.DateTime.Now.ToString("yyyy_MM") + "/txt_" + strFileName);
                            ...
                            uploadPath = "~/ImgUpload/Main/" + System.DateTime.Now.ToString("yyyy_MM") + "/txt_" + strFileName;
                        }
                        else if (strCheck == "2")           //生成图片水印
                        {
                            //添加图片水印
                            string o_webFilePath = HttpContext.Current.Server.MapPath("~/ImgUpload/Main/" + System.DateTime.Now.ToString("yyyy_MM") + "/img_" + strFileName);
                            file.SaveAs(o_webFilePath);
                            ...
                            uploadPath = "~/ImgUpload/Main/" + System.DateTime.Now.ToString("yyyy_MM") + "/img_" + strFileName;
                        }
                        #endregion
                    }
                    catch (Exception ex)
