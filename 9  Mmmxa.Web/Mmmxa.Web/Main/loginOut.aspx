...
<script runat="server">
    ...
    private void LinkButtonLoginOut_Click(object sender, EventArgs e)
    {
        ...
        if (Page.Request.Cookies["dnt"] != null)
        {
            ...
            shopnum1Cookie.Values.Clear();
            shopnum1Cookie.Expires = System.DateTime.Now.AddDays(-6);
            shopnum1Cookie.Domain = "jyhbbs.nrqiang.com";
            Page.Response.Cookies.Add(shopnum1Cookie);
        }
    }
...
setcookie('dnt','',0,'/','BBS.nrqiang.com','');
...
<body>
    <form id="form1" runat="server">
     <!--head start-->
        ...
        <!--main start-->
        <br /><br />
       <h2 style="font-size:large; color:Green;"><center>恭喜您退出成功！</center></h2>
       <center style="display:none"><span id="loadtime">5</span></center>
       <center>正在<a href="/">返回首页</a>...</center>
       <br /><br />
     <!--//main end-->
        <!--foot start-->
      <%--  <iframe src="http://BBS.nrqiang.com//logout.aspx?userkey=dc3949ba" height="0" width="0" visible="false"></iframe>--%>
        <!--foot end-->
    <!--js-->
    </form>
</body>
