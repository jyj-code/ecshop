        ...
        <div id="mallTextNav" class="clearfix">
            <div class="mallNav_main nall_hid">
                <ul>
                    ...
                    <li><a href="<%=ShopUrlOperate.RetMultiUrl("ArticleListSearch","tag=1&guid=154&Category=电子优惠券") %>">电子优惠券</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrl("ArticleListSearch","tag=2&guid=106&Category=网商社区") %>">网商社区</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrl("ArticleListSearch","tag=3&guid=103&Category=官网活动") %>">官网活动</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrl("ArticleListSearch","tag=4&guid=100&Category=积分商城") %>">积分商城</a></li>
                    <li><a href="<%=ShopUrlOperate.RetMultiUrl("ArticleListSearch","tag=5&guid=97&Category=商城促销") %>">商城促销</a></li>
                </ul>
            </div>
        </div>
    </div>
