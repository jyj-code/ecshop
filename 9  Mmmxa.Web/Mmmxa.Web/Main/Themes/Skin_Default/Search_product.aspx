...
<style type="text/css">
.ThrCategory_fwr{  z-index:111;}
#FlowCate{ top:0;}
a.nextpage{ width:60px;}
a.nextpage:hover{width:60px;}
</style>
<body>
    ...
    <div class="FlowCat_cont">
        <div class="article_cont">
            <div class="list_left fl">
                <!--商品分类-->
                <ShopNum1:ProductOneTwoCategory ID="ProductOneTwoCategory1" runat="server" SkinFilename="ProductOneTwoCategory.ascx" ShowCountOne="10" ShowCountTwo="500" />
                <!--推荐商品-->
                ...
                <!--广告-->
                <div class="leftimg">
                    <a href="#"><img src="Themes/Skin_Default/Images/seach01.jpg" width="220" height="325" /></a>
                </div>
            </div>
