...
<body>
    ...
    <div class="FlowCat_cont">
        <div class="warp_site">首页 》商城视频</div>
        <div class="article_cont clearfix">
            <div class="list_left fl">
                ...
                <div class="store_category_view">
                    <h3>推荐视频</h3>
                    <div class="announ_list">                          
                        <ShopNum1:VideoIsRecommendList ID="VideoIsRecommendList" ShowCount="10" runat="server" SkinFilename="VideoIsRecommendList.ascx" />
                    </div>
                </div>
                <!-- 热点视频 -->
                <div class="store_category_view">
            ...
            <div class="list_right fr">
                ...
                <div class="precont VideoBox">
                    <div class="all_top"><span class="latest_shop1 fl">推荐视频</span><span style="float:right; padding-right:20px;"><a href="Video_ListV82.aspx?PageID=1&type=0">更多</a></span></div>
                ...
                <!-- 最新视频 -->
                <div class="precont VideoBox">
                    <div class="all_top"><span class="latest_shop1 fl">最新视频</span><span style="float:right; padding-right:20px;"><a href="Video_ListV82.aspx?PageID=1&type=1">更多</a></span></div>
                    <div class="preshow clearfix">                     
                ...
                <!-- 热点视频 -->
                <div class="precont VideoBox">
                    <div class="all_top"><span class="latest_shop1 fl">热点视频</span><span style="float:right; padding-right:20px;"><a href="Video_ListV82.aspx?PageID=1&type=2">更多</a></span></div>
                    <div class="preshow clearfix">
