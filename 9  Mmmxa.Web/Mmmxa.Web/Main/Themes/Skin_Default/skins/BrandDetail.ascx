    ...
    <ItemTemplate>
        <div class="brands_shop clearfix">
            ...
            <div class="brands_shop_intro fl">
                <p class="brname"><%#((DataRowView)Container.DataItem).Row["Name"]%></p>
                <p><%#((DataRowView)Container.DataItem).Row["Description"]%></p>
                <p>官方网站：<a href="http://<%#((DataRowView)Container.DataItem).Row["WebSite"].ToString()%>" target="_blank"><%# ((DataRowView)Container.DataItem).Row["WebSite"]%></a></p>
            </div>
        </div>
    </ItemTemplate>
</asp:Repeater>
                ...
                <div class="product-wrap">
                    <div class="pro_img">
                        <a href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>">
                            <img src="<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["ThumbImage"].ToString())+"_160x160.jpg"%>" onerror="javascript:this.src='../ImgUpload/noimg.jpg_160x160.jpg'" /></a></div>
                    <div class="pro_name">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td width="130" class="showbigImg">                                    
                                    <div class="area_imgs">
                                        <a href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>" class="area_imgs">
