...
{ 
    var boolresult=true;
    var inputcontrol=$("#MemberRegister_ctl00_TextBoxMemLoginID").val();
...
function existemail() 
{   var boolresult=true;
    var inputcontrol=$("#MemberRegister_ctl00_TextBoxEmail").val();
...
{
    var boolresult=true;
    var inputcontrol=$("#MemberRegister_ctl00_TextBoxMobile").val();
...
{
    var boolresult=true;
    var inputcontrol=$("#MemberRegister_ctl00_TextBoxPwd").val();
...
{
   var boolresult=true;
    var inputcontrol=$("#MemberRegister_ctl00_TextBoxRePwd").val();
    var context = document.getElementById("spanSurePwd");
    var pwd =$("#MemberRegister_ctl00_TextBoxPwd").val();
    if(inputcontrol == pwd) 
    {
        var reg = new RegExp("^[a-zA-Z0-9]{6,15}$");
        if(reg.test(inputcontrol)) 
...
function existpublishmemlogid() 
{
   ...
   var boolresult=true;
    var inputcontrol=$("#MemberRegister_ctl00_TextBoxPublishMemloid").val();
...
function existcode() 
{
   ...
   var boolresult=true;
    var inputcontrol=$("#MemberRegister_ctl00_TextBoxCode").val();
...
$(document).ready(function(){
   ...
   {        
        ...
        if(check.checked) 
        {
            ...
            if((existepwd()&&existesurepwd()&&existcode())&&(existmemname()||existMobile()||existemail()))
            {
               ss=true;
            }
            else
            ...
            <div class="form form1 fl">
                ...
                <div class="LoginWays" style="display: block;">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tr class="item" id="Reg0" >
                            ...
                            <td class="td2 tl">
                                <div style="position: relative;">
                                    <asp:TextBox ID="TextBoxMemLoginID" runat="server" CssClass="text" MaxLength="20"
                                        onfocus='Showtips("spanName","由2-20位由英文字母,汉字、数字和下划线组成的字符串组成")' onblur="existmemname()"
                                        autocomplete="off">
                                    </asp:TextBox>
                        ...
                        <tr class="item" id="Reg1"  style=" display:none;">
                            <td class="label">
                                手机号码：
                            </td>
                            <td class="td2 tl">
                                <div style="position: relative;">
                                    <asp:TextBox ID="TextBoxMobile" runat="server" CssClass="text" MaxLength="100" onblur="existMobile()"
                                        onfocus='Showtips("spanMobile","请填写您常用的手机号码，以便找回密码等服务")'>
                                    </asp:TextBox>
                                    <span id="spanMobile" class="null"></span>
                                     <i class="i2"></i>
                                </div>
                            </td>
                        </tr>
                        <tr class="item" id="Reg2" style=" display:none;">
                            <td class="label">
                                电子邮箱：
                            </td>
                            <td class="td2 tl">
                                <div style="position: relative;">
                                    ...
                                    <span id="spanEmail" class="null"></span>
                                    <i class="i3"></i>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="item">
                            ...
                            <td class="td2 tl">
                                <div style="position: relative;">
                                    ...
                                    <span id="spanSurePwd" class="null"></span>
                                    <s></s>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="item" style="height: 30px;">
                            ...
                            <td>
                                ...
                                <br />
                                <span id="spanIfAgree" visible="false" style=" color:Red"></span>
                            </td>
                        </tr>
                        <tr>
                            <td class="label">
                            ...
                            <td>
                                <div class="login">
                                    <asp:Button ID="ButtonConfirm" runat="server" OnClientClick="return agreement();"
                                        class="btn-img btn-regist2" value="同意以上协议"  Text="注册"/>
                                </div>
	...
	autoTab: function(){
		...
		ctrls.bind({
		    click: function(e){
				...
				if(index=="0")
				{
				 $("#MemberRegister_ctl00_TextBoxMobile").val("");
				 $("#MemberRegister_ctl00_TextBoxEmail").val("");
				}
				if(index=="1")
				{
				 $("#MemberRegister_ctl00_TextBoxEmail").val("");
				 $("#MemberRegister_ctl00_TextBoxMemLoginID").val("");
				}
				if(index=="2")
				{
				 $("#MemberRegister_ctl00_TextBoxMobile").val("");
			     ...
			     $("#MemberRegister_ctl00_TextBoxPwd").val("");
				 $("#MemberRegister_ctl00_TextBoxRePwd").val("");
			     $("#MemberRegister_ctl00_TextBoxCode").val("");
				 reloadcode();
		    }
		});
	}
