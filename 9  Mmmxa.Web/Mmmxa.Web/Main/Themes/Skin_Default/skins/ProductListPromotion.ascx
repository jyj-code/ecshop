...
<div class="pro_area">
    <div class="paixu"><span class="title">促销商品</span></div>
    <!--排序条件-->
                ...
                <div class="product-wrap">
                    <div class="pro_img">
                        <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>">
                            <img src="<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["ThumbImage"].ToString())%>" width="164" height="164" onerror="javascript:this.src='../ImgUpload/noImage.gif'" /></a></div>
                    <div class="pro_name">
