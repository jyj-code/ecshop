...
//                alert(existcode())
    ...
    function existemail() 
    {
        ...
        ({
            url: "/api/CheckMemberLogin.ashx",
            type:"GET",
            data: "type=emailisexistfind&Email="+inputcontrol,//type=mobileisexistfind&Mobile=
            success: function(result) 
            {
                  if(result!=null)
                  {
    ...
    {   var boolresult=true;
        ...
        ({
            url: "/api/CheckMemberLogin.ashx",
            data: "type=mobileisexistfind&Mobile="+inputcontrol+"",
            success: function(result) 
            {
                  if(result!=null)
                  {
    ...
    $(function()
    {
        ...
        $("#butGetCode").click(function(){
            ...
            if(mobileCode=="")
            {
                yzCode.innerHTML="验证码不存在!";return false;
            }
            if($("#spanSendYZM").attr("state")=="0")
            {
                 yzCode.innerHTML="验证码不正确!";return false;
            }
            ...
            ({
                url:"/api/CheckMemberLogin.ashx",
                data:"type=sendemobile&Mobile="+inputcontrol+"",
                success:function(result)
                {
        ...
        <div class="findtable">
            <table border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr id="trEmailCencel" class="trsrucee" style=" display:none;">
                    ...
                    <td align="left">
                        <p class="yellow1">
                          <a style="text-decoration:none;" href="javascript:window.location.href = window.location.href;">验证邮件发送失败,请点击重新完成验证！</a>
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <div class="findtable">
                <table border="0" cellpadding="0" cellspacing="0" align="center">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Button ID="ButtonFindPwdSubmit" OnClientClick="return OnButtonSumit()"
                                runat="server" Text="提交" CssClass="finbtn" />
                        </td>
                    </tr>
                </table>
            </div>
