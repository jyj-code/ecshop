...
<div class="pro_area">
    ...
    <div class="paixu">
        ...
        <div class="comArea">
            ...
            所有地区
            </span></b><%=Common.ReqStr("") %>
            <%if (Common.ReqStr("addcode") != "" && Common.ReqStr("addcode") != "-1")
              { %>
        ...
        <asp:LinkButton ID="LinkButtonRenqi" runat="server" CssClass="comSort" title="按人气从高到低" EnableViewState="false">人气<i id="IRenqi" runat="server"   class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonSales" runat="server" CssClass="comSort" title="按销量从高到低" EnableViewState="false">销量<i id="ISales" runat="server"   class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonXinyong" runat="server" CssClass="comSort" title="按信用从高到低" EnableViewState="false">信用<i id="IXinyong" runat="server"  class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonPrice" runat="server" CssClass="comSort" title="按价格从低到高" EnableViewState="false">价格<i id="IPrice" runat="server"  class="comSort-u"></i></asp:LinkButton>
        <div class="comprice">
            <div class="price-box">
                ...
                <div class="product-wrap">
                    ...
                    <div class="pro_price">
                        <b>
                            ...
                            <del></del>
                            </b> 销量：<font color="green"><%#((DataRowView)Container.DataItem).Row["SaleNumber"]%></font>
                    </div>
                    <div class="pro_price">
