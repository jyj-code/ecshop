...
<div class="searchlist">
    ...
    <ItemTemplate>
     <a><%#((DataRowView)Container.DataItem).Row["BrandGuid"]%><%#((DataRowView)Container.DataItem).Row["BrandName"]%></a>
    </ItemTemplate>
    </asp:Repeater>
            <br />
    ...
    <ItemTemplate>
    <a><%#((DataRowView)Container.DataItem).Row["Name"]%><%#((DataRowView)Container.DataItem).Row["Code"]%></a>
    </ItemTemplate>
    </asp:Repeater>
</div>
<div class="aBox">
                ...
                <table width="100%">
                    <tr>
                        ...
                        商品名：<%# ((DataRowView)Container.DataItem).Row["Name"]%>  
                         ...
                         <td align="left">上架时间：<%# ((DataRowView)Container.DataItem).Row["CreateTime"]%>  </td>
                    </tr>
                    <tr>
                        <td width="80px;">
