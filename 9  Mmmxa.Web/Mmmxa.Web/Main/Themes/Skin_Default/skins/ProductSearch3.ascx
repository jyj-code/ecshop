...
<style type="text/css">
    .cur{ font-size:12px; font-weight:bold;color:#f00;}
    .tlh a:visited{ color:#666;}
    .tlh a:visited{ text-decoration:underline;}
	.tlh a:hover{ color:#f00;  font-size:14;}
	.tlh a:active{  color:#f00; font-weight:bold;}
            ...
            <ShopNum1:ProductAttribute ID="ProductAttribute1" runat="server" SkinFilename="ProductAttribute.ascx" />--%>
                <table >
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListRegionCode1" CssClass="areCarge" runat="server" AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListRegionCode2" CssClass="areCarge" runat="server" AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListRegionCode3" CssClass="areCarge" runat="server" AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListProductGuid1" CssClass="areCarge" runat="server" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td>
                            商品二级：
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListProductGuid2" CssClass="areCarge" runat="server" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td>
                            商品三级：
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListProductGuid3" CssClass="areCarge" runat="server" AutoPostBack="true">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
                ...
                <div>
                   ...
                   －
                    ...
                    <p>商品名称：<asp:TextBox ID="TextBoxProductName" CssClass="areCarge" runat="server"></asp:TextBox></p>
                    <p class="ser_but" style="padding-left:62px;"><asp:Button ID="ButtonSearch" CssClass="search_btn" runat="server" Text="商品搜索"/></p>   
                </div>
                    ...
                    <div class="latest_shop_detail">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <p>
                                     <span class="priceon"><%#((DataRowView)Container.DataItem).Row["ShopPrice"]%></span></p>
                                    <p>
