            ...
            <div class="accretion">
                <table width="100%" border="0" cellpadding="10">
                    ...
                    <tr id="VerifyCode" runat="server">
                        ...
                        <tr>
                        <td valign="middle" align="left" style="padding-top:0;"><asp:TextBox ID="TextBoxCode" runat="server" CssClass="inpt_cont" onkeydown="if(event.keyCode==13){(document.getElementById('MessageBoardAdd_ctl00_ButtonConfrim')).focus();(document.getElementById('MessageBoardAdd_ctl00_ButtonConfrim')).click();}"></asp:TextBox></td>
                        <td valign="middle" align="left" style="padding-left:5px; padding-top:0;"><img src="imagecode.aspx?javascript:Math.random()" id="Img1" border="0" onclick="reloadcode()"
                                alt="看不清?点一下" style="cursor: pointer;" /></td>
                                <td valign="middle" align="left" style="padding-left:5px; padding-top:0;"><a style="cursor: pointer" onclick="reloadcode()">看不清楚?点一下</a></td>
                        </tr>
                        </table>
