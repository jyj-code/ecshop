...
<div class="panic_se">
    <div class="panic_se_left_top">
        <div class="psl_left">数码、家电专场</div>
        <div class="psl_right">
    ...
    <div class="panic_cont">
        <div class="panic_se_right">
           <%-- <img width="240" height="463" src="Themes/Skin_Default/Images/pan_ad08.jpg" />--%>
                    ...
                    <ItemTemplate>
                        <div class="psld_de">
                            ...
                            <%--<div class="panic_time" id='<%# "PanicBuy" + (PanicBuyList.i).ToString() %>'>
                                剩余时间：<span class="time"><script>show_date_timev(('<%# PanicBuyList.IsBegin(Eval("PanicBuyStartTime"),Eval("PanicBuyEndTime")).Replace("-","/") %>'),'<%# "PanicBuy" + (PanicBuyList.i++).ToString() %>')</script></span>
                            </div>--%>
