                    ...
                    <ItemTemplate>
                        <div class="psld_de">
                           ...
                           <%-- <div class="panic_time" id='<%# "PanicBuy" + (PanicBuyList.i).ToString() %>'>
                                剩余时间：<span class="time"><script>show_date_timez(('<%# PanicBuyList.IsBegin(Eval("PanicBuyStartTime"),Eval("PanicBuyEndTime")).Replace("-","/") %>'),'<%# "PanicBuy" + (PanicBuyList.i++).ToString() %>')</script></span>
                            </div>--%>
