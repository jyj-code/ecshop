<%@ Control Language="C#" %>
<div class="bBox" style="margin-top:12px; border:none;">
    <div class="bBoxnt">
        <h2>
            资讯点评</h2>
    </div>
                ...
                <div class="desc_list">
                    <div class="desc_list_top">
                        <div class="desc_name fl">
                            <b style="color: Red" style="display:none">【<%# ShopNum1.ShopWebControl.ShopArticleCommentList.GetValue(Eval("Rank"))%>】</b>
                            评论人：<%# Eval("MemLoginID")%>
                        </div>
