...
<div class="all_top"><span class="latest_shop1 fl"><asp:Label ID="lblVideoTitle" runat="server"></asp:Label>视频列表</span></div>
<div class="preshow clearfix">  
<ul class="VideoList clearfix">
    <asp:Repeater ID="RepeaterData" runat="server">
        <ItemTemplate>
            <li>
                <a class="VideoImg" href='<%# ShopUrlOperate.RetUrl("VideoDetail",((DataRowView)Container.DataItem).Row["Guid"] )%>'>
                ...
                <span class="VideoName">
                    <a href='<%# ShopUrlOperate.RetUrl("VideoDetail",((DataRowView)Container.DataItem).Row["Guid"] )%>'>
