...
//获得地区 和地区选中样式
 $(function()
 {
       ...
       //得到排序状态
       var soft='<%=Page.Request.QueryString["sort"] == null ? "desc" : Page.Request.QueryString["sort"].ToString() %>';
      
       var Ordername=$("#ShopListSearch1_ctl00_HiddenFieldOrdername").val();
       if(Ordername=="clickcount")//人气
       {
            $("#A_Renqi").addClass("selected");
       }
       if(Ordername=="salesum")//销量
       {
            $("#A_Xiaoliang").addClass("selected");
       }
       if(Ordername=="shopreputation")//信用
       {
            $("#A_XinYong").addClass( "selected");
       }
...
<div class="shop_conts">
    <div class="paixu">
       ...
       <%-- <span class="paispan">排序：</span>
        <div class="comRange">
            ...
            <div class="moren-list" style="display: none">
                <a href="<%=ShopUrlOperate.RetUrlForSearch("ShopListSearch","clickcount&sort=desc","ordername")%>"
                    title="按人气从高到低"><i class="mr-ico-pu"></i>按人气从高到低</a> <a href="<%=ShopUrlOperate.RetUrlForSearch("ShopListSearch","salesum&sort=desc","ordername")%>"
        ...
        <asp:LinkButton ID="LinkButtonRenqi" runat="server" CssClass="comSort"  Visible="false" title="按人气从高到低">人气<i id="IRenqi" runat="server"  class="comSort-d"></i></asp:LinkButton>
        
<asp:LinkButton ID="LinkButtonMoren" runat="server" CssClass="comSort" title="默认">默认<i id="IMoren" runat="server"  class="comSort-d"></i></asp:LinkButton>
        ...
        <asp:LinkButton ID="LinkButtonRuzhu" runat="server" CssClass="comSort">入驻时间<i id="IRuzhu" runat="server" class="comSort-d"></i></asp:LinkButton>
        <div class="shoprigth">
            店铺名称：
                        ...
                        <tr value="2">
                            <td width="500">
                                <div class="shoppics">
                                    <a href="<%#ShopUrlOperate.GetShopUrl(((DataRowView)Container.DataItem).Row["ShopID"].ToString())%>">
                                        <asp:Image ID="Image1" runat="server" Width="70" Height="70" Style="" ImageUrl='<%# ((DataRowView)Container.DataItem).Row["Banner"]%>'
                            ...
                            <td>
                                <div class="salesdateil" value="1">
                                    ...
                                    <p>
                                        最近成交<b><%#((DataRowView)Container.DataItem).Row["SaleSum"]%></b>笔</p>
                            ...
                            <td valign="top">
                                <div class="shopcomments">
                                    <div class="commentsimgs">
                                        <asp:Image ID="ImageProduct" runat="server" Width="86" Height="20" Style="" ImageUrl='<%# "~/"+((DataRowView)Container.DataItem).Row["pic"].ToString()%>' />
                                    </div>
                                    <p style="padding-left: 0;">
                                        好评率：<%#Convert.ToDouble(((DataRowView)Container.DataItem).Row["HaoPingLV"])*100%>%</p>
                                        ...
                                        <div class="shopcoms">
                                            ...
                                            <div class="shopplun">
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="shoptable">
                                                    <tr>
                                                        <td>
                                                            主营行业：<%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["SalesRange"].ToString(),6,"")%>
                                                        </td>
                                                        <td>
                                                            与同行业相比
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <%#((DataRowView)Container.DataItem).Row["CharacterBL"]%>
                                            </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <%#((DataRowView)Container.DataItem).Row["AttitudeBL"]%>
                </div>
                </td> </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <%#((DataRowView)Container.DataItem).Row["SpeedBL"]%></div>
                    </td>
                </tr>
