                    ...
                    <ItemTemplate>
                        <li class="iten itenone" style='display:<%#Container.ItemIndex>5?"none":"block" %>'>
                            ...
                            <div class="subCategory">
                                <div class="subView">
                                    <asp:DataList ID="DataListCategoryRight" runat="server" RepeatDirection="Horizontal" RepeatColumns="3" RepeatLayout="Flow">
                                        <ItemTemplate>
                                            <ul>
                                                <li class="subItem">
                                                    <h3 class="subItem_hd">
                    ...
                    <AlternatingItemTemplate>
                        <li class="iten itentwo" style='display:<%#Container.ItemIndex>5?"none":"block" %>'>
                            <h3 class="item_hd item_hd2">
                                <asp:Image ID="ImageLogo" runat="server" ImageUrl='<%# Eval("logoimg")%>' Width="28" Height="16" onerror="javascript:this.src='/ImgUpload/noimg.jpg_25x25.jpg'" />
                                <a href='<%#ShopUrlOperate.RetUrl("Search_productlist",((DataRowView)Container.DataItem).Row["code"].ToString(),"code")%>'>
                                    <%# Eval("Name")%></a>
                            </h3>
                            <asp:HiddenField ID="HiddenFieldID" runat="server" Value='<%# Eval("ID")%>' />
