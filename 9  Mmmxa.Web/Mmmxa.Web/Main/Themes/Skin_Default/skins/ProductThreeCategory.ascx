                 ...
                 DivRightTwo.html(lodding); 
                    //获取对应的2级和3级分类
                     ...
                     ({
                         ...
                         data: "id="+id+"&type=getproductcategory&fz=zz",
    ...
    <asp:Repeater ID="RepeaterData" runat="server">
        <ItemTemplate>
            <div class="test" id="<%# ((DataRowView)Container.DataItem).Row["ID"] %>">
                <div class="xingfu">
                    <span class="namespan fl"><%# ((DataRowView)Container.DataItem).Row["Name"]%></span>
                ...
                <div class="buxingfu">
                    ...
                    <asp:Repeater ID="RepeaterChild" runat="server">
                        <ItemTemplate>
                            <a href='<%# ShopUrlOperate.RetUrl("Search_productlist",((DataRowView)Container.DataItem).Row["Code"].ToString(),"code")%>'><%# ((DataRowView)Container.DataItem).Row["Name"]%></a>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
                <div class="tag_list" id="DivTwo<%# ((DataRowView)Container.DataItem).Row["ID"] %>"></div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
</div>
