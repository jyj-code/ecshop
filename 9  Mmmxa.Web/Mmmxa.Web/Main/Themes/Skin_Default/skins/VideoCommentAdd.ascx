...
<div class="CommentsAdd_con">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
            <td align="right" width="15%" valign="top">评论内容：</td>
            <td width="85%">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidatorContent" runat="server"
                        ControlToValidate="TextBoxContent" Display="Dynamic" ErrorMessage="只能输入110个字符"
                        ValidationGroup="supplierRegistValidate" ValidationExpression="^[\s\S]{0,110}$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr style="height:45px;">
            <td align="right" width="15%"><asp:Label ID="LabelCheckCode" runat="server" Text="验证码："></asp:Label></td>
            <td width="85%">
                <div id="divVerifyCode" runat="server">
                    <table cellpadding="0" cellspacing="0" border="0" class="identyTab">
                        <tr>
                            <td valign="middle" align="left">
                                <input runat="server" id="VideoCommentAddVerifyCode" name="VideoCommentAddVerifyCode" type="text" value="请输入验证码" onfocus="this.value=''" onkeydown="if(event.keyCode==13){(document.getElementById('VideoCommentAdd_ctl00_ButtonConfirm')).focus();(document.getElementById('VideoCommentAdd_ctl00_ButtonConfirm')).click();}" class="identyArea" />
                            </td>
                            <td valign="middle" align="left">
                                <img src="imagecode.aspx" id="VideoCommentAddVerifyImg" onclick="reloadcodeVideoCommentAdd()" alt="看不清?点一下" />
                            </td>
                            <td valign="middle" align="left"><a style="cursor: pointer" onclick="reloadcodeVideoCommentAdd()">看不清楚?点一下</a></td>
                        </tr>
                    </table>                    
                </div>
            </td>
        ...
        <tr>
            <td></td>
            <td class="submitBtn">
                <span><asp:Button ID="ButtonConfirm" runat="server" CssClass="submit" ValidationGroup="supplierRegistValidate" /></span>
            </td>
        </tr>
    </table>
