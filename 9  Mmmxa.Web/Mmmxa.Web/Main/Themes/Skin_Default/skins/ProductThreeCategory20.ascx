                    ...
                    <ItemTemplate>
                        <li class="iten itenone">
                            <h3 class="item_hd item_hd1">
                                <asp:Image ID="ImageLogo" runat="server" ImageUrl='<%# Eval("logoimg").ToString()%>' Width="11" Height="11" />&nbsp;&nbsp;  
                                <a href='<%#ShopUrlOperate.RetUrl("Search_productlist",((DataRowView)Container.DataItem).Row["code"].ToString(),"code")%>'><%# Eval("Name")%></a>
                            </h3>
                    ...
                    <AlternatingItemTemplate>
                        <li class="iten itentwo">
                            <h3 class="item_hd item_hd2">
                                 <asp:Image ID="ImageLogo" runat="server" ImageUrl='<%# Eval("logoimg")%>' Width="11"  Height="11" />&nbsp;&nbsp; 
                                 <a href='<%#ShopUrlOperate.RetUrl("Search_productlist",((DataRowView)Container.DataItem).Row["code"].ToString(),"code")%>'><%# Eval("Name")%></a>
                            </h3>
                            <asp:HiddenField ID="HiddenFieldID" runat="server" Value='<%# Eval("ID")%>' />
                            <p class="itemCol1 item_col">
