...
<style type="text/css">
.prduct1 ul li .image a{border: 1px solid #e7e7e7; }
.prduct1 ul li .image a:hover{border: 1px solid #A22525;}
</style>
<div class="bBox1">
    <div class="prduct1">
            ...
            <asp:Repeater ID="RepeaterData" runat="server">
                <ItemTemplate>
                    <li style="margin-bottom: 9px; _margin-bottom: 12px;">
                        <p class="image">
                            <a href='<%#ShopUrlOperate.shopHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString() )%>' style="display:block;">
                                <asp:Image ID="ImageProduct" runat="server" Height="175" Width="175" Style=""
                                    ImageUrl='<%# ((DataRowView)Container.DataItem).Row["ThumbImage"]%>' onerror="javascript:this.src='/ImgUpload/noImage.gif'" /></a>
                        </p>
