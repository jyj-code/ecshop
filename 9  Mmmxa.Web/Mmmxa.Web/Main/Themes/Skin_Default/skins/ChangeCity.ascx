...
<div class="city_cut_title" style="padding-top:0; position:relative;top:-5px;">
    <div class="city_cut_china"  style="zoom: 1;">
        <asp:Label ID="LabelCity" runat="server" Text="全县土老帽"></asp:Label></div>
                ...
                <div class="in_box">
                    <div class="row1">
                        <a class="site_all Left" runat="server" id="allUrl" runat="server">
                            <asp:Label ID="LabelAllTotalCity" runat="server" Text="【全县土老帽】"></asp:Label></a>
                    </div>
                    <div class="row2">
