    ...
    <div id="content">
        <div style='<%=Common.ReqStr("type")=="0"||Common.ReqStr("type")==""? "display:block": "display:none"%>'>
            <div class="pad" style="margin-bottom: 0px;">
                <table width="40%" border="0" cellspacing="0" cellpadding="0" class="tabbiao">
                    <tr>
                        <th align="right">
                            左边客服：
                        </th>
                    ...
                    <tr id="tr_Phone">
                        ...
                        <td>
                            <input id="txt_Phone" type="text" maxlength="11" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
        ...
        <div style='<%=Common.ReqStr("type")=="0"||Common.ReqStr("type")==""? "display:none": "display:block"%>'>
            <div class="shangpinkj">
                ...
                <table cellspacing="1" cellpadding="0" border="0" class="blue_tb1" width="100%">
                    <tr>
                        <th>
                        </th>
                        <th>
              ...
              if(confirm("是否执行批量删除操作？")){
                    var arryid=new Array();var bflag=false;
                     $("input[name='subcheck']").each(function(){
                            if($(this).is(":checked")){arryid.push("'"+$(this).val()+"'");
                     ...
                     if(!bflag)
                     {
                            alert("请选择需要删除的在线客服！");return false;
                     }
