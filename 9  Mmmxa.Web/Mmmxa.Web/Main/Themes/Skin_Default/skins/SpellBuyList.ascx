...
<div class="group">
    ...
    <div class="group_top">
        ...
        <div class="fr">
            <a class="curr" href='<%=ShopUrlOperate.RetUrlNew("SpellBuyList","-1") %>' id="allCategory">全部</a>
            <asp:Repeater ID="RepeaterCategory" runat="server">
                <ItemTemplate>
                    <a href='<%#ShopUrlOperate.RetUrlNew("SpellBuyList",Eval("Code")) %>' id='select<%#Eval("Code")%>'>
    ...
    <div class="group_paixu">
        ...
        <div class="pagenet" style="display:none;">
            <%-- 1/5--%>
            <span><%=Request.QueryString["pageid"] == null ? "1" : Request.QueryString["pageid"].ToString()%></span>
            <span>/</span>
            <span><asp:Label ID="LabelPageCount1" runat="server" Text=""></asp:Label></span>
            <a class="pgup"><asp:LinkButton ID="linBtnPrev" runat="server"></asp:LinkButton></a>
            <a class="pgup">上一页</a>
        </div>
    </div>
    <div class="group_content clearfix">
        ...
        <asp:Repeater ID="RepeaterData" runat="server">
            <ItemTemplate>
                ...
                <div class="tg_end" style="display:none;"><img width="125" height="72" src="/Main/Themes/Skin_Default/images/tg_end.png" alt=""></div>
                    <div class="group_de_title">
                        <span>【<a href='<%#ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()) %>' target="_blank"><%#Eval("ShopName")%></a>】</span>
                        <a href='<%#ShopUrlOperate.shopDetailHrefByShopIDNew(Eval("id").ToString(),Eval("ShopID").ToString(),"ProductIsSpell_Detail") %>'
                            target="_blank">
                    ...
                    <div class="group_de_img">
                        ...
                        <div class="font02">
                            ...
                            <div class="BuyNum">
                                <span><%#Eval("groupcount")%></span>人已购买
                            </div>
                        </div>
                        <a href='<%#ShopUrlOperate.shopDetailHrefByShopIDNew(Eval("Id").ToString(),Eval("ShopID").ToString(),"ProductIsSpell_Detail") %>'
                            target="_blank">
		 ...
		 <a href='<%#ShopUrlOperate.shopDetailHrefByShopIDNew(Eval("id").ToString(),Eval("ShopID").ToString(),"ProductIsSpell_Detail") %>'
                    ...
                    <div class="group_de_pirce">
                            <span class="emyuan">&yen;</span> 
                            <span class="emyuan"><%#Eval("GroupPrice")%></span>
                    </div>      
 		</a>              
                </div>
            </ItemTemplate>
    ...
    <div class="fenye">
        ...
        <!--分页排序 Start-->
        <div id="pageDiv2" runat="server" class="page_sort"></div>
        <!--//分页排序 End-->
        <div class="clear"></div>
    </div>
    <!--//分页 End-->
