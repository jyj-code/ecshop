        ...
        <ItemTemplate>
            <div class="article_list">
                ...
                <div class="article_detail">
                    <div class="supdem">
                        <div class="zeus">
                            <asp:Image ID="Image1" runat="server" Width="300" height="300" ImageUrl='<%#((DataRowView)Container.DataItem).Row["Image"]%>' onerror="javascript:this.src='../ImgUpload/noImage.gif'"/>
                            </div>
                        <div class="poseidon">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr class="title">
                                    <td>
                                        ...
                                        <span class="fonsize"><%# ((DataRowView)Container.DataItem).Row["Title"]%></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <label>发布时间：</label><span class="azure"><%# Convert.ToDateTime(((DataRowView)Container.DataItem).Row["ReleaseTime"]).ToString("yyyy-MM-dd")%></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>
                                            有效时间：</label>
                                        <span class="loyseau"><%# Convert.ToDateTime(((DataRowView)Container.DataItem).Row["ValidTime"].ToString().Split('/')[0]).ToString("yyyy-MM-dd")%></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <label>区&nbsp;&nbsp;&nbsp;&nbsp;域：</label><%# ((DataRowView)Container.DataItem).Row["AddressValue"]%>
                                    </td>
                                </tr>
                                <tr class="other">
                                    <td>
                                        <label>电&nbsp;&nbsp;&nbsp;&nbsp;话：</label>
                                        <span class="damask"><%# ((DataRowView)Container.DataItem).Row["Tel"]%></span>
                                    </td>
                                </tr>
                                <tr class="other">
                                    <td>
                                        <label>邮&nbsp;&nbsp;&nbsp;&nbsp;箱 ：</label><span class="heras"><%# ((DataRowView)Container.DataItem).Row["Email"]%></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
