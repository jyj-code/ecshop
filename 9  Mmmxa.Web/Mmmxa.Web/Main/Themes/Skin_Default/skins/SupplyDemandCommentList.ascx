...
<div class="CommentsList">
    <h1 class="CommentsList_title">评论列表</h1>
        ...
        <ItemTemplate>
            <div class="CommentsList_con">
                <div class="MemberInfo">
                    ...
                    <p class="MemberName"><%# ((DataRowView)Container.DataItem).Row["CreateMerber"]%>
                ...
                <div class="discuss">
                    ...
                    <p class="discussAnswer" style="display:block"><span>回复：</span><%# ((DataRowView)Container.DataItem).Row["Reply"]%></p>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
    <!--涂抹层-->
    <div class="EraseLayer"></div>
    <!--分页 Start-->
    <div class="fenye">
        <!--分页跳转 Start-->
        <div class="page_skip">
