...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: left;
                ...
                <tr style="height: 100px; line-height: 100px; ">
                    ...
                    <td style="color:#029900; font-size:27px; font-weight:bold; text-align:left; width:70%">
                ...
                <tr style="height: 30px; ">
                    ...
                    <td style="width:70%; vertical-align:top;">
                        如果<span id="time" style="color:Red">60</span>秒后没有收到短信，请点击<asp:Button ID="ButtonReturnSend" runat="server" Text="再次发送" Height="21px"  Enabled="false"/>
