...
//    $(".moren-list a").click(function(){
//   $("Search_productlistNew$ctl00$HiddenLinkButtonStatus")=this.title;
//      $("#<%= LinkButtonStatus.ClientID %>").text(this.title);
//    });
})
</script>
...
<div class="pro_area">
    ...
    <div class="paixu">
        ...
        <asp:LinkButton ID="LinkButtonSales" runat="server" CssClass="comSort" title="按销量从高到低">销量<i id="ISales" runat="server"   class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonXinyong" runat="server" CssClass="comSort" title="按信用从高到低">信用<i id="IXinyong" runat="server"  class="comSort-d"></i></asp:LinkButton>
        <asp:LinkButton ID="LinkButtonPrice" runat="server" CssClass="comSort" title="按价格从低到高">价格<i id="IPrice" runat="server"  class="comSort-u"></i></asp:LinkButton>
        <div class="comprice">
            <div class="price-box">
        ...
        <div style="float: right;">
           ...
           <div class="comRange">
           <b class="comRange-text">
            <asp:LinkButton ID="LinkButtonStatus" runat="server" Text="商品类型默认排序"></asp:LinkButton></b>
        
            <div class="moren-list">
                 <asp:LinkButton ID="LinkButtonNew" runat="server" title="新品"><i class="mr-ico-pu"></i>新品</asp:LinkButton>
                <asp:LinkButton ID="LinkButtonHot" runat="server" title="热卖"><i class="mr-ico-pd"></i>热卖</asp:LinkButton>
                <asp:LinkButton ID="LinkButtonGood" runat="server" title="精品"><i class="mr-ico-msd"></i>精品</asp:LinkButton>
                <asp:LinkButton ID="LinkButtonRecommend" runat="server" title="推荐"><i class="mr-ico-msd"></i>推荐</asp:LinkButton>
               <%-- <asp:LinkButton ID="LinkButton7" runat="server" title="恢复默认排序">恢复默认排序</asp:LinkButton>--%>
          </div>
        </div>
       ...
       <%-- <div class="comRange">
            <b class="comRange-text">
                <asp:LinkButton ID="LinkButton1" runat="server">默认排序</asp:LinkButton></b>
                ...
                <div class="product-wrap">
                    <div class="pro_img">
                        <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>">
                            <img src="<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["originalimage"].ToString())%>" width="164" height="164" onerror="javascript:this.src='../ImgUpload/noImage.gif'" /></a></div>
                    <div class="pro_name">
                        <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>"  title="<%#((DataRowView)Container.DataItem).Row["Name"].ToString() %>" class="pname">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td width="130" class="showbigImg">
                                    <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>"
                                        class="area_imgs">
                                        <img src='<%# Page.ResolveUrl(((DataRowView)Container.DataItem).Row["originalimage"].ToString())%>'
                                ...
                                <td width="260">
                                    <div class="area_name">
                                        <p>
                                            <a href="<%#ShopUrlOperate.shopDetailHref(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>" title="<%#((DataRowView)Container.DataItem).Row["Name"].ToString() %>"
                                                class="pname">
                                                <%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["Name"].ToString(),32,"") %>
                                            </a>
                                        </p>
                                ...
                                <td align="center" width="112">
                                    ...
                                    <!--店铺担保-->
                                        ...
                                        <asp:Repeater ID="RepeaterShopEnsure" runat="server" EnableViewState="false">
                                            ...
                                            <asp:Image ID="Image2" runat="server" height="15" width="15" ImageUrl='<%#((DataRowView)Container.DataItem).Row["ImagePath"]%>' onerror="javascript:this.src='../ImgUpload/noImage.gif'"/>
                                            </div>
                                            </td>
                                            <td>
...
<asp:HiddenField ID="HiddenLinkButtonStatus" runat="server" />
