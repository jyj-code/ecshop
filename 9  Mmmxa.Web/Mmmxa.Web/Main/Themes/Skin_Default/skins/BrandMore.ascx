        ...
        <ItemTemplate>
                 <div class="Brandbox">
                    ...
                    <a href='BrandDetail.aspx?BrandGuid=<%# ((DataRowView)Container.DataItem).Row["Guid"] %>'
                        target="_self">
                        <asp:Image ID="ImageBrand" runat="server" Height="70px" ImageUrl='<%# Globals.ImagePath+"s_"+((DataRowView)Container.DataItem).Row["Logo"] %>' onerror="javascript:this.src='../ImgUpload/noImage.gif'"
                            Width="90px" />
                    </a>
                    <p style="width: 160px;">
