...
<div class="search_bonx_detail">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <p>
                <span>文章一级：</span>
                <asp:DropDownList ID="DropDownListArticleCategoryCf" CssClass="artic_select" runat="server" AutoPostBack="True"></asp:DropDownList>
            </p>
            <p>
                <span>文章二级：</span>
                <asp:DropDownList ID="DropDownListArticleCategoryCs" CssClass="artic_select" runat="server" AutoPostBack="True"></asp:DropDownList>
            </p>
            <p>
                <span>文章三级：</span>
                <asp:DropDownList ID="DropDownListArticleCt" CssClass="artic_select" runat="server"></asp:DropDownList>
            </p>    
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <p>
        ...
        <asp:TextBox ID="TextBoxEndTime" runat="server" class="Wdate Wdate1 artic_select"  onclick="WdatePicker()"></asp:TextBox>
    </p>
    <p>
        <span>文章标题：</span>
...
<div class="latest_shop" style=" display:none;">
    ...
    <div class="page">
        ...
        <asp:TextBox ID="TextBoxPageNum" MaxLength="4" runat="server" onfocus="this.select();" Height="15px"
