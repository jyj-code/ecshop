        ...
        <asp:Repeater ID="RepeaterData" runat="server">
            <ItemTemplate>
                <table width="100%">
                    <tr>
                        <td rowspan="4">
                            <asp:Image id="Img1" ImageUrl='<%# ((DataRowView)Container.DataItem).Row["Banner"]%>' runat="server" alt="图片"
                                width="100" height="100" onerror="javascript:this.src='../ImgUpload/noImage.gif'" />
                               
                        </td>
                        <td align="left">
                            <a href='<%#ShopUrlOperate.GetShopUrl(((DataRowView)Container.DataItem).Row["ShopID"].ToString())%>' target="_blank">
