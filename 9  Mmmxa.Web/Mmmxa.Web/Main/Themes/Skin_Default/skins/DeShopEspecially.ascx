    ...
    <div class="news_pics">
        <ul>
            <asp:Repeater ID="RepeaterData" runat="server">
                <ItemTemplate>
                    <li><a href='<%#ShopUrlOperate.GetShopUrlNew(((DataRowView)Container.DataItem).Row["ShopID"].ToString())%>' class="shopimg">
                    <asp:Image ID="Img1" ImageUrl='<%# ((DataRowView)Container.DataItem).Row["Banner"]%>'
                        ...
                        <div class="shop_name">
                            <a href='<%#ShopUrlOperate.GetShopUrlNew(((DataRowView)Container.DataItem).Row["ShopID"].ToString())%>' target="_blank" title='<%# ((DataRowView)Container.DataItem).Row["ShopName"] %>'> <%#ShopNum1.Common.Utils.GetUnicodeSubString(((DataRowView)Container.DataItem).Row["ShopName"].ToString(),20,"")%></a>
                            <p class="dianzhu">
