                        ...
                        <ItemTemplate>
                            <div class="cart-tbody cart_bottom">
                                <div class="order_cl order-goods">
                                   <a href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>" class="or_img"  title='<%#Eval("Name") %>'  target="_blank">
                                    ...
                                    <div class="or_name">
                                        <p>
                                         <a href="<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["Guid"].ToString(),((DataRowView)Container.DataItem).Row["MemLoginID"].ToString(),"ProductDetail")%>" title='<%#Eval("Name") %>'  target="_blank">   
        ...
        <div class="consignee clearfix">
            <div class="conmess">
                ...
                <span style="display:none"> 
                    <asp:Button ID="ButtonAddReceivAddress" runat="server" OnClientClick="return checkSub();" Text="确定添加" CssClass="shiyong"/>
                </span>
            </div>
