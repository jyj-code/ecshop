...
<div class="threedenglu">
    ...
    <div class="threecon clearfix">
        <div class="threecheck">
            <p class="checkp">
                <input type="radio" name="signuped" value="1" autocomplete="off" class="f-radio" checked="checked" />已经注册过本商城的用户？
                <i>（绑定<asp:Literal ID="LiteralAccount" runat="server"></asp:Literal>本商城账户名）</i>
            </p>
            <table border="0" cellpadding="0" cellspacing="0" class="cheaktable">
                <tr>
                    <td align="right" style="width: 100px;">用户名：</td>
                    <td>
                        <input type="text" id="seconduserBind_userName" name="seconduserBind_userName" class="inputcheck" value="" />
                        <span style="color: red">*</span> <span id="spanErruserBind_userName" style="color: Red"></span>
                    </td>
                </tr>
                <tr>
                    <td align="right">密码：</td>
                    <td>
                        <input type="password" id="seconduserBind_password" name="seconduserBind_password" class="inputcheck" />
                        <span style="color: red">*</span> <span id="spanErruserBind_password" style="color: Red"></span>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td class="commit"><input type="button" value="绑定" class="bangdingbtn" onclick="CheckMemLogin()" /></td>
                </tr>
                <tr>
                    <td></td>
        ...
        <div class="threecheck">
            <p class="checkp">
                <input type="radio" name="signuped" value="0" autocomplete="off" class="f-radio" id="otherRadio" checked="checked" />
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="cheaktable">
                <tr>
                    <td align="right" style="width: 100px;">用户名：</td>
                    <td>
                        <input type="text" id="seconduserBind_userName_c" name="seconduserBind_userName_c" class="inputcheck" value=""  />
                        <span style="color: red">*</span> <span id="spanErrUserName" style="color: Red"></span>
                        <span id="spanContent1" style="color: Red"></span>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 100px;">邮箱：</td>
                    <td>
                        <input type="text" id="email" name="seconduserBind_email" class="inputcheck" value="" onblur="existemail(this)" />
