...
<div id="mallNav">
    <div class="mallNav_con">
        <div id="mallTextNav" class="clearfix">
            ...
            <td style="font-size:14px; font-weight:bold; color:#ffffff; padding-left:16px; line-height:24px;padding-top:2px;"><a class="cartenet" href="<%= ShopUrlOperate.RetUrl("ShoppingCart1") %>" style="color:#ffffff;" >去结算</a></td>
            </tr>
            </table>
            <span
            ...
            <div class="mallNav_others" id="mallNav_others" style="display: none;">
                <ul>
                    ...
                    <li class="mallNav_last maNav" id="dparent2">
                        <a href='<%= ShopUrlOperate.RetUrl("ShoppingCart1") %>'><span class="spjt">购物车结算</span> </a>
