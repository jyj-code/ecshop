...
<body>
    ...
    <div class="FlowCat_cont clearfix">
                ...
                <div id="focus" class="integral_focus">
                    <div id="Rleft">
                        <div id='ad8' runat='server'>
                          ...
                          <ShopNum1:AdvertisementPPTStyle ID="AdvertisementPPTStyle" runat="server" SkinFilename="AdvertisementPPT.ascx"  AdID="ad8" AdType="2"/>
        ...
        <div class="integral_con clearfix">
            ...
            <div class="list_right fr">
                <ShopNum1:IntegralProductlist ID="IntegralProductlist" runat="server"  SkinFilename="IntegralProductlist.ascx"  ShowCount="20" />
            </div>
        </div>
