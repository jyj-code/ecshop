...
<head>
    ...
    <ShopNum1:VideoMeto ID="meto1" runat="server" Type="1" SkinFilename="Meto.ascx" />
...
<body>
    ...
    <div class="FlowCat_cont">
        <div class="warp_site">首页 》<a href="/video.aspx">商城视频</a>》视频详细</div>
        <div class="article_cont clearfix">
            <div class="list_left fl">
                <!-- 相关视频 -->
                <div class="store_category_view">
                    <h3>相关视频</h3>
                    <ShopNum1:VideoRelativelyList ID="VideoRelativelyList" ShowCount="1" runat="server" SkinFilename="VideoRelativelyList.ascx" />
                </div>
                <!-- 热点视频 -->
                <div class="store_category_view">
                    <h3>热点视频</h3>
