<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_MobilePayment_List"   CodeBehind="MobilePayment_List.aspx.cs"      %>
...
<body>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Memo" HeaderText="描述" SortExpression="Memo" Visible="false"
                        ...
                        <ItemTemplate>
                            <a href="<%# "MobilePayment_Operate.aspx?guid="+Eval("Guid") %>" style="color: #4482b4;">
                                编辑</a>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchMobile"
