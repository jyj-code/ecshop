<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopType_Operate"   CodeBehind="ShopType_Operate.aspx.cs"      %>
...
<body style="height:200px">
    ...
    <div id="right">
        <div class="welcon clearfix">
            ...
            <div class="tablebtn">
                <asp:Button ID="ButtonConfirm" runat="server" Text="确定" CssClass="fanh" OnClick="ButtonConfirm_Click" ToolTip="Submit" />
