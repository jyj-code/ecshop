<%@ page language="C#" autoeventwireup="true" inherits="Agent_AgentAdmin_AgentProuductChecked_List, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="height: 35px; vertical-align: top;">
                           ...
                           <td class="lmf_padding">
                            ...
                            <tr>
                            <td> <asp:TextBox ID="TextBoxPrice1" runat="server" CssClass="tinput" Width="66"></asp:TextBox>
                            </td>
                                        <td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxPrice2"
                                    Display="Dynamic" ErrorMessage="价格格式不正确" ValidationExpression="^[0-9]+(.[0-9]{1,3})?$"></asp:RegularExpressionValidator></td>
                            </tr>
                            </table>
                        ...
                        <td><asp:Button ID="Button1" runat="server" Text="查询" CssClass="dele" OnClick="ButtonSearch_Click" />
            ...
            <table cellpadding="0" cellspacing="0" border="0">
                ...
                <td valign="top" class="lmf_app">
                    <asp:LinkButton ID="ButtonCancelAudit" runat="server" 
                     CssClass="shwtg lmf_btn" OnClientClick="return AuditButton()" OnClick="ButtonCancelAudit_Click"   ><span>审核未通过</span></asp:LinkButton>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="商品名称">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.shopDetailHrefNew(Eval("Guid").ToString(),Eval("MemLoginID").ToString(),"ProductDetail") %>' target="_blank">
...
())%> >','#ffffff')" onmouseout="hideddrivetip()" height="20" width="20" />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="Search"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownListIsAudit" Name="isAudit" PropertyName="SelectedValue"
                Type="String" />
            <asp:ControlParameter ControlID="TextBoxShopName" Name="ShopName" PropertyName="Text" Type="String" />
