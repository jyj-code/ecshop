<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_SupplyDemandDetails"   CodeBehind="SupplyDemandDetails.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        ...
        <div class="tablebtn">
            <asp:Button ID="ButtonAudit" runat="server" OnClick="ButtonAudit_Click" Text="审核通过" CssClass="fanh"  CausesValidation="False" ></asp:Button>&nbsp;&nbsp;&nbsp;
            <asp:Button ID="ButtonCancelAudit" runat="server" Text="审核未通过" OnClick="ButtonCancelAudit_Click" CssClass="fanh"  CausesValidation="False" ></asp:Button>&nbsp;&nbsp;&nbsp;
