<%@ page language="C#" autoeventwireup="true" inherits="Admin_Announcement_List"   CodeBehind="Announcement_List.aspx.cs"      %>
                        ...
                        <tr style="height: 35px; vertical-align: top;">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBoxStartTime" CssClass="tinput" runat="server" Style="width: 66px;"></asp:TextBox>
                                        </td>
                                        ...
                                        <td>
                                            <GroupFly:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="TextBoxStartTime"
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxEndTime" CssClass="tinput" runat="server" Style="width: 66px;"></asp:TextBox>
                                        </td>
                                        <td style="padding-left: 4px; vertical-align: top;">
                                        ...
                                        <td>
                                            <GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBoxEndTime"
                        ...
                        <tr>
                            ...
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="ButtonDelete" runat="server" OnClick="ButtonDelete_Click" OnClientClick="return DeleteButton()"
                                    CausesValidationGroup ="False" class="shanchu lmf_btn"><span>批量删除</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
