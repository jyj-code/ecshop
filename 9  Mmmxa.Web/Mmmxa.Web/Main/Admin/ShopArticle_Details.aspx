<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopArticle_Details"   CodeBehind="ShopArticle_Details.aspx.cs"      %>
...
<form id="form1" runat="server">
 <div id="right">
   <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <span id="Span1"><asp:Label ID="LabelPageTitle" runat="server" Font-Bold="True" Text="店铺文章详细"></asp:Label></span></h3>
            </div>
            <div class="rr">
            </div>
        </div>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" id="RadioButtonListSendObject"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBoxCategoryGuid" ReadOnly="true"  CssClass="allinput3 tinput" runat="server">无</asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBoxMemberLoginID" ReadOnly="true"  CssClass="allinput3 tinput" runat="server">无</asp:TextBox>
            </td>
        </tr>
        <tr>
            <th style="text-align: right">
        ...
        <tr>
         ...
         <div class="tablebtn">
         <asp:Button ID="LinkButton1" runat="server" Text="审核通过"  CssClass="fanh" OnClick="ButtonAudit_Click"></asp:Button>&nbsp;&nbsp;&nbsp;
