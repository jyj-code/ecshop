<%@ page language="C#" autoeventwireup="true" inherits="ShopNum1_ShopNum1Admin_ShopNum1_ScoreProductCategory_List, ShopNum1.Deploy" %>
...
<head id="Head1" runat="server">
    <title>积分商品分类列表</title>
    <link rel="stylesheet" type="text/css" href="style/css.css" />

    <script type="text/javascript" language="javascript" src="js/CommonJS.js"></script>
    <script type="text/javascript"  language="javascript">
                $(function(){
                        $("#TreeViewData td").addClass("f_size");
                });
    </script>
    <style type="text/css">
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabeTitle" runat="server" Text="积分商品分类列表"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
