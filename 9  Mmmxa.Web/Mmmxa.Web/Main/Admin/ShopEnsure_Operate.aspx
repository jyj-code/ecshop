<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopEnsure_Operate"   CodeBehind="ShopEnsure_Operate.aspx.cs"      %>
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:FileUpload ID="FileUploadImage" runat="server" /><font color="red">
                                  <span style="color: Red">*</span></font>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxEnsureMoney" CssClass="tinput" runat="server" MaxLength="7"  Width="100"></asp:TextBox>  
                            <span >元</span>
