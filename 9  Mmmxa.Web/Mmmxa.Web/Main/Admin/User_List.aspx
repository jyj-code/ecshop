<%@ page language="C#" autoeventwireup="true" inherits="Admin_User_List"   CodeBehind="User_List.aspx.cs"      %>
                ...
                <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField ControlStyle-Width="35">
                           ...
                           <ItemTemplate>
                            <span>
                                ...
                                <input type="hidden" name="hidName" value='<%# Eval("LoginID")%>' /></span>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                <a href='adduser.aspx?width=700&height=450&id=<%# Eval("Guid")%>' style="color:#4482b4;" class="dialog">编辑</a>
                                <span>
                            ...
                            <input type="hidden" name="hidName" value='<%# Eval("LoginID")%>' /></span>
                                       <script type="text/javascript" language="javascript">
                                            $(function(){
                                                    $("input[name='hidName']").each(function(){
                                                            if($(this).val()=="Admin")
                                                            {
                                                                $(this).parent().remove();
                                                            }
