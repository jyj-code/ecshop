<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopReputation_List"   CodeBehind="ShopReputation_List.aspx.cs"      %>
                    ...
                    <asp:TemplateField HeaderText="操作" SortExpression="IsShow">
                        <ItemTemplate>
                            <a href="<%# "ShopReputation_Operate.aspx?Guid="+Eval("Guid") %>" style="color: #4482b4;">
                                编辑</a>
                            <asp:LinkButton ID="LinkDelte" CommandArgument='<%# Eval("Guid") %>' runat="server" Style="color: #4482b4;" OnClick="ButtonDeleteBylink_Click"
                                OnClientClick="return window.confirm('您确定要删除吗?');">删除</asp:LinkButton>
                        </ItemTemplate>
