<%@ page language="C#" autoeventwireup="true" inherits="Admin_ReceiveMessage_List"   CodeBehind="ReceiveMessage_List.aspx.cs"      %>
            ...
            <div class="order_edit">
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height: 35px; vertical-align:top;">
                        ...
                        <tr>
                        <td><asp:TextBox ID="textBoxSSendTimeStart" runat="server" CssClass="tinput" Width="58"></asp:TextBox></td>
                        <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorSSendTimeStart" runat="server"
                        ...
                        <td><ShopNum1:ToolkitScriptManager ID="ToolkitScriptManager2" runat="server" EnableScriptGlobalization="True"
                        ...
                        <td><ShopNum1:CalendarExtender ID="CalendarExtender5"
                                    runat="server" TargetControlID="textBoxSSendTimeStart" PopupButtonID="imgCalendarStartTime"
                                    CssClass="ajax__calendar" Format="yyyy-MM-dd">
                                </ShopNum1:CalendarExtender></td>
                        <td class="lmf_px"><asp:Label ID="LabelName2" runat="server" Text="-" Font-Bold="False"></asp:Label></td>
                        <td><asp:TextBox ID="textBoxSSendTimeEnd" runat="server" CssClass="tinput" Width="58"></asp:TextBox></td>
                        <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarEndTime" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                height: 18px; position: relative; top: 3px;" /></td>
                        <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorSSendTimeEnd" runat="server"
                                ControlToValidate="textBoxSSendTimeEnd" Display="Dynamic" ErrorMessage="时间格式不正确"
                                ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                        <td><ShopNum1:CalendarExtender ID="CalendarExtender6" runat="server" TargetControlID="textBoxSSendTimeEnd"
                        ...
                        <td><asp:Button ID="ButtonSearch" runat="server" OnClick="ButtonSearch_Click" Text="查询"
                                CssClass="dele" /><asp:TextBox ID="textBoxLoginID" Visible="false" runat="server"
                                    CssClass="tinput" Width="100"></asp:TextBox></td>
                        </tr>
                        </table>
                         </td>
