<%@ page language="C#" autoeventwireup="true" inherits="Admin_MMSMemberGroup_List"   CodeBehind="MMSMemberGroup_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "MMSMemberGroup_Operate.aspx?guid='"+Eval("Guid")+"'" %>" style="color: #4482b4;">
                                编辑</a>
