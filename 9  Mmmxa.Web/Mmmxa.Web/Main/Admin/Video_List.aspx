<%@ page language="C#" autoeventwireup="true" inherits="Admin_Video_List"   CodeBehind="Video_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
                    ...
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="TextBoxStartTime" runat="server" CssClass="tinput" Width="58"></asp:TextBox>
                                    </td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBoxEndTime" runat="server" CssClass="tinput" Width="58"></asp:TextBox>
                                    </td>
                                    <td valign="top" style="padding-left: 4px;">
                          ...
                          <%--  <td valign="top" class="lmf_app">
                            ...
                            <td valign="top" class="lmf_app" style="display:none">
                                <asp:LinkButton ID="ButtonSearchComment" runat="server" CausesValidation="False"
                                    OnClientClick="if(Page_ClientValidate()) return EditButton();return false;" CssClass="chakanpl lmf_btn"
                                    OnClick="ButtonSearchComment_Click">
            ...
            <cc1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="视频分类" DataField="Name" SortExpression="Name" ItemStyle-HorizontalAlign="Center"/>
                    ...
                    <asp:TemplateField HeaderText="推荐" SortExpression="Title">
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# PageOperator.GetListImageStatus(DataBinder.Eval(Container, "DataItem(IsRecommend)","{0}")=="0"?"1":"0")  %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="center" />
                    </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="GetVideoAll"
            ...
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="all" Type="String" Name="SubstationID"/>    
            </SelectParameters>
