<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopVedio_List"   CodeBehind="ShopVedio_List.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownListSubstationID" runat="server" Width="201px" CssClass="tselect">
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <td>
                            <GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="textBoxEndDate" PopupButtonID="img2" CssClass="ajax__calendar" /></td>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分站名称" SortExpression="Title">
                        <ItemTemplate>
