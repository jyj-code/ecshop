<%@ page language="C#" autoeventwireup="true" inherits="Admin_SurveyTheme_Operate"   CodeBehind="SurveyTheme_Operate.aspx.cs"      %>
...
<head runat="server">
    ...
    <style type="text/css">
       #CalendarExtender4_daysBody tr td{ height:15px; line-height:15px;}
       #CalendarExtender1_daysBody tr td{ height:15px; line-height:15px;}
    </style>
</head>
<body class="widthah">
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img id="imgCalendarSReplyTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;height: 18px; position: relative; top: 4px" />
                       <GroupFly:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="textBoxStartTime" PopupButtonID="imgCalendarSReplyTime2" CssClass="ajax__calendar"  Format="yyyy-MM-dd" />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidatorTextBoxTime1" runat="server" ControlToValidate="textBoxStartTime" Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                        ...
                        <td>
                            ...
                            <img id="img1" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px;position: relative; top: 4px" />
                <GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="textEndTime" PopupButtonID="img1" CssClass="ajax__calendar" Format="yyyy-MM-dd" />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="textEndTime" Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                   <%-- <tr>
                        <th align="right">
