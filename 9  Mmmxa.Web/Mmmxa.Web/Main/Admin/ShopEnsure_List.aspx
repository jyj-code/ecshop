<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopEnsure_List"   CodeBehind="ShopEnsure_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ShopEnsure_Operate.aspx?id="+Eval("id") %>" style="color: #4482b4;">编辑</a>
