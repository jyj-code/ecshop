<%@ page language="C#" autoeventwireup="true" inherits="Admin_OrderScore_List"   CodeBehind="OrderScore_List.aspx.cs"      %>
    ...
    <div id="right">
        <div class="mhead">
            <div class="ml">
                <div class="mr">
                    <ul class="mul">
                        <li id="current1">
                            <asp:LinkButton ID="LinkButtonAll" runat="server" CssClass="cur" 
                                onclick="LinkButtonAll_Click">全部订单</asp:LinkButton>
                        </li>
                        <li id="current2">
                            <asp:LinkButton ID="LinkButtonOderStatusOk" runat="server" 
                                onclick="LinkButtonOderStatusOk_Click">已处理</asp:LinkButton>
                        </li>
                        <li id="current3">
                            <asp:LinkButton ID="LinkButtonOderStatusNo" runat="server" 
                                onclick="LinkButtonOderStatusNo_Click">未处理</asp:LinkButton>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td class="lmf_padding">
                            <asp:Label ID="LabelShouldPayPrice" runat="server" Text="订单积分："></asp:Label>
                        </td>
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" runat="server" AutoPostBack="false" Width="207px" CssClass="tselect">
                            </asp:DropDownList>
                        </td>
                        <td>
                                        &nbsp;&nbsp;<asp:Button ID="ButtonSearch" runat="server"  Text="搜索"
                                            CssClass="orderbtn" onclick="ButtonSearch_Click" />
                                    </td>
                    </tr>
                </table>
                <div class="sbtn">
                ...
                <tr>
                <td valign="top">
                    <asp:LinkButton ID="ButtonReport" runat="server" 
            ...
            <cc1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                BorderStyle="None" OnPageIndexChanging="Num1GridViewShow_Changing" >
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TotalScore" HeaderText="订单总积分" >
