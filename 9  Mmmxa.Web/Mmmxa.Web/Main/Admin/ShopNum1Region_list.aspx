<%@ page language="C#" autoeventwireup="true" inherits="Main_Prefecture_list, ShopNum1.Deploy" %>
             ...
             <table cellpadding="0" cellspacing="0" border="0">
                ...
                <td valign="top" class="lmf_app">
                    <asp:LinkButton ID="ButtonDelete" runat="server" CausesValidation="False" CssClass="shanchu lmf_btn" 
                        OnClientClick="return EditButton()" OnClick="ButtonDelete_Click"  ><span>单个删除</span></asp:LinkButton>
                ...
                <td valign="top" class="lmf_app">
                    ...
                    <asp:LinkButton ID="ButtonNodeOperate" runat="server"  CausesValidation="False"
                        CssClass="zhankai lmf_btn" OnClick="ButtonNodeOperate_Click"  ><span>全部展开</span></asp:LinkButton>

                </td>
                <td valign="top" class="lmf_app">

                   
                    <asp:LinkButton ID="btnCreateRegion" runat="server"  CausesValidation="False"
                        CssClass="zhankai lmf_btn" OnClick="btnCreateRegion_Click" ToolTip="生成区域" ><span>生成区域</span></asp:LinkButton>

                </td>
                <td>(前台区域是静态的,可以通过这里更新区域。)</td>
                <td valign="top" class="lmf_app">
