<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_MemberActualAuthentication_List"   CodeBehind="MemberActualAuthentication_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tr style=" height:35px; vertical-align:top;">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                <td><asp:TextBox ID="TextBoxStartTime" CssClass="tinput" runat="server" Width="65"></asp:TextBox></td>
                ...
                <td><GroupFly:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="TextBoxStartTime"
                ...
                <td class="lmf_px">-</td>
                <td><asp:TextBox ID="TextBoxEndTime" CssClass="tinput" runat="server" Width="65"></asp:TextBox></td>
                ...
                <td><GroupFly:CalendarExtender ID="CalendarExtender1"  runat="server" TargetControlID="TextBoxEndTime" PopupButtonID="img1" CssClass="ajax__calendar" /></td>
                <td> <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxEndTime"
                        ...
                        <td>
                   &nbsp;&nbsp;<asp:Button ID="ButtonSearch" runat="server" Text="查询" CssClass="fanh" OnClick="ButtonSearch_Click" />
                </td>
                </tr>
                </table>
                </td>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
                ...
                <td valign="top" class="lmf_app">
                  &nbsp;&nbsp;<asp:LinkButton ID="ButtonDelete" runat="server" CausesValidation="False" OnClientClick="return DeleteButton()" OnClick="butDel_Click" CssClass="shanchu lmf_btn"   ><span>批量删除</span></asp:LinkButton>
                </td>
                <td valign="top" class="lmf_app">
        ...
        <Columns>
            ...
            <asp:TemplateField>
                 <HeaderTemplate>审核状态</HeaderTemplate>
                 <ItemTemplate>
              ...
              <asp:TemplateField HeaderText="操作" SortExpression="IsShow">
                        <ItemTemplate>
                            <a href="<%# "MemberActualAuthentication_Operate.aspx?guid="+"'"+Eval("Guid")+"'"%>" style="color: #4482b4;">查看</a>
