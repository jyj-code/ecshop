<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopArticleComment_Operate"   CodeBehind="ShopArticleComment_Operate.aspx.cs"      %>
    ...
    <form id="form1" runat="server">
      ...
      <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <span id="Span1"><asp:Label ID="LabelPageTitle" runat="server" Font-Bold="True" Text="资讯评论详细"></asp:Label></span></h3>
            </div>
            <div class="rr">
            </div>
        </div>
        <div class="welcon clearfix">
                 ...
                 <tr class="radiobtn">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxContent" CssClass="allinput3 tinput" runat="server" TextMode="MultiLine" Width="500px" ReadOnly="true"
                    Height="100px"></asp:TextBox>
                                        ...
                                        <tr style="display:none">
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxReply" CssClass="allinput3 tinput" runat="server" TextMode="MultiLine" Width="500px"    Height="100px"></asp:TextBox>
          ...
          <div class="tablebtn">
                <asp:Button ID="ButtonConfirm" runat="server" Text="确定" ToolTip="Submit"
                    CssClass="fanh" onclick="ButtonConfirm_Click" Visible="false"/>
                <input id="inputReset" runat="server" runat="server" type="reset" value="重置" class="fanh" Visible="false"/>
                <asp:Button ID="ButtonIsAudit1" runat="server" Text="审核通过" OnClick="ButtonIsAudit1_Click" CssClass="fanh"  CausesValidation="False"></asp:Button>&nbsp;&nbsp;&nbsp;
                <asp:Button ID="ButtonIsAudit0" runat="server" Text="审核未通过"  OnClick="ButtonIsAudit0_Click"  CssClass="fanh"  CausesValidation="False"  ></asp:Button>&nbsp;&nbsp;&nbsp;
