<%@ page language="C#" autoeventwireup="true" inherits="Admin_OpenShop"   CodeBehind="OpenShop.aspx.cs"      %>
...
<head id="Head1" runat="server">
   ...
   function ReceiveServerData1(shopName) {
    ...
    //接收表单的URL地址
    var url = "/Main/Api/userCheck.aspx"   
...
else { context.innerHTML = "店铺名格式不正确";}
}
else { context.innerHTML = "店铺名不能为空";}
}
//]]>
          ...
          <div class="inner_page_list">
            <table border="0" cellpadding="0"  cellspacing="1">
                ...
                <tr>
                    ...
                    <td valign="middle">
                        <asp:RadioButton ID="RadioButtonGr" runat="server"  Text="个人" GroupName="lx" AutoPostBack="true"  OnCheckedChanged="RadioButtonGr_CheckedChanged" Checked="true"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="RadioButtonQy" runat="server"  Text="企业" GroupName="lx" AutoPostBack="true" OnCheckedChanged="RadioButtonQy_CheckedChanged"/>
                    </td>
                </tr>
                <tr>
                    <th align="right">
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="TextBoxShopName" MaxLength="20" runat="server" onchange="CheckShopName(this)" CssClass="tinput"></asp:TextBox>
                        <span style="color: Red">*</span>

                             <span style="display: inline;" id="spanName"></span><span style="color: #bbb; display: inline">
                            店名最短为3个中英文字符</span> 
                ...
                <tr>
                    ...
                    <td>
                         <asp:DropDownList ID="DropDownListSubstationID" runat="server" AutoPostBack="true" Width="207px" CssClass="tselect">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator5" InitialValue="-1" runat="server"
                            ControlToValidate="DropDownListSubstationID" ErrorMessage="分站名称必选！"></asp:RequiredFieldValidator>
                    </td>                
                </tr>
                <tr>
                    <th align="right">
                    ...
                    <td>
                                    ...
                                    <asp:DropDownList ID="DropDownListShopCategoryCode1" runat="server" AutoPostBack="true"  CssClass="tselect"
                                        OnSelectedIndexChanged="DropDownListShopCategoryCode1_SelectedIndexChanged" Style="width: 100px;">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="DropDownListShopCategoryCode2" runat="server" AutoPostBack="true" CssClass="tselect"
                                        OnSelectedIndexChanged="DropDownListShopCategoryCode2_SelectedIndexChanged" Style="width: 100px;">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="DropDownListShopCategoryCode3" runat="server" Style="width: 100px;" CssClass="tselect">
                                    </asp:DropDownList>
                                    <span style="color: Red">*</span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="TextBoxMainGoods" MaxLength="200" TextMode="MultiLine" Width="200" Height="90" runat="server"  CssClass="tinput"></asp:TextBox>
                        <span style="color: Red">*</span>

                             <span style="display: inline;" id="spanName"></span><span style="color: #bbb; display: inline">
                            介绍店铺主要销售的商品</span> 
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                            ControlToValidate="TextBoxMainGoods" Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td>
                                ...
                                <asp:DropDownList ID="DropDownListRegionCode1" runat="server" AutoPostBack="true" CssClass="tselect" Style="width: 80px;"
                            OnSelectedIndexChanged="DropDownListRegionCode1_SelectedIndexChanged">
                        </asp:DropDownList>
                        <asp:DropDownList ID="DropDownListRegionCode2" runat="server" AutoPostBack="true" CssClass="tselect" Style="width: 80px;"
                            OnSelectedIndexChanged="DropDownListRegionCode2_SelectedIndexChanged">
                        </asp:DropDownList>
                        <asp:DropDownList ID="DropDownListRegionCode3" runat="server" CssClass="tselect" Style="width: 80px;">
                        </asp:DropDownList>
                        <span style="color: Red">*</span>
                ...
                <tr>
                    ...
                    <td>
                           ...
                           <span style="color: Red">*</span>
                           <span style="color: #bbb">请填写真实准确的身份证号</span>
