<%@ page language="C#" autoeventwireup="true" inherits="Service_ServiceAdmin_ServiceSite_EamilSetting, ShopNum1.Deploy" enableviewstate="true" %>
...
<head id="Head1" runat="server">
   ...
   function EmailCheck()
   {
       if($("#selectSendType option:selected").val()=="0"){alert("请选择邮件发送方式！");return false;}
       return true;
   }
   $(function(){
...
<style type="text/css">
    .fanht{ text-align:center; background:url(images/btn2.jpg)  no-repeat; color:#333;  font-size:13px; width:105px; height:28px; line-height:28px; border:none;  cursor:pointer;}
</style>
</head>
<body>
    ...
    <div id="right">
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    <tr class="radiobtn">
                        ...
                        </asp:DropDownList><span>必须选择邮件发送方式(<font color="red">*</font>)</span></td>
                    </tr>
                   <tr class="radiobtn">
                        <th align="right" width="150px">
                            <asp:Localize ID="Localize2" runat="server" Text="SMTP服务器："></asp:Localize>
                        </th>
                        <td valign="middle"><asp:TextBox ID="txtSmtpServer" runat="server" CssClass="tinput" Width="200px"></asp:TextBox><span>SMTP服务器不能为空(<font color="red">*</font>)</span></td>
                    </tr>
                    <tr class="radiobtn">
                        <th align="right" width="150px">
                            <asp:Localize ID="LocalizeEmailServer" runat="server" Text="SMTP服务器端口："></asp:Localize>
                        </th>
                        <td valign="middle"><asp:TextBox ID="TextBoxServerPort" runat="server" CssClass="tinput" Width="200px"></asp:TextBox><span>SMTP服务器端口不能为空(<font color="red">*</font>)</span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" value="0" id="TextBoxEmailPassword"  runat="server" class="tinput" style="width:200px"/>
                    ...
                    <tr>
                     ...
                     <tr class="radiobtn" style="display:none">
                        ...
                        <td>
                            <asp:CheckBoxList ID="CheckBoxListEmailCode" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                     <tr>
      ...
      <div class="tablebtn">
            <asp:Button ID="ButtonEdit" runat="server" Text="确定" CssClass="fanh" OnClientClick="return EmailCheck()" OnClick="ButtonEdit_Click" />
