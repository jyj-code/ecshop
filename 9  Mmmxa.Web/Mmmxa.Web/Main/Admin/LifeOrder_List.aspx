<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_LifeOrder_List"   CodeBehind="LifeOrder_List.aspx.cs"      %>
...
$(function(){
        $("#sk_go").click(function(){
                ...
                var sub=$("#DropDownListSubstationID").val();
                if(sstatus!="")
                {
                    location.href="?style="+sstyle+"&status="+sstatus+"&trdeid="+tradeid+"&orid="+orid+"&mid="+mid+"&ct="+ct+"&et="+et+"&sp1="+sp1+"&sp2="+sp2+"&shopid="+shopid+"&sn="+escape(shopname)+"&pageid=1&sub="+sub;
                }
                else
                   location.href="?trdeid="+tradeid+"&orid="+orid+"&mid="+mid+"&ct="+ct+"&et="+et+"&sp1="+sp1+"&sp2="+sp2+"&shopid="+shopid+"&sn="+escape(shopname)+"&pageid=1&sub="+sub;
        });
});
    </script>
</head>
<body class="widthah">
<input type="hidden" id="hidstyle" value='<%=ShopNum1.Common.Common.ReqStr("style") %>' />
    ...
    <div id="right">
            ...
            <div class="ml">
                <div class="mr">
                    <ul class="mul">
                        ...
                        <li id="current7" style="display:none;">
        ...
        <div class="welcon clearfix">
            ...
            <table cellspacing="0" cellpadding="4" border="0" id="Table1" rules="cols" class="gridview_m">
                 ...
                 <th scope="col">分站名称</th><th scope="col">订单号</th><th scope="col">店铺ID</th><th scope="col">店铺名称</th><th scope="col">手机号码</th>
          ...
          <tbody>
                         ...
                         %>
                            <tr style="cursor:default;" onmouseout="Num1GridViewShow_mout(this)" onmouseover="Num1GridViewShow_mover(this)">
                                ...
                                <td align="center" style="">
                                    ...
                                    <span id="Span2"><%=dr["shopID"]%></span>
                                </td><td align="center" style="">
                                    <span id="Span3"><%=dr["ShopName"]%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span5"><%=dr["mobile"]%></span>
                                </td>
                                <td align="center" style="">
                                ...
                                <td align="center" style="">
                                    <span id="Span10"><%=ChangeOderStatus(dr["OderStatus"].ToString())%></span>
                                </td>
                                <td align="center" style="">
		   ...
		   <div class="btnlist" style="overflow:auto;" id="showPage" runat="server" visible="false">   </div>
                        ...
                        function checknum(str)
                        {
                            ...
                            if (!re.test(str))
                            {
		                        ...
		                        $(function(){
		                               ...
		                               var sub='<%=ShopNum1.Common.Common.ReqStr("sub") %>';
		                               if(sub!="")
		                               {
		                                    $("#DropDownListSubstationID").val(sub);
		                               }
		                                ...
		                                $(".fpage").find(".quedbtn").click(function(){
		                                      ...
		                                      {
		                                          location.href='?style=<%=Request.QueryString["style"] %>&status=<%=Request.QueryString["status"] %>&tradeid=<%=Request.QueryString["tradeid"] %>&orid=<%=Request.QueryString["orid"] %>&mid=<%=Request.QueryString["mid"] %>&ct=<%=Request.QueryString["ct"] %>&et=<%=Request.QueryString["et"] %>&sp1=<%=Request.QueryString["sp1"] %>&sp2=<%=Request.QueryString["sp2"] %>&shopid=<%=Request.QueryString["shopid"] %>&sn=<%=Request.QueryString["sn"] %>&pagesize='+pagesize+'&pageid='+pageindex;
		                                      }
		                                });
		                        });
		                </script>
