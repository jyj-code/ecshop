<%@ page language="C#" autoeventwireup="true" inherits="Admin_CategoryAdBuyAudit_List"   CodeBehind="CategoryAdBuyAudit_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AllowPaging="True" AddSequenceColumn="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="广告图片">
                        <ItemTemplate>
                            <img src='<%# Page.ResolveUrl("~/ImgUpload/MemberImg/CategoryAdImg/"+Eval("AdvertisementPic").ToString())%> '
                                onmouseover="javascript:ddrivetip('<img width=200px height=200 src=<%# Page.ResolveUrl("~/ImgUpload/MemberImg/CategoryAdImg/"+Eval("AdvertisementPic").ToString())%> >','#ffffff')"
                      ...
                      <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "CategoryAdBuy_SearchDetail.aspx?guid='"+Eval("ID")+"'&type=Audit" %>" style="color: #4482b4;">
                                查看</a>
