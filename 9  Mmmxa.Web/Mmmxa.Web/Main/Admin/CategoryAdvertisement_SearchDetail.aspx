<%@ page language="C#" autoeventwireup="true" inherits="Admin_CategoryAdvertisement_SearchDetail"   CodeBehind="CategoryAdvertisement_SearchDetail.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <table border="0" cellpadding="0" cellspacing="0" class="shoptable">
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd">
                            <asp:DropDownList ID="DropDownListAdPageName" Enabled="false" AutoPostBack="true" CssClass="tselect" 
                    runat="server" Width="180px" OnSelectedIndexChanged="DropDownListAdPageName_SelectedIndexChanged">
                ...
                <asp:DropDownList ID="DropDownListAdID" Enabled="false" AutoPostBack="true" runat="server" CssClass="tselect" 
                    Width="180px" OnSelectedIndexChanged="DropDownListAdID_SelectedIndexChanged">
                    <asp:ListItem Selected="True" Value="-1">-请选择-</asp:ListItem>
                </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd">
                            <asp:DropDownList ID="DropDownListCategory1" Width="180" Enabled="false" AutoPostBack="true" CssClass="tselect" 
                    runat="server" OnSelectedIndexChanged="DropDownListCategory1_SelectedIndexChanged">
                    <asp:ListItem Selected="True" Value="-1">-请选择-</asp:ListItem>
                </asp:DropDownList>
                <asp:DropDownList ID="DropDownListCategory2" Width="180" Enabled="false" AutoPostBack="true" CssClass="tselect" 
                    runat="server" OnSelectedIndexChanged="DropDownListCategory2_SelectedIndexChanged">
                    <asp:ListItem Selected="True" Value="-1">-请选择-</asp:ListItem>
                </asp:DropDownList>
                <asp:DropDownList ID="DropDownListCategory3" Width="180" Enabled="false" runat="server" CssClass="tselect" >
                    <asp:ListItem Selected="True" Value="-1">-请选择-</asp:ListItem>
                </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd">
                            <asp:DropDownList ID="DropDownListIsBuy" Width="180" Enabled="false" runat="server" CssClass="tselect">
