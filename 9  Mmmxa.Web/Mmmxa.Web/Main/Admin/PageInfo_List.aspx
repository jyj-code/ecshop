<%@ page language="C#" autoeventwireup="true" inherits="Admin_PageInfo_List"   CodeBehind="PageInfo_List.aspx.cs"      %>
...
<body >
    <form id="form1" runat="server">
      ...
      <div id="right">
            ...
            OnClick="ButtonEdit_Click" CssClass="bji lmf_btn" ><span>编辑</span></asp:LinkButton>
                ...
                <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                    ...
                    <AlternatingRowStyle BackColor="White" />
                      ...
                      <Columns>
                        ...
                        <asp:BoundField DataField="pagename" SortExpression="pagename" HeaderText="页面名" ItemStyle-HorizontalAlign="Center"  />
                        <asp:BoundField DataField="pagenote" SortExpression="pagenote" HeaderText="说明"  ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="filename" SortExpression="filename" HeaderText="文件名"  ItemStyle-HorizontalAlign="Center" />
                    </Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="Search"
        TypeName="ShopNum1.BusinessLogic.ShopNum1_PageInfo_Action">
        <SelectParameters>
