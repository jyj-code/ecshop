<%@ page language="C#" autoeventwireup="true" inherits="Admin_OrderScore_Operate"   CodeBehind="OrderScore_Operate.aspx.cs"      %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="ordertable">
                ...
                <tr align="center">
                    ...
                    <td align="center"  style=" display:none;">
                     ...
                     <td align="center">
                     <a target="_blank" href='<%#ShopUrlOperate.shopDetailHrefNew(Eval("ProductGuid").ToString(),Eval("IsShopMemLoginID").ToString(),"ProductIntegral")%>'>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="ordertable2">
                <tr>
                    <th colspan="6" align="left">
                        <div class="shux">
                            <asp:Label ID="LabelPageTitle" runat="server" Font-Bold="True" Text="积分订单信息"></asp:Label>
                        </div>
                    </th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th>
                        <asp:Label ID="LabelTotalScore" runat="server" Text="订单总积分："></asp:Label>
                    </th>
                    <td>
