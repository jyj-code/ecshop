<%@ page language="C#" autoeventwireup="true" inherits="Service_ServiceAdmin_ServiceOnLineService_Operate, ShopNum1.Deploy" %>
...
<%--    <script type="text/javascript">
        function funCheck()
        {
            var txt=document.getElementById("TextBoxServiceAccount").value;
        }
    </script>--%>
</head>
<body>
        ...
        <div class="welcon clearfix">
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                    ...
                    <td>
                            ...
                            <asp:DropDownList ID="DropDownListType" runat="server" CssClass="tselect" AutoPostBack="true" OnSelectedIndexChanged="DropDownListType_SelectedIndexChanged">
                            </asp:DropDownList>
            ...
            <script type="text/javascript" language="javascript">
                  ...
                  function CheckSub()
                  {
                    ...
                    if($("#TextBoxServiceAccount").val()=="")
                    {
                        return false;
                    }
                      var typeUser=$("#DropDownListType").find("option:selected").val();
                      if(typeUser.indexOf("QQ")!=-1||typeUser.indexOf("qq")!=-1)
                      {
                         return checknum($("#TextBoxServiceAccount").val());
                      }else
                      {
                        return true;
                      }
            ...
            <div class="tablebtn">
                <asp:Button ID="ButtonConfirm" runat="server" Text="确定" CssClass="qued" OnClick="ButtonConfirm_Click"
                    ToolTip="Submit" OnClientClick="return CheckSub();" />
                <asp:Button ID="ButtonBack" runat="server" CssClass="fanh" CausesValidation="false"
                    PostBackUrl="ServiceOnLineService_List.aspx" Text="返回列表" /><GroupFly:MessageShow
