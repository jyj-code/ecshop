<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_EmailMemberGroup_List"   CodeBehind="EmailMemberGroup_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%#"EmailMemberGroup_Operate.aspx?type=1&guid='"+Eval("Guid")+"'" %>" style="color: #4482b4;">
                                编辑</a>
