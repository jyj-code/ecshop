<%@ page language="C#" autoeventwireup="true" inherits="Admin_MMSInterface_Operate"   CodeBehind="MMSInterface_Operate.aspx.cs"      %>
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:DropDownList ID="DropDownListType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownListType_SelectedIndexChanged"  Width="160"
                                CssClass="tselect">
                                <asp:ListItem Text="-请选择-" Value="-1"></asp:ListItem>
                                <asp:ListItem Text="亿美短信接口" Value="0"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxPwd" runat="server" Style="width: 150px;" CssClass="tinput" TextMode="Password"></asp:TextBox>
                     ...
                     <tr>
                       <th align="right">接收手机号：</th>
                       <td><asp:TextBox ID="txtTel" runat="server" Style="width: 150px;" CssClass="tinput"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="butTest" runat="server" Text="测试发送" ToolTip="Submit" CssClass="fanh"  OnClick="butTest_Click" />(测试前请先保存正确的配置)</td>
                   </tr>
                    <tr>
                       <th align="right">发送内容：</th>
                       <td><asp:TextBox ID="txtRc" runat="server" Style="width: 150px;" CssClass="tinput" Text="[武汉群翔软件]"></asp:TextBox> </td>
                   </tr>
                </table>
            </div>
<div class="tablebtn">
