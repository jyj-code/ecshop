<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_Theme_ActivityList"   CodeBehind="Theme_ActivityList.aspx.cs"      %>
...
<div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <td valign="top" class="lmf_app">
                   <asp:LinkButton ID="ButtonDelete" runat="server" CssClass="shanchu lmf_btn" OnClientClick="return DeleteButton();" OnClick="ButtonDelete_Click"><span>批量删除</span></asp:LinkButton>
                </td>
                <td valign="top" class="lmf_app">
	...
	<table cellspacing="0" cellpadding="4" border="0" id="Num1GridViewShow" rules="cols" class="gridview_m">
		 <thead><tr align="center" style="color:White;" class="list_header">
            ...
            <th scope="col">活动名称</th><th scope="col">开始时间</th><th scope="col">结束时间</th><th scope="col">活动说明</th>
          <th scope="col">状态</th><th scope="col">操作</th></tr>
          </thead>
          ...
          <%if (dt != null)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    string strThemeDescription = dt.Rows[i]["ThemeDescription"].ToString().Length > 19 ? dt.Rows[i]["ThemeDescription"].ToString().Substring(0, 19) : dt.Rows[i]["ThemeDescription"].ToString();
                    string strSubstationID = dt.Rows[i]["SubstationID"].ToString();
                    string newHref = string.Empty;
                    string DomainName = string.Empty;
                    if (strSubstationID == "all")
                    {
                        newHref = "/themesproduct.html";
                    }
                    else
                    {
                        ShopNum1.BusinessLogic.ShopNum1_SubstationManage_Action SubstationManage_Action = (ShopNum1.BusinessLogic.ShopNum1_SubstationManage_Action)ShopNum1.CityFactory.LogicFactory.CreateShopNum1_SubstationManage_Action();
                        DomainName = SubstationManage_Action.GetDomainNameBySubstationID(strSubstationID);
                        string domain = ShopNum1.Common.ShopSettings.siteDomain.Substring(ShopNum1.Common.ShopSettings.siteDomain.IndexOf("."));
                        newHref = "http://" + DomainName  + domain + "/themesproduct.html";
                    }
                    ...
                    %>
                     ...
                     <tr style="cursor:default;" onmouseout="Num1GridViewShow_mout(this)" onmouseover="Num1GridViewShow_mover(this)">
			            <td align="center" style="">
                            ...
                            <span id="Span1"><a href="<%=newHref %>?themeguid=<%=strId %>" target="_blank"><%=strName%></a></span>
                        </td><td align="center" style="">
                            <span id="Span2"><%=strStartTime%></span>
                        </td><td align="center" style="">
                            <span id="Span3"><%=strEndTime%></span>
                        </td>
                        <td align="center" style="">
                            <span id="Span6"><%=strThemeDescription%></span>
                        </td>
                        <td align="center" style="">
                            <span id="Span5"><%=strTXT%></span>
                        </td>
                        <td align="center" style="">
                            <a style="color: #4482b4;" href="Theme_ActivityOperate.aspx?update=<%=strId %>&jk">
                                编辑</a>
                            <a style="color: #4482b4;" href="Theme_ProductList.aspx?Aid=<%=strId %><%=strUrlEnd%>&vj">
                                管理</a>
                           <a style="color: #4482b4;" href="?delete=<%=strId %>&jk"  onclick="return window.confirm('您确定要删除吗?');">删除</a>
                        </td>
		          </tr>
                <%}
            } %>
