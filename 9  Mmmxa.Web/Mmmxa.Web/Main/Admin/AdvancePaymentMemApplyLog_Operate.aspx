<%@ page language="C#" autoeventwireup="true" inherits="Admin_AdvancePaymentMemApplyLog_Operate"   CodeBehind="AdvancePaymentMemApplyLog_Operate.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="提款审核"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
