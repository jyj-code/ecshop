<%@ page language="C#" autoeventwireup="true" inherits="Admin_ProductIntegral_List"   CodeBehind="ProductIntegral_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="商品名称" SortExpression="Name" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                                <a target="_blank" href='<%#ShopUrlOperate.shopDetailHrefNew(Eval("Guid").ToString(),Eval("MemLoginID").ToString(),"ProductIntegral")%>' class="sroceimg">
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ProductIntegralDetal.aspx?guid="+Eval("Guid")+"&type=1" %>"
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="GetDataInfoInAdmin"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="DropDownListIsNew" Name="IsNew" PropertyName="Text"
                    Type="Int32" />
                <asp:ControlParameter ControlID="DropDownListIsHot" Name="IsHot" PropertyName="Text" Type="Int32" />
