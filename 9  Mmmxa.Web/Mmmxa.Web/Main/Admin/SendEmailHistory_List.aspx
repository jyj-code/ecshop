<%@ page language="C#" autoeventwireup="true" inherits="Produce_ServiceAdmin_ServiceSenEmailHistory_List, ShopNum1.Deploy" %>
...
<body style="padding: 0; background-image: url(images/Bg_right.gif); background-repeat: repeat;">
    ...
    <cc1:Num1GridView ID="Num1GridView" runat="server" AutoGenerateColumns="False"
    ...
    <div class="vote2" style="padding-left:2px;">
        <asp:Button ID="ButtonSend" runat="server" OnClientClick="return EditButton()" CausesValidation="False"
            Text="重新发送" CssClass="bt3 cancel" OnClick="ButtonSend_Click" />
