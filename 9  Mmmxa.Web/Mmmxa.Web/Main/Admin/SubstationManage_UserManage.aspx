<%@ page language="C#" autoeventwireup="true" inherits="Admin_SubstationManage_UserManage"   CodeBehind="SubstationManage_UserManage.aspx.cs"      %>
...
<body class="widthah" style="height:600px;">
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    【<asp:Label ID="LabelSubName" runat="server" Text="北京"></asp:Label>】分站用户管理</h3>
            </div>
            <div class="rr">
            </div>
        </div>
            ...
            <div class="order_edit">
                ...
                <div class="sbtn">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td valign="top">
                                <a href="adduser.aspx?width=700&height=450&sub=<%=HiddenFieldSubstationID.Value %>" class="tianjia2 lmf_btn dialog"><span>添加</span></a>
                            </td>
                ...
                <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                <a href='adduser.aspx?width=700&height=450&id=<%# Eval("Guid")%>&sub=<%# Eval("SubstationID")%>' style="color:#4482b4;" class="dialog">编辑</a>
     ...
     <asp:HiddenField ID="CheckGuid" runat="server" Value="0" />
        ...
        <asp:HiddenField ID="HiddenFieldSubstationID" runat="server" Value="all" />
    </form>
</body>
</html>
