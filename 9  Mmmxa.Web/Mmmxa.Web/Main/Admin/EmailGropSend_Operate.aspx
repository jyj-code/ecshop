<%@ page language="C#" autoeventwireup="true" inherits="Produce_ServiceAdmin_ServiceEmailGropSend_Operate, ShopNum1.Deploy" validaterequest="false" %>
...
<body class="widthah">
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3><asp:Label ID="LabelTitle" runat="server" Text="邮件群发"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
               ...
               <select id="selectEmail" runat="server" multiple="true" style="height:160px; width:50%">
                    ...
                    <tr class="radiobtn" style="display:none">
                     ...
                     <tr style="display:none">
                        ...
                        <td>
                            <p id="ce05437f-75a7-4ee2-8014-4bd992357e51" lang="下单时邮件提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;订单号为：{$OrderNumber}&nbsp;&nbsp;站点名称：{$ShopName}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
                            <p id="baf3ca6b-e3b2-4a9d-beb3-5385ed81c69c" lang="申请开店邮件提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;站点名称：{$ShopName}&nbsp;&nbsp;系统时间：{$SysSendTime}&nbsp;&nbsp;店铺状态：{$ShopStatus}</p>
                            <p id="e77e5311-e0d2-4b6e-b16d-65db7f4ace40" lang="确认收货邮件提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;订单号为：{$OrderNumber}&nbsp;&nbsp;站点名称：{$ShopName}&nbsp;&nbsp;系统时间：{$SysSendTime}&nbsp;&nbsp;订单状态：{$OrderStatus}</p>
                            <p id="204e827c-a610-4212-836e-709cd59cba83" lang="付款时邮件提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;订单号为：{$OrderNumber}&nbsp;&nbsp;站点名称：{$ShopName}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
                            <p id="7c367402-4219-46b7-bc48-72cf48f6a836" lang="发货时邮件提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;订单号为：{$OrderNumber}&nbsp;&nbsp;发货备注：{$Memo}&nbsp;&nbsp;商铺网站：{$DoMain}&nbsp;&nbsp;发货时间：{$SendTime}&nbsp;&nbsp;快递单号：{$SendNumber}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
                            <p id="7790bcf5-f88a-46bd-8ead-959118481c02" lang="注册时邮件提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;密码：{$PassWord}&nbsp;&nbsp;邮箱验证地址：{$CheckUrl}&nbsp;&nbsp;站点名称：{$ShopName}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
                            <p id="60c1bef2-33e4-4510-944c-afca43d09f0c" lang="开店审核后提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;商铺网站：{$DoMain}&nbsp;&nbsp;店铺状态：{$ShopStatus}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
                            ...
                            <p id="00000000-0000-0000-0000-000000000000" lang="自定义模板标题" style="display:none"></p>
                       </td>
                    </tr>
                       </table>
                     </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TextBoxEmailTitle" runat="server" ErrorMessage="邮件标题不能为空!"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <th align="right" width="145px">
      ...
      <%--        <asp:UpdatePanel ID="updatepanel2" runat="server">
                <ContentTemplate>--%>
                <asp:Button ID="ButtonConfirm" runat="server" Text="确定" CssClass="fanh" OnClientClick="return SendEmail()" OnClick="ButtonConfirm_Click" />
