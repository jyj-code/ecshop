<%@ page language="C#" autoeventwireup="true" inherits="Admin_CategoryAdID_List"   CodeBehind="CategoryAdID_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="默认图片" SortExpression="CategoryAdDefalutPic">
                        <ItemTemplate>
                            <img src='<%# Page.ResolveUrl("~/ImgUpload/"+Eval("CategoryAdDefalutPic").ToString())%> '
                                onmouseover="javascript:ddrivetip('<img width=200px height=200 src=<%# Page.ResolveUrl("~/ImgUpload/"+Eval("CategoryAdDefalutPic").ToString())%> >','#ffffff')"
