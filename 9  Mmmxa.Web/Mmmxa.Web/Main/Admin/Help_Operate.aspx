<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_Help_Operate"   CodeBehind="Help_Operate.aspx.cs"      %>
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:TextBox ID="TextBoxTitle" runat="server" CssClass="tinput" MaxLength="5"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <div style=" display:none">
                            ...
                            <input id="Button1" type="button" value="插入附件" onclick="openSingleAttachMent()" class="selpic"  visible="false" />
                            </div>
                            <asp:TextBox ID="FCKeditorContent" name="Texteditor" runat="server" CssClass="Texteditor" Width="600px"
