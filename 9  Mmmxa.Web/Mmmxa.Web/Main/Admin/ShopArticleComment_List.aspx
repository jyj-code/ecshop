<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopArticleComment_List"   CodeBehind="ShopArticleComment_List.aspx.cs"      %>
...
<body class="widthah">
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height:35px; vertical-align:top;">
                            <td align="right">
                                <asp:Label ID="Label1" runat="server" Text="分站名称："></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="DropDownListSubstationID"  Width="200" runat="server"
                                    CssClass="tselect">
                                </asp:DropDownList>
                            </td>
                ...
                <tr>
                <td><asp:TextBox ID="TextBoxSSendTime1" CssClass="tinput" Width="67px" runat="server"></asp:TextBox></td>
                ...
                <td><GroupFly:CalendarExtender ID="CalendarExtender4"
                                        runat="server" TargetControlID="TextBoxSSendTime1"  Format="yyyy-MM-dd"   PopupButtonID="imgCalendarSReplyTime1"
                                        CssClass="ajax__calendar" /></td>
                ...
                <td class="lmf_px">-</td>
                <td><asp:TextBox ID="TextBoxSSendTime2" runat="server" CssClass="tinput" Width="67px"></asp:TextBox></td>
                ...
                <td><GroupFly:CalendarExtender ID="CalendarExtender1"
                                        runat="server" TargetControlID="TextBoxSSendTime2"   Format="yyyy-MM-dd"    PopupButtonID="imgCalendarSReplyTime2"
                                        CssClass="ajax__calendar" /></td>
                <td> <asp:RegularExpressionValidator ID="RegularExpressionValidatorStartDate2" runat="server"
                                    ...
                                    ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                <td class="lmf_padding"></td> 
                <td><asp:Button ID="ButtonSearch" runat="server" CssClass="dele" OnClick="ButtonSearch_Click"
                                    Text="查询" /></td> 
                <td></td> 
                <td></td>                   
                </tr>
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="IPAddress" HeaderText="发表IP" SortExpression="IPAddress">
                      ...
                      <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ShopArticleComment_Operate.aspx?guid='"+Eval("Guid")+"'&Type=List" %>" style="color: #4482b4;">
                                查看</a>
    ...
    <div style=" display:none">
        ...
        <asp:DropDownList ID="DropDownListSIsReply" Width="207" runat="server" CssClass="tselect">
                ...
                <td><asp:TextBox ID="TextBoxSReplyTime1" CssClass="tinput" Width="67px" runat="server"></asp:TextBox></td>
                <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarSReplyTime3" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top:3px" /></td>
                <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorStartDate3" runat="server"
                ...
                <td><GroupFly:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TextBoxSReplyTime1"
                                    PopupButtonID="imgCalendarSReplyTime3" CssClass="ajax__calendar" /></td> 
                <td class="lmf_px">-</td> 
                <td><asp:TextBox CssClass="tinput" Width="67px" ID="TextBoxSReplyTime2" runat="server"></asp:TextBox></td> 
                <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarSReplyTime4" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top: 4px" /></td> 
                <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorStartDate4" runat="server"
                                    ControlToValidate="TextBoxSReplyTime2" Display="Dynamic" ErrorMessage="时间格式不正确"
                                    ValidationExpression="^\d{4}-(\d{2}|\d{1})-(\d{2}|\d{1})( (\d{2}|\d{1}):(\d{2}|\d{1}):(\d{2}|\d{1}))*"></asp:RegularExpressionValidator></td> 
                <td><GroupFly:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TextBoxSReplyTime2"
