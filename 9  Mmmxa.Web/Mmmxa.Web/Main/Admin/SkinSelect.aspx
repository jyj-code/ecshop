<%@ page language="C#" autoeventwireup="true" inherits="Admin_SkinSelect"   CodeBehind="SkinSelect.aspx.cs"      %>
                            ...
                            <ItemTemplate>
                                <li style="text-align: center;">
                                    ...
                                    <p style="padding-left:12px;">
                                        ...
                                        <a target="_blank" href='<%# Page.ResolveUrl(Eval("SkinImage").ToString()) %>' style="margin-right: 10px;">预览</a>
                                        
                                        <asp:LinkButton ID="LinkButtonDelete" Style="margin-right: 10px;" runat="server"  CommandName="delete">删除</asp:LinkButton>
                                    </p>
                                </li>
                            </ItemTemplate>
                        </asp:DataList>
