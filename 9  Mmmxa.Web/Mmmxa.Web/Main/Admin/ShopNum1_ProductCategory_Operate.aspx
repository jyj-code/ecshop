<%@ page language="C#" autoeventwireup="true" inherits="ShopNum1_ShopNum1Admin_ProductCategory_Operate, ShopNum1.Deploy" %>
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                           <asp:DropDownList ID="DropDownListCateType" runat="server" CssClass="tselect">
                            </asp:DropDownList><asp:Label ID="Label2" runat="server" Text="*" ForeColor="red"></asp:Label>
                            <span>商品类型分类。</span>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            </asp:DropDownList><asp:Label ID="Label3" runat="server" Text="*" ForeColor="red"></asp:Label>
                            <span>商城所属分类。</span>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img id="ImageOriginalImge" runat="server" onerror="javascript:this.src='/ImgUpload/noImg.jpg'"
                                src="" alt="" width="50" height="50" />
                            <input id="ButtonSelectSingleImage" type="button" value="选择图片" onclick="openSingleChild()"
                                class="selpic" />
                            <%--<asp:FileUpload ID="fileCategory" runat="server" /><img src="" id="imgshow" runat="server" style="width:50px; height:50px;" alt=""/>--%>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="CheckBoxIsShow" runat="server" Text="是" /><span> 商品分类是否在前台显示。</span>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
