<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopSales"   CodeBehind="ShopSales.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                   <%-- <asp:BoundField DataField="MemLoginID" HeaderText="排名" SortExpression="MemLoginID">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>--%>
                     <asp:BoundField DataField="Name" HeaderText="店主名称" SortExpression="Name">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchShopSalesClickCount"
            TypeName="ShopNum1.BusinessLogic.ShopNum1_ShopInfoList_Action">
            <SelectParameters>
              <asp:ControlParameter ControlID="txtshophost" Name="shophost"
                    PropertyName="Text" Type="String"  DefaultValue="-1"  />
