<%@ page language="C#" autoeventwireup="true" inherits="Admin_Third_loginOperate"   CodeBehind="Third_loginOperate.aspx.cs"      %>
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr style="display:none">
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxRedirectURL" runat="server" CssClass="tinput"></asp:TextBox><span> 请输入回调地址</span>
                        </td>
                    </tr>
                    <tr>
