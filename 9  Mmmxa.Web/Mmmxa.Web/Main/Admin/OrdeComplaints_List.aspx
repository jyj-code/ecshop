<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_OrdeComplaints"   CodeBehind="OrdeComplaints.aspx.cs"      %>
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <td>
                                <asp:TextBox ID="TextBoxComplaintShop" CssClass="tinput" Width="158" runat="server"></asp:TextBox>
                            </td>
                            <td class="lmf_padding">
                                投诉类别：
                            </td>
                            <td>
                                <asp:DropDownList ID="DropDownListType" runat="server" Width="158" CssClass="tselect">
                                </asp:DropDownList>
                            </td>
                            <td class="lmf_padding">
                                订单编号：
                            ...
                            <td>
                                <asp:TextBox ID="TextBoxOrderID" CssClass="tinput" Width="158" runat="server"></asp:TextBox>
                            </td>
                            <td>
            ...
            <div>
                <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="OrderID" HeaderText="订单编号" SortExpression="OrderID" ItemStyle-HorizontalAlign="Center" />
