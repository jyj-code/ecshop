<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopApplyRankChecked_List"   CodeBehind="ShopApplyRankChecked_List.aspx.cs"      %>
          ...
          <div id="right">
            ...
            <div class="welcon clearfix">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td>
                                    ...
                                    <td>
                                          <asp:DropDownList ID="DropDownListIsAudit" runat="server" Width="201px" CssClass="tselect"></asp:DropDownList>
                                    </td>
                                    <td>
            ...
            OnClientClick="return AuditButton()"   ><span>审核通过</span></asp:LinkButton>
                        ...
                        <ShopNum1:num1gridview ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                            ...
                            PagingStyle="None" TableName=""  DataSourceID="ObjectDataSourceDate"
                ...
                <asp:BoundField DataField="MemberLoginID" HeaderText="申请会员" SortExpression="MemberLoginID" ItemStyle-HorizontalAlign="Center" />
