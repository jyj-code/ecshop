<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="Admin_SkinBackup"   CodeBehind="SkinBackup.aspx.cs"      %>
...
<head runat="server">
    ...
    <style type="text/css">
    .backa a{ display:block; margin:0;}
    .backa .lmf_l{ float:left;}
    .backa .lmf_r{ float:right;}
    </style>
</head>
<body>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
           ...
           <asp:Image ID="ImageCurrentSkin" runat="server" Height="138" Width="132" BackColor="White" BorderStyle="Solid" BorderWidth="1" />
                    ...
                    <div class="bname" style="padding:10px 5px; color:#464646;">
                        <p>
                            <b>当前模板</b></p>
                        <p>
                            模板文件夹名称： <asp:Label ID="LabelFolderNameValue" runat="server"></asp:Label></p>
                        <p>
                            模板名称： <asp:Label ID="LabelNameValue" runat="server"></asp:Label></p>
                        <p>
                            模板说明： <asp:Label ID="LabelDescriptionValue" runat="server"></asp:Label></p>
                ...
                <div class="backlist">
                    <ul>
                        <asp:DataList ID="DataListShow" runat="server" RepeatDirection="Horizontal"
                            Width="100%" HorizontalAlign="Center" OnItemCommand="DataListShow_ItemCommand"
                            RepeatLayout="Flow">
                            <ItemTemplate>
                                <li style="text-align:center;">
                                    <div class="bfrist">
                                            <img src="images/moban.jpg" width="127" height="133" />
                                        <div class="lmf_xuanzhong"></div>
                                            <div class="lmf_xuanzhongtext">正在使用</div>
                                    </div>
