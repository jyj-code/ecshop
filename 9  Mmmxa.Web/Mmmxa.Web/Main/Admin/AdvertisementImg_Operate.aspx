<%@ page language="C#" autoeventwireup="true" inherits="Admin_AdvertisementImg_Operate"   CodeBehind="AdvertisementImg_Operate.aspx.cs"      %>
             ...
             <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                    ...
                    <td valign="middle">
                            ...
                            <asp:TextBox ID="TextBoxID" CssClass="tinput" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox><span> 广告ID</span>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxPageName" CssClass="tinput" runat="server"></asp:TextBox><span> 输入页面名称</span>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxpath" runat="server" CssClass="tinput"></asp:TextBox><img id="imgshow" runat="server" src="" style="width:100px; height:100px;"  />
                ...
                <tr id="Tr1" runat="server" >
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxDes" CssClass="tinput" runat="server" TextMode="MultiLine" ></asp:TextBox><span> 广告描述</span>
