<%@ page language="C#" autoeventwireup="true" inherits="Admin_ZtcGoods_List"   CodeBehind="ZtcGoods_List.aspx.cs"      %>
                    ...
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListState" runat="server" 
                                CssClass="tselect" Style="width: 100px; margin-right: 0;" >
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="直通车名称"  ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                        <a  target="_blank"   href='<%#ShopUrlOperate.shopHref(Eval("ProductGuid").ToString(),Eval("MemberID").ToString())%>' class="tjimga">
                    ...
                    <asp:BoundField HeaderText="销售数量" DataField="SellCount" SortExpression="SellCount"
                        ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="Ztc_Money" HeaderText="预存款余额" SortExpression="Ztc_Money"
                        ItemStyle-HorizontalAlign="Center" />
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ZtcGoodsDetal.aspx?ID="+Eval("ID")+"&type=1" %>"
