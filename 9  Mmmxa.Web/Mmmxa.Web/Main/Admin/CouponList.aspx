<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_CouponList"   CodeBehind="CouponList.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr style="height: 35px; vertical-align:top;">
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DropDownListRegionCode3" runat="server" CssClass="tselect" Width="100">
                            </asp:DropDownList>
                            </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                    ...
                    <tr style="height: 35px; vertical-align:top;">
                        ...
                        <tr>
                        <td><asp:TextBox ID="TextBoxStartTime1" CssClass="tinput" runat="server" Width="68"></asp:TextBox></td>
                        ...
                        <td><GroupFly:CalendarExtender ID="CalendarExtender4"
                        ...
                        <td class="lmf_px">-</td>
                        <td><asp:TextBox ID="TextBoxStartTime2" CssClass="tinput" runat="server" Width="68"></asp:TextBox></td>
                        ...
                        <td><GroupFly:CalendarExtender ID="CalendarExtender1"
                                    runat="server" TargetControlID="TextBoxStartTime2" PopupButtonID="img1" CssClass="ajax__calendar" Format="yyyy-MM-dd" /></td>
                        <td><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxStartTime2"
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                        <td><asp:TextBox ID="TextBoxEndTime1" CssClass="tinput" runat="server" Width="68"></asp:TextBox></td>
                        ...
                        <td><GroupFly:CalendarExtender ID="CalendarExtender2"
                                    runat="server" TargetControlID="TextBoxEndTime1" PopupButtonID="img2" CssClass="ajax__calendar" Format="yyyy-MM-dd" /></td>
                        <td><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBoxEndTime1"
                                Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[123456789]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]| [2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d {2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26]) |((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                        <td class="lmf_px">-</td>
                        <td><asp:TextBox ID="TextBoxEndTime2" CssClass="tinput" runat="server" Width="68"></asp:TextBox></td>
                        ...
                        <td><GroupFly:CalendarExtender ID="CalendarExtender3"
                                    runat="server" TargetControlID="TextBoxEndTime2" PopupButtonID="img3" CssClass="ajax__calendar" Format="yyyy-MM-dd" /></td>
                        <td> <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBoxEndTime2"
                                Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[123456789]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]| [2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d {2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26]) |((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" Width="207px" runat="server" CssClass="tselect">
                            </asp:DropDownList>
                        </td>
                ...
                <td valign="top" style="display:none;">
                     <asp:LinkButton ID="ButtonSearchShop" runat="server" CausesValidation="False" 
                        OnClientClick=" return EditButton()" CssClass="dele" OnClick="ButtonSearchShop_Click"
                        Visible="false"  ><span>查看</span></asp:LinkButton>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分站名称" SortExpression="SubstationID" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                        ...
                        <ItemTemplate>
                            <a target="_blank" title='<%#Eval("CouponName") %>' href='<%# ShopUrlOperate.shopDetailHrefNew(Eval("Guid").ToString(),Eval("MemLoginID").ToString(),"Coupon") %>' title="<%#Eval("CouponName") %>">
