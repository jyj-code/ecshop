<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopTemplate_Operate"   CodeBehind="ShopTemplate_Operate.aspx.cs"      %>
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr runat="server" id="ShopTemplateImg">
                        ...
                        <td valign="top">
                            ...
                            <span style="color: Red">*</span> (支持png、jpg、gif、bmp格式图片。)<a id="ImageLink" runat="server" target="_blank">
