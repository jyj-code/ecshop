<%@ page language="C#" autoeventwireup="true" inherits="Admin_SupplyDemandComment_Operate"   CodeBehind="SupplyDemandComment_Operate.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <%-- <span style=" color:red">*</span>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TextBoxReplyContent" runat="server" ErrorMessage="回复内容不能为空！"></asp:RequiredFieldValidator>--%>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="tablebtn">
                ...
                <asp:Button ID="ButtonAudit" runat="server" Text="审核通过" OnClick="ButtonAudit_Click" CausesValidation="False" CssClass="fanh"></asp:Button>&nbsp;&nbsp;&nbsp;
                <asp:Button ID="ButtonCancelAudit" runat="server"  Text="审核未通过" OnClick="ButtonCancelAudit_Click" CausesValidation="False" CssClass="fanh"></asp:Button>&nbsp;&nbsp;&nbsp;
