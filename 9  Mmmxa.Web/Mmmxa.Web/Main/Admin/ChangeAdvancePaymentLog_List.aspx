<%@ page language="C#" autoeventwireup="true" inherits="Admin_ChangeAdvancePaymentLog_List"   CodeBehind="ChangeAdvancePaymentLog_List.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit" style="margin-bottom: 1px;">
                        ...
                        <tr style="height: 35px; vertical-align: top;">
                            ...
                            <td>
                                <asp:DropDownList ID="DropdownListSOperateType" runat="server" Width="201px" CssClass="tselect">
                                    ...
                                    <asp:ListItem Value="2">提现</asp:ListItem>
                                    <asp:ListItem Value="3">消费</asp:ListItem>
                                    <asp:ListItem Value="4">收入</asp:ListItem>
                                    <asp:ListItem Value="5">系统</asp:ListItem>
                                    <asp:ListItem Value="6">转账</asp:ListItem>
                                    </asp:DropDownList>
                            </td>
                            <td class="lmf_padding">
               ...
               <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td valign="top">
                    <asp:LinkButton ID="ButtonReportAll" OnClick="ButtonReportAll_Click" runat="server"  OnClientClick="return ImportData(true);"  CausesValidation="False" CssClass="daochubtn lmf_btn"><span>导出全部</span></asp:LinkButton>
                    </td>
                </tr>
                </table>
                </div>
            ...
            <div id="divPage" runat="server" style="display: none;">
                <div class="navigator">
                    &nbsp;
                    <asp:Label ID="LabelPageTitle" runat="server" Font-Bold="True" Text="变更预存款"></asp:Label>
                </div>
