<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopApplyRank_List"   CodeBehind="ShopApplyRank_List.aspx.cs"      %>
...
<body style="padding: 0; background-image: url(images/Bg_right.gif); background-repeat: repeat;">
    ...
    <div class="vote2">
        <asp:Button ID="ButtonAudit" runat="server" Visible="false" Text="审核通过" CssClass="bt3" OnClick="ButtonAudit_Click"
            OnClientClick="return AuditButton()" />
        <asp:Button ID="ButtonCancelAudit" runat="server" Visible="false" Text="审核未通过" CssClass="bt3" OnClientClick="return AuditButton()"
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="GetShopRankApply"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="TextBoxMemLoginID" DefaultValue="-1" 
                Name="memLoginID" PropertyName="Text" Type="String" />
