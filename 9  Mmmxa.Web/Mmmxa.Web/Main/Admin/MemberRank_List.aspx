<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_MemberRank_List"   CodeBehind="MemberRank_List.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <td valign="top" class="lmf_app" style="display:none;">
                    ...
                    OnClientClick="return EditButton()" CausesValidation="False" CssClass="fanh" Visible="false"   ><span>编辑</span></asp:LinkButton>
            ...
            <cc1:Num1GridView ID="Num1GridviewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="等级图片" SortExpression="pic">
                        <ItemTemplate>
                         <asp:Image ID="Imagepic" runat="server" src='<%# Eval("pic") %>' />
                       </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="最小积分" DataField="minScore" SortExpression="minScore">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="最大积分" DataField="maxScore" SortExpression="maxScore">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
