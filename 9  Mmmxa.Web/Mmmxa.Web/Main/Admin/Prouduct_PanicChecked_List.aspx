<%@ page language="C#" autoeventwireup="true" inherits="Admin_Prouduct_PanicChecked_List"   CodeBehind="Prouduct_PanicChecked_List.aspx.cs"      %>
            ...
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="DropDownListProductGuid1" runat="server" AutoPostBack="True"
                                        OnSelectedIndexChanged="DropDownListProductGuid1_SelectedIndexChanged" CssClass="tselect" style=" width:100px;">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="DropDownListProductGuid2" runat="server" AutoPostBack="True"
                                        OnSelectedIndexChanged="DropDownListProductGuid2_SelectedIndexChanged" CssClass="tselect" style=" width:100px;">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="DropDownListProductGuid3" runat="server" CssClass="tselect" style=" width:100px;">
                                    </asp:DropDownList>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><asp:Button ID="ButtonSearch" OnClick="ButtonSearch_Click" runat="server" Text="查询"  CssClass="dele"  />
             ...
             <table cellpadding="0" cellspacing="0" border="0">
                ...
                <td valign="top" style="display:none;">
                    <asp:LinkButton ID="ButtonSearchDetail" runat="server" Visible="false"  CssClass="dele"   OnClick="ButtonSearchDetail_Click"
                        OnClientClick="return EditButton()"   ><span>查看</span></asp:LinkButton>
                ...
                <td valign="top" class="lmf_app">
                    <ShopNum1:MessageShow ID="MessageShow" Visible="false" runat="server" />
                        ...
                        <cc1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                            ...
                            GridViewSortDirection="Ascending" PagingStyle="None" Style="margin:0 auto; text-align:center;"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="商品名称" SortExpression="Name" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <a href='<%# ShopUrlOperate.shopDetailHrefNew(Eval("Guid").ToString(),Eval("MemLoginID").ToString(),"ProductIsPanic_Detail") %>'
                                            target="_blank">
                            ...
                            <ItemTemplate>
                          <a href="<%# "ProductSearchDetal.aspx?guid="+Eval("Guid")+"&Type=Panic&Back=4" %>"   style="color: #4482b4;">查看</a>
