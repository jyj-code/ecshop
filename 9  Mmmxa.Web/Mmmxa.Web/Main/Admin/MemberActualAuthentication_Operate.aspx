<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_MemberActualAuthentication_Operate"   CodeBehind="MemberActualAuthentication_Operate.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3><asp:Label ID="LabelPageTitle" runat="server" Font-Bold="True" Text="操作会员实名认证"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
    ...
    <table cellpadding="0" cellspacing="1" border="0">
       ...
       <tr>
                    ...
                    <td align="left">
                        <textarea id="TextBoxAuditFailedReason" runat="server" style="height:100px;width:500px;" class="allinput1"></textarea>
    ...
    <div class="vote" style="padding-left: 2px; margin:15px 42px; margin-left:250px;">
    <asp:Button ID="ButtonConfiirm" runat="server" ValidationGroup="ConfiirmButton" Text="确定" CssClass="fanh" OnClick="ButtonConfiirm_Click"/>
