<%@ page language="C#" autoeventwireup="true" inherits="Tg_Settings, ShopNum1.Deploy" %>
       ...
       <table border="0" cellpadding="0" cellspacing="1">
            <tr>
                <th align="right" width="150px">
                        ...
                        <asp:Label ID="LabelUnionPostUrl" runat="server" Text="GroupFlyTG团购地址："></asp:Label>
                ...
                <td valign="middle">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorLogoUnionPostUrl" runat="server"
                            ...
                            ValidationExpression="^[\s\S]{0,200}$"></asp:RegularExpressionValidator><span>请输入GroupFlyTG团购地址</span>
