<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_CouponList_Audit"   CodeBehind="CouponList_Audit.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <td>
                            <asp:DropDownList ID="DropDownListSubstationID" Width="160" runat="server" CssClass="tselect">
                            </asp:DropDownList>
                            </td>
                            ...
                            <td>
                                <asp:TextBox ID="TextBoxShopName" CssClass="tinput" runat="server" Width="160"></asp:TextBox>
                            </td>
                            <td class="lmf_padding" align="right">
                                所属店铺：
                            </td>
                            <td>
                                <asp:TextBox ID="TextBoxShopID" CssClass="tinput" runat="server" Width="160"></asp:TextBox>
                            </td>
                            <td></td>
                        </tr>
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownListType" Width="160" runat="server" CssClass="tselect">
                                </asp:DropDownList>
                            </td>
                            <td class="lmf_padding" align="right">
                                审核状态：
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownListIsAudit" runat="server" Width="160" CssClass="tselect">
                                </asp:DropDownList>
                            </td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 7px; display:none;" >
                        <tr>
                            <td width="80" style="text-align: right; padding-right: 5px;">
                                开始时间：
                            </td>
                            <td width="350">
                                ...
                                <img id="img1" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px;
                                    position: relative; top: 4px" /><GroupFly:CalendarExtender ID="CalendarExtender1"
                                        runat="server" TargetControlID="TextBoxStartTime2" PopupButtonID="img1" CssClass="ajax__calendar" />
                            ...
                            <td width="280">
                                ...
                                <img id="img2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px;
                                    position: relative; top: 4px" /><GroupFly:CalendarExtender ID="CalendarExtender2"
                                        runat="server" TargetControlID="TextBoxEndTime1" PopupButtonID="img2" CssClass="ajax__calendar" />
                                ...
                                <img id="img3" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px;
                                    position: relative; top: 4px" /><GroupFly:CalendarExtender ID="CalendarExtender3"
                                        runat="server" TargetControlID="TextBoxEndTime2" PopupButtonID="img3" CssClass="ajax__calendar" />
                ...
                <td valign="top">
                    <asp:LinkButton ID="ButtonSearchShop" runat="server" CausesValidation="False" 
                        OnClientClick=" return EditButton() " CssClass="dele" OnClick="ButtonSearchShop_Click" Visible="false"   >
                    <span>查看</span></asp:LinkButton>


                </td>
                <td valign="top" >
                    <asp:LinkButton ID="ButtonOperate" runat="server"  OnClick="ButtonOperate_Click"
                        OnClientClick="return OperateButton()" CssClass="shtg lmf_btn"   >
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="优惠券名称" SortExpression="ShopName">
                        <ItemTemplate>
                            <a target="_blank" title='<%#Eval("CouponName") %>' href='<%# ShopUrlOperate.shopDetailHrefNew(Eval("Guid").ToString(),Eval("MemLoginID").ToString(),"Coupon") %>' title="<%#Eval("CouponName") %>">
                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("CouponName") %>'></asp:Label></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
