<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopNum1_ShopProductProp_List"   CodeBehind="ShopNum1_ShopProductProp_List.aspx.cs"      %>


<%@ Register Src="UserControl/MessageShow.ascx" TagName="MessageShow" TagPrefix="ShopNum1" %>
<%@ Import Namespace="System.Data" %>
<%@ Import Namespace="ShopNum1MultiEntity" %>
...
<body>
    ...
    <div id="right">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <input id="checkboxItem" value='<%#Eval("id")%>'
                                type="checkbox" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="属性名称">
                     ...
                     <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="属性值">
                        <ItemTemplate>
                           <p mode="wrap" style="width:600px;text-align: left; white-space: normal;"><%# Eval("propDetail")%></p>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetPropByProductCategory"
            TypeName="ShopNum1.BusinessLogic.ShopNum1_ShopProductProp_Action">
                <SelectParameters>
