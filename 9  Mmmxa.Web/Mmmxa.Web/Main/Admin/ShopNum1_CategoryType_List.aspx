<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopNum1_CategoryType_List"   CodeBehind="ShopNum1_CategoryType_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <td><asp:Label ID="LabelCategoryName" runat="server" Text="所属分类："></asp:Label></td>
                <td><asp:TextBox ID="TextBoxCategoryName" CssClass="tinput" Width="160" runat="server"></asp:TextBox></td>
                <td class="lmf_padding"><asp:Label ID="LabelName" runat="server" Text="类型名称："></asp:Label></td>
                <td><asp:TextBox ID="TextBoxName" CssClass="tinput" Width="160" runat="server"></asp:TextBox></td>
                <td class="lmf_padding"><asp:Label ID="LabelID" runat="server" Text="是否显示："></asp:Label></td>
                <td><asp:DropDownList ID="DropDownListIsShow" Width="100" runat="server" CssClass="tselect">
                    </asp:DropDownList></td>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td valign="top" >
                                <asp:LinkButton ID="ButtonAdd" runat="server" OnClick="ButtonAdd_Click" CausesValidation="False" class="tianjia2 lmf_btn"><span>添加</span></asp:LinkButton>
                            </td>
                        ...
                        Text="编辑" OnClientClick="return EditButton()" OnClick="ButtonEdit_Click" Visible="false" />
                                <asp:LinkButton ID="ButtonDelete" runat="server" OnClick="ButtonDelete_Click" OnClientClick="return DeleteButton()" CausesValidation="False" class="shanchu lmf_btn"><span>批量删除</span></asp:LinkButton>
                             </td>
                            <td valign="top" class="lmf_app">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ShopNum1_CategoryType_Operate.aspx?guid="+Eval("ID")+"" %>" style="color: #4482b4;">编辑</a>
