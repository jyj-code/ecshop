<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopDoMainChecked_List"   CodeBehind="ShopDoMainChecked_List.aspx.cs"      %>
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height: 35px; vertical-align: top;">
                            <td>
                                <asp:Label ID="Label5" runat="server" Text="分站名称："></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tselect" Style="width: 201px;">
                                </asp:DropDownList>
                            </td>
