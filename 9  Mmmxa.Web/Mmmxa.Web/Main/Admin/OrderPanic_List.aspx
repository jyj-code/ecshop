<%@ page language="C#" autoeventwireup="true" inherits="Admin_OrderPanic_List"   CodeBehind="OrderPanic_List.aspx.cs"      %>
...
$(function(){
        $("#sk_go").click(function(){
                ...
                location.href="OrderPanic_List.aspx?fz="+sFz+"&trdeid="+tradeid+"&orid="+orid+"&mid="+mid+"&ct="+ct+"&et="+et+"&sp1="+sp1+"&sp2="+sp2+"&shopid="+shopid+"&sn="+escape(shopname)+"&pageid=1";
        });
});
    </script>
</head>
