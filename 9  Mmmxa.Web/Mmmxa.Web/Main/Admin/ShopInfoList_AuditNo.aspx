<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopInfoList_AuditNo"   CodeBehind="ShopInfoList_AuditNo.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <AlternatingRowStyle BackColor="White" />
                 ...
                 <asp:TemplateField HeaderText="操作" SortExpression="IsShow">
                        <ItemTemplate>
 		                <a href="<%# "ShopInfo_AuditOperate.aspx?guid="+"'"+Eval("Guid")+"'&GoBack=nosh"%>" style="color: #4482b4;">
                                查看</a>
