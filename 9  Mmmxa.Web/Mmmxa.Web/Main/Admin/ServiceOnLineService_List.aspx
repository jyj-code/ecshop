<%@ page language="C#" autoeventwireup="true" inherits="Service_ServiceOnLineService_List, ShopNum1.Deploy" %>
            ...
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td>此处的客服为全国站的客服信息，不包含分站，分站信息由分站独立管理</td>
                    </tr>
                </table>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ServiceOnLineService_Operate.aspx?guid="+"'"+Eval("Guid")+"'" %>" style="color: #4482b4;">
                                编辑</a>
