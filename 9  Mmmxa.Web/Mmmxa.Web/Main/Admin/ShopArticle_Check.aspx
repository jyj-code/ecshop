<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopArticleCheck"   CodeBehind="ShopArticleCheck.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tinput" Width="200">
                        ...
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <tr>
                            <td><asp:TextBox ID="textBoxStartDate" runat="server" CssClass="tinput" Style="width: 58px;"></asp:TextBox></td>
                            <td style=" vertical-align:top; padding-left:4px;"><img id="imgCalendarSReplyTime1" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top: 3px" /></td>
                            <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorStartDate" runat="server"
                            ...
                            <td><GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="textBoxStartDate"
                                    PopupButtonID="imgCalendarSReplyTime1" CssClass="ajax__calendar" /></td>
                            <td class="lmf_px">-</td>
                            <td><asp:TextBox ID="textBoxEndDate" runat="server" CssClass="tinput" Style="width: 58px;"></asp:TextBox></td>
                            <td style=" vertical-align:top; padding-left:4px;"><img id="imgCalendarSReplyTime2" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top: 3px" /></td>
                            <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorStartDate0" runat="server"
                                    ControlToValidate="textBoxEndDate" Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                            <td><GroupFly:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="textBoxEndDate"
                ...
                <td valign="top" class="lmf_app">
                    <asp:LinkButton ID="ButtonDelete" runat="server" CausesValidation="False" 
                        OnClientClick="return DeleteButton()" OnClick="ButtonDelete_Click" CssClass="shanchu lmf_btn"  >
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分站名称" SortExpression="SubstationID">
                                    <ItemTemplate>
                                        <%#GetSubstationIDNameBySubstationID(Eval("SubstationID").ToString())%>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="100px"/>
                                </asp:TemplateField>
                    <asp:TemplateField HeaderText="资讯标题" SortExpression="Title">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.shopDetailHrefNew(Eval("Guid").ToString(),Eval("MemLoginID").ToString(),"NewsDetail") %>'
                                target="_blank">
                    ...
                    <asp:TemplateField HeaderText="发布人" SortExpression="MemLoginID">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.shopHrefNew(Eval("MemLoginID").ToString()) %>' target="_blank">
                    ...
                    <asp:TemplateField HeaderText="审核状态" SortExpression="MemLoginID">
                      ...
                      <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ShopArticle_Details.aspx?guid='"+Eval("Guid")+"'&type=check" %>" style="color: #4482b4;">
                                查看</a>
