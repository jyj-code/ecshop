<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopAuditFailedReason"   CodeBehind="ShopAuditFailedReason.aspx.cs"      %>
...
<div style=" padding:20px;">
    ...
    <div class="inner_page_list">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="TextBoxShopAuditFailedReason" CssClass="tinput" Width="490" runat="server" TextMode="MultiLine" Height="190"></asp:TextBox>
                    ...
                    <div style="text-align: center; margin-top: 12px;">
                        <asp:Button ID="ButtonConfirm" runat="server" Text="确定"
                            ToolTip="Submit" CssClass="dele" OnClick="ButtonConfirm_Click"/>
    ...
    <asp:Panel ID="PanelShowMsg" runat="server"  Visible="false">
     <div style=" width:100%; height:100; margin-top:60px; text-align:center;">操作成功！</div>
    </asp:Panel>            
            </div>
