<%@ page language="C#" autoeventwireup="true" inherits="Admin_Member_Operate"   CodeBehind="Member_Operate.aspx.cs"      %>
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                        ...
                        <td valign="middle">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorMemLoginID" runat="server"
                               ...
                               <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                ControlToValidate="TextBoxMemLoginID" Display="Dynamic" ErrorMessage="会员ID为长度为2-20位由英文字母,汉字和数字组成的字符串"
                                ValidationExpression="^[\s\S]{2,20}$"></asp:RegularExpressionValidator>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxMobile" runat="server" CssClass="tinput"  onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="11"></asp:TextBox>
                            ...
                            <asp:Button ID="ButtonCheckMobile" runat="server" OnClick="ButtonCheckMobile_Click" Text="检测手机号码"
                              CssClass="selpic" CausesValidation="False" />
                        </td>
                    </tr>
                      <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxPwd2" runat="server" CssClass="tinput" TextMode="Password" onblur="emptyPwdCheck()"></asp:TextBox>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelPayPwd2" runat="server" Text="支付密码确认："></asp:Label>
                        </th>
                        <td>
                            <asp:TextBox ID="TextBoxPayPwd2" runat="server" CssClass="tinput" TextMode="Password"  ></asp:TextBox>
                            <asp:Label ID="Label11" runat="server" Text="填写后两次支付密码后，保存支付密码"></asp:Label>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidatorPayPwd2" runat="server"
                              ...
                              <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToCompare="TextBoxPayPwd"
                                ControlToValidate="TextBoxPayPwd2" ErrorMessage="支付密码不一致" Display="Dynamic"></asp:CompareValidator>
                        </td>
                    </tr>
