<%@ page language="C#" autoeventwireup="true" inherits="Admin_OrderPanic_Operate"   CodeBehind="OrderPanic_Operate.aspx.cs"      %>
                        ...
                        <div class="ftotle">
                            ...
                            <b>
                                <asp:Label ID="LabelSurplusPriceValue" runat="server"></asp:Label></b> -<asp:Label
                                    ID="LabelScorePrice" runat="server" Text="使用积分(积分抵用的金额)："></asp:Label>
                            <b>
