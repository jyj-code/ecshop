<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopNum1_SupplyDemandCategory_List"   CodeBehind="ShopNum1_SupplyDemandCategory_List.aspx.cs"      %>
                ...
                <div class=" fl">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="ButtonDelete" runat="server" OnClientClick="return EditButton()"
                                    OnClick="ButtonDelete_Click" CausesValidation="False" class="shanchu lmf_btn"><span>单个删除</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
