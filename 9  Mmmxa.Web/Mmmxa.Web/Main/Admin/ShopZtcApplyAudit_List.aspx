<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopZtcApplyAudit_List"   CodeBehind="ShopZtcApplyAudit_List.aspx.cs"      %>
                       ...
                       <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <GroupFly:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="TextBoxTime1"
                                        ...
                                        <td>
                                            <GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBoxTime2"
                ...
                <div class="sbtn">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td>
                                下面的数据为所有发布到全国站平台的直通车信息，分站直通车不归此处管理。
                            </td>
                        </tr>
                    </table>
