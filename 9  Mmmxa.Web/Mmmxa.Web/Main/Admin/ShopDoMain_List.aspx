<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopDoMain_List"   CodeBehind="ShopDoMain_List.aspx.cs"      %>
            ...
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr style="height: 35px; vertical-align: top;">
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="分站名称："></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tselect" Width="230">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;&nbsp;&nbsp;</td>
                        <td>
            ...
            <shopnum1:num1gridview id="num1GridViewShow" runat="server" autogeneratecolumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="域名" SortExpression="DoMain">
                        <ItemTemplate>
                            <a href='<%# "http://"+ Eval("DoMain") %><%#Eval("GoUrl").ToString().Substring(Eval("GoUrl").ToString().IndexOf('.'))%>' target="_blank">
