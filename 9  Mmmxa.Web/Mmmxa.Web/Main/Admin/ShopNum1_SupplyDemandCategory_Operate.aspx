<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopNum1_SupplyDemandCategory_Operate"   CodeBehind="ShopNum1_SupplyDemandCategory_Operate.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelTitle" runat="server" Text="添加供求分类"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                    <th align="right" width="150px">
                            ...
                            <asp:Localize ID="Localize1" runat="server" Text="供求分类名称："></asp:Localize>
                    ...
                    <td valign="middle">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidatorName" runat="server"
                                ControlToValidate="TextBoxName" Display="Dynamic" ErrorMessage="供求分类名称最多50个字符"
                ...
                <tr>
                    <th align="right">
                            <asp:Localize ID="Localize2" runat="server" Text="供求分类关键字："></asp:Localize>
                    </th>
                    <td>
                        
                            <asp:TextBox ID="TextBoxKeywords" runat="server" CssClass="tinput"></asp:TextBox><span> 供求分类设置的关键字，利于SEO优化。</span>
                ...
                <tr>
                    <th align="right">
                            ...
                            <asp:Localize ID="Localize4" runat="server" Text="供求分类排序："></asp:Localize>
                    ...
                    <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidatorRepertoryOrderID" runat="server"
                                ControlToValidate="TextBoxOrderID" ErrorMessage="请输入数字" ValidationExpression="^[0-9]*$"
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:CheckBox ID="CheckBoxIsShow" runat="server" Checked="True" Text="是" /><span>供求分类是否在前台显示。</span>
                        
                    </td>
                </tr>
                <tr>
                    <th align="right">
                            <asp:Localize ID="Localize3" runat="server" Text="供求分类描述："></asp:Localize>
                    ...
                    <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidatorDescription" runat="server"
                                ControlToValidate="TextBoxDescription" Display="Dynamic" ErrorMessage="供求分类描述最多200个字符"
                                ValidationExpression="^[\s\S]{0,200}$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
            </table>
