<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_OrdeComplaintsOperate"   CodeBehind="OrdeComplaintsOperate.aspx.cs"      %>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="shoptd" style="height: 130px;">
                                <asp:TextBox ID="TextBoxProcessingResult" CssClass="tinput txtarea" runat="server" Height="100"
                                    Width="500" TextMode="MultiLine"></asp:TextBox>
                                <asp:Label ID="Label8" runat="server" ForeColor="Red" Text="*"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorResult" runat="server"
                                    ControlToValidate="TextBoxProcessingResult"
