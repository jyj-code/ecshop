<%@ page language="C#" autoeventwireup="true" inherits="Service_ServiceAdmin_ServiceMessageBoard_List, ShopNum1.Deploy" %>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 4px; vertical-align: top;">
                                        <img id="imgCalendarSReplyTime1" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                                            height: 18px; position: relative; top: 4px" /><asp:RegularExpressionValidator ID="RegularExpressionValidatorTextBoxSendTime1"
                                    ...
                                    <td>
                                        <GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBoxSendTime1"
                                    ...
                                    <td style="padding-left: 4px; vertical-align: top;">
                                        <img id="imgCalendarSReplyTime2" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                                            height: 18px; position: relative; top: 4px" /><asp:RegularExpressionValidator ID="RegularExpressionValidatorTextBoxSendTime2"
                                                runat="server" ControlToValidate="TextBoxSendTime2" Display="Dynamic" ErrorMessage="时间格式不正确"
                                                ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator>
                                    </td>
                                    <td>
                                        <GroupFly:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TextBoxSendTime2"
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" Width="98%" AddSequenceColumn="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ShopNum1MessageBoard_Operate.aspx?Guid="+"'"+Eval("Guid")+"'" %>" style="color: #4482b4;">
                                查看</a>
