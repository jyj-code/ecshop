<%@ page language="C#" autoeventwireup="true" inherits="Admin_AttachMentCateGory_List"   CodeBehind="AttachMentCateGory_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <asp:Button ID="ButtonEdit" runat="server" OnClientClick="return EditButton()" Text="编辑"
                    CssClass="fanh" OnClick="ButtonEdit_Click" Visible="false" />
