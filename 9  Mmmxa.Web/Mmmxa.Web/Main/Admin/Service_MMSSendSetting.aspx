<%@ page language="C#" autoeventwireup="true" inherits="Admin_Service_MMSSendSetting"   CodeBehind="Service_MMSSendSetting.aspx.cs"      enableviewstate="true" %>
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                    <th align="right" width="180px;">
                       ...
                       <asp:Label ID="LabelPayIsMMS" runat="server" Text="付款时是否给卖家发送短信："></asp:Label>
                ...
                <tr>
                    <th align="right">
                         ...
                         <asp:Label ID="LabelShipmentOKIsMMS" runat="server" Text="确认收货时是否给卖家发送短信："></asp:Label>
                    </th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                           ...
                           <asp:DropDownList ID="DropDownListOrderToShopIsMMS" runat="server" Width ="220px"  CssClass="tselect">
                            <asp:ListItem Value="0">不发送短信</asp:ListItem>
                            <asp:ListItem Value="1">发送短信</asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr>
                    <th align="right">
                          ...
                          <asp:Label ID="LabelCancelOrderIsMMS" runat="server" Text="取消订单时是否给商家发送短信："></asp:Label>
                        
                    </th>
                    <td>
                       
                         <asp:DropDownList ID="DropDownListCancelOrderIsMMS" runat="server" Width="220px"  CssClass="tselect">
                            <asp:ListItem Value="0">不发送短信</asp:ListItem>
                            <asp:ListItem Value="1">发送短信</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                           ...
                           <asp:DropDownList ID="DropDownListRegistOrderIsMMS" runat="server" Width="220px"  CssClass="tselect">
                            <asp:ListItem Value="0">不发送短信</asp:ListItem>
                            <asp:ListItem Value="1">发送短信</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                         ...
                         <asp:DropDownList ID="DropDownListApplyOpenShopIsMMS" runat="server" Width="220px" CssClass="tselect">
                            <asp:ListItem Value="0">不发送短信</asp:ListItem>
                            <asp:ListItem Value="1">发送短信</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownListAuditOpenShopIsMMS" runat="server" Width="220px"  CssClass="tselect">
                            <asp:ListItem Value="0">不发送短信</asp:ListItem>
                            <asp:ListItem Value="1">发送短信</asp:ListItem>
                        </asp:DropDownList>
                    </td>
