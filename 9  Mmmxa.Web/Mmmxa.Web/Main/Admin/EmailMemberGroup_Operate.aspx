<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_EmailMemberGroup_Operate"   CodeBehind="EmailMemberGroup_Operate.aspx.cs"      %>
           ...
           <div class="mhead">
            <div class="ml">
                <div class="mr"  id="header" >
                    <ul class="mul">
                        <li >
                            <a   class="cur"  id="current1"     style="cursor: pointer;" onclick="change_option(2,1)">
                    <asp:Label runat="server" ID="Label6" Text="会员组添加" /></a>
                        ...
                        <li >
                            <a id="current2" style="cursor: pointer;" onclick="change_option(2,2);">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidatorName" runat="server"
                            ControlToValidate="TextBoxName" Display="Dynamic" ErrorMessage="会员组名称最多50个字符" ValidationExpression="^[\s\S]{0,50}$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <th align="right">
                    ...
                    <td>
                             <asp:TextBox ID="TextBoxDescription" runat="server" CssClass="tinput" Height="60px" TextMode="MultiLine"
        ...
        <div id="content2" runat="server" style="display: none; font-size: 14px;">
            ...
            <div class="tablebtn">
               ...
               <asp:Button ID="Button3" runat="server" CssClass="fanh" CausesValidation="false"
                    PostBackUrl="~/Main/Admin/EmailMemberGroup_List.aspx" Text="返回列表" />
