<%@ page language="C#" autoeventwireup="true" inherits="Admin_Service_EmailSendSetting"   CodeBehind="Service_EmailSendSetting.aspx.cs"      enableviewstate="true" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="shoptable">
                <tr>
                    <th align="right" width="260px">
                        <div class="shopth">
                            <asp:Label ID="LabelPayIsEmail" runat="server" Text="付款时是否给卖家发送邮件："></asp:Label>
                        </div>
                    </th>
                    <td>
                        <div class="shoptd">
                ...
                <tr>
                    <th align="right">
                        <div class="shopth">
                            <asp:Label ID="LabelShipmentOKIsEmail" runat="server" Text="确认收货时是否给卖家发送邮件："></asp:Label>
                        </div>
                    </th>
                    <td>
                        <div class="shoptd">
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd">
                            <asp:DropDownList ID="DropDownListOrderToShopIsEmail" runat="server" Width="180px" CssClass="tselect">
                                <asp:ListItem Value="0">不发送邮件</asp:ListItem>
                                <asp:ListItem Value="1">发送邮件</asp:ListItem>
                            </asp:DropDownList>
                           <%-- <span>请选择</span>--%>
