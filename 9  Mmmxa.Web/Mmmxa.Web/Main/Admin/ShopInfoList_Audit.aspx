<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopInfoList_Audit"   CodeBehind="ShopInfoList_Audit.aspx.cs"      %>
...
<body >
            ...
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tinput" Width="120">
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxShopName" CssClass="tinput" runat="server" Width="120"></asp:TextBox>
                        </td>
                         <td class="lmf_padding" align="left">
                            会员ID：
                        </td>
                        <td>
                            <asp:TextBox ID="TextBoxMemberName" CssClass="tinput" runat="server" Width="120"></asp:TextBox>
                        </td>
                        <td class="lmf_padding">
                            店铺类型：
                        </td>
                        <td>
                            <asp:DropDownList ID="DropDownListShopType" runat="server" CssClass="tinput" Width="120">
                            <asp:ListItem Text="-请选择-" Value="-1"></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="ButtonDelete" runat="server" CausesValidation="False" OnClientClick="return DeleteOneButton()"
                                    CssClass="shanchu lmf_btn" OnClick="ButtonDelete_Click"><span>单个删除</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
                ...
                <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="店铺名称" SortExpression="ShopName">
                                    <ItemTemplate>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Bind("ShopName") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center"/>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField HeaderText="申请时间" DataField="ApplyTime" SortExpression="ApplyTime" ItemStyle-HorizontalAlign="Center"/>
                                    <asp:BoundField HeaderText="排序号" DataField="OrderID" SortExpression="OrderID" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource" runat="server" SelectMethod="Search2"
