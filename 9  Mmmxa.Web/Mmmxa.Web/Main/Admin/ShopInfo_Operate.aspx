<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopInfo_Operate"   CodeBehind="ShopInfo_Operate.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        ...
        <div style="text-align:right"><span style="color:red;">注意：以下用* 标识的数据都是可更改的。&nbsp;&nbsp;&nbsp;</span></div>
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:TextBox ID="TextBoxSubstationID" CssClass="tinput" runat="server" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th align="right" width="150px">
                    ...
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:TextBox ID="TextBoxName" CssClass="tinput" runat="server" ReadOnly="true"></asp:TextBox>
                            <span></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxShopCategory" CssClass="tinput" runat="server" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxShopID" CssClass="tinput" runat="server" ReadOnly="true"></asp:TextBox>
                            <span></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="请填写正确的手机号"
                                Display="Dynamic" ControlToValidate="TextBoxPhone" ValidationExpression="^(1[3|5|8][0-9])\d{8}$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxIdentityCard" CssClass="tinput" runat="server" ReadOnly="true"></asp:TextBox>
                            <span></span>
                        </td>
                    </tr>
                    <tr style=" display:none">
                    ...
                    <tr style=" display:none">
                        ...
                        <td valign="middle">
                            <asp:DropDownList ID="DropDownListIsExpires" runat="server" CssClass="tselect" Style="width: 100px;
                                margin-top: 5px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListIsClose" runat="server" CssClass="tselect" Style="width: 100px;
                                margin-top: 5px;">
                                <asp:ListItem Value="-1">-请选择-</asp:ListItem>
                                <asp:ListItem Value="0">否</asp:ListItem>
                                <asp:ListItem Value="1">是</asp:ListItem>
