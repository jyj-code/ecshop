<%@ page language="C#" autoeventwireup="true" inherits="Admin_AdvancePaymentAlterOperate"   CodeBehind="AdvancePaymentAlterOperate.aspx.cs"      %>
...
<body class="widthah">
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            ...
            <div class="order_edit" style="margin-bottom:1px; display:none;" >
                <div>
                        ...
                        <td>
                            ...
                            <td>
                                <asp:DropDownList ID="DropdownListSOperateType" runat="server" Width="201px" CssClass="tselect">
                                    ...
                                    <asp:ListItem Value="0">后台提取</asp:ListItem>
                                    <asp:ListItem Value="1">后台充值</asp:ListItem>
                                    <asp:ListItem Value="2">会员自助提取</asp:ListItem>
                            ...
                            <td><asp:TextBox ID="TextBoxSDate1" runat="server" CssClass="tinput" Width="100"></asp:TextBox></td>
                            <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarCreateTime1" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; top:3px; position:relative;" /></td>
                            <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorTextBoxSDate1" runat="server"
                                    ControlToValidate="TextBoxSDate1" Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^\d{4}-(\d{2}|\d{1})-(\d{2}|\d{1})( (\d{2}|\d{1}):(\d{2}|\d{1}):(\d{2}|\d{1}))*"></asp:RegularExpressionValidator></td>
                            ...
                            <td class="lmf_px">-</td>
                            <td><asp:TextBox ID="TextBoxSDate2" runat="server" CssClass="tinput" Width="100"></asp:TextBox></td>
                            <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarCreateTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;top:3px; position:relative;"></td>
                            <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorTextBoxSDate2" runat="server"
                                    ControlToValidate="TextBoxSDate2" Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^\d{4}-(\d{2}|\d{1})-(\d{2}|\d{1})( (\d{2}|\d{1}):(\d{2}|\d{1}):(\d{2}|\d{1}))*"></asp:RegularExpressionValidator></td>
                            <td> <asp:CompareValidator ID="CompareValidatorTextBoxSDate2" runat="server" ErrorMessage="开始时间应当大于结束时间"
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr class="radiobtn">
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DropDownListOperateType" runat="server" CssClass="tselect" Width="230">
                                <asp:ListItem Value="1">充值</asp:ListItem>
                                <asp:ListItem Value="0">提取</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
