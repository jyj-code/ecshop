<%@ page language="C#" autoeventwireup="true" inherits="Admin_SubstationShopReport"   CodeBehind="SubstationShopReport.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SumShop" HeaderText="分站店铺数量" SortExpression="SumShop">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                </Columns>
            </ShopNum1:Num1GridView>
        </div>
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="GetSubstationSumShopData"
