<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_addpic"   CodeBehind="addpic.aspx.cs"      %>
        ...
        <div style=" padding:20px;">
                <table border="0" cellpadding="0" cellspacing="0" class="shoptable" width="100%">
                    <tr>
                        ...
                        <td>
                            <div class="shoptd">
                               <asp:DropDownList ID="DropDownListImageType" runat="server" CssClass="tselect" AutoPostBack="true"></asp:DropDownList>
                                <font color="red"> *</font>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="shoptd">
                               <asp:TextBox ID="textBoxName" runat="server" CssClass="tinput" MaxLength="50" Style="width: 195px;"></asp:TextBox><font color="red">*</font>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th align="right">
                            <div class="shopth" style="height: 120px; line-height: 120px;">上传图片：</div>
                        </th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="shoptd">
                                <asp:CheckBoxList ID="CheckBoxListImageSpec" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" Enabled="true">
                                </asp:CheckBoxList>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bottomLine" style="padding: 15px 0;">
                                <asp:Button ID="btnConfirm" ValidationGroup="addImage" runat="server" Text="确定" OnClick="btnConfirm_Click" CssClass="fanh" />
