<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_EmailSetting"   CodeBehind="EmailSetting.aspx.cs"      %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
      ...
      $(function(){
          $.get(ajaxurl,null,function(data){alert(data);
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    <tr class="radiobtn">
                        ...
                        </asp:DropDownList><span>必须选择邮件发送方式</span></td>
                    </tr>
                   <tr class="radiobtn">
                        <th align="right" width="150px">
                            <asp:Localize ID="Localize2" runat="server" Text="SMTP服务器："></asp:Localize>
                        </th>
                        <td valign="middle"><asp:TextBox ID="txtSmtpServer" runat="server" CssClass="tinput" Width="200px"></asp:TextBox><span>SMTP服务器不能为空</span></td>
                    </tr>
                    <tr class="radiobtn">
                        <th align="right" width="150px">
                            <asp:Localize ID="LocalizeEmailServer" runat="server" Text="SMTP服务器端口："></asp:Localize>
                        </th>
                        <td valign="middle"><asp:TextBox ID="TextBoxServerPort" runat="server" CssClass="tinput" Width="200px"></asp:TextBox><span>SMTP服务器端口不能为空</span></td>
                    </tr>
                    <tr>
                        <th align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxEmailAddress" runat="server" ValidationGroup="EmailAddress"  CssClass="tinput" Width="200px"></asp:TextBox>
