<%@ page language="C#" autoeventwireup="true" inherits="Admin_CityPaymentApplyLog_List"   CodeBehind="CityPaymentApplyLog_List.aspx.cs"      %>
...
<body class="widthah">
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxOrderNumber" runat="server" CssClass="tinput" Width="120px"></asp:TextBox>
                        </td>
                        <td class="lmf_padding">
                            <asp:Label ID="LabelSMemLoginID" runat="server" Text="管理员账号："></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TextBoxSMemLoginID" runat="server" CssClass="tinput" Width="120px"></asp:TextBox>
                        </td>
                        <td class="lmf_padding">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="MemLoginID" HeaderText="分站管理员账号" SortExpression="MemLoginID">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="OperateMoney" HeaderText="提现金额" SortExpression="OperateMoney">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    ...
                    <asp:TemplateField HeaderText="审核" SortExpression="IsShow">
                        <ItemTemplate>
                            <a href="<%# "CityPaymentMemApplyLog_Operate.aspx?guid="+Eval("Guid")+"&Type=0" %>"
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="Search"
            TypeName="ShopNum1.BusinessLogic.ShopNum1_AgentPaymentApplyLog_Action">
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="TextBoxSDate2" Name="endtime" PropertyName="Text"
                    Type="String" />
                <asp:Parameter Name="SubstationID" Type="String" DefaultValue="-1" />
            </SelectParameters>
