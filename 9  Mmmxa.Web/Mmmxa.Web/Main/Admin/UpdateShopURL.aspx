<%@ page language="C#" autoeventwireup="true" inherits="Admin_UpdateShopURL"   CodeBehind="UpdateShopURL.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            ...
            <div class="tablebtn" onmouseover="funCheckShopUrl()">
                 <asp:Button ID="ButtonUpdata" runat="server" ValidationGroup="shopurl" Text="确定" CssClass="fanh"
                            onclick="ButtonUpdata_Click" OnClientClick="return HideBtn(this)"/> <img class="append_image" alt="正在加载请稍等候" src="/Main/Themes/Skin_Default/Images/lodding.gif" style="display:none;" /><%-- --%>
