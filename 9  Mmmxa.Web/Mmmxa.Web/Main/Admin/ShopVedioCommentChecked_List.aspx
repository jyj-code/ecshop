<%@ page language="C#" autoeventwireup="true" inherits="Main_MainAdmin_VedioCommentChecked_List, ShopNum1.Deploy" %>
            ...
            <div class="order_edit">
                <table style="width: 100%">
                    <tr style="height:30px;">
                        <td style="text-align:right; ">分站名称：</td>
                        <td><asp:DropDownList ID="DropDownListSubstationID" runat="server" Width="220" CssClass="tselect">
                            </asp:DropDownList></td>
                        <td style="text-align:right;  display:none">
                            <asp:Label ID="LabelSTitle" runat="server" Text="评论标题："></asp:Label>
                        </td>
                        <td style=" display:none">
                            <asp:TextBox ID="TextBoxSTitle" CssClass="tinput" runat="server" Width="220"></asp:TextBox>
                        </td>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DropDownListSIsReply" Visible="false" runat="server" Width="220">
                            </asp:DropDownList>
                        </td>
