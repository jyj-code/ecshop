<%@ page language="C#" autoeventwireup="true" inherits="Admin_Order_List"   CodeBehind="Order_List.aspx.cs"      %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src='js/resolution-test.js'></script>
         <style type="text/css">
    #CalendarExtender1_popupDiv{ height:200px;}
    #CalendarExtender2_popupDiv{ height:200px;}
    </style>
...
$(function(){
        $("#sk_go").click(function(){
                ...
                var sp1=$("#txtSp1").val();
                var sp2=$("#txtSp2").val();
                var sFz=$("#DropDownListSubstationID").find("option:selected").val();
                 var sstyle=$("#hidstyle").val();
                var sstatus=$("#hidstatus").val();
                if(sstatus!="")
                {
                    location.href="?fz="+sFz+"&style="+sstyle+"&status="+sstatus+"&trdeid="+tradeid+"&orid="+orid+"&mid="+mid+"&ct="+ct+"&et="+et+"&sp1="+sp1+"&sp2="+sp2+"&shopid="+shopid+"&sn="+escape(shopname)+"&pageid=1";
                }
                else
                   location.href="?fz="+sFz+"&trdeid="+tradeid+"&orid="+orid+"&mid="+mid+"&ct="+ct+"&et="+et+"&sp1="+sp1+"&sp2="+sp2+"&shopid="+shopid+"&sn="+escape(shopname)+"&pageid=1";
        });
});
    </script>
</head>
<body class="widthah"><input type="hidden" id="hidstyle" value='<%=ShopNum1.Common.Common.ReqStr("style") %>' />
<input type="hidden" id="hidstatus" value='<%=ShopNum1.Common.Common.ReqStr("status") %>' />
    ...
    <div id="right">
            ...
            <div class="ml">
                <div class="mr">
                    <ul class="mul">
                        ...
                        <li id="current3">
                            <asp:LinkButton ID="LinkButtonPayment" runat="server" OnClick="LinkButtonPayment_Click">已付款未发货</asp:LinkButton>
                        </li>
                        <li id="current4">
                        ...
                        <li id="current6">
                            <asp:LinkButton ID="LinkButtonRefund" runat="server" OnClick="LinkButtonRefund_Click">已退货</asp:LinkButton>
                        </li>
                        <li id="current7">
                            <asp:LinkButton ID="LinkButtonReturnGoods" runat="server" OnClick="LinkButtonReturnGoods_Click">已退款</asp:LinkButton>
                        </li>
                        <li id="current8">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <input type="text" id="txtOrderNumber" onkeyup="NumTxt_Int(this)" class="tinput" style="width:200px;" value='<%=ShopNum1.Common.Common.ReqStr("orid") %>' />
                        </td>
                    ...
                    <tr>
                        <td>分站ID：</td>
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tselect"
                                Style="width: 207px;">
                            </asp:DropDownList>
                        </td>
                           <td style="text-align: right;">
                        ...
                        <td>
                             <input type="text" id="txtTradeId" class="dinput dp" onkeyup="NumTxt_Int(this)"  style="width:200px;"  value='<%=ShopNum1.Common.Common.ReqStr("trdeid") %>' />
                        </td>
                            <td style="text-align:right;">
                    ...
                    <tr>
                        <td colspan="6">(友情提示：如果多个订单通过支付宝第三方支付一起支付的,在支付宝显示的是交易号。)</td>
                    </tr>
                </table>
                <div class="sbtn">
                ...
                <td valign="top" class="lmf_app">
                    <asp:LinkButton ID="ButtonReportx" runat="server" OnClick="ButtonReportx_Click" OnClientClick="return ImportData(true);"  CausesValidation="False" CssClass="daochubtn lmf_btn"><span>导出全部订单</span></asp:LinkButton>
                </td>
            ...
            <table cellspacing="0" cellpadding="4" border="0" id="Table1" rules="cols" class="gridview_m">
                 ...
                 <th scope="col">分站名称</th><th scope="col">订单号</th><th scope="col">店铺名称</th>
                 <th scope="col">下单时间</th><th scope="col">订单总额</th><th scope="col">买家会员名</th><th scope="col">收货人</th>
                 <th scope="col">状态</th><th scope="col">退款/退货状态</th><th scope="col">商品类型</th>  <th scope="col">操作</th>
          </tr>
          </thead>
          <tbody>
                     ...
                     for (int i = 0; i < dt_OrderList.Rows.Count; i++)
                     {
                         ...
                         %>
                            <tr style="cursor:default;" onmouseout="Num1GridViewShow_mout(this)" onmouseover="Num1GridViewShow_mover(this)">
                                ...
                                <td align="center" style="">
                                    <span id="Span11"><%=GetSubstationIDname(dr["SubstationID"].ToString())%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span1"><a href='Order_Operate.aspx?guid=<%=dr["guid"]%>'><%=dr["ordernumber"]%></a></span>
                                </td><td align="center" style="">
                                    <span id="Span3"><%=dr["ShopName"]%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span6"><%=dr["CreateTime"]%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span7"><%=dr["ShouldpayPrice"]%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span8"><%=dr["MemLoginID"]%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span9"><%=dr["Name"]%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span10"><%=ChangeOderStatus(dr["OderStatus"].ToString(), dr["feetype"].ToString())%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span13"><%=ChangeRefundStatus(dr["refundstatus"].ToString(), dr["paymentstatus"].ToString(), dr["OderStatus"].ToString())%></span>
                                </td>
                                <td align="center" style="">
                                    <span id="Span4"><%=GetOrderTypeImg(dr["OrderType"].ToString(), dr["feetype"].ToString())%></span>
                                </td>
                                <td align="center" style="">
                                      <a href="Order_Operate.aspx?guid=<%=dr["guid"] %>&Type=1" style="color: #4482b4;">查看</a>
                                      <%if (dr["Oderstatus"].ToString() == "3")
                                        { %>
                                        <a href="SetMemberScoreV82.aspx?guid=<%=dr["guid"] %>" style="color: #4482b4;">赠送积分</a>
                                      <%} %>
                                      <a style="color: #4482b4;display:none" href="?orid=<%=dr["ordernumber"] %>&jk"  onclick="return window.confirm('您确定要删除吗?');">删除</a>
                                </td>
		            </tr>
                     <%}
                     %>
		   ...
		   <td style="height:30px;" colspan="13"> 
		    <div class="btnlist" style="overflow:auto;" id="showPage" runat="server" visible="false">
		       <div class="fnum"> 每页显示数量：
		         <a href="?tradeid=<%=Request.QueryString["tradeid"] %>&orid=<%=Request.QueryString["orid"] %>&mid=<%=Request.QueryString["mid"] %>&ct=<%=Request.QueryString["ct"] %>&et=<%=Request.QueryString["et"] %>&sp1=<%=Request.QueryString["sp1"] %>&sp2=<%=Request.QueryString["sp2"] %>&shopid=<%=Request.QueryString["shopid"] %>&sn=<%=Request.QueryString["sn"] %>&pagesize=10" id="page10">10</a>
		         <a href="?tradeid=<%=Request.QueryString["tradeid"] %>&orid=<%=Request.QueryString["orid"] %>&mid=<%=Request.QueryString["mid"] %>&ct=<%=Request.QueryString["ct"] %>&et=<%=Request.QueryString["et"] %>&sp1=<%=Request.QueryString["sp1"] %>&sp2=<%=Request.QueryString["sp2"] %>&shopid=<%=Request.QueryString["shopid"] %>&sn=<%=Request.QueryString["sn"] %>&pagesize=20" id="page20">20</a>
		         <a href="?tradeid=<%=Request.QueryString["tradeid"] %>&orid=<%=Request.QueryString["orid"] %>&mid=<%=Request.QueryString["mid"] %>&ct=<%=Request.QueryString["ct"] %>&et=<%=Request.QueryString["et"] %>&sp1=<%=Request.QueryString["sp1"] %>&sp2=<%=Request.QueryString["sp2"] %>&shopid=<%=Request.QueryString["shopid"] %>&sn=<%=Request.QueryString["sn"] %>&pagesize=50" id="page50">50</a>
		       </div>
		                <div class="fpage" id="pageDiv" runat="server">  </div>
                        ...
                        function checknum(str)
                        {
                            ...
                            if (!re.test(str))
                            {
		                        ...
		                        $(function(){
		                                ...
		                                var  fz='<%=ShopNum1.Common.Common.ReqStr("fz") %>';
		                                 
		                                if(fz!="")
		                                { 
		                                    $("#DropDownListSubstationID").val(fz);
                 ...
                 { 
                    %>
                    <tr>
                     <td style="font-weight:bold; text-align:center" colspan="13">
