<%@ page language="C#" autoeventwireup="true" inherits="Admin_ArticleCategory_List"   CodeBehind="ArticleCategory_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="table1" style=" margin-bottom:20px;">
                 <asp:TreeView ID="TreeViewCategory" runat="server" ShowCheckBoxes="All" ShowLines="True" style="padding-left:20px;">
        ...
        <asp:Button ID="Button2" runat="server" OnClick="ButtonEdit_Click" Text="编辑"
            CausesValidation="False" CssClass="bji picbtn"/> 
              <asp:Button ID="ButtonDelete" runat="server" OnClick="ButtonDelete_Click" OnClientClick="return EditButton()"
            Text="单个删除" CausesValidation="False" CssClass="shanchu com" />
