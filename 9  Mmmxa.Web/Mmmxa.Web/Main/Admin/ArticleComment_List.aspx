<%@ page language="C#" autoeventwireup="true" inherits="Admin_ArticleComment_List"   CodeBehind="ArticleComment_List.aspx.cs"      %>
...
<body class="widthah">
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelPageTitle" runat="server" Text="主站平台文章评论"></asp:Label>
                </h3>
            </div>
            <div class="rr">
            </div>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <td class="lmf_padding">
                                <asp:Label ID="LabelSIsAudit1" runat="server" Text="评论文章："></asp:Label>
                            </td>
                            <td>
                ...
                <tr style="height:35px; vertical-align:top;">
                <td><asp:TextBox ID="TextBoxSSendTime1" runat="server" Width="72px" CssClass="dinput"></asp:TextBox></td>
                <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarSSendTime1" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                ...
                <td><ShopNum1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBoxSSendTime1"
                                    PopupButtonID="imgCalendarSSendTime1" CssClass="ajax__calendar" Format="yyyy-MM-dd">
                                </ShopNum1:CalendarExtender></td>
                                <td class="lmf_px">-</td>
                <td><asp:TextBox ID="TextBoxSSendTime2" runat="server" Width="72px" CssClass="dinput"></asp:TextBox></td>
                <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarSSendTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top:3px;" /></td>
                ...
                <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorSendTime2" runat="server"
                                    ...
                                    ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                <td><ShopNum1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TextBoxSSendTime2"
                 ...
                 <td class="lmf_padding">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                            <td><asp:TextBox ID="TextBoxSReplyTime1" runat="server" Width="72px" CssClass="dinput"></asp:TextBox></td>
                <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarSReplyTime1" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top: 3px;" /></td>
                <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorSReplyTime1" runat="server"
                                    ControlToValidate="TextBoxSReplyTime1" Display="Dynamic" ErrorMessage="时间格式不正确"
                                    ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                <td><ShopNum1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TextBoxSReplyTime1"
                                    PopupButtonID="imgCalendarSReplyTime1" CssClass="ajax__calendar" Format="yyyy-MM-dd">
                                </ShopNum1:CalendarExtender></td>
                <td class="lmf_px">-</td>
                <td><asp:TextBox ID="TextBoxSReplyTime2" runat="server" Width="72px" CssClass="dinput"></asp:TextBox></td>
                <td style="padding-left:4px; vertical-align:top;"><img id="imgCalendarSReplyTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top: 3px;" /></td>
                <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorSReplyTime2" runat="server"
                                    ControlToValidate="TextBoxSReplyTime2" Display="Dynamic" ErrorMessage="时间格式不正确"
                                    ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                <td><ShopNum1:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="TextBoxSReplyTime2"
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="评论文章" SortExpression="ArticleTitle">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.RetUrl("ArticleDetail",Eval("ArticleGuid").ToString()) %>'
                                target="_blank">
                                <%#Eval("ArticleTitle").ToString().Length > 16 ? Eval("ArticleTitle").ToString().Substring(0, 16) + "..." : Eval("ArticleTitle").ToString()%>
                                </a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
