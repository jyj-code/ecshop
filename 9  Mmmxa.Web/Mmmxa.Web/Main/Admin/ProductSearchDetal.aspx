<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ProductSearchDetal"   CodeBehind="ProductSearchDetal.aspx.cs"      %>
...
<body class="widthah">
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr style="display:none;">
                        ...
                        <td>
                            ...
                            <span>  <asp:Label ID="LabelPriceName" runat="server" Text="商品价"></asp:Label> </span>
            ...
            <div class="tablebtn">
                <asp:Button ID="ButtonAudit" runat="server" CssClass="fanh" Text="审核通过" OnClick="ButtonAudit_Click" ></asp:Button>&nbsp;&nbsp;&nbsp;
