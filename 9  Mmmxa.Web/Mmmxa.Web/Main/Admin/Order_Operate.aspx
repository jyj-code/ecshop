<%@ page language="C#" autoeventwireup="true" inherits="Admin_Order_Operate"   CodeBehind="Order_Operate.aspx.cs"      %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="style/css.css" />
      ...
      <script type="text/javascript" language="javascript">
            $(function(){
                    $(".ordertable td.remove").each(function(){
                            $(this).remove();
                    });
            });
      </script>
...
<body>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
                ...
                <tr align="center">
                  ...
                  <th scope="col" >
                   ...
                   <%-- <td align="center"  style=" display:none;">
                    ...
                    <td align="center"  scope="col"  rowspan='<%=RepeaterData.Items.Count%>'   class="<%#Container.ItemIndex==0?"block":"remove"%>">
                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("ShouldPayprice") %>'></asp:Label>
                    </td>
                    
                    <%--  <td align="center" style="display:none" class="remove">
            ...
            </table><asp:GridView ID="Num1GridViewShowOrderProduct" runat="server" AutoGenerateColumns="False"
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="ordertable2">
                ...
                <tr>
                    ...
                    <td valign=middle>
                        ...
                        <img id="imgRefund" runat="server" style="width:100px; height:100px;" visible="false" />
                    </td>
                    <th>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="ordertable2">
                ...
                <tr style="display:none;">
                    <th>
                        <asp:Label ID="LabelUseScore" runat="server" Text="使用的消费积分："></asp:Label>
                    </th>
                    <td colspan="3">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="ordertable2" style="display:none;">
                <tr>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; display: none;">
        <tr>
            <td colspan="4" style="width: 100%; background-color: #6699CC;">
