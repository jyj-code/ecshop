<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopCategoryAply_Audit"   CodeBehind="ShopCategoryAply_Audit.aspx.cs"      %>
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <tr>
                            <td><asp:TextBox ID="TextBoxStartTime" CssClass="tinput" Style="width: 58px;" runat="server"></asp:TextBox></td>
                            ...
                            <td class="lmf_px">-</td>
                            <td><asp:TextBox ID="TextBoxEndTime" CssClass="tinput" Style="width: 58px;" runat="server"></asp:TextBox></td>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="店铺名称" SortExpression="ShopName">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.shopHrefNew(Eval("ShopID").ToString()) %>' target="_blank">
                                <%# Eval("ShopName") %></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
