<%@ page language="C#" autoeventwireup="true" inherits="Service_ServiceAdmin_ServiceSite_Settings, ShopNum1.Deploy" enableviewstate="true" %>
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        <th align="right" width="150px">
                            <asp:Localize ID="Localize12" runat="server" Text="城市多用户模式："></asp:Localize>
                        </th>
                        <td valign="middle">
                            <asp:RadioButton ID="RadioButtonMain" Checked="true" runat="server" Text="主站模式" GroupName="main" />
                            <asp:RadioButton ID="RadioButtonCity" runat="server" Text="分站模式"  GroupName="main"/>
                            <span style="color:Red">主站模式：指拥有主站前台和城市分站前台；分站模式：指只有城市分站前台，没有主站前台。确定模式后，请勿随意更改。</span>
                        </td>
                    </tr>
                    <tr>
                        <th align="right" width="150px">
                            <asp:Localize ID="Localize13" runat="server" Text="主域名默认指向城市站点："></asp:Localize>
                        </th>
                        <td valign="middle">
                            <asp:TextBox ID="TextBoxDefaultMainCityUrl" runat="server" Text="http://" CssClass="tinput" Width="380px"></asp:TextBox>
                            <span style="color:Red">输入主域名后，默认指向的站点（分站模式下必填）。</span>
                        </td>
                    </tr>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PanelLogo" runat="server" Visible="false">
                    <tr>
                        <th align="right">
                        ...
                        <td>
                            ...
                            <input id="ButtonSelectSingleImage" type="button" value="选择图片" onclick="openSingleChild()"
                                class="selpic" />
                            <asp:Label ID="Label11" runat="server" Text="注意尺寸(建议尺寸329 x 72)"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="ButtonSelectMemberImage" type="button" value="选择图片" onclick="openSingleChild2()"
                                class="selpic" />
                            <asp:Label ID="Label7" runat="server" Text="注意尺寸(建议尺寸329 x 72)"></asp:Label>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <th align="right" valign="top">
                    ...
                    <asp:Panel ID="PanelRwm" runat="server" Visible="false">
                    <tr>
                        <th align="right" valign="top">
