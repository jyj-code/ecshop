<%@ page language="C#" autoeventwireup="true" inherits="Admin_LogisticsCompany_List"   CodeBehind="LogisticsCompany_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <td class="lmf_tiaojian">物流公司：</td>
                <td><asp:TextBox ID="textBoxName" MaxLength="100" runat="server" CssClass="tinput"></asp:TextBox></td>
                <td><asp:Button ID="ButtonSearch" runat="server" OnClick="ButtonSearch_Click" Text="查询" CssClass="dele" /></td>
                </tr>
                </table>
                <div class="sbtn">
                    <table cellpadding="0" cellspacing="0" border="0">
            ...
            <ShopNum1:Num1GridView ID="Num1GridiewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" SortExpression="IsShow">
                        <ItemTemplate>
                            <a href="<%# "LogisticsCompany_Operate.aspx?id="+Eval("ID") %>" class="dialog" style="color: #4482b4;">
                                编辑</a>
