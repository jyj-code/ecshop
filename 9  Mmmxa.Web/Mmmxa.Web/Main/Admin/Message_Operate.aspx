<%@ page language="C#" autoeventwireup="true" inherits="Admin_Message_Operate"   CodeBehind="Message_Operate.aspx.cs"      %>
           ...
           <div class="mhead">
            <div class="ml">
                <div class="mr"  id="header" >
                    ...
                    <asp:Label runat="server" ID="tab01" Text="消息内容" /></a>
                    ...
                    <asp:Label runat="server" ID="tab02" Text="发送对象" /></a>
