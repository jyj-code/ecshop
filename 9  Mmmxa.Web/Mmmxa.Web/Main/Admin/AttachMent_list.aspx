<%@ page language="C#" autoeventwireup="true" inherits="Admin_AttachMent_list"   CodeBehind="AttachMent_list.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <td><asp:Localize ID="LocalizeAssociatedCategoryGuid" runat="server" Text="附件类别："></asp:Localize></td>
                <td><asp:DropDownList ID="DropDownListAssociatedCategoryGuid" runat="server" Width="258px"
                        CssClass="tselect">
                    </asp:DropDownList></td>
                <td><asp:Button ID="Button1" CssClass="dele" runat="server" Text="查询" /></td>
                </tr>
                </table>
                <div class="sbtn">
