<%@ page language="C#" autoeventwireup="true" inherits="Main_MainAdmin_SupplyDemandComment_List, ShopNum1.Deploy" %>
...
<body class="widthah">
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelTitle" runat="server" Text="主站供求评论列表" />
                </h3>
            </div>
            <div class="rr">
            </div>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="评论内容">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.RetUrlNew("SupplyDemandDetail",Eval("SupplyDemandGuid")) %>'
                                target="_blank">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="GetSupplyDemandCommentAll1"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="TextBoxTime2" Name="createTime2" PropertyName="Text"
                    Type="String" />
                <asp:Parameter Type="String" DefaultValue="all" Name="SubstationID" />
            </SelectParameters>
