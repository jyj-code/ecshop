<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_Limit_Product"   CodeBehind="Limit_Product.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
		 ...
		 <thead><tr align="center" style="color:White;" class="list_header">
            ...
            <th scope="col" style="display:none;">商品状态</th>
           </thead>
          <tbody>
          <%if (dt_Lp != null)
            {
                for (int i = 0; i < dt_Lp.Rows.Count; i++)
                {
                   ...
                   <tr style="cursor:default;" onmouseout="Num1GridViewShow_mout(this)" onmouseover="Num1GridViewShow_mover(this)">
                    <td align="center"><a rel="<%=stroriginalImage%>" target="_blank" href="<%=ShopUrlOperate.shopHref(strGuid,strMemloginId)%>" title="<%=strName %>">
                        <img src="<%=strImg %>" style="width:50px; height:50px;" /></a></td>
                    <td align="center"><a rel="<%=stroriginalImage%>" target="_blank" href="<%=ShopUrlOperate.shopHref(strGuid,strMemloginId)%>" title="<%=strName %>"><%=strName%></a> </td>
                    <td align="center"><%=strPrice%></td>
            ...
            {%>
                     <tr><td colspan="5"><center>您还没有添加活动商品!</center></td></tr>
                  <%}%>
