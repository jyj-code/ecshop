<%@ page language="C#" autoeventwireup="true" inherits="Admin_ComplaintsManagement_List"   CodeBehind="ComplaintsManagement_List.aspx.cs"      %>
            ...
            <div class="welcon clearfix">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                                <tr style="height:35px; vertical-align:top;">
                                    ...
                                    <td class="lmf_padding">举报类别：
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="DropDownListType" Width="201px" runat="server" CssClass="tselect" ></asp:DropDownList>
                                    </td>
                                    <td>
                                        <asp:Button ID="ButtonSearch" runat="server" CssClass="dele" OnClick="ButtonSearch_Click" Text="查询" />
...
/>
                        ...
                        <asp:BoundField HeaderText="被举报人" DataField="ReportShop" SortExpression="ReportShop" ItemStyle-HorizontalAlign="Center" />
