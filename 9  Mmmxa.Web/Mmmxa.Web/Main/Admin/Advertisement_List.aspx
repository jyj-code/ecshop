<%@ page language="C#" autoeventwireup="true" inherits="Admin_Advertisement_List"   CodeBehind="Advertisement_List.aspx.cs"      %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td valign="top">
                                  ...
                                  <asp:LinkButton ID="ButtonAdd" runat="server" CausesValidation="False" OnClick="ButtonAdd_Click"  CssClass="tianjia2 lmf_btn"  Visible="false">
