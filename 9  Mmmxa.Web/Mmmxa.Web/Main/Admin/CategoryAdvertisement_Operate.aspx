<%@ page language="C#" autoeventwireup="true" inherits="CategoryAdvertisement_Operate, ShopNum1.Deploy" %>
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                    ...
                    <td valign="middle">
                            ...
                            <asp:TextBox ID="TextBoxPageName" runat="server" CssClass="tinput"></asp:TextBox><span style="color: Red">*</span><span>不能为空</span>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxAdPrice" MaxLength="9" CssClass="tinput" runat="server"></asp:TextBox><span> 输入价格</span>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxAdvertisementflow" MaxLength="9" CssClass="tinput" runat="server"></asp:TextBox> /天
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxAdIntroduce" MaxLength="50" CssClass="tinput" runat="server"></asp:TextBox><span> 加入广告标题</span>
