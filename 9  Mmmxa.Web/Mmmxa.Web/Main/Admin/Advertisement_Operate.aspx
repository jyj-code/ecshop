<%@ page language="C#" autoeventwireup="true" inherits="Admin_Advertisement_Operate"   CodeBehind="Advertisement_Operate.aspx.cs"      %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="welcon clearfix">
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidatorTextBoxPageName" runat="server" ControlToValidate="TextBoxPageName"
                ...
                <span style="color:Red">*</span>
                <asp:RequiredFieldValidator ID="RequiredFieldValidatorTextBoxFileName" runat="server" ControlToValidate="TextBoxFileName"
                 Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
               ...
               <tr>
                  ...
                  <tr>
                    ...
                    <td>
                         ...
                         <asp:TextBox ID="TextBoxExplain" runat="server" CssClass="tinput"
                   ></asp:TextBox>
                ...
                <asp:DropDownList ID="DropDownListAdType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListAdType_SelectedIndexChanged"  Width="151px" CssClass="tselect">
                ...
                <asp:DropDownList ID="DropDownListPathType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListPathType_SelectedIndexChanged"  Width="148px" CssClass="tselect">
                 ...
                 <tr>
                    ...
                    <td>
                 <asp:TextBox ID="TextBoxContent" runat="server" TextMode="MultiLine" Height="129px" CssClass="tinput"
                ...
                <input id="ButtonSelectSingleImage" runat="server" type="button" value="插入图片" visible="false"
                 ...
                 <tr id="adheight" runat="server" style="display:none">
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionHeight"
                                runat="server" ControlToValidate="TextBoxHeight" ErrorMessage="只能输入数字" ValidationExpression="^[0-9]*$"
                 ...
                 <tr id="adwidth" runat="server"  style="display:none">
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxWidth" runat="server"  CssClass="tinput"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="RegularExpressionWidth"
                                runat="server" ControlToValidate="TextBoxWidth" ErrorMessage="只能输入数字" ValidationExpression="^[0-9]*$"
                                Display="Dynamic"></asp:RegularExpressionValidator>
                     </td>
                </tr>
            ...
            <asp:Button ID="ButtonConfirm" runat="server" Text="确定" CssClass="fanh" OnClick="ButtonConfirm_Click" />
                ...
                <asp:Button ID="ButtonBack" runat="server" Text="返回列表" CssClass="fanh" CausesValidation="false" OnClick="ButtonBack_Click" />
