<%@ page language="C#" autoeventwireup="true" inherits="Admin_SendMessage_List"   CodeBehind="SendMessage_List.aspx.cs"      %>
            ...
            <div class="order_edit">
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td style=" display:none">
                        ...
                        <tr>
                        <td><asp:TextBox ID="textBoxSSendTimeStart" runat="server" CssClass="tinput_data"></asp:TextBox></td>
                        ...
                        <td><ShopNum1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="textBoxSSendTimeStart"
                        ...
                        <td><asp:TextBox ID="textBoxSSendTimeEnd" runat="server" CssClass="tinput_data"></asp:TextBox></td>
                        ...
                        <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorSSendTimeEnd" runat="server"
                                ...
                                ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                        <td><ShopNum1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="textBoxSSendTimeEnd"
                ...
                <td valign="top" style="display:none;">
                    <asp:LinkButton ID="ButtonAdd" runat="server" OnClick="ButtonAdd_Click"  Visible="false" OnClientClick="GetCheckedBoxValues()"
                        CssClass="addcate lmf_btn"  ><span>添加短信</span></asp:LinkButton>
