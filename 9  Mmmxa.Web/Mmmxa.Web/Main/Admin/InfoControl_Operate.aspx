<%@ page language="C#" autoeventwireup="true" inherits="Admin_InfoControl_Operate"   CodeBehind="InfoControl_Operate.aspx.cs"      %>
             ...
             <table border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxPageFileName"   Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxPageFileName"  Display="Dynamic" ErrorMessage="标题最多50个字符" ValidationExpression="^[\s\S]{0,50}$"></asp:RegularExpressionValidator>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxControlName"
                    Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBoxControlName"   Display="Dynamic" ErrorMessage="标题最多50个字符" ValidationExpression="^[\s\S]{0,50}$"></asp:RegularExpressionValidator>
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxControlFileName" CssClass="tinput" runat="server" Width="200"></asp:TextBox>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ControlToValidate="TextBoxControlFileName"
                                                Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBoxControlFileName"   Display="Dynamic" ErrorMessage="标题最多50个字符" ValidationExpression="^[\s\S]{0,50}$"></asp:RegularExpressionValidator>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBoxControlKey"  Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="TextBoxControlKey"  Display="Dynamic" ErrorMessage="标题最多50个字符" ValidationExpression="^[\s\S]{0,50}$"></asp:RegularExpressionValidator>
...
onerror="javascript:this.src='../../ImgUpload/noImage.gif'" runat="server" />
            ...
            <div class="tablebtn">
                <asp:Button ID="BottonConfirm" runat="server" OnClick="ButtonConfirm_Click" Text="确定" CssClass="fanh"
                        ToolTip="Submit"  />
                    
                    <asp:Button ID="BottonBack" runat="server" Text="返回列表"  CausesValidation="False" CssClass="fanh"
                        OnClick="BottonBack_Click" />
                    <asp:Button ID="ButtonSeeData" runat="server" CausesValidation="False" Text="管理控件数据" CssClass="c_fanh"
                       OnClick="ButtonSeeData_Click" Visible="false"  />
