<%@ page language="C#" autoeventwireup="true" inherits="Admin_SeeBuyRate"   CodeBehind="SeeBuyRate.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <td class="lmf_padding" align="right">
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" runat="server" Width="200px" CssClass="tselect">
                            </asp:DropDownList>
                        </td>
                    ...
                    <tr style="height: 35px; vertical-align:top; display:none">
                        ...
                        <td colspan="3">
                            ...
                            <asp:CompareValidator ID="CompareValidatorTextBoxMarketPrice2" runat="server" ErrorMessage="开始价格应当低于末尾价格"
                                ...
                                Operator="GreaterThan"></asp:CompareValidator>
                                 <asp:Button ID="ButtonSearch" runat="server" OnClick="ButtonSearch_Click" Text="查询" CssClass="dele" />
                        </td>
                    </tr>
                    <tr>
                        <td class="lmf_padding" align="right">
                        ...
                        <td>
                            <asp:TextBox ID="txtProductName" runat="server" CssClass="tinput" Width="190"></asp:TextBox>
                        </td>
                        <td class="lmf_padding">
                        ...
                        <td><asp:Button ID="Button1" runat="server" OnClick="ButtonSearch_Click" Text="查询" CssClass="dele" /></td>
                    </tr>
                </table>
                <div class="sbtn">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="城市分站">
                    <ItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchSeeBuyRate"
            ...
            <SelectParameters>
               <asp:ControlParameter ControlID="txtProductName"  Name="name" PropertyName="Text" Type="String" />
                 <asp:ControlParameter ControlID="DropDownListProductGuid1" DefaultValue="-1" Name="productCategoryCode1" PropertyName="SelectedValue" Type="String" />
                 <asp:ControlParameter ControlID="DropDownListProductGuid2" DefaultValue="-1"  Name="productCategoryCode2" PropertyName="SelectedValue" Type="String" />
                 <asp:ControlParameter ControlID="DropDownListProductGuid3" DefaultValue="-1"  Name="productCategoryCode3" PropertyName="SelectedValue" Type="String" />
                ...
                <asp:ControlParameter ControlID="TextBoxMarketPrice2" DefaultValue="0" Name="marketPrice2"
                    PropertyName="Text" Type="Decimal" />
                <asp:ControlParameter ControlID="DropDownListSubstationID" DefaultValue="0" Name="SubstationID"
                    PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
