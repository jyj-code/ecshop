<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_CouponType_List"   CodeBehind="CouponType_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分类名称">
                        <ItemTemplate>
                            <%# Eval("Name").ToString().Length > 20 ? Eval("Name").ToString().Substring(0, 20) : Eval("Name").ToString()%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"/>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="描述">
                        <ItemTemplate>
                            <%# Eval("Comment").ToString().Length > 20 ? Eval("Comment").ToString().Substring(0, 20) : Eval("Comment").ToString()%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"/>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "CouponType_Operate.aspx?ID="+Eval("ID") %>" style="color: #4482b4;">编辑</a>
