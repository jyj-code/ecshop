<%@ page language="C#" autoeventwireup="true" inherits="Union_Settings, ShopNum1.Deploy" %>
...
<div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                   <asp:Label ID="LabelPageTitle" runat="server" Text="整合ShopNum1联盟系统"></asp:Label>
          ...
          <div class="inner_page_list">
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                    ...
                    ValidationExpression="^[\s\S]{0,200}$"></asp:RegularExpressionValidator><span>请您输入ShopNum1联盟地址</span>
            ...
            <div class="tablebtn">
                ...
                <asp:Button ID="ButtonConfirm" runat="server" Text="确定" ToolTip="Submit"
                        OnClick="ButtonConfirm_Click" CssClass="fanh" />
