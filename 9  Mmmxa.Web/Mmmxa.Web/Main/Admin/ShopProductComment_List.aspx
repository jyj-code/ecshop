<%@ page language="C#" autoeventwireup="true" inherits="Main_MainAdmin_ShopProductComment_List, ShopNum1.Deploy" %>
...
<body>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                       ...
                       <td align="right">
                        ...
                        <img id="imgCalendarSReplyTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                height: 18px; position: relative; top: 4px" /> <GroupFly:CalendarExtender ID="CalendarExtender4"
                                    ...
                                    CssClass="ajax__calendar" Format="yyyy-MM-dd" />
                        </td>
                        <td>
                        ...
                        <td class="lmf_px">-</td>
                        <td><asp:TextBox ID="TextBoxTime2" CssClass="tinput" runat="server"  Width="66"></asp:TextBox></td>
                       <td valign="top" style="padding-left:4px;"><img id="img1" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px;
                                position: relative; top: 4px" /><GroupFly:CalendarExtender ID="CalendarExtender1"
                                    runat="server" TargetControlID="TextBoxTime2" PopupButtonID="img1" CssClass="ajax__calendar" Format="yyyy-MM-dd" /></td>
                       <td><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxTime2"
                ...
                <div class="sbtn">
                    ...
                    <asp:Button ID="ButtonSearchDetail" runat="server" Text="查看" CssClass="dele" Visible="false" OnClientClick="return EditButton()"
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="评论店铺">
                        <ItemTemplate>
                             <a href='<%#ShopUrlOperate.GetShopUrlNew(Eval("Shopids").ToString()) %>' target="_blank"><%# Eval("shopname")%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                ...
                <%--    <asp:TemplateField HeaderText="审核状态">
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ShopProductComment_Detail.aspx?guid="+Eval("Guid")+"&Type=List" %>" style="color: #4482b4;">
                                查看</a>
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="GetProductAll1"
