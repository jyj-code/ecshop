<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopNum1SupplyDemandCheck_List"   CodeBehind="ShopNum1SupplyDemandCheck_List.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelTitle" runat="server" Text="主站供求信息审核列表" /></h3>
            </div>
            <div class="rr">
            </div>
        </div>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="Search"
       ...
       <asp:HiddenField ID="CheckAudit" runat="server" Value="-1"/>
