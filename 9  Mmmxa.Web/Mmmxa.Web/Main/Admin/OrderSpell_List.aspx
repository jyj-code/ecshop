<%@ page language="C#" autoeventwireup="true" inherits="Admin_OrderSpell_List"   CodeBehind="OrderSpell_List.aspx.cs"      %>
                     ...
                     for (int i = 0; i < dt_OrderList.Rows.Count; i++)
                     {
                         ...
                         %>
                            <tr style="cursor:default;" onmouseout="Num1GridViewShow_mout(this)" onmouseover="Num1GridViewShow_mover(this)">
                                ...
                                <td align="center" style="">
                                    <span id="Span4"><%=GetSubstationIDname(dr["SubstationID"].ToString())%></span>
                                </td>
                                <td align="center" style="">
                                ...
                                <td align="center" style="">
                                      ...
                                      <a style="color: #4482b4;" href="?orid=<%=dr["ordernumber"] %>&jk"  onclick="return window.confirm('您确定要删除吗?');">删除</a>
                                </td>
		            </tr>
                     <%}%>
