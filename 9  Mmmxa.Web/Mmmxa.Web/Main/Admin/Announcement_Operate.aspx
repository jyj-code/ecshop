<%@ page language="C#" autoeventwireup="true" inherits="Admin_Announcement_Operate"   CodeBehind="Announcement_Operate.aspx.cs"      %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorCreateTime" runat="server"
                                ...
                                <GroupFly:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TextBoxCreateTime" 
