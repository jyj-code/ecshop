<%@ page language="C#" autoeventwireup="true" inherits="Admin_ArticleComment_Audit"   CodeBehind="ArticleComment_Audit.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelPageTitle" runat="server" Text="主站平台文章评论审核列表"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
            ...
            <div class="order_edit">
                <table style="width: 100%">
                    ...
                    <tr  style="height:30px;" >
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSIsAudit" runat="server" Width="190px" CssClass="tselect">
                            </asp:DropDownList>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr  style="height:30px;" >
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSIsReply" runat="server" Width="190px" CssClass="tselect">
                            </asp:DropDownList>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr  style="height:30px;" >
                        ...
                        <td style="width: 42px; height: 25px"  colspan="3">
                            &nbsp;
                        </td>
                    </tr>
                    <tr  style="height:30px;" >
                ...
                <div class="sbtn">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td valign="top" style="padding-left:8px; display:none;" >
