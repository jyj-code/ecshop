<%@ page language="C#" autoeventwireup="true" inherits="Admin_ProductIntegralChecked_List"   CodeBehind="ProductIntegralChecked_List.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxMemLoginID" runat="server" CssClass="tinput" Width="100"></asp:TextBox>
                        </td>
                        <td class="lmf_padding">
                            <asp:Localize ID="LocalizePrice" runat="server" Text="积分范围："></asp:Localize>
                        </td>
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                ...
                <div class="sbtn">
                     ...
                     <td valign="top" >
                        <asp:LinkButton ID="ButtonSee"  runat="server"   CssClass="chank2 lmf_btn"
                             onclick="ButtonSee_Click1"  OnClientClick="return EditButton()" >
                   ...
                   <td valign="top" class="lmf_app" >
                    ...
                    <td valign="top" class="lmf_app">
                    <asp:LinkButton ID="ButtonCancelAudit" runat="server" OnClick="ButtonCancelAudit_Click"  OnClientClick="return AuditButton()"  CssClass="shwtg lmf_btn" 
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="积分" SortExpression="Score" ItemStyle-Width="50">
                        <ItemTemplate>
                             <%# Eval("Score")%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    ...
                    <asp:BoundField HeaderText="库存" DataField="RepertoryCount" SortExpression="RepertoryCount"
                        ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="CreateTime" HeaderText="申请时间" SortExpression="SaleTime" ItemStyle-Width="100"
                        ItemStyle-HorizontalAlign="Center" />
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ProductIntegralDetal.aspx?guid="+Eval("Guid")+"&Type=0" %>" style="color: #4482b4;">查看</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
