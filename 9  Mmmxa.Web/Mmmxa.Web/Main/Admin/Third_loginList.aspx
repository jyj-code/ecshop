<%@ page language="C#" autoeventwireup="true" inherits="Admin_Third_loginList"   CodeBehind="Third_loginList.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "Third_loginOperate.aspx?id="+Eval("ID") %>" style="color: #4482b4;">编辑</a>
                            <asp:LinkButton ID="LinkDelte" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("ID")%>' Visible="false"
