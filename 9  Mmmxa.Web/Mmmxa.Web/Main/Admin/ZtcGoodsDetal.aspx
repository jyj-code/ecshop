<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ZtcGoodsDetal"   CodeBehind="ZtcGoodsDetal.aspx.cs"      %>
            ...
            <div class="inner_page_list">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Image ID="ImageProduct" runat="server"  ImageUrl='<%#Eval("ZtcImg")%>' Width="300" Height="260"/>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
