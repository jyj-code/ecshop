<%@ page language="C#" autoeventwireup="true" inherits="Admin_Image_List_Select"   CodeBehind="Image_List_Select.aspx.cs"      %>
...
var sweetTitles = {
	x : 10,	y : 20,tipElements : ".editname",	init : function() {
		$(this.tipElements).mouseover(function(e){
			...
			if(e.pageX>740)
			{    
			    $('#tooltip').css({"opacity":"0.8","top":(e.pageY+20)+"px","left":(e.pageX-150)+"px"}).show('fast');	
			}
			else
			{
         ...
         sweetTitles.init();
          //$('a').imgPreview({imgCSS: { width: 300,left:100}});
     });
                            </script>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td align="center" style="width: 90px">
                                                <input id="checkboxItem" value='<%# Eval("Guid") %>' lang='<%#Eval("ImagePath")%>' type="checkbox" />
                    ...
                    <tr>
                        <td style="width: 100%" align="left">
                            <div style="float: left;">
                                ...
                                <asp:Button ID="ButtonDel" runat="server" CssClass="dele" Text="删除" 
                                    OnClientClick="DeleteButton()" onclick="ButtonDel_Click" />
                            </div>
                            <!-- 分页部分-->
