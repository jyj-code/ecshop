<%@ page language="C#" autoeventwireup="true" inherits="Admin_Email_Operate"   CodeBehind="Email_Operate.aspx.cs"      %>
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <p id="457f965d-f1cc-45cf-b4a5-ddbbd6b7fdc0" lang="下单时给商家发送邮件" style="display:none">用户名：{$Name}&nbsp;&nbsp;订单号为：{$OrderNumber}&nbsp;&nbsp;会员名称：{$MemLoginId}&nbsp;&nbsp;会员电话：{$UserTel}&nbsp;&nbsp;会员手机号码：{$UserMobile}&nbsp;&nbsp;商品名称：{$ProductName}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
                            ...
                            <p id="4a12724c-5154-4928-b867-d5bd180e80e6" lang="注册会员成功" style="display:none">用户名：{$Name}&nbsp;&nbsp;站点名称：{$ShopName} &nbsp;&nbsp;系统时间：{$SysSendTime}</p>
                             <p id="5387cec4-05ed-41d1-bc1f-c900c4959585" lang="开店审核失败后提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;商铺网站：{$DoMain}&nbsp;&nbsp; 店铺状态：{$ShopStatus}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
