<%@ page language="C#" autoeventwireup="true" inherits="Admin_DefaultAd_List"   CodeBehind="DefaultAd_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "DefaultAd_Operate.aspx?guid="+Eval("guid") %>" style="color: #4482b4;">编辑</a>
