<%@ page language="C#" autoeventwireup="true" inherits="Admin_Brand_List"   CodeBehind="Brand_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListIsRecommond" runat="server" CssClass="tselect" Style="width: 100px;">
                                <asp:ListItem Value="-2" Selected="True">-全部-</asp:ListItem>
                                <asp:ListItem Value="1">是</asp:ListItem>
                                <asp:ListItem Value="0">否</asp:ListItem>
                            </asp:DropDownList>
            ...
            <ShopNum1:Num1GridView ID="Num1GridviewShow" runat="server" AutoGenerateColumns="False"
                ...
                PagingStyle="None" TableName="" DataSourceID="ObjectDataSourceData" AllowMultiColumnSorting="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None"  BorderWidth="0" CellPadding="4" GridLines="Vertical">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="品牌图片" SortExpression="logo">
                        <ItemTemplate>
                            <img src='<%# Page.ResolveUrl(""+Eval("Logo").ToString())%> ' onmouseover="javascript:ddrivetip('<img width=200px height=200 src=<%# Page.ResolveUrl(Eval("Logo").ToString())%> >','#ffffff')"
