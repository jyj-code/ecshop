<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopAmountReport"   CodeBehind="ShopAmountReport.aspx.cs"      %>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <img id="imgCalendarSReplyTime1" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                        height: 18px; position: relative; top: 4px; *top: 2px" /><asp:RegularExpressionValidator
