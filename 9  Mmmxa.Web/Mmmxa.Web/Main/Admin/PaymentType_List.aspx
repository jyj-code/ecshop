<%@ page language="C#" autoeventwireup="true" inherits="Admin_PaymentType_List"   CodeBehind="PaymentType_List.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <td valign="top" class="lmf_app">
                    ...
                    OnClientClick="return DeleteButton()" OnClick="ButtonDelete_Click" CssClass="shanchu lmf_btn" Visible="false"><span>批量删除</span></asp:LinkButton>
                </td>
                 <td valign="top" class="lmf_app">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="图片">
                        <ItemTemplate>
                            <asp:Image ID="ImageBakcImg" runat="server"  ImageUrl='<%#Eval("BakcImg") %>' Width="60" Height="60"/>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
