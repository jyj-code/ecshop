<%@ page language="C#" autoeventwireup="true" inherits="Admin_PageInfo_Operate"   CodeBehind="PageInfo_Operate.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                 ...
                 <asp:DropDownList ID="DropDownListFileName" runat="server" AutoPostBack="true" Width="260" OnSelectedIndexChanged="DropDownListFileName_SelectedIndexChanged" CssClass="tselect">
                </asp:DropDownList>
                 ...
                 <asp:TextBox ID="TextBoxPageNote" runat="server" CssClass="tinput"></asp:TextBox>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="TextBoxContent" runat="server" TextMode="MultiLine" Height="300px" CssClass="tinput"
