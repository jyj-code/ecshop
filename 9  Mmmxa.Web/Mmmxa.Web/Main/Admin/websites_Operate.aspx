<%@ page language="C#" autoeventwireup="true" inherits="Admin_websites_Operate"   CodeBehind="websites_Operate.aspx.cs"      enableeventvalidation="false" %>
           ...
           <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                    ...
                    <td>
                            ...
                            <asp:DropDownList ID="DropDownListRegionCode1" runat="server" AutoPostBack="true"
                                OnSelectedIndexChanged="DropDownLis1_SelectedIndexChanged" CssClass="tselect" style=" width:80px;">
                            </asp:DropDownList>
                            <asp:DropDownList ID="DropDownListRegionCode2" runat="server" Visible="false" AutoPostBack="true"
                                OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" CssClass="tselect" style=" width:80px;">
                            </asp:DropDownList>
                            <asp:DropDownList ID="DropDownListRegionCode3" runat="server" Visible="false" CssClass="tselect" style=" width:80px;">
                            </asp:DropDownList>
                ...
                <tr class="radiobtn">
                    ...
                    <td>
                            ...
                            <asp:RadioButtonList ID="RadioButtonListOpen" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
