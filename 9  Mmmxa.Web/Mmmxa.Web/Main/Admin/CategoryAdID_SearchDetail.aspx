<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_CategoryAdID_SearchDetail"   CodeBehind="CategoryAdID_SearchDetail.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            <table border="0" cellpadding="0" cellspacing="0" class="shoptable">
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd" style="height:120px;" >
                           <asp:TextBox ID="TextBoxIntroduce" TextMode="MultiLine" Height="100px" Width="500px"  CssClass="tinput" 
