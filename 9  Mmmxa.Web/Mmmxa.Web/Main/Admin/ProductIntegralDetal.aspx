<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ProductIntegralDetal"   CodeBehind="ProductIntegralDetal.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelPageTitle" runat="server" Text="积分商品查看页"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
        <div class="welcon clearfix">
            ...
            <div class="tablebtn">
                ...
                <asp:Button ID="ButtonEdit" runat="server" Text="审核通过" CssClass="fanh" OnClick="ButtonOperate_Click"></asp:Button>&nbsp;&nbsp;&nbsp;
                <asp:Button ID="ButtonCancelAudit" runat="server" OnClick="ButtonCancelAudit_Click" Text="审核未通过" CssClass="fanh"></asp:Button>&nbsp;&nbsp;&nbsp;
