<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_OrderProductReport"   CodeBehind="OrderProductReport.aspx.cs"      %>
            ...
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr style="height: 35px; vertical-align: top;">
                        <td>订单号：</td>
                        <td><asp:TextBox ID="txtOrderNumber" CssClass="tinput" Width="200" runat="server"></asp:TextBox></td>
                        <td class="lmf_padding">商品名称：</td>
                        <td><asp:TextBox ID="txtProductName" CssClass="tinput" Width="200" runat="server"></asp:TextBox></td>
                      </tr>  
                      <tr style="height: 35px; vertical-align: top;">  
                        <td>店铺名称：</td>
                        <td><asp:TextBox ID="TextBoxShopName" CssClass="tinput" Width="200" runat="server"></asp:TextBox></td>
                        <td class="lmf_padding">交易日期： </td>
                        <td><asp:TextBox ID="TextBoxStartDate" runat="server" CssClass="tinput" Width="63"></asp:TextBox>
                        ...
                        <img id="imgCalendarSReplyTime1" alt="UserName" src="/ImgUpload/Calendar.png" style="width: 16px;
                                ...
                                -
                                <asp:TextBox ID="TextBoxEndDate" runat="server" CssClass="tinput" Width="63"></asp:TextBox>
                        ...
                        <td>&nbsp;&nbsp;&nbsp;<asp:Button ID="ButtonSearch" runat="server" Text="搜索" CssClass="dele" OnClick="ButtonSearch_Click" />
                        </td>
                    </tr>
                </table>
                <div>
...
<%--                    <asp:BoundField DataField="MemLoginID" HeaderText="店主" SortExpression="MemLoginID">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchOrderProduct"
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="txtOrderNumber"  Name="ordernum" PropertyName="Text" Type="String" />
                <asp:ControlParameter ControlID="txtProductName"  Name="productname" PropertyName="Text" Type="String" />
