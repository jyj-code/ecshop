<%@ page language="C#" autoeventwireup="true" inherits="AdminWelcome_List, ShopNum1.Deploy" %>
    ...
    <div id="right">
        ...
        <div class="rhigth">
            ...
            <div style="float: left; font-size: 12px; color: #888888; padding-top: 10px; padding-left: 10px;">
                ...
                </font>&nbsp;&nbsp;系统当前模式：<asp:Label ID="LabelCityMode" runat="server" Text=""></asp:Label>
            </div>
            <div class="rr">
            </div>
        </div>
        <div class="welcon clearfix">
                ...
                <div class="ordercont">
                  ...
                  <p>
                        <a href="ShopProductCommentAudit_List.aspx">待处理商品评论：
                            ...
                            <p>
                        <a href="ShopZtcApplyAudit_List.aspx?isAudit=0">待处理直通车：
                            <asp:Label ID="lblZtAudit" runat="server"></asp:Label>个</a></p>
                </div>
            </div>
            <!--商城动态-->
            <div class="orderinfo rc4">
                ...
                <div class="ordercont">
                      <p>
                        今日销售总金额：
                            ￥<asp:Label ID="LabelProductPriceCount" runat="server" Text="0"></asp:Label></p>
                    <p>
                          今日订单量：
                            <asp:Label ID="LabelOrderNow" runat="server" Text="0"></asp:Label>个</p>
                    <p>
                        今日注册会员数：
                            <asp:Label ID="LabelMemberCount" runat="server" Text="0"></asp:Label>个</p>
                    <p>
                        今日入驻的店铺：
                            <asp:Label ID="LabelShopNowCount" runat="server" Text="0"></asp:Label>个</p>
                    <p>
                       会员总数：
                            <asp:Label ID="LabelMemberAllCount" runat="server" Text="0"></asp:Label>个</p>
                    <p>
                       店铺总数量：
                            <asp:Label ID="LabelShopAllCount" runat="server" Text="0"></asp:Label>个</p>
                    <p style="display: none;">
                       今日销售商品总量：
                            <asp:Label ID="LabelBuyNumberCount" runat="server" Text="0"></asp:Label></p>
                </div>
            </div>
        </div>
    </div>
