<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopNum1_SupplyDemand_List"   CodeBehind="ShopNum1_SupplyDemand_List.aspx.cs"      %>
                    ...
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListCommon_Cf" runat="server" AutoPostBack="true" CssClass="tselect"
                                OnSelectedIndexChanged="DropDownListCommon_Cf_SelectedIndexChanged" Style="width: 100px;
                                margin-right: 0;">
                            </asp:DropDownList>
                            <asp:DropDownList ID="DropDownListCommon_Cs" runat="server" AutoPostBack="true" CssClass="tselect"
                                OnSelectedIndexChanged="DropDownListCommon_Cs_SelectedIndexChanged" Style="width: 100px;
                                margin-right: 0;">
                            </asp:DropDownList>
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="tinput" Width="68" ID="TextBoxCreateTime2" runat="server"></asp:TextBox>
                                    </td>
                                    <td style="padding-left: 4px; vertical-align: top;">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="信息标题" SortExpression="Title">
                        <ItemTemplate>
                            <a href='<%# ShopUrlOperate.RetUrl("SupplyDemandDetail",Eval("ID").ToString()) %>'
                                target="_blank">
                               <%# Eval("Title").ToString().Length > 16 ? Eval("Title").ToString().Substring(0, 16) : Eval("Title").ToString()%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:BoundField HeaderText="查询关键字" DataField="Keywords" SortExpression="Keywords"
                        ItemStyle-HorizontalAlign="Center" />
                     <asp:TemplateField HeaderText="是否过期" SortExpression="ValidTime">
                        <ItemTemplate>
                            <%# IsOutOFTime(Eval("ValidTime").ToString()) %>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
