<%@ page language="C#" autoeventwireup="true" inherits="Admin_Email_List"   CodeBehind="Email_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit" style="display:none;">
                ...
                <td style="display:none"><asp:Localize ID="LocalizeTitle" runat="server" Text="邮件标题："></asp:Localize></td>
                <td style="display:none"><asp:TextBox ID="TextBoxTitle" runat="server" CssClass="tinput" Width="220"></asp:TextBox></td>
                <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorTextBoxTitle" runat="server"
                        ControlToValidate="TextBoxTitle" Display="Dynamic" ErrorMessage="最多50个字符" ValidationExpression="^[\s\S]{0,50}$"></asp:RegularExpressionValidator></td>
                <td class="lmf_padding" style="display:none"><asp:Localize ID="LocalizeTypeName" runat="server" Text="邮件类别："></asp:Localize></td>
                <td style="display:none"><asp:DropDownList ID="DropDownListTypeName" runat="server" CssClass="tselect">
                    </asp:DropDownList></td>
                </tr>
                  ...
                  <%--  <asp:BoundField HeaderText="分类名称" DataField="TypeName" ItemStyle-HorizontalAlign="Center" />--%>
                    <asp:BoundField DataField="Description" HeaderText="邮件描述" ItemStyle-HorizontalAlign="Center" />
                      <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "Email_Operate.aspx?guid='"+Eval("Guid")+"'" %>" style="color: #4482b4;">编辑</a>
