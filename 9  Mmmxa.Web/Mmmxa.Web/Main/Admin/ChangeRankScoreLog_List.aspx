<%@ page language="C#" autoeventwireup="true" inherits="Admin_ChangeRankScoreLog_List"   CodeBehind="ChangeRankScoreLog_List.aspx.cs"      %>
...
<body class="widthah">
        ...
        <div class="welcon clearfix">
                        ...
                        <tr style="height: 35px; vertical-align: top;">
                            ...
                            <td>
                                <asp:DropDownList ID="DropdownListSOperateType" runat="server" Width="201px" CssClass="tselect">
                                    ...
                                    <asp:ListItem Value="2">转账积分</asp:ListItem>
                            ...
                            <td>
                                <asp:TextBox ID="TextBoxSDate1" runat="server" CssClass="tinput" Width="68"></asp:TextBox>
                            </td>
                            ...
                            <td>
                                <asp:TextBox ID="TextBoxSDate2" runat="server" CssClass="tinput" Width="68"></asp:TextBox>
                            </td>
                            <td style="padding-left: 4px; vertical-align: top;">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CurrentScore" HeaderText="当前积分" SortExpression="CurrentScore">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="变更积分" SortExpression="OperateScore">
                        <ItemTemplate>
                             <%#Convert.ToInt32(Eval("CurrentScore").ToString()) > Convert.ToInt32(Eval("LastOperateScore").ToString())? "-" : "+"%><%#Eval("OperateScore")%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="变更后积分" DataField="LastOperateScore" SortExpression="LastOperateScore">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="GetDataInfoAdmin"
        TypeName="ShopNum1.BusinessLogic.ShopNum1_RankScoreModifyLog_Action">
        <SelectParameters>
