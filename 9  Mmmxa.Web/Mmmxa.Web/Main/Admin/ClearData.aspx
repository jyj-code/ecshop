<%@ page language="C#" autoeventwireup="true" inherits="Admin_ClearData"   CodeBehind="ClearData.aspx.cs"      %>
...
<body style="padding: 0; background-image: url(images/Bg_right.gif); background-repeat: repeat;
    ...
    <div id="right"  >
        ...
        <div class="welcon clearfix" style="padding-left:20px;padding-right:20px;">
         <p style="color:#333333;margin-top:0px;border-bottom:1px dashed #cccccc;width:100%;padding-bottom:10px; font-size:13px;">
                ...
                <div class="product_content">
                    <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="ffffff">
                        ...
                        <tr>
                            <td colspan="2"   style="padding-left:52px;color:#2672ac;padding-top:10px;">
                             全选/取消：<asp:CheckBox ID="CheckboxCheckAll"  name="CheckAll"  runat="server"  Visible="false" />
                               <input id="checkboxAll" onclick="javascript: SelectAllCheckboxes(this);" type="checkbox" runat="server" />
                        ...
                        <!--;ShopNum1_SpecificationManagement;ShopNum1_SpecificationDetails-->
                           商品数据：<asp:CheckBox ID="CheckboxProduct"  name="ClearData" runat="server" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>商品数据,包括商品分类,图片,评论,订单数据,商品属性,直通车数据,规格管理,商品类型</span>
                        ...
                        <tr>
                        <td colspan="2"   style="padding-left:52px;color:#2672ac;">
                          品牌数据：<asp:CheckBox ID="CheckboxCategoryAndBrand"  name="ClearData" runat="server" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>商品品牌</span>
                        ...
                        <td colspan="2"  style="padding-left:136px;color:#2f7ecc;">
                           订单数据：<input id="CheckboxOrder"  name="ClearData" type="checkbox" value="ShopNum1_OrderInfo;ShopNum1_OrderProduct;ShopNum1_OrderOperateLog" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>包括订单操作记录等数据</span>
                               ...
                               <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                          会员数据：<asp:CheckBox ID="CheckboxMem"  name="ClearData"  runat="server" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>会员信息,会员预览历史,签到数据信息,等级积分变更表,消费积分变更表,供求类别,供求信息,供求评论,系统后台操作日志,订单操作日志,用户浏览器记录,商品评价,但不包括会员等级</span>
                          <%--<input id="CheckboxMem"  name="ClearData" type="checkbox" value="ShopNum1_Member;ShopNum1_MessageBoard;ShopNum1_Address;ShopNum1_AdvancePaymentFreezeLog;ShopNum1_AdvancePaymentApplyLog;ShopNum1_MemberGroup;ShopNum1_MemberAssignGroup;ShopNum1_AdvancePaymentModifyLog;ShopNum1_RankScoreModifyLog" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>会员信息,但不包括会员等级</span>--%>
                              ...
                              <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                          店铺数据：<asp:CheckBox ID="CheckboxShop"  name="ClearData" runat="server" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>店铺信息,店铺信誉,店铺保证,店铺申请担保列表,优惠劵,但不包括店铺等级</span>
                        ...
                        清空供应商：<input id="CheckboxSupplier"  name="ClearData" type="checkbox" value="ShopNum1_SupplierFinancialManagement;ShopNum1_SupplierRepertoryRecord;ShopNum1_SupplierImagePath;ShopNum1_SupplierImage;ShopNum1_SupplierImage_Type;ShopNum1_Product;ShopNum1_SupplierProductCategory;ShopNum1_SupplierCategoryRelated;ShopNum1_SupplierImageCategory;ShopNum1_Supplier;ShopNum1_SupplierOrderProduct" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>供应商数据,包括供应商商品、商品分类、商品图片</span>
                             ...
                             <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                         图片数据：<asp:CheckBox ID="CheckboxImage" name="ClearData"  runat="server" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>图片,图片类型,图片路径</span>
                         <%--<input id="CheckboxImage"  name="ClearData" type="checkbox" value="ShopNum1_Image;ShopNum1_Image_Type;ShopNum1_ImageCategory" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>图片,图片类型,图片路径</span>--%>
                          ...
                          <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                        资讯数据：<asp:CheckBox ID="CheckboxArticle" name="ClearData"  runat="server" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>资讯,资讯评论,资讯相关,公告</span>
                        <%--<input id="CheckboxArticle"  name="ClearData" type="checkbox" value="ShopNum1_Article;ShopNum1_ArticleComment;ShopNum1_RelatedArticle" /><span style=" color:#666666;"> <span style="color:#ff0000;">* </span>资讯,资讯评论,资讯相关</span>--%>
                         ...
                         <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                        视频数据：<asp:CheckBox ID="CheckboxVideo"  name="ClearData" runat="server" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>视频,视频分类,视频评论</span>
                        ...
                        <%-- <tr>
                        <td colspan="2"  style="padding-left:136px;color:#2f7ecc;">
                            积分商城：<asp:CheckBox ID="CheckboxScore" runat="server" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>积分订单,积分商品,积分购物车,积分订单商品,积分商品分类</span>
                            <%--<input id="CheckboxScore"  name="ClearData" type="checkbox" value="ShopNum1_Shop_ScoreProduct;ShopNum1_Shop_ScoreProductCategory" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>积分订单,积分商品,积分购物车,积分订单商品,积分商品分类</span>
                         </td>
                        </tr>--%>
                           <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                        站内消息：<asp:CheckBox ID="CheckboxAgentMessage"  name="ClearData" runat="server" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>后台站内消息,会员站内消息,系统发送消息</span>
                       <%-- <input id="CheckboxAgentMessage"  name="ClearData" type="checkbox" value="ShopNum1_MessageInfo" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>后台站内消息,会员站内消息</span>--%>
                         ...
                         <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                        附件数据：<asp:CheckBox ID="CheckboxAttachMent"  name="ClearData" runat="server" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>附件,附件分类</span>
                       <%-- <input id="CheckboxAttachMent"  name="ClearData" type="checkbox" value="ShopNum1_AttachMent;ShopNum1_AttachMentCategory" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>附件,附件分类</span>--%>
                        ...
                        <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                       在线调查：<asp:CheckBox ID="CheckboxSurveyOption" name="ClearData"  runat="server" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>在线调查,在线调查选项表</span>
                     <%--  <input id="CheckboxSurveyOption"  name="ClearData" type="checkbox" value="ShopNum1_SurveyTheme;ShopNum1_SurveyOption" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>在线调查,在线调查选项表</span>--%>
                       ...
                       友情链接：<asp:CheckBox ID="CheckboxLink" name="ClearData"  runat="server" /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>友情链接</span>
 ...
 <tr>
                        <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                       在线客服：<asp:CheckBox ID="CheckboxService" name="ClearData"  runat="server"  /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>在线客服</span>
                        ...
                        <tr>
                          <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                       积分商品：<asp:CheckBox ID="CheckboxScore" name="ClearData"  runat="server"  /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>积分商品,积分商品分类,积分订单,积分订单商品</span>
                        </td>
                        </tr>
                       
                       
                          <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                       预存款信息：<asp:CheckBox ID="CheckboxAdvancePayment" name="ClearData"  runat="server"  /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>预存款充值,预存款冻结,预存款变更,转账历史</span>
                        </td>
                        </tr>
                         <tr>
                          <td colspan="2"  style="padding-left:52px;color:#2672ac;">
                       促销活动：<asp:CheckBox ID="CheckboxLimtPackage" name="ClearData"  runat="server"  /><span style="color:#666666;"> <span style="color:#ff0000;">* </span>折扣活动,限时商品,团购活动</span>
                        </td>
                        </tr>
                    ...
                    <div style="border-top:1px dashed #cccccc;margin-top:21px;padding-top:15px; padding-bottom:25px;width:100%; background:#f1f5f8;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="f1f5f8">
                            ...
                            <td align="left">
                                <asp:TextBox ID="TextBoxLoginID" runat="server" CssClass="orinput" style="border: 1px solid #DCDCDC;height: 22px;line-height: 22px;margin-right: 10px;width: 240px;"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="padding-top:10px;">
                                <asp:TextBox ID="TextBoxPwd" runat="server" TextMode="Password" CssClass="orinput" style="border: 1px solid #DCDCDC;height: 22px;line-height: 22px;margin-right: 10px;width: 240px;"></asp:TextBox>
