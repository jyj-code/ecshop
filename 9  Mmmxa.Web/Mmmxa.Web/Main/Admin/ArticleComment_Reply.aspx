<%@ page language="C#" autoeventwireup="true" inherits="Admin_ArticleComment_Reply"   CodeBehind="ArticleComment_Reply.aspx.cs"      %>

<%@ Register Src="UserControl/MessageShow.ascx" TagName="MessageShow" TagPrefix="ShopNum1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>查看|回复文章评论</title>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelPageTitle" runat="server" Font-Bold="True" Text="查看|回复文章评论"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
        <div class="welcon clearfix">
            <table border="0" cellpadding="0" cellspacing="0" class="shoptable">
                ...
                <tr>
                    <th align="right">
                        <div class="shopth">
                            <asp:Label ID="LabelArticleGuid" runat="server" Text="评论文章："></asp:Label>
                        </div>
                    </th>
                    <td>
                        <div class="shoptd">
                    ...
                    <td>
                        <div class="shoptd" style="height: 115px;">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                ControlToValidate="TextBoxContent" Display="Dynamic" ErrorMessage="评论内容最多200个字符" 
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd" style="height: 115px; border-bottom: none;">
                            <asp:TextBox ID="TextBoxReplyContent" CssClass="tinput txtarea" runat="server" TextMode="MultiLine"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="TextBoxReplyContent" runat="server" ErrorMessage="回复内容必填！"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                ControlToValidate="TextBoxReplyContent" Display="Dynamic" ErrorMessage="回复内容最多200个字符" 
                                ValidationExpression="^[\s\S]{0,200}$"></asp:RegularExpressionValidator>(回复字数不能大于200个！) 
                        </div>
                    </td>
                </tr>
            </table>
            <div class="tablebtn">
                ...
                <asp:Button ID="ButtonBack" runat="server" Text="返回列表" CssClass="fanh" OnClick="ButtonBack_Click" ValidationGroup="fh" />
