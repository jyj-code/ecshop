<%@ page language="C#" autoeventwireup="true" inherits="Admin_CategoryAdvertisement_List"   CodeBehind="CategoryAdvertisement_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "CategoryAdvertisement_Operate.aspx?ID="+Eval("ID") %>" style="color: #4482b4;">编辑</a>
