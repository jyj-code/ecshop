<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopInfoList_Manage"   CodeBehind="ShopInfoList_Manage.aspx.cs"      %>
...
<body >
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                             <asp:Button ID="ButtonSearch" runat="server" OnClientClick="document.getElementById('form1').target='';return true;" OnClick="ButtonSearch_Click" Text="查询"
                                            CssClass="dele" />
                                    </td>
                    </tr>
                    <tr style="height: 35px; vertical-align: top; display:none">
                        ...
                        <tr>
                            <td valign="top">
                                <asp:DropDownList ID="DropDownListOperate" runat="server" Width="150" CssClass="tselect">
                                    ...
                                    <asp:ListItem Value="5"> 设为主站推荐</asp:ListItem>
                                    <asp:ListItem Value="23"> 设为主站热门</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="30">开启商品审核</asp:ListItem>
                                    <%--<asp:ListItem Value="21">增加店铺微信</asp:ListItem>--%>
                                    <asp:ListItem>---------------</asp:ListItem>
                                    <%--<asp:ListItem Value="10"> 取消明星</asp:ListItem>
                                    <asp:ListItem Value="9"> 取消人气</asp:ListItem>--%>
                                    <asp:ListItem Value="8"> 取消主站推荐</asp:ListItem>
                                    <asp:ListItem Value="24"> 取消主站热门</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="22">取消店铺微信</asp:ListItem>
                                    <asp:ListItem Value="31">关闭商品审核</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            ...
                            <td valign="top" class="lmf_app" style="display:none;">
                                <asp:LinkButton ID="ButtonDelete" runat="server" OnClick="ButtonDelete_Click" OnClientClick="document.getElementById('form1').target='';return DeleteButton()"
                                    class="shanchu lmf_btn"><span>单个删除</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="ButtonUpdateRank" runat="server" OnClick="ButtonUpdateRank_Click"
                                    OnClientClick="document.getElementById('form1').target='';return EditButton()" class="xiudp lmf_btn"><span>修改店铺等级</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
                            ...
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="ButtonUpataShopURL" runat="server" OnClick="ButtonUpataShopURL_Click"
                                    OnClientClick="document.getElementById('form1').target='';return EditButton()" class="xgdpurl lmf_btn"><span>修改店铺URL</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="ButtonChangeOrderID" runat="server" OnClick="ButtonChangeOrderID_Click"
                                    OnClientClick="document.getElementById('form1').target='';return EditButton()" class="glpx lmf_btn"><span>管理排序</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="ButtonShopPayMent" runat="server" OnClick="ButtonShopPayMent_Click"
                                    OnClientClick="document.getElementById('form1').target='';return EditButton()" class="guanli lmf_btn"><span>管理支付类型</span></asp:LinkButton>
                            </td>
                            <td valign="top" class="lmf_app">
                                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="ButtonWxPayMent_Click"
                                    OnClientClick="document.getElementById('form1').target='';return EditButton()" class="guanli lmf_btn"><span>管理微信费用</span></asp:LinkButton>
                            </td>
                            <td>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分站" SortExpression="ShopName">
                        <ItemTemplate>
                            <a>
                    ...
                    <asp:TemplateField HeaderText="店铺名称" SortExpression="ShopName">
                        <ItemTemplate>
                            <a id="A1" href='<%#ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()) %>' target="_blank"
                                runat="server">
                                <%# Eval("ShopName").ToString().Length > 13 ? Eval("ShopName").ToString().Substring(0, 13) : Eval("ShopName").ToString()%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="店铺地址" SortExpression="ShopID">
                        <ItemTemplate>
                            <a id="A2" href='<%#ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()) %>' title='<%#ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()) %>' target="_blank"
                                runat="server">
                                <%#ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()).ToString().Length >= 26 ? ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()).ToString().Substring(0, 26)+"..." : ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()).ToString()%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="类型" SortExpression="ShopType">
                        <ItemTemplate>
                            <%# Eval("ShopType").ToString() == "1" ? "企业" : "个人"%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="主站推荐" SortExpression="IsClose">
                        <ItemTemplate>
                            <asp:Image ID="Imagetj" runat="server" ImageUrl='<%# GetListImageStatus(Eval("IsSystemRecommend").ToString()) %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="主站热门" SortExpression="IsClose">
                        <ItemTemplate>
                            <asp:Image ID="Imagerm" runat="server" ImageUrl='<%# GetListImageStatus(Eval("IsSystemHot").ToString()) %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="开启微信" SortExpression="IsWeiXin">
                        <ItemTemplate>
                            <asp:Image ID="Imagewx" runat="server" ImageUrl='<%# GetListImageStatus(Eval("IsWeiXin").ToString()) %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="主站排序" DataField="SystemOrderID" SortExpression="SystemOrderID"
                        ItemStyle-HorizontalAlign="Center"></asp:BoundField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource" runat="server" SelectMethod="SearchInfoList2"
