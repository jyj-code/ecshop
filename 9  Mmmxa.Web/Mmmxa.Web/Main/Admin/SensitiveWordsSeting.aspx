<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_SensitiveWordsSeting"   CodeBehind="SensitiveWordsSeting.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <td><asp:Label ID="LabelName" runat="server" Text="名称："></asp:Label></td>
                <td><asp:TextBox ID="TextBoxName"
                        CssClass="tinput" runat="server" Width="258"></asp:TextBox></td>
                <td><asp:Button ID="ButtonSearch" runat="server" CssClass="dele" Text="搜索" OnClick="ButtonSearch_Click" /></td>
                </tr>
                </table>
                <div class="sbtn">
                    <table cellpadding="0" cellspacing="0" border="0">
