<%@ page language="C#" autoeventwireup="true" inherits="Admin_ChangeCityAdvancePaymentLog_List"   CodeBehind="ChangeCityAdvancePaymentLog_List.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height: 35px; vertical-align: top;">
                            <td class="lmf_padding">
                                <asp:Label ID="Label3" runat="server" Text="分站名称："></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr style="height: 35px; vertical-align: top;">
                            <td class="lmf_padding">
                                <asp:Label ID="Label4" runat="server" Text="是否主站："></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="DropdownListIsMainAdmin" runat="server" Width="201px" CssClass="tselect">
                                    <asp:ListItem Value="-1" Selected="True">-全部-</asp:ListItem>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="城市分站" SortExpression="ShopName">
                        <ItemTemplate>
                            <a>
                    ...
                    <asp:TemplateField HeaderText="平台" SortExpression="IsMainAdmin">
                        <ItemTemplate>
                             <%#AgentType(Eval("IsMainAdmin").ToString())%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="Search"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownListSubstationID" Name="SubstationID" PropertyName="SelectedValue"
                Type="String" />
            <asp:ControlParameter ControlID="DropdownListIsMainAdmin" Name="IsMainAdmin" PropertyName="SelectedValue"
                Type="Int32" />
