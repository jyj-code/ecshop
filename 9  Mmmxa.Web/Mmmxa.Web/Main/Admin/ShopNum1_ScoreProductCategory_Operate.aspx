<%@ page language="C#" autoeventwireup="true" inherits="ShopNum1_Admin_ScoreProductCategory_Operate, ShopNum1.Deploy" %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelTitle" runat="server" Text="新增积分商品分类"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
