<%@ page language="C#" autoeventwireup="true" inherits="TbCategory_Settings, ShopNum1.Deploy" %>
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:TextBox ID="TextBoxKey" runat="server" CssClass="tinput" MaxLength="50" Width="415px"></asp:TextBox>
                     </td>
                    </tr>
                    <tr>
                        <th align="right">
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxUnionPostUrl" runat="server" CssClass="tinput" MaxLength="50" Width="416px"></asp:TextBox>
                        </td>
                    </tr>
