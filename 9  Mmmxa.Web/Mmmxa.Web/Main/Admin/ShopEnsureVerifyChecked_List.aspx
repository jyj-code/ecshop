<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopEnsureVerifyChecked_List"   CodeBehind="ShopEnsureVerifyChecked_List.aspx.cs"      %>
...
<body class="widthah">
            ...
            <div class="welcon clearfix">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td>
                                    ...
                                    <td>
                                      <asp:DropDownList ID="DropDownListIsAudit" runat="server" CssClass="tselect" Width="201"></asp:DropDownList>
    ...
    <asp:Button ID="ButtonSearch" runat="server" Text="查询" OnClick="ButtonSearch_Click" CssClass="dele"  />
                ...
                <tr>
                <td valign="top">
                    <asp:LinkButton ID="ButtonAudit" runat="server"  CssClass="shtg lmf_btn" OnClientClick="return EditButton();" OnClick="ButtonAudit_Click"  >
            <span>审核通过</span></asp:LinkButton>
             ...
             <span>批量删除</span></asp:LinkButton>
                ...
                <asp:BoundField DataField="ApplyTime" HeaderText="申请时间" SortExpression="ApplyTime" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="PaymentName" HeaderText="支付方式" SortExpression="PaymentName" ItemStyle-HorizontalAlign="Center" />
