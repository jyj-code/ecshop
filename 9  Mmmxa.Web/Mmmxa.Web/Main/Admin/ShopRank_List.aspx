<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopRank_List"   CodeBehind="ShopRank_List.aspx.cs"      %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridviewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%#"ShopRank_Operate.aspx?guid="+Eval("Guid")%>" style="color: #4482b4;">编辑</a>
