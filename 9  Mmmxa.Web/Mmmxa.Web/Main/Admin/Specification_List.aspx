<%@ page language="C#" autoeventwireup="true" inherits="Admin_SpecificationList"   CodeBehind="SpecificationList.aspx.cs"      %>
        ...
        <div class="welcon clearfix">            
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="规格名称" SortExpression="SpecName" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="规格值"  ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate><p mode="wrap" style="width:650px;text-align: left; white-space: normal;"><%#((DataRowView)Container.DataItem).Row["detailSpec"].ToString()%></p></ItemTemplate>
                    </asp:TemplateField>
