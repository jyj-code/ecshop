<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopArticle_List"   CodeBehind="ShopArticle_List.aspx.cs"      %>
            ...
            <div class="order_edit">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr style=" height:35px; vertical-align:top;">
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tselect" Width="201" >
                            </asp:DropDownList>
                        </td>
                        <td class="lmf_padding">
                            发布人：
                    ...
                    <tr style="height:35px; vertical-align:top;">
                       ...
                       <td class="lmf_padding">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                        <td><asp:TextBox ID="textBoxStartDate" runat="server" CssClass="tinput" Width="68"></asp:TextBox></td>
                        ...
                        <td> <GroupFly:CalendarExtender ID="CalendarExtender4"
                                    runat="server" TargetControlID="textBoxStartDate"  Format="yyyy-MM-dd"  PopupButtonID="imgCalendarSReplyTime2"
                        ...
                        <td class="lmf_px">-</td>
                        <td><asp:TextBox ID="textBoxEndDate" runat="server" CssClass="tinput" Width="68"></asp:TextBox></td>
                        ...
                        <td><GroupFly:CalendarExtender ID="CalendarExtender1"
                                    runat="server" TargetControlID="textBoxEndDate"  Format="yyyy-MM-dd"   PopupButtonID="img1" CssClass="ajax__calendar" /></td>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="标题" SortExpression="Title">
                      ...
                      <asp:TemplateField  HeaderText="店铺" SortExpression="MemLoginID">
                         <ItemTemplate>
                            <center>  <a href='<%#ShopUrlOperate.shopHrefNew(Eval("MemLoginID").ToString()) %>' target="_blank"><%#GetShopName(Eval("MemLoginID").ToString())%></a></center> 
                         </ItemTemplate>
                   </asp:TemplateField>
