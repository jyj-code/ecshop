<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopVedioChecked_List"   CodeBehind="ShopVedioChecked_List.aspx.cs"      %>
                           ...
                           <tr style="height:35px; vertical-align:top;">
                                    <td>
                                     ...
                                     <td>
                                         ...
                                         <asp:TextBox ID="textBoxStartDate" runat="server" CssClass="tinput" Style="width: 68px;"></asp:TextBox>
                                ...
                                &nbsp;<GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" 
TargetControlID="textBoxStartDate"
                                    PopupButtonID="imgCalendarSReplyTime1" CssClass="ajax__calendar" />
                                -<asp:TextBox ID="textBoxEndDate" runat="server" CssClass="tinput" Style="width: 68px;"></asp:TextBox>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorStartDate0" runat="server"
                                    ControlToValidate="textBoxEndDate" Display="Dynamic" ErrorMessage="时间格式不正确" 
ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator>
                                &nbsp;<GroupFly:CalendarExtender ID="CalendarExtender2" runat="server" 
TargetControlID="textBoxEndDate"
                                    ...
                                    <td>
                                     ...
                                     <td>
                                           <asp:Button ID="ButtonSearch" runat="server" Text="查询" OnClick="ButtonSearch_Click" CssClass="dele"  />
                                    </td>                            
                                     <td>
                ...
                <div class="sbtn">
                    ...
                    <asp:LinkButton ID="Button1" runat="server"  CssClass="shtg lmf_btn" OnClientClick="return AuditButton();"
                        ...
                        OnClientClick="return DeleteButton()" OnClick="ButtonDelete_Click" CssClass="shanchu lmf_btn" ><span>批量删除</span></asp:LinkButton>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="审核状态" SortExpression="IsAudit">
                     ...
                     <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "ShopVedio_Details.aspx?guid='"+Eval("Guid")+"'&type=Checked" %>" style="color: #4482b4;">
                                查看</a>
