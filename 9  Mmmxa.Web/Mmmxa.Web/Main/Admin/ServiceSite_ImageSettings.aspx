<%@ page language="C#" autoeventwireup="true" inherits="Service_ServiceAdmin_ServiceSite_ImageSettings, ShopNum1.Deploy" enableviewstate="true" %>
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                 <tr class="radiobtn">
                    ...
                    <td>
                            ...
                            <asp:RadioButtonList ID="RadioButtonListIfSetWaterMark" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <img id="ImgWaterMarkOriginalImge" alt="" src="" runat="server" height="110" />(建议高宽在100px以内)
                 ...
                 <tr class="radiobtn">
                        ...
                        <td>
                                ...
                                <asp:RadioButtonList ID="RadioButtonListWaterMarkImagePosition" runat="server" RepeatDirection="Horizontal"  RepeatLayout="Flow">
                     ...
                     <tr>
                        ...
                        <tr>
                            <tr>
                                ...
                                <td>
                                        <asp:TextBox ID="TextBoxWaterMarkWords" runat="server" CssClass="tinput"></asp:TextBox><span style="color: Red"> *</span>
                                        ...
                                        <tr>
                                         ...
                                         <tr class="radiobtn">
                                                ...
                                                <th align="right">
                                                    ...
                                                    <td align="left">
                                                        <asp:RadioButtonList ID="RadioButtonListWordsWaterMarkPosition" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
