<%@ page language="C#" autoeventwireup="true" inherits="Main_MainAdmin_ShopVedioComment_List, ShopNum1.Deploy" %>
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownListSubstationID" runat="server" Width="200"
                                    CssClass="tselect">
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <tr>
                            <td><asp:TextBox ID="TextBoxSCommentTime1" CssClass="tinput" Style="width: 68px;" runat="server"></asp:TextBox></td>
                            ...
                            <td class="lmf_px">－</td>
                            <td><asp:TextBox ID="TextBoxSCommentTime2" CssClass="tinput" Style="width: 68px;" runat="server"></asp:TextBox></td>
                            ...
                            <td><GroupFly:CalendarExtender ID="CalendarExtender1"
                                        ...
                                        CssClass="ajax__calendar" /></td>
                            <td><asp:TextBox ID="TextBoxSReplyTime1" Visible="false" CssClass="tinput" Style="width: 100px;"
