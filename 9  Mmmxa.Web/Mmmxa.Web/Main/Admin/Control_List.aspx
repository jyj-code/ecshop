<%@ page language="C#" autoeventwireup="true" inherits="Admin_Control_List"   CodeBehind="Control_List.aspx.cs"      %>
...
<body>
  ...
  <div>
        ...
        <asp:Button ID="ButtonDelete" runat="server" CausesValidation="False" Text="批量删除" OnClientClick="return DeleteButton()"
                ...
                <table cellpadding="0" cellspacing="1" border="0" style="width: 100%">
                    ...
                    <tr style="background-color: #EEEEEE;" class="btconfig; height:30px;">
                      ...
                      <%-- <input id="inputReset" runat="server" type="reset" value="重置" class="bt2" />--%>
                                <uc1:messageshow
                            id="MessageShow" runat="server" visible="False" />
