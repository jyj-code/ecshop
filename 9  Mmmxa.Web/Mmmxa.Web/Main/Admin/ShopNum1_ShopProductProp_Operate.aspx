<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopNum1_ShopProductProp_Operate"   CodeBehind="ShopNum1_ShopProductProp_Operate.aspx.cs"      %>
...
function ChangeInput()
{
   ...
   if(radioButton.checked)
   {    
      tb.style.display="none"; document.getElementById("ButtonValueAdd").style.display="none";                
   }
   else
   {   
      tb.style.display="block";document.getElementById("ButtonValueAdd").style.display="block";      
   }
}
...
{
     var radioButton = document.getElementById("RadioButtonListShowType_4");
   if(document.getElementById("TextBoxProductPropName").value==""){alert("属性名称不能为空！"); return false;}
    ...
    {          
        ...
        {
            if(inputs[i].name=="orderProp_Order"){alert("排序编号不能为空！");inputs[i].focus();inputs[i].className='error';  return false;} 
            if(inputs[i].name=="propValue"){alert("属性值不能为空！");inputs[i].focus();inputs[i].className='error';  return false;} 
...
<body>
    ...
    <div id="right">
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr class="radiobtn">
                        ...
                        <td>
                            <asp:RadioButtonList ID="RadioButtonListShowType" runat="server"  RepeatLayout="Flow" RepeatDirection="Horizontal">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="ButtonValueAdd" runat="server" type="button" value="添加属性值" class="selpic" onclick="if(checkRowsLimit()) {addNewRow();}"  style=" margin-left:10px;"/>
                        </td>
                    </tr>
                    <tr>
                     <th align="right">
                    ...
                    <td colspan="2" id="trProp" runat="server">
                        ...
                        <tr><td align="center" style="width:150px;">排序</td><td align="center" style="width:200px;">属性名称</td><td align="center">操作</td></tr>
                        <%if (dt_Prop != null)
                          {
      ...
      type=text maxlength=30 name="orderProp_Order" class="input1" value='<%=dt_Prop.Rows[i]["orderid"] %>'/></td>
         <td align="left"><input type=text  maxlength=30 name="propValue" class="input1" value='<%=dt_Prop.Rows[i]["name"] %>' /></td>
         <td align="left"><a href="javascript:void(0)" onclick="removeRow(this,'<%=dt_Prop.Rows[i]["id"] %>')">删除</a><input type="hidden" name="hidDG" value='<%=dt_Prop.Rows[i]["id"] %>'/></td></tr>
                             <% }
                          } %>
                        </table>
                    </td>
