<%@ page language="C#" autoeventwireup="true" inherits="Admin_ShopEnsureVerify_List"   CodeBehind="ShopEnsureVerify_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
               ...
               <td>分站ID：</td>
               <td>
                    <asp:DropDownList ID="DropDownListSubstationID" CssClass="tinput" Width="183px"  runat="server">
                    </asp:DropDownList>
               </td>
               <td>&nbsp;&nbsp;&nbsp;</td>
               <td>担保名称：</td>
               <td><asp:TextBox ID="TextBoxName" runat="server" CssClass="tinput" Width="200"></asp:TextBox></td>
               <td>&nbsp;&nbsp;&nbsp;</td>
               <td>店铺ID：</td>
               <td><asp:TextBox ID="TextBoxMemberLoginID" runat="server" CssClass="tinput" Width="200"></asp:TextBox></td>
               <td><asp:Button ID="ButtonSearch" runat="server" Text="查询" OnClick="ButtonSearch_Click"
                ...
                <td valign="top" class="lmf_app" style="display:none;">
                    <asp:LinkButton ID="ButtonCancelAudit" runat="server" CssClass="qb"  Visible="false" OnClientClick="return EditButton();"
                        OnClick="ButtonCancelAudit_Click"  ><span>取消审核</span></asp:LinkButton>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作"  >
                        <ItemTemplate>
				<asp:LinkButton ID="LinkDelte" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("Guid")%>'   OnClientClick="return window.confirm('您确定要删除吗?');" OnClick="ButtonDeleteBylink_Click">删除</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="15%" />
                    </asp:TemplateField> 
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchEnsureApply_ListNew"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="TextBoxMemberLoginID" Name="MemberLoginID" PropertyName="Text" Type="String" />
