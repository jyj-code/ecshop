<%@ page language="C#" autoeventwireup="true" inherits="Admin_ServiceSite_BasicSettings"   CodeBehind="ServiceSite_BasicSettings.aspx.cs"      %>
        ...
        <div class="mhead">
            <div class="ml">
                <div class="mr" id="header">
                    <ul class="mul">
                        <li><a class="cur" id="current1" style="cursor: pointer;" onclick="changeTab(5,1);">
                            <asp:Label runat="server" ID="tab01" Text="审核设置" /></a>
                        </li>
                        <li><a id="current2" style="cursor: pointer;" onclick="changeTab(5,2);">
                            <asp:Label runat="server" ID="tab02" Text="操作条件" /></a>
                        </li>
                        <li><a id="current3" style="cursor: pointer;" onclick="changeTab(5,3);">
                            <asp:Label runat="server" ID="tab03" Text="赠送设置" /></a>
                        </li>
                        <li><a id="current4" style="cursor: pointer;" onclick="changeTab(5,4);">
                            <asp:Label runat="server" ID="tab04" Text="提成设置" /></a>
                        </li>
                        <li><a id="current5" style="cursor: pointer;" onclick="changeTab(5,5);">
                            <asp:Label runat="server" ID="tab05" Text="其他设置" /></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="welcon clearfix">
            ...
            <div id="content1" runat="server" style="display: block;">
                <div class="inner_page_list">
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelVideoCommentISAudit" runat="server" Text="视频评论是否需要审核："></asp:Label>
                        </th>
                        <td>
            ...
            <div id="content2" runat="server" style="display: none;">
                 ...
                 <tr style="display:none;">
                        <th align="right" width="180px">
                            <asp:Label ID="Label7" runat="server" Text="预存款支付是否需要短信确认码："></asp:Label>
                        </th>
                        <td valign="middle">
            ...
            <div id="content3" runat="server" style="display: none;">
                ...
                <tr>
                        <th align="right">
                            <asp:Label ID="Label2" runat="server" Text="签到是否送积分："></asp:Label>
                        </th>
                        <td>
                            <asp:DropDownList ID="DropDownListSignOrSendScore" runat="server" CssClass="tselect"
                                Width="301px">
                                <asp:ListItem Value="0">不送积分</asp:ListItem>
                                <asp:ListItem Value="1">赠送积分</asp:ListItem>
                            </asp:DropDownList>
                            <span style="color: Red">*</span>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                            <asp:Label ID="Label5" runat="server" Text="签到赠送消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="Label6" runat="server" Text="签到赠送等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelRegPresentScore" runat="server" Text="会员注册赠送消费积分："></asp:Label>
                        </th>
                        <td>
...
为空"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelRegPresentRankScore" runat="server" Text="会员注册赠送等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMyMessageRankSorce" runat="server" Text="发布平台留言赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMyMessageSorce" runat="server" Text="发布平台留言赠送的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMyShopMessageRankSorce" runat="server" Text="发布店铺留言赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMyShopMessageSorce" runat="server" Text="发布店铺留言赠送的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelBuyProductRankScore" runat="server" Text="消费额和赠送等级积分比例："></asp:Label>
                        </th>
                        <td>
                            <asp:TextBox ID="TextBoxBuyProductRankScore" MaxLength="9" runat="server" CssClass="tinput"
                                Width="299px"></asp:TextBox> %
                            <span style="color: Red">*</span><span>(10%,表示 100元赠送10积分)</span>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelBuyProductScore" runat="server" Text="消费额和赠送消费积分比例："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelMyCommentRankSorce" runat="server" Text="商品评论赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelMyCommentSorce" runat="server" Text="商品评论赠送的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelSellerCommentRankSorce" runat="server" Text="卖家回评赠送会员的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelSellerCommentSorce" runat="server" Text="卖家回评赠送会员的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelArticleCommentRankSorce" runat="server" Text="平台资讯评论赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelArticleCommentSorce" runat="server" Text="平台资讯评论赠送的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelShopArticleCommentRankSorce" runat="server" Text="店铺资讯评论赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelShopArticleCommentSorce" runat="server" Text="店铺资讯评论赠送的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMySupplyDemandCommentRankSorce" runat="server" Text="供求评论赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMySupplyDemandCommentSorce" runat="server" Text="供求评论赠送的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMyCategoryInfoCommentRankSorce" runat="server" Text="分类评论赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelMyCategoryInfoCommentSorce" runat="server" Text="分类评论赠送的消费积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelVideoCommentRankSorce" runat="server" Text="视频评论赠送的等级积分："></asp:Label>
                        </th>
                        <td>
                    ...
                    <tr style=" display:none">
                        <th align="right">
                            <asp:Label ID="LabelVideoCommentSorce" runat="server" Text="视频评论赠送的消费积分："></asp:Label>
                        </th>
                        <td>
...
能输入数字" ValidationExpression="^[0-9]*$" Display="Dynamic"></asp:RegularExpressionValidator>
            ...
            <!-- start***************************提成设置*************************** -->
            <div id="content4" runat="server" style="display: none;">
                <div class="inner_page_list">
                    <table border="0" cellpadding="0" cellspacing="1">
                <tr>
                        <th align="right">
                    ...
                    <tr>
                        <th align="right">
                            <span>店铺订单分站提成开关：</span>
                        </th>
                        <td>
                            <asp:DropDownList ID="DropDownListIsAgentOrderCommission" runat="server" Width="301px"
                                CssClass="tselect">
                                <asp:ListItem Value="false">不开启</asp:ListItem>
                                <asp:ListItem Value="true">开启</asp:ListItem>
                            </asp:DropDownList>
                            <span style="color: Red">*</span><span>指对应分站的店铺订单确认收货后，分给分站的提成。</span>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                            <span>店铺订单分站提成比例：</span>
                        </th>
                        <td>
                            <asp:TextBox ID="TextBoxAgentOrderCommission" MaxLength="9" runat="server" CssClass="tinput"
                                Width="299px" Text="30">
                            </asp:TextBox>
                            % <span style="color: Red">*</span>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="TextBoxOrderCommission"
                                Display="Dynamic" ErrorMessage="该值不能为空">
                            </asp:RequiredFieldValidator>
            ...
            <!-- start***************************其他设置*************************** -->
            <div id="content5" runat="server" style="display: none;">
                <div class="inner_page_list">
                    <table border="0" cellpadding="0" cellspacing="1">
                <tr style=" display:none">
                        <th align="right">
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="Label3" runat="server" Text="每次积分兑换最大商品量："></asp:Label>
                        </th>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxMaxScroeProductCount"
                                Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                            <span>请输入积分兑换最大商品量</span>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                            <asp:Label ID="Label4" runat="server" Text="直通车每日扣除预存款金额："></asp:Label>
                        </th>
                        <td>
                            <asp:TextBox ID="TextBoxZtcGoodsMoney" CssClass="tinput" runat="server" Width="299px" MaxLength="8">1</asp:TextBox>
                            <span style="color: Red">*</span>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBoxZtcGoodsMoney"
                                Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                            <span>请输入预存款金额(系统每天会自动扣除直通车用户预存款)</span>
                        </td>
                    </tr>
                    <tr>
