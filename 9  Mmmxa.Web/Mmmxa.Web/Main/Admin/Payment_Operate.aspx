<%@ page language="C#" autoeventwireup="true" inherits="Admin_Payment_Operate"   CodeBehind="Payment_Operate.aspx.cs"      %>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:DropDownList ID="DropDownListPaymentType" runat="server" CssClass="tselect">
                                ...
                                <asp:ListItem Value="Alipay3.aspx">支付宝即时到账</asp:ListItem>
                                ...
                                <asp:ListItem Value="Baofoo.aspx">宝付支付</asp:ListItem>
                                <asp:ListItem Value="ShengPay.aspx">盛付通支付</asp:ListItem>
                                <asp:ListItem Value="huanxun.aspx">环迅支付</asp:ListItem>
                                <asp:ListItem Value="TL.aspx">通联支付</asp:ListItem>
                                <asp:ListItem Value="Baofoo.aspx">宝付支付V3.0</asp:ListItem>
                                <asp:ListItem Value="BaofooV4.aspx">宝付支付V4.0</asp:ListItem>
                                <asp:ListItem Value="ShengPay.aspx">盛付通支付</asp:ListItem>
                                <asp:ListItem Value="huanxun.aspx">环迅支付(E)</asp:ListItem>
                                <asp:ListItem Value="YiShouFu.aspx">环迅支付(R)</asp:ListItem>
                                <asp:ListItem Value="ChinaPayClient.aspx">银联支付(ChinaPay)</asp:ListItem>
                                <asp:ListItem Value="KqSend.aspx">快钱支付</asp:ListItem>
                                <asp:ListItem Value="alidirectpay.aspx">支付宝网银</asp:ListItem>
                                 <asp:ListItem Value="TL.aspx">通联支付</asp:ListItem>
                                 <asp:ListItem Value="Boc.aspx">交通银行</asp:ListItem>
                            </asp:DropDownList>
