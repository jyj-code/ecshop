<%@ page language="C#" autoeventwireup="true" inherits="Admin_CityPaymentMemApplyLog_Operate"   CodeBehind="CityPaymentMemApplyLog_Operate.aspx.cs"      %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="分站提款审核"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
        <div class="welcon clearfix">
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        <th align="right">
                            <asp:Label ID="Label3" runat="server" Text="分站ID："></asp:Label>
                        </th>
                        <td>
                            <font class="font1">
                                <asp:Label ID="LabelSubstationID" runat="server"></asp:Label></font>
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                            <asp:Label ID="Label10" runat="server" Text="分站用户："></asp:Label>
                        </th>
                        <td>
                            <font class="font1">
                    ...
                    <asp:Panel ID="Panel1" runat="server" Visible="false">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox_Bank" runat="server" ReadOnly="true" ></asp:TextBox>
                                <span>开户银行名称</span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        <th align="right">
                            <asp:Label ID="LabelMemo" runat="server" Text="分站用户备注："></asp:Label>
                        </th>
                        <td>
            ...
            <div class="tablebtn">
                ...
                <input id="ResetGoBack" runat="server" type="button" onclick="javascript: window, location.href = 'CityPaymentApplyLog_List.aspx'"
