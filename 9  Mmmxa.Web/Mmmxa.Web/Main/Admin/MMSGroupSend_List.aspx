<%@ page language="C#" autoeventwireup="true" inherits="Admin_MMSGroupSend_List"   CodeBehind="MMSGroupSend_List.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
                 ...
                 <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:35px; vertical-align:top;">
                        ...
                        <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorEndDate" runat="server"
                                ...
                                ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                        <td><ShopNum1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TextBoxCreateTime2"
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="短信内容" SortExpression="SendObjectMMS">
                        <ItemTemplate>
                            <span title='<%#Eval("SendObjectMMS").ToString() %>'>
                           <%# Eval("SendObjectMMS").ToString().Length > 26 ? Eval("SendObjectMMS").ToString().Substring(0,26) +"...": Eval("SendObjectMMS").ToString()%></span>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
