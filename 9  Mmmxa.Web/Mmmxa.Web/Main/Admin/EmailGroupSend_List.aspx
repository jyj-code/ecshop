<%@ page language="C#" autoeventwireup="true" inherits="Admin_EmailGroupSend_List"   CodeBehind="EmailGroupSend_List.aspx.cs"      %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <tr>
                            <td><asp:TextBox ID="TextBoxCreateTime1" runat="server" CssClass="tinput" Width="66"></asp:TextBox></td>
                            ...
                            <td> <ShopNum1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBoxCreateTime1"
                                    PopupButtonID="imgCalendarStartTime" CssClass="ajax__calendar" Format="yyyy-MM-dd">
                                </ShopNum1:CalendarExtender></td>
                            <td class="lmf_px">-</td>
                            <td><asp:TextBox ID="TextBoxCreateTime2" runat="server" CssClass="tinput" Width="66"></asp:TextBox></td>
                            ...
                            <td> <asp:RegularExpressionValidator ID="RegularExpressionValidatorEndDate" runat="server"
                                    ...
                                    ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                            <td><ShopNum1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TextBoxCreateTime2"
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <%--分页--%>
                <PagerStyle CssClass="lmf_page" BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Center" />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Guid" HeaderText="GUID" SortExpression="Guid" Visible="False"
                        ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="EmailTitle" HeaderText="邮件标题" SortExpression="EmailTitle"
                        ItemStyle-HorizontalAlign="Center" />
                    ...
                    <asp:BoundField DataField="SendObjectEmail" HeaderText="发送对象" SortExpression="SendObjectEmail">
                    ...
                    <%-- <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a style="display:none" href="<%# "EmailGropSend_Operate.aspx?guid='"+Eval("Guid")+"'" %>" style="color: #4482b4;">编辑</a>
                        <asp:LinkButton ID="LinkDelte" runat="server" Style="color: #4482b4;" OnClick="ButtonDeleteBylink_Click"
                           Visible="false"  CommandArgument='<%# Eval("Guid") %>' OnClientClick="return window.confirm('您确定要删除吗?');">删除</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>--%>
                </Columns>
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchEmailGroupSend"
