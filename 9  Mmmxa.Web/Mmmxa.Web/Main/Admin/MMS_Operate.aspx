<%@ page language="C#" autoeventwireup="true" inherits="Admin_MMS_Operate"   CodeBehind="MMS_Operate.aspx.cs"      %>
            ...
            <div class="inner_page_list">
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                     ...
                     <tr>
                        <th align="right"><asp:Label ID="Label1" runat="server" Text="标签说明："></asp:Label></th>
                         <td>
<p id="190d25f8-a9e9-4162-b4e8-0a3954c83473" lang="下单时给卖家短信提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;订单号为：{$OrderNumber}&nbsp;&nbsp;会员名称：{$MemLoginId}&nbsp;&nbsp;会员电话：{$UserTel}&nbsp;&nbsp;会员手机号码：{$UserMobile}&nbsp;&nbsp;商品名称：{$ProductName}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
...
<p id="e77e5311-e0d2-4b6e-b16d-65db7f4ace40" lang="确认收货短信提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;订单号为：{$OrderNumber}&nbsp;&nbsp;站点名称：{$ShopName}&nbsp;&nbsp;系统时间：{$SysSendTime}
&nbsp;&nbsp;订单状态：{$OrderStatus}</p>
<p id="0610a526-229e-4075-b084-3b6a5b929759" lang="确认消费短信提醒" style="display:none">用户名：{$Name}&nbsp;&nbsp;消费金额：{$PayMoney}&nbsp;&nbsp;系统时间：{$SysSendTime}</p>
...
<p id="4a12724c-5154-4928-b867-d5bd180e80e6" lang="注册会员成功" style="display:none">用户名：{$Name}&nbsp;&nbsp;站点名称：{$ShopName} &nbsp;&nbsp;系统时间：{$SysSendTime}</p></td>
                    </tr>
                    <tr>
                        <th align="right">
            ...
            <div class="tablebtn">
                <asp:Button ID="butConfirm" runat="server" OnClick="butConfirm_Click" Text="确定" CssClass="fanh" ToolTip="Submit" />
