<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_SupplyDemandCommentAudit_List"   CodeBehind="SupplyDemandCommentAudit_List.aspx.cs"      %>
...
<body class="widthah">
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelTitle" runat="server" Text="主站供求评论审核列表" /></h3>
            </div>
            <div class="rr">
            </div>
        </div>
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td>
                            ...
                            <tr>
                            <td><asp:TextBox ID="TextBoxTime1" CssClass="tinput" Style="width:58px;" runat="server"></asp:TextBox></td>
                            <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorStartDate" runat="server"
                                    ControlToValidate="TextBoxTime1" Display="Dynamic" ErrorMessage="时间格式不正确" ValidationExpression="^((((1[6-9]|[2-9]\d)\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\d|3[01]))|(((1[6-9]|[2-9]\d)\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\d|30))|(((1[6-9]|[2-9]\d)\d{2})-0?2-(0?[1-9]|1\d|2[0-9]))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))( (20|21|22|23|[0-1]?\d):[0-5]?\d:[0-5]?\d)?$"></asp:RegularExpressionValidator></td>
                            ...
                            <td class="lmf_px">-</td>
                            <td><asp:TextBox ID="TextBoxTime2" CssClass="tinput" Style="width:58px;" runat="server"></asp:TextBox></td>
                            <td><asp:RegularExpressionValidator ID="RegularExpressionValidatorEndDate" runat="server"
                            ...
                            <td style="padding-left: 4px; vertical-align: top;"><img id="imgCalendarSReplyTime3" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                    height: 18px; position: relative; top: 3px;" /></td>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%# "SupplyDemandComment_Operate.aspx?guid='"+Eval("Guid")+"'&goback=sh" %>" style="color: #4482b4;">
                                查看</a>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="GetSupplyDemandCommentAll1"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="TextBoxTime2" Name="createTime2" PropertyName="Text"
                Type="String" />
            <asp:Parameter Type="String"  Name="SubstationID" DefaultValue="all" />
