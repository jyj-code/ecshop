<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_ShopRank_Operate"   CodeBehind="ShopRank_Operate.aspx.cs"      %>
...
function GetCheckedBoxValues()
{
   ...
   function openLogoSingleChild()
    ...
    <style type="text/css">
         #CalendarExtender4_daysBody td{height:15px; line-height:15px;}
    </style>
</head>
<body>
                ...
                <table border="0" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td valign="middle">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                runat="server" ControlToValidate="TextBoxRankValue" ErrorMessage="只能输入数字" ValidationExpression="^[0-9]*$"
                                Display="Dynamic"></asp:RegularExpressionValidator><br />(店铺等级值是为了区分等级之间的差距，等级值越高，那么表示等级越高，请不要设置和其他等级相同的等级值，请输入0到100之间的任意整数。)
                        </td>
                    </tr>
                    <tr>
                        <th align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img id="image" src="" runat="server" alt="" width="20" height="20" />友情提示：图片高度控制在20px内
                        </td>
                    </tr>
                    <%--<tr>
                        <th align="right">
