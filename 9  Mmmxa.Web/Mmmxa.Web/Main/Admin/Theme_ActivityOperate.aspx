<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_Theme_ActivityOperate"   CodeBehind="Theme_ActivityOperate.aspx.cs"      enableviewstate="false" %>
...
<body>
   ...
   <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3><span id="LabelTitle">主题活动</span></h3>
            </div>
            <div class="rr">
            </div>
        </div>
            ...
            <div class="inner_page_list">
                <table cellspacing="1" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <script type="text/javascript" language="javascript" src="/JS/DatePicker/WdatePicker.js" defer="defer"></script>
                            <input type="text" id="txtStartTime" class="datetinput ss_nrduan" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
                        </td>
                    </tr>
                     <tr>
                        <th align="right">
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <br />
                           <span style="color:Red;">*</span><span id="imgCheck"  check="errormsg">横幅图片不能为空！</span>  图片建议尺寸：宽1190 * 高458
                        </td>
                    </tr>
                    <tr>
                        <th align="right" style="width:100px;">
                        ...
                        <td>
                           ...
                           <span style="color:Red;">*</span><span check="errormsg">活动说明不能为空(输入字符不能超过200)！</span>
                        </td>
                    </tr>
                    <tr runat="server" id="showUrl" visible="false">
                                <th align="right" style="width: 100px;">
                                    <span id="Span6">主题链接：</span>
                                </th>
                                <td>
                                    <input type="text" class="tinput" id="copyTxt" value='<%=ThemUrl %>' style="width: 400px;" onmouseover="this.select()" />
                                    (在网站装修栏目管理那里设置主题活动导航)
                                </td>
                     </tr>
                    <tr>
                      ...
                      <tr style="display:none;">
                        ...
                        <td>
                            <input type="text" id="txtFinalTime" class="datetinput ss_nrduan" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
...
//             }
        ...
        if(parseInt(substartTime2)<parseInt(subendTime2)){return true;}else if(parseInt(substartTime)<parseInt(subendTime)){return true;}else{return false;}}
            ...
            <div class="tablebtn">
                <asp:Button ID="btnSub" CssClass="fanh" runat="server" OnClientClick="return funCheck()" Text="提交" OnClick="btnSub_Click" />   <input type="button" onclick="location.href='Theme_ActivityList.aspx';" class="fanh" value="返回"/><asp:Label ID="lblMsg" runat="server" ForeColor="Red" Visible="false"></asp:Label>
            </div>
        </div>
    </div>
    </form>
