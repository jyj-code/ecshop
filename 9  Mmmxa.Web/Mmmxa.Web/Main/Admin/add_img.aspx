<%@ page language="C#" autoeventwireup="true" inherits="Main_Admin_add_img"   CodeBehind="add_img.aspx.cs"      %>
...
<body>
    ...
    <groupfly:messageshow id="MessageShow" runat="server" visible="False" />
 <div class="welcon clearfix">
            <table border="0" cellpadding="0" cellspacing="0" class="shoptable">
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd">
                            <asp:TextBox ID="textBoxName" runat="server" Width="175px"  CssClass="tinput" ></asp:TextBox><font color="red">*</font>
