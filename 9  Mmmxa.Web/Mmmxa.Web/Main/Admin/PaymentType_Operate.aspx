<%@ page language="C#" autoeventwireup="true" inherits="Admin_PaymentType_Operate"   CodeBehind="PaymentType_Operate.aspx.cs"      %>
        ...
        <div class="welcon clearfix">
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Image ID="ImageUrl" runat="server"  onerror="javascript:this.src='/ImgUpload/noImage.gif'"  Width="120" Height="120"/>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxMemo" runat="server" CssClass="tinput" TextMode="MultiLine" Width="400" Height="100"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th align="right">
