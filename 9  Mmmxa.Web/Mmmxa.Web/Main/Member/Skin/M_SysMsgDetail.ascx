...
<div class="tjsp_mian">
  <p class="ptitle" ><a href="M_Welcome.aspx">我是买家</a><span class="breadcrume_icon">>></span><a href='<%="M_SysMsg.aspx?isread="+Common.ReqStr("isread")+"&pageid=1"%>'>系统消息</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">系统消息详细</span></p>
  ...
  <tr>
     ...
     <asp:Literal ID="LitContent" runat="server"></asp:Literal>
        ...
        <div style="text-align:center; margin:20px 10px 50px 10px;" >&nbsp;
             <a href='M_SysMsg.aspx?isread=<%=Request.QueryString["isread"]%>&pageid=<%=Request.QueryString["pageid"] %>' class="baocbtn" style="float:none; display:block; color:#ffffff; margin:0 auto;">返回</a>
        </div>
