        ...
        $.get("/Api/Main/Member/GetJson.ashx?type=GetShopQgProduct&start2="+val1+"&end2="+val2+"",null,function(data){
                    if(data!="")
                    {
                        if(data!="[object XMLDocument]" && data!="")
                        {
                            ...
                            $.each(vdata,function(m,n)
                            {
                                Str+="<dl><dt><a target=\"_blank\" href=\""+n.ahref+"\"><img src=\""+n.originalimage+"\" width=\"130\" height=\"130\"  onerror=\"javascript:this.src='/ImgUpload/noImg.jpg'\"  /></a></dt><dd>"+n.name+"</dd><dd style=\"padding-top:10px;\"><strong style=\"font-size:16px;\" class=\"red\">￥"+n.shopprice+"</strong></dd></dl>";    
                            });
                            $("#zxqg").html(Str);
                        }
                        else
...
<li style="text-indent:4px;" id="channel3" onmouseover="channelkey(3)">已浏览商品</li>
    ...
    <div id="menucontent1" class="menu" style="display:block;">
      <div class="me_l">
      <img src="images/jiantouzxl.jpg" width="21" height="125" onclick="funShangC()" id="shangImage2"  style=" cursor:pointer" /> 
       </div>
        <div style=" width:540px; float:left;"  id="zxtg">
	        
        </div>
        <div class="me_r">
        <img src="images/jiantouzxr.jpg" width="21" height="125" onclick="funNextC()" id="xiaImage2" style=" cursor:pointer" />
       </div>
      </div>

    <div id="menucontent2" class="menu" style="display:none;">
    <div class="me_l">
      <img src="images/jiantouzxl.jpg" width="21" height="125" onclick="funShangD()" id="shangImage3" style=" cursor:pointer"  /> 
       </div>
         <div style=" width:540px; float:left;" id="zxqg">
	      	 
        </div>	
        <div class="me_r">
        <img src="images/jiantouzxr.jpg" width="21" height="125" onclick="funNextD()" id="xiaImage3"  style=" cursor:pointer" />
       </div>
      
      </div>
    <div id="menucontent3" class="menu" style="display:none;">
    <div class="me_l">
      <img src="images/jiantouzxl.jpg" width="21" height="125"  onclick="funShangB()" id="shangImage1" style=" cursor:pointer"/> 
       </div>
            <div style=" width:540px; float:left;"  id="yllsp">
		
          </div>
     <div class="me_r">
        <img src="images/jiantouzxr.jpg" width="21" height="125" onclick="funNextB()" id="xiaImage1"  style=" cursor:pointer"  />
        </div>
