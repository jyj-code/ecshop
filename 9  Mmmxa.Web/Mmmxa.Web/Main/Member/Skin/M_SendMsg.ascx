...
<script>
    ...
    {
        var user=$("#M_SendMsg_ctl00_txtUser").val();
        if(user!="")
        {
...
//                                $("#errUser").html("");
    ...
    {
        var title=$("#M_SendMsg_ctl00_txtTitle").val();
        if(title=="")
        {
    ...
    {
        var Msg=$("#M_SendMsg_ctl00_txtMsg").val();
        if(Msg=="")
        {
            $("#errMsg").html("内容不能为空！");
            return false;
...
<div class="tjsp_mian">
  <p class="ptitle" ><a href="M_Welcome.aspx">我是买家</a><span class="breadcrume_icon">>></span><a href="javascript:void(0)">我的站内信</a><span class="breadcrume_icon">>></span><span class="breadcrume_text">发送站内信</span></p>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top:15px;" >
  <tr>
    <th colspan="2" scope="col">发送站内信</th>
    </tr>
    <tr id="showthis">
    <td class="bordleft" style=" border-bottom:solid 1px #c6dfff;" >会员名：</td>
    <td class="bordrig" style=" border-bottom:solid 1px #c6dfff;">
        <input type="text" id="txtUser" runat="server" class="textwb fontSize"  onblur="funCheckUserName()" size="12"/> <span class=red>*</span><span class="red" id="errUser"></span>
       <br />  会员名不能为空,多个会员可以用英文逗号隔开.<br />
      
    </td>
  </tr>
  <tr>
    <td class="bordleft">标题：</td>
    <td class="bordrig">
     <input type="text" id="txtTitle" class="textwb fontSize" runat="server" onblur="funCheckTitle()" size="12" /> <span class=red>*</span>
     <span class="red" id="errTitle"></span>
    </td>
  </tr>
 <tr>
    <td class="bordleft" style=" border-bottom:solid 1px #c6dfff;" >消息内容：</td>
    <td class="bordrig" style=" border-bottom:solid 1px #c6dfff;">
       <textarea runat="server" id="txtMsg"  class="textwb fontSize" style=" width:400px; height:130px;" onblur="funCheckMsg()" size="12"  ></textarea> <span class=red>*</span>
