    ...
    <div class="pad">
        <table border="0" cellspacing="0" cellpadding="0" class="lineh">
            <tr class="up_spac">
                ...
                <td>
                    <asp:DropDownList ID="DropDownListType" runat="server" CssClass="tselect" Width="100">
                ...
                <td>
                    <asp:DropDownList ID="DropDownListStatus" runat="server" CssClass="tselect" Width="100">
                        <asp:ListItem Value="-1">-全部-</asp:ListItem>
                        <asp:ListItem Value="0">未处理</asp:ListItem>
                        <asp:ListItem Value="1" Enabled="false">处理中</asp:ListItem>
                ...
                <td>
                     <input id="inputordernumber" type="text" runat="server" class="ss_nr1" maxlength="20" style="width:130px;" />
                </td>
                <td>
