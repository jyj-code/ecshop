...
<div id="list_main">
    <ul id="sidebar">
        <li class='<%=Common.ReqStr("isread")=="0"?"TabbedPanelsTab TabbedPanelsTabSelected":"TabbedPanelsTab" %>'>
            <a href="?isread=0&pageid=1">未读信息</a></li>
        <li class='<%=Common.ReqStr("isread")=="1"?"TabbedPanelsTab TabbedPanelsTabSelected":"TabbedPanelsTab" %>'>
                ...
                <asp:Repeater ID="RepMsg" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="th_ri">
                                <a href='M_SysMsgDetail.aspx?guid=<%#Eval("Guid")%>&isread=<%=Common.ReqStr("isread") %>&pageid=<%=Common.ReqStr("pageid")%>'>
                                    查看</a>
                            </td>
                        </tr>
                    </ItemTemplate>
