...
<script src="/JS/jquery-1.6.2.min.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        {
            if($("#M_AddSupply_ctl00_DropDownListRegionCode1").val()=="-1")
            {
                $("#errRegion").html("地区必选！");
                return false;
            }
        ...
        {
            var TextBoxTitle=$("#M_AddSupply_ctl00_TextBoxTitle").val();
            if(TextBoxTitle!="")
            {
                $("#errTitle").html("*");
                return true;
        ...
        {
            var TextBoxTel=$("#M_AddSupply_ctl00_TextBoxTel").val();
            if(TextBoxTel!="")
            {
                $("#errTel").html("*");
                return true;
            ...
            {
                $("#errTel").html("联系电话不能为空！");
                return false;
            }
        }
        
        function funCheckContactName()
        {
            var TextBoxContactName=$("#M_AddSupply_ctl00_TextBoxTel").val();
        ...
        {
            var ValidTime=$("#M_AddSupply_ctl00_TextBoxValidTime").val();
            if(ValidTime!="")
            {
                var date = new Date();
        ...
        {
            var email=$("#M_AddSupply_ctl00_TextBoxEmail").val();
            if(email!="")
            {
...
　　                $("#M_AddSupply_ctl00_TextBoxEmail").val("");
　　                return false;          
　　            }  
　　            else
　　            {
...
//             alert(id);
             $.ajax({
                 ...
                 success: function (ajaxData) {
                    if(ajaxData!="")
                    {
                        if(id=="-1")
                        {
                            $("#M_AddSupply_ctl00_HiddenFieldSupplyDemandCategory").val("0");
                        ...
                        {
                            $("#M_AddSupply_ctl00_HiddenFieldSupplyDemandCategory").val($(val).val());
             ...
             $.ajax({
                 ...
                 success: function (ajaxData) {
                    if(ajaxData!="")
                    {
                        if(id==-1)
                        {   
                            $("#M_AddSupply_ctl00_HiddenFieldSupplyDemandCategory").val($("#DropDownListSupplyDemandCategory1").val());
                            $("#DropDownListSupplyDemandCategory3").html("<option value=\"-1\">-请选择-</option>");
                        }
                        else
                        {
         ...
         function funSelectValue3(val)
         {
            ...
            if(id=="-1")
            {
                $("#M_AddSupply_ctl00_HiddenFieldSupplyDemandCategory").val($("#DropDownListSupplyDemandCategory2").val());
            }
            else
            {
                $("#M_AddSupply_ctl00_HiddenFieldSupplyDemandCategory").val($(val).val());
            ...
            $.ajax({
                 ...
                 success: function (ajaxData) {
                    if(ajaxData!="")
                    {
                       ...
                       //alert($("#M_AddSupply_ctl00_HiddenGuid").val().length);
                       //编辑处理
                       if($("#M_AddSupply_ctl00_HiddenGuid").val()!="0")
                       {
                          if($("#M_AddSupply_ctl00_HiddenGuid").val().length==9)
                            {
                                var code1=$("#M_AddSupply_ctl00_HiddenGuid").val().substring(0,3);
                                $("#DropDownListSupplyDemandCategory1 option").each(function()
                                {
                                    if($(this).val().split('|')[1]==code1){$(this).attr("selected","selected");
                                        funSelectValue1(this);
                                        var code2=$("#M_AddSupply_ctl00_HiddenGuid").val().substring(0,6);
                                        $("#DropDownListSupplyDemandCategory2 option").each(function()
                                        {
                                            if($(this).val().split('|')[1]==code2)
                                            {
                                                ...
                                                var code3=$("#M_AddSupply_ctl00_HiddenGuid").val();
                            ...
                            else if($("#M_AddSupply_ctl00_HiddenGuid").val().length==6)
                            {
                                var code1=$("#M_AddSupply_ctl00_HiddenGuid").val().substring(0,3);
                                $("#DropDownListSupplyDemandCategory1 option").each(function()
                                {
                            ...
                            else if($("#M_AddSupply_ctl00_HiddenGuid").val().length==3)
                            {
                                var code1=$("#M_AddSupply_ctl00_HiddenGuid").val().substring(0,3);
                                $("#DropDownListSupplyDemandCategory1 option").each(function()
                                {
             ...
             $.ajax({
                 ...
                 success: function (ajaxData) {
                    if(ajaxData!="")
                    {
                        ...
                        if($("#M_AddSupply_ctl00_HiddenAddressCode").val()!="0")
                        {
                            if($("#M_AddSupply_ctl00_HiddenAddressCode").val().length==9)
                            {
                                var code1=$("#M_AddSupply_ctl00_HiddenAddressCode").val().substring(0,3);
                                $("#DropDownListRegionCode1 option").each(function()
                                {
                                    if($(this).val().split('|')[1]==code1){$(this).attr("selected","selected");
                                        funSelectRegionCode1(this);
                                        var code2=$("#M_AddSupply_ctl00_HiddenAddressCode").val().substring(0,6);
                                        $("#DropDownListRegionCode2 option").each(function()
                                        {
                                            if($(this).val().split('|')[1]==code2)
                                            {
                                                ...
                                                var code3=$("#M_AddSupply_ctl00_HiddenAddressCode").val();
                            ...
                            else if($("#M_AddSupply_ctl00_HiddenAddressCode").val().length==6)
                            {
                                var code1=$("#M_AddSupply_ctl00_HiddenAddressCode").val().substring(0,3);
                                $("#DropDownListRegionCode1 option").each(function()
                                {
                            ...
                            else if($("#M_AddSupply_ctl00_HiddenAddressCode").val().length==3)
                            {
                                var code1=$("#M_AddSupply_ctl00_HiddenAddressCode").val().substring(0,3);
                                $("#DropDownListRegionCode1 option").each(function()
                                {
    ...
    <script type="text/javascript">
        function funSelectRegionCode1(val)
             ...
             $.ajax({
                 ...
                 success: function (ajaxData) {
                    if(ajaxData!="")
                    {
                        if(id=="-1")
                        {
                            $("#M_AddSupply_ctl00_HiddenFieldRegionCode").val("0");
                        ...
                        else
                        {
                            ...
                            $("#M_AddSupply_ctl00_HiddenFieldRegionCode").val($(val).val());
                        }
             ...
             $.ajax({
                 ...
                 success: function (ajaxData) {
                    if(ajaxData!="")
                    {
                        if(id=="-1")
                        {
                            $("#M_AddSupply_ctl00_HiddenFieldRegionCode").val($("#DropDownListRegionCode1").val())
                            $("#DropDownListRegionCode3").html("<option value=\"-1\">-请选择-</option>");
                        }
                        else
                        {
         ...
         function funSelectRegionCode3(val)
         {
            ...
            if(id=="-1")
            {
                $("#M_AddSupply_ctl00_HiddenFieldRegionCode").val($("#DropDownListRegionCode2").val())
            }
            else
            {
                $("#M_AddSupply_ctl00_HiddenFieldRegionCode").val($(val).val());
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="biaod" style="margin-top:15px;" >
  <tr>
    <th colspan="2" scope="col" width="130">
        <asp:Label ID="LabelTitle" runat="server" Text="发布供求信息"></asp:Label></th>
    </tr>
    <tr>
    <td class="bordleft" width="130">城市分站平台：</td>
    <td class="bordrig" >
        <asp:DropDownList ID="DropDownListSubstationID" runat="server" CssClass="tselect1" Width="200">
        </asp:DropDownList>
            <span id="Span1" class="star">(选择您发布的供求信息显示在哪一个城市平台，选择之后不可编辑！)</span>
    </td>
  </tr>
  <tr>
    <td class="bordleft" width="130">所属类别：</td>
    <td class="bordrig" >
  ...
  <tr>
    <td  class="bordleft">信息标题：</td>
    <td class="bordrig">
    <asp:TextBox ID="TextBoxTitle" runat="server" CssClass="textwb" onblur="funCheckTitle()" MaxLength="50"></asp:TextBox>
    <span class="star" id="errTitle">*</span>
    </td>
  </tr>
  <tr>
    <td class="bordleft">交易类型：</td>
    <td class="bordrig">
        <asp:RadioButton ID="RadioButtonGong" runat="server"  GroupName="gq" Checked="true" Text="供" Width="60px"/>
        <asp:RadioButton ID="RadioButtonQiu" runat="server" GroupName="gq" Text="求" Width="60px"/>
    </td>
  </tr>
  <tr>
    <td class="bordleft">联系电话：</td>
    <td class="bordrig">
    <asp:TextBox ID="TextBoxTel" runat="server" onblur="funCheckTel()"  CssClass="textwb"></asp:TextBox>
    <span class="star" id="errTel">*</span>    
    </td>
  </tr>
  <tr>
    <td class="bordleft">电子邮件：</td>
    <td class="bordrig">
  ...
  <tr>
    <td class="bordleft">联系人：</td>
    <td class="bordrig">
    <asp:TextBox ID="TextBoxContactName" runat="server" onblur="funCheckContactName()" CssClass="textwb"></asp:TextBox>
    <span class="star" id="errContactName">*</span>
    <span class="gray1"></span>
    </td>
  </tr>
  <tr>
    <td class="bordleft">过期时间：</td>
    <td class="bordrig">
   <asp:TextBox ID="TextBoxValidTime" runat="server" CssClass="Wdate  ss_nrduan" onclick="WdatePicker()" style=" width:200px" onblur="funcheckValidTime()" onchange="funcheckValidTime()"></asp:TextBox>
  <span class="red" id="errTime">*</span> 
    </td>
  </tr>
  <tr>
    <td class="bordleft">关键字：</td>
    <td class="bordrig">
  ...
  <tr>
    <td class="bordleft">信息描述：</td>
    <td class="bordrig">
    <asp:TextBox ID="TextBoxDescription" runat="server" CssClass="textwb1" TextMode="MultiLine" Font-Size="13px"></asp:TextBox>
    <div class="texttw_star"><span class="gray1">请认真填写，以便于被搜索引擎收录</span></div>
    </td>
  </tr>
  <tr>
    <td class="bordleft">选择图片：</td>
    <td class="bordrig">
  ...
  <tr>
    <td class="bordleft" style=" border-bottom:solid 1px #c6dfff;" >信息内容：</td>
    <td class="bordrig" style=" border-bottom:solid 1px #c6dfff;">
        <asp:TextBox ID="TexteditorContent" runat="server" CssClass="Texteditor" 
         ></asp:TextBox>
        ...
        <div style="text-align:center; margin:20px 0px 50px 0px;" >
            <asp:Button ID="ButtonTj" runat="server" Text="确定" CssClass="baocbtn" OnClientClick="return funCheckButton()" />
