...
<%@ Import Namespace="System.Data" %>
  ...
  <tr>
    <td class="bordleft" width="160">评论内容：</td>
    <td class="bordrig">
        <%#Eval("Comment")%> 
    </td>
  </tr>
  <tr>
    <td class="bordleft">审核状态：</td>
    <td class="bordrig">
  ...
  <tr style=" display:none">
    <td class="bordleft" style="border-bottom: solid 1px #c6dfff;">回复时间：</td>
