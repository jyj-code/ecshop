...
<script type="text/javascript" language="javascript">
    $(function(){
            $("#searchsub").click(function(){
                    var rType='<%=Common.ReqStr("type")%>';
                    location.href="M_ExitGoods.aspx?rid="+$("#exitnumber").val()+"&oid="+$("#ordernumber").val()+"&sid="+$("#shopmemloginid").val()+"&type="+rType+"";
            });
    });
     // 判断是否是数字
    ...
    function ontoPage(o)
    {
       ...
       if(checknum(pageindex))
       {
            ...
            if(pageEnd<=pageindex)
                pageindex=pageEnd;
             var rType='<%=Common.ReqStr("type")%>';
             location.href="M_ExitGoods.aspx?rid="+$("#exitnumber").val()+"&oid="+$("#ordernumber").val()+"&sid="+$("#shopmemloginid").val()+"&type="+rType+"&pageid="+pageindex+"";
       }
    }
</script>
    ...
    <div class="pad">
        <table border="0" cellspacing="0" cellpadding="0" class="lineh">
            <tr class="up_spac">
                ...
                <td>
                    <input id="exitnumber" type="text" class="ss_nr1" value='<%=Common.ReqStr("rid") %>' maxlength="15" />
                </td>
                <td align="right" class="ss_nr_spac">
                    订单编号：
                </td>
                <td>
                    <input id="ordernumber" type="text" class="ss_nr1" value='<%=Common.ReqStr("oid") %>' maxlength="15" />
                </td>
            </tr>
            <tr class="up_spac">
                <td align="right">
                ...
                <td colspan="3" style="text-align:left;">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                <input id="shopmemloginid" type="text" class="ss_nr1" value='<%=Common.ReqStr("sid") %>' maxlength="10" />
                            </td>
                            <td>
    ...
    <div id="list_main">
        <ul id="sidebar">
            <li class="<%=Common.ReqStr("type") == "2" ? "TabbedPanelsTab TabbedPanelsTabSelected" : "TabbedPanelsTab"%>">
                <a href="M_ExitGoods.aspx?type=2">申请中退货</a></li>
            <li class="<%=Common.ReqStr("type") == "1"|| Common.ReqStr("type") == ""? "TabbedPanelsTab TabbedPanelsTabSelected" : "TabbedPanelsTab"%>">
                <a href="M_ExitGoods.aspx?type=1">已处理的退货</a></li>
        </ul>
        <div class="biaogenr">
                ...
                <asp:Repeater ID="repExitMoney" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%#M_ExitGoods.RefundStatus(Eval("refundstatus").ToString(), "1")%>
                            </td>
                            <td>
                               ...
                               <input type="hidden" id="hidStatusTxt" value='<%#M_ExitGoods.RefundStatus(Eval("refundstatus").ToString(),"1")%>' />
                               <input type="hidden" id="hidStatusReason" value='<%#M_ExitGoods.ReasonType(Eval("refundreason").ToString())%>' />
       ...
       <div style="width: 100%; height:500px;" class="showpopone">
            <table cellspacing="0" cellpadding="0" border="0" style="padding-top: 10px; margin: 10px 0 20px 120px;">
                <tr class="up_spac">
                    ...
                    <td id="isreceive" align="left"></td>
                </tr>
                <tr class="up_spac">
                    <td align="right">
                        退货金额：
                    </td>
                    <td id="exitmoney" align="left"></td>
                </tr>
                 <tr class="up_spac">
                    <td align="right">
                        图片凭证：
                    </td>
                    <td id="piccheck" align="left"></td>
                </tr>
                <tr class="up_spac">
                    <td align="right">
                        退货原因：
                    </td>
                    <td id="exitreason" align="left"></td>
                </tr>
                <tr class="up_spac">
                    <td align="right">
                        退货说明：
