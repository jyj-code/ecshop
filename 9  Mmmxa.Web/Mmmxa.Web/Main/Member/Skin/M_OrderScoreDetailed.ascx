            ...
            <ItemTemplate>
                <tr style="height: 0; margin: 0; padding: 0; border: 0;">
                    <td style="width: 100px; padding: 10px; border-bottom: solid 1px #c6dfff;" class="bordleft2">
                        <a target="_blank"  href='<%#ShopUrlOperate.shopDetailHrefNew(((DataRowView)Container.DataItem).Row["ProductGuid"].ToString(),((DataRowView)Container.DataItem).Row["IsShopMemLoginID"].ToString(),"ProductIntegral")%>' class="sroceimg">
