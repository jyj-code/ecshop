<%@ page language="C#" autoeventwireup="true" inherits="AgentAdminWelcome_List, ShopNum1.Deploy" %>
...
<body>
    ...
    <div id="right">
        ...
        <div class="rhigth">
            ...
            <div style="float: left; font-size: 12px; color: #888888; padding-top: 10px; padding-left: 10px;">
                欢迎您：<font color="#ff6600" style="font-weight: bold;"><asp:Label ID="LabelLoginID"
                    runat="server"></asp:Label>
                </font>&nbsp;&nbsp;城市平台：<font color="#ff6600" style="font-weight: bold;"><asp:Label ID="LabelCity" runat="server"></asp:Label></font>&nbsp;&nbsp;当前平台预存款：<font color="#ff6600" style="font-weight: bold;">￥<asp:Label ID="LabelAdvancePayment" runat="server"></asp:Label></font>&nbsp;&nbsp;&nbsp;您上次登录的时间是：<asp:Label ID="LabelLastLoginTime" runat="server"></asp:Label>&nbsp;&nbsp;
                您当前系统的版本是：<font class="StorePrice"><asp:Label ID="LabelVersion" runat="server" Visible="false"></asp:Label>ShopNum1V8.2.1
                </font>
            </div>
            <div class="rr">
            </div>
        ...
        <div class="welcon clearfix">
            ...
            <div class="orderinfo">
                ...
                <div class="ordercont">
                    ...
                    <p>
                        <a href="Order_List.aspx?style=3&status=1">
                            已支付待发货订单：
            ...
            <div class="orderinfo rc4">
                ...
                <div class="ordercont">
                    <p>
                        <a href="Order_List.aspx">今日销售总金额：
                            ￥<asp:Label ID="LabelProductPriceCount" runat="server"></asp:Label></a></p>
                    <p>
                        <a href="Order_List.aspx">今日订单量：
                            <asp:Label ID="LabelOrderNow" runat="server"></asp:Label>个</a></p>
                    <p style="display:none">
                        <a href="Member_List.aspx">今日注册会员数：
                            <asp:Label ID="LabelMemberCount" runat="server"></asp:Label>个</a></p>
                    <p>
                        <a href="ShopInfoList_Manage.aspx">今日入驻的店铺：
                            <asp:Label ID="LabelShopNowCount" runat="server"></asp:Label>个</a></p>
                    <p style="display:none">
                        <a href="Member_List.aspx">会员总数：
                            <asp:Label ID="LabelMemberAllCount" runat="server"></asp:Label>个</a></p>
                    <p>
                        <a href="ShopInfoList_Manage.aspx">店铺总数量：
                            <asp:Label ID="LabelShopAllCount" runat="server"></asp:Label>个</a></p>
                    <p style="display: none;">
                        <a href="Order_List.aspx">今日销售商品总量：
                            <asp:Label ID="LabelBuyNumberCount" runat="server"></asp:Label></a></p>
                </div>
            </div>
        </div>
    </div>
