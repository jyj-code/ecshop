<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Video_Operate, ShopNum1.Deploy" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <th align="right">
                ...
                <asp:Label ID="Label9" runat="server" Text="*" Style="color: Red"></asp:Label></font>
       ...
       <tr>
            ...
            <td align="left">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBoxAddress"
                    Display="Dynamic" ErrorMessage="视频代码最多500个字符" ValidationExpression="^[\s\S]{0,500}$"></asp:RegularExpressionValidator>
            </td>
        </tr>
             <th align="right" >
             ...
             <tr >
               ...
               <%--<asp:TextBox ID="FCKeditorRemark" runat="server" CssClass="Texteditor" Width="600px"
                ...
                <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="FCKeditorRemark"
                    ...
                    ClientValidationFunction="checkFckeditorContent"></asp:CustomValidator>--%></td>
                </tr>
