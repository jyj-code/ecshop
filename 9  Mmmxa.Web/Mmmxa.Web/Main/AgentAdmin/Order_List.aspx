<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Order_List, ShopNum1.Deploy" %>
...
$(function(){
        $("#sk_go").click(function(){
                ...
                if(sstatus!="")
                {
                    location.href="?style="+sstyle+"&status="+sstatus+"&trdeid="+tradeid+"&orid="+orid+"&mid="+mid+"&ct="+ct+"&et="+et+"&sp1="+sp1+"&sp2="+sp2+"&shopid="+shopid+"&sn="+escape(shopname)+"&pageid=1";
                }
                else
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            ...
            <table cellspacing="0" cellpadding="4" border="0" id="Table1" rules="cols" class="gridview_m">
                 ...
                 <th scope="col">订单号</th><th scope="col">店铺ID</th><th scope="col">店铺名称</th>
          ...
          <tbody>
               <%if (dt_OrderList != null)
                 ...
                 { 
                    %>
                    <tr>
                     <td style="font-weight:bold; text-align:center" colspan="12">
