<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_SurveyOption_Manage, ShopNum1.Deploy" %>
     ...
     <div class="welcon clearfix">
                        ...
                        <tr >
                            ...
                            <td  style="width:350px;">
                                <asp:TextBox ID="textBoxNAME" runat="server" CssClass="tinput"  ></asp:TextBox>
                                    ...
                                    ID="RequiredFieldValidatorName" runat="server" ControlToValidate="textBoxNAME"
               ...
               <div class="sbtn">
                   ...
                   <asp:Button ID="ButtonBack" runat="server" Text="返回列表"   CssClass="chongxinfs picbtn"   
                    ...
                    AutoGenerateColumns="False" DataSourceID="ObjectDataSourceData" Width="98%"
                    AscendingImageUrl="~/images/SortAsc.gif" DescendingImageUrl="~/images/SortDesc.gif"
                      BorderColor="#CCDDEF" BorderStyle="Solid" BorderWidth="1px"
                    CellPadding="4" Style="margin-top: 15px;">
