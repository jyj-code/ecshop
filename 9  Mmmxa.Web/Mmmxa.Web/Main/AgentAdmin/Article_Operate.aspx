<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Article_Operate, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
                ...
                <div class="inner_page_list">
                    <table border="0" cellpadding="0" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBoxPublisher" runat="server" CssClass="tinput" ReadOnly="true"></asp:TextBox>
                                <span>请输入作者/发布人</span>
            ...
            <div class="tablebtn">
                ...
                <asp:Button ID="Button3" runat="server" CssClass="fanh" CausesValidation="false"
                    PostBackUrl="~/Main/AgentAdmin/Article_List.aspx" Text="返回列表" />
