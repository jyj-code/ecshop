<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_SupplyDemandCommentAudit_List, ShopNum1.Deploy" %>
                ...
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="height: 35px; vertical-align: top;">
                            ...
                            <tr>
                            <td><asp:TextBox ID="TextBoxTime1" CssClass="tinput" Style="width:68px;" runat="server"></asp:TextBox></td>
                            ...
                            <td class="lmf_px">-</td>
                            <td><asp:TextBox ID="TextBoxTime2" CssClass="tinput" Style="width:68px;" runat="server"></asp:TextBox></td>
