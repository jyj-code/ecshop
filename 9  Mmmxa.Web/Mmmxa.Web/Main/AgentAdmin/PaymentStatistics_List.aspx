<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_PaymentStatistics_List, ShopNum1.Deploy" %>
...
<body>
    ...
    <div id="right">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="SearchPaymentStatistics"
            TypeName="ShopNum1.BusinessLogic.ShopNum1_ExtendOrderStatistics_Action">
                <SelectParameters>
