<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Theme_ActivityList, ShopNum1.Deploy" %>
          ...
          <%if (dt != null)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    string strThemeDescription = dt.Rows[i]["ThemeDescription"].ToString().Length > 29 ? dt.Rows[i]["ThemeDescription"].ToString().Substring(0,29): dt.Rows[i]["ThemeDescription"].ToString();
