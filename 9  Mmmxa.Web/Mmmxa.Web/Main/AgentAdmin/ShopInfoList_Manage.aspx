<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_ShopInfoList_Manage, ShopNum1.Deploy" %>
                        ...
                        <tr>
                            <td valign="top">
                                <asp:DropDownList ID="DropDownListOperate" runat="server" Width="150" CssClass="tselect">
                                    ...
                                    <asp:ListItem Value="5"> 设为分站推荐</asp:ListItem>
                                    <asp:ListItem Value="23"> 设为分站热门</asp:ListItem>
                                 ...
                                 <%--   <asp:ListItem Value="21">增加店铺微信</asp:ListItem>--%>
                                    ...
                                    <asp:ListItem Value="8"> 取消分站推荐</asp:ListItem>
                                    <asp:ListItem Value="24"> 取消分站热门</asp:ListItem>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="店铺地址" SortExpression="ShopID">
                        <ItemTemplate>
                            <a id="A2" href='<%#ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()) %>' target="_blank"
                                runat="server">
                                <asp:Label ID="Label7" runat="server" Text='<%#ShopUrlOperate.GetShopUrlNew(Eval("ShopID").ToString()) %>'></asp:Label></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="分站推荐" SortExpression="IsClose">
                        <ItemTemplate>
                            <asp:Image ID="Imagetj" runat="server" ImageUrl='<%# GetListImageStatus(Eval("IsRecommend").ToString()) %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="分站热门" SortExpression="IsClose">
                        <ItemTemplate>
                            <asp:Image ID="Imagerm" runat="server" ImageUrl='<%# GetListImageStatus(Eval("IsHot").ToString()) %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="启用状态" SortExpression="IsClose">
                        <ItemTemplate>
                            <asp:Image ID="Imageqy" runat="server" ImageUrl='<%# GetListImageStatus(Eval("IsClose").ToString()=="1"?"0":"1") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:BoundField HeaderText="分站排序" DataField="OrderID" SortExpression="OrderID"
                        ItemStyle-HorizontalAlign="Center"></asp:BoundField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource" runat="server" SelectMethod="SearchInfoList2"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="TextBoxEndTime" DefaultValue="" Name="endTime" PropertyName="Text"
                    Type="String" />
                 <asp:ControlParameter ControlID="HiddenFieldSubstationID" DefaultValue="" Name="SubstationID"
                    PropertyName="Value" Type="String" />
            </SelectParameters>
