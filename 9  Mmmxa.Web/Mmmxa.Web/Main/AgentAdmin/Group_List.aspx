<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Group_List, ShopNum1.Deploy" %>
...
<body style="height:600px;">
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                ...
                <span>批量删除</span></asp:LinkButton> 
                        ...
                        <TD><GroupFly:MessageShow ID="MessageShow" Visible="false" runat="server" /></TD>
                    </tr>
                </table>
            </div>
                ...
                <Columns>                  
                    ...
                    <asp:BoundField DataField="ShortName" HeaderText="角色组标志" SortExpression="ShortName">
                     ...
                     <asp:TemplateField HeaderText="操作">
                        <ItemTemplate><%#ShopNum1.Common.Utils.GetUnicodeSubString(Eval("Remarks").ToString(), 100, "..")%></ItemTemplate>
                     </asp:TemplateField>
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                             <a href='addGroup.aspx?width=700&height=450&id=<%# Eval("Guid")%>' style="color:#4482b4;" class="dialog">编辑</a>
             <asp:LinkButton ID="LinkButton1" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("Guid")%>' OnClick="PowerSet_Click" CausesValidation="false" >权限设置</asp:LinkButton>
                                
                            <asp:LinkButton ID="LinkDelte" runat="server" Style="color: #4482b4;" CommandArgument='<%# Eval("Guid")%>' CausesValidation="false"
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="Search"
            TypeName="ShopNum1.BusinessLogic.ShopNum1_Group_Action" 
            OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                <asp:Parameter Name="IsDeleted" Type="Int32" DefaultValue="0" />
                <asp:ControlParameter  Type="String"  PropertyName="Value"  Name="SubstationID"  ControlID="HiddenFieldSubstationID" />
            </SelectParameters>
