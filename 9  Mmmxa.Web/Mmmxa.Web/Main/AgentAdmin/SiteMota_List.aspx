<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_SiteMota_List, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="pagename" ItemStyle-Width="49%" HeaderText="页面名" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="KeyWords" ItemStyle-Width="48%" HeaderText="关键字" ItemStyle-HorizontalAlign="Center" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceDate" runat="server" SelectMethod="SearchMetoListNew"
