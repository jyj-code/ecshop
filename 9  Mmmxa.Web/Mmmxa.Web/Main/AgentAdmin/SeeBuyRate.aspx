<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_SeeBuyRate, ShopNum1.Deploy" %>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="商品名称" SortExpression="Name" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <%#Eval("Name").ToString().Length > 26 ? Eval("Name").ToString().Substring(0, 26) + "..." : Eval("Name").ToString()%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="productcategoryname" HeaderText="商品分类" SortExpression="productCategoryCode" 
                        ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                   <asp:BoundField DataField="brandname" HeaderText="品牌分类" SortExpression="brandGuid"
                ItemStyle-HorizontalAlign="Center"></asp:BoundField>
            ...
            <SelectParameters>
               <asp:ControlParameter ControlID="txtProductName"  Name="name" PropertyName="Text" Type="String" />
                ...
                <asp:ControlParameter ControlID="TextBoxMarketPrice2" DefaultValue="0" Name="marketPrice2"
                    PropertyName="Text" Type="Decimal" />
                <asp:ControlParameter ControlID="HiddenFieldSubstationID" DefaultValue="all"  Name="SubstationID" PropertyName="Value" Type="String" />
            </SelectParameters>
