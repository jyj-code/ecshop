<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_ArticleComment_List, ShopNum1.Deploy" %>
...
<body class="widthah">
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3>
                    <asp:Label ID="LabelPageTitle" runat="server" Text="分站平台资讯评论"></asp:Label>
                </h3>
            </div>
            <div class="rr">
            </div>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="评论资讯" SortExpression="ArticleTitle">
                        <ItemTemplate>
                            <a href='<%#ShopUrlOperate.RetUrl("ArticleDetail",Eval("ArticleGuid").ToString()) %>'
                                target="_blank">
                                <%#Eval("ArticleTitle").ToString().Length > 26 ? Eval("ArticleTitle").ToString().Substring(0, 26) + "..." : Eval("ArticleTitle").ToString()%>
                                </a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceData" runat="server" SelectMethod="Search"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="TextBoxSIPAddress" DefaultValue="" Name="IP" PropertyName="Text"
                Type="String" />
