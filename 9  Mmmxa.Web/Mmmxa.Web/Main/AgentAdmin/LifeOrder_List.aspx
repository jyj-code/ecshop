<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_LifeOrder_List, ShopNum1.Deploy" %>
    ...
    <div id="right">
        ...
        <div class="welcon clearfix">
                    ...
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="TextBoxCreateTime1" CssClass="tinput" Width="68" runat="server" ></asp:TextBox>
                                    </td>
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="tinput" ID="TextBoxCreateTime2" Width="68" runat="server" ></asp:TextBox>
                                    </td>
                                    <td valign="top" style="padding-left: 4px;">
            ...
            <table cellspacing="0" cellpadding="4" border="0" id="Table1" rules="cols" class="gridview_m">
                 ...
                 <th scope="col">订单号</th><th scope="col">店铺ID</th><th scope="col">店铺名称</th><th scope="col">手机号码</th>
