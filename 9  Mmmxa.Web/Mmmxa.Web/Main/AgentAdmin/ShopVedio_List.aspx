<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_ShopVedio_List, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
            <div class="order_edit">
                <div>
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="height:35px; vertical-align:top;">
                            ...
                            <tr>
                            <td><asp:TextBox ID="textBoxStartDate" runat="server" CssClass="tinput" Style="width: 68px;"></asp:TextBox></td>
                            <td style="padding-left:4px; vertical-align:top;">
                            <img id="imgCalendarSReplyTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px;position: relative; top: 3px" /></td>
                            <td> 
                            <GroupFly:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="textBoxStartDate" PopupButtonID="imgCalendarSReplyTime2"
                            ...
                            <td class="lmf_px">-</td>
                            <td><asp:TextBox ID="textBoxEndDate" runat="server" CssClass="tinput" Style="width:68px;"></asp:TextBox></td>
                            <td style="padding-left:4px; vertical-align:top;">
                            <img id="img2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px; position: relative; top:3px" /></td>
                            <td>
                            <GroupFly:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="textBoxEndDate" PopupButtonID="img2" CssClass="ajax__calendar" Format="yyyy-MM-dd" /></td>
                            <td><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="textBoxEndDate"
                ...
                <td valign="top" class="lmf_app" style=" display:none">
                    <asp:LinkButton ID="ButtonAudit" runat="server"  OnClick="ButtonAudit_Click"
                        OnClientClick="return OperateButton()" CssClass="zxcz lmf_btn"  ><span>执行操作</span></asp:LinkButton>
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="标题" SortExpression="Title">
                        <ItemTemplate>
                            <a href='<%# ShopUrlOperate.shopDetailHrefNew(Eval("Guid").ToString(),Eval("MemLoginID").ToString(),"VideoDetail") %>'
                                target="_blank">
