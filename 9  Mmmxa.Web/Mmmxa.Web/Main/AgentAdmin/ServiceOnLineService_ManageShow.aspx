<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_ServiceOnLineService_ManageShow, ShopNum1.Deploy" %>
                        ...
                        <td>
                            <div class="shoptd">
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td colspan="6">
                                            <asp:TextBox ID="TextBoxServerPhone" runat="server"  CssClass="tinput" MaxLength="14"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
