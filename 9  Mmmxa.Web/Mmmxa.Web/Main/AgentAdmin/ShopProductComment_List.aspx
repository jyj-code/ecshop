<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_ShopProductComment_List, ShopNum1.Deploy" %>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr style=" height:35px; vertical-align:top;">
                       ...
                       <td valign="top" style="padding-left:4px;"><img id="img1" alt="" src="/ImgUpload/Calendar.png" style="width: 16px; height: 18px;
                                position: relative; top: 4px" /><GroupFly:CalendarExtender ID="CalendarExtender1" Format="yyyy-MM-dd"
                                    runat="server" TargetControlID="TextBoxTime2" PopupButtonID="img1" CssClass="ajax__calendar" /></td>
