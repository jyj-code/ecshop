<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_PageAdID_Operate, ShopNum1.Deploy" %>
...
<body>
    ...
    <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3><asp:Label ID="lbltitle" runat="server" Text="添加广告位"></asp:Label></h3>
            </div>
            <div class="rr">
            </div>
        </div>
            ...
            <table border="0" cellpadding="0" cellspacing="1">
                ...
                <tr style="display:none">
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxHeight" CssClass="tinput" runat="server" ></asp:TextBox><span> 广告的高度</span>
                ...
                <tr style="display:none">
                    ...
                    <td>
                            ...
                            <asp:TextBox ID="TextBoxWidth" CssClass="tinput" runat="server"></asp:TextBox><span> 广告的宽度</span>
