<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_VedioCommentChecked_List, ShopNum1.Deploy" %>
            ...
            <div class="order_edit">
                <table style="width: 100%">
                    <tr style="height:30px;">
                        ...
                        <td width="100" style="text-align:right; padding-right:5px; display:none">
                    ...
                    <tr  style="height:30px;">
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxSCommentTime1" CssClass="tinput" Style="width: 68px;" runat="server"></asp:TextBox>
                            ...
                            －<asp:TextBox ID="TextBoxSCommentTime2" CssClass="tinput" Style="width: 68px;" runat="server"></asp:TextBox>
                            ...
                            <img id="imgCalendarSReplyTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                height: 18px; position: relative; top: 4px;" /><GroupFly:CalendarExtender ID="CalendarExtender1"
