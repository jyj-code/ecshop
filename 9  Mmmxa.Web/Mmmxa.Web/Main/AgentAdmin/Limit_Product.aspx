<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Limit_Product, ShopNum1.Deploy" %>
          ...
          <%if (dt_Lp != null)
            {
                for (int i = 0; i < dt_Lp.Rows.Count; i++)
                {
                   ...
                   <tr style="cursor:default;" onmouseout="Num1GridViewShow_mout(this)" onmouseover="Num1GridViewShow_mover(this)">
                    <td align="center"><a rel="<%=stroriginalImage%>" target="_blank" href="<%=ShopUrlOperate.shopHref(strGuid,strMemloginId)%>" title="<%=strName %>"><img src="<%=strImg %>" style="width:50px; height:50px;" /><%=strName%></a></td>
