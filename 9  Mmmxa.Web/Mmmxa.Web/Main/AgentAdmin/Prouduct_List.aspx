<%@ page language="C#" autoeventwireup="true" inherits="AgentAdminProuduct_List, ShopNum1.Deploy" %>
            ...
            <div class="order_edit">
                ...
                <td valign="top">
                     <asp:DropDownList ID="DropDownListOperate" runat="server" CssClass="tselect" Width="150">
                        ...
                        <asp:ListItem Value="IsHot,1">设为分站站热卖</asp:ListItem>
                        <asp:ListItem Value="IsRecommend,1">设为分站推荐</asp:ListItem>
                        ...
                        <asp:ListItem Value="IsHot,0">取消分站热卖</asp:ListItem>
                        <asp:ListItem Value="IsRecommend,0">取消分站推荐</asp:ListItem>
             ...
             <table cellspacing="0" cellpadding="4" border="0" id="Table1" rules="cols" class="gridview_m">
                 ...
                 <th scope="col">商品名称</th><th scope="col">店铺名</th><th scope="col">商品图片</th><th scope="col">商品价格</th>
                 <th scope="col">库存</th><th scope="col">所属分类</th><th scope="col">新品</th><th scope="col">分站热卖</th>
                 <th scope="col">分站推荐</th><th scope="col">可售</th><th scope="col">上架</th><th scope="col">排序号</th><th scope="col">操作</th>
          </tr>
          </thead>
          <tbody>
