<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_CityPaymentApplyLog_List, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
            ...
            <ShopNum1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="MemLoginID" HeaderText="管理员账号" SortExpression="MemLoginID">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
