<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_UserDefinedColumn_Operate, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
            <table border="0" cellpadding="0" cellspacing="0" class="shoptable">
                <tr>
                    ...
                    <td valign="middle">
                        <div class="shoptd">
                            ...
                            <asp:Label ID="Label4" runat="server" Text="注意:自定义栏目不要加太多,以免前台导航变型"></asp:Label>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="shoptd">
                            <asp:TextBox ID="TextBoxLinkAddress" runat="server" CssClass="tinput"></asp:TextBox>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorAddress" runat="server" ControlToValidate="TextBoxLinkAddress"
                                Display="Dynamic" ErrorMessage="该值不能为空"></asp:RequiredFieldValidator>
                            <asp:Label ID="Label5" runat="server" Text="注意:本站地址直接写页面名如：shopnum1,外网地址请写完整地址如：http://www.shopnum1.com "></asp:Label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd">
                            <asp:TextBox ID="TextBoxOrderID" MaxLength="9" runat="server" CssClass="tinput"></asp:TextBox><span></span>
                ...
                <tr>
                    <th align="right">
                        <div class="shopth" style="height: 115px; border-bottom: none;">
            ...
            <div class="tablebtn">
                ...
                <asp:Button ID="Button1" runat="server" CssClass="fanh" CausesValidation="false"
                    PostBackUrl="~/Main/agentadmin/UserDefinedColumn_List.aspx" Text="返回列表" />
