<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_OrderPanic_List, ShopNum1.Deploy" %>
...
$(function(){
        $("#sk_go").click(function(){
                ...
                var sp1=$("#txtSp1").val();
                var sp2=$("#txtSp2").val();
                location.href="OrderPanic_List.aspx?trdeid="+tradeid+"&orid="+orid+"&mid="+mid+"&ct="+ct+"&et="+et+"&sp1="+sp1+"&sp2="+sp2+"&shopid="+shopid+"&sn="+escape(shopname)+"&pageid=1";
        });
});
    </script>
</head>
