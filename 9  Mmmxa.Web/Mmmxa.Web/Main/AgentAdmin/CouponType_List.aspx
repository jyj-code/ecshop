<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_CouponType_List, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
            ...
            <ShopNum1:Num1GridView ID="num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="分类名称" DataField="Name" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderText="描述" DataField="Comment" SortExpression="Comment" ItemStyle-HorizontalAlign="Center" />
