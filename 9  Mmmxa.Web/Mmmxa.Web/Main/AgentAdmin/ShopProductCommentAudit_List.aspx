<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_ShopProductCommentAudit_List, ShopNum1.Deploy" %>
             ...
             <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr style=" height:35px; vertical-align:top;">
                       <%--  <td >
                        ...
                        <tr>
                        <td>
                        <asp:TextBox ID="TextBoxTime1" CssClass="tinput" runat="server" Width="68"></asp:TextBox>
                        </td>
                        <td valign="top" style="padding-left:4px;">
                        <img id="imgCalendarSReplyTime2" alt="" src="/ImgUpload/Calendar.png" style="width: 16px;
                                height: 18px; position: relative; top: 4px" /> <GroupFly:CalendarExtender ID="CalendarExtender4" Format="yyyy-MM-dd"
                        ...
                        <td class="lmf_px">-</td>
                        <td><asp:TextBox ID="TextBoxTime2" CssClass="tinput" runat="server"  Width="68"></asp:TextBox></td>
