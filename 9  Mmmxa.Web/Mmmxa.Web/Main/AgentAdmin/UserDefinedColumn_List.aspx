<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_UserDefinedColumn_List, ShopNum1.Deploy" %>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td valign="top" class="lmf_app">
                            <asp:LinkButton ID="ButtonEdit" runat="server" Visible="false" OnClick="ButtonEdit_Click" OnClientClick="return EditButton()"
