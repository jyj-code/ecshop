<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_ArticleComment_Reply, ShopNum1.Deploy" %>
                ...
                <tr>
                    ...
                    <td>
                        <div class="shoptd" style="height: 115px; border-bottom: none;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TextBoxReplyContent" runat="server" ErrorMessage="回复内容必填！"></asp:RequiredFieldValidator>
                        </div>
                    </td>
                </tr>
            </table>
