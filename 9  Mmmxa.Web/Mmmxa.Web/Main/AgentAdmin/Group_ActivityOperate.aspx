<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Group_ActivityOperate, ShopNum1.Deploy" enableviewstate="false" %>
...
<body>
   ...
   <div id="right">
        <div class="rhigth">
            ...
            <div class="rcon">
                <h3><span id="LabelTitle">团购活动</span></h3>
            </div>
            <div class="rr">
            </div>
        </div>
                ...
                <table cellspacing="1" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="txtStartTime" class="datetinput ss_nrduan" runat="server" onclick="WdatePicker({minDate:'%y-%M-#{%d}'})" />
                        </td>
                    </tr>
                     <tr>
                        <th align="right">
                        ...
                        <td>
                            <input type="text" id="txtEndTime" class="datetinput ss_nrduan" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/><span check="errormsg" style="color:Red;"></span>
                            <span style="color:Red;">*</span>活动结束时间不能小于开始时间！
                        </td>
                    </tr>
                      <tr style="display:none;">
                        ...
                        <td>
                            <input type="text" id="txtFinalTime" class="datetinput ss_nrduan" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/><span check="errormsg" style="color:Red;"></span>
...
//             }
        ...
        if(parseInt(substartTime2)<parseInt(subendTime2)){return true;}else if(parseInt(substartTime)<parseInt(subendTime)){return true;}else{return false;}}
            ...
            <div class="tablebtn">
                <asp:Button ID="btnSub" CssClass="fanh" runat="server" OnClientClick="return funCheck()" Text="提交" OnClick="btnSub_Click" />   <input type="button" onclick="location.href='Group_ActivityList.aspx';" class="fanh" value="返回"/>
