<%@ page language="C#" autoeventwireup="true" inherits="AgentAdminaddGroup, ShopNum1.Deploy" %>
...
<body style="background: none;">
    ...
    <div class="inner_page_list">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" style="line-height: 180%;
            text-align: left">
            <tr>
            ...
            <tr>
                ...
                <td colspan="4">
                    <textarea id="TextBoxRemarks" runat="server" class="tinput" style="width:420px; height:150px;"></textarea>
