<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_Video_List, ShopNum1.Deploy" %>
                    ...
                    <tr style="height: 35px; vertical-align: top;">
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="TextBoxStartTime" runat="server" CssClass="tinput" Width="68"></asp:TextBox>
                                    </td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBoxEndTime" runat="server" CssClass="tinput" Width="68"></asp:TextBox>
                                    </td>
                                    <td valign="top" style="padding-left: 4px;">
            ...
            <cc1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="视频标题" SortExpression="Title">
                        <ItemTemplate>
                            <a href="<%#GetUrl("VideoDetail",Eval("Guid").ToString()) %>" target="_blank">
