<%@ page language="C#" autoeventwireup="true" inherits="AgentAdmin_VideoComment_List, ShopNum1.Deploy" %>
        ...
        <div class="welcon clearfix">
            ...
            <cc1:Num1GridView ID="Num1GridViewShow" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CreateTime" HeaderText="评论时间" SortExpression="CreateTime" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="MemLoginID" HeaderText="评论人" SortExpression="MemLoginID" ItemStyle-HorizontalAlign="Center" />
