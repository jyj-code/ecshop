<div class="zhszmian">
      ...
      <div class="zhs_ri">
         <ul>
           ...
           <li><asp:LinkButton ID="LinkButton_Set" runat="server" CssClass="alink_blue" PostBackUrl="../A_ChangePwdWay.aspx" >设置交易密码</asp:LinkButton>  </li>
          </ul>
      </div>
 ...
 <div style="clear: both;"></div>
    <div class="dengl">
        ...
        <div class="denflot dthree">
            <a href="A_UpPwd.aspx" class="xiug" target="win"  onclick="subItem(this)"  >
             修改
            </a>
        </div>
    </div>
    ...
    <div class="dengl">
        ...
        <div class="denflot dthree">
        <a    href="A_ChangePwdWay.aspx"   class="xiug" target="win"  onclick="subItem(this)"    >
             设置
            </a>
        </div>
    </div>
