       ...
       $("#a1").click(function(){
        if(ExistEmail())
        {
            ...
            $("#a2").click(function(){
                 ...
                 {
                    $.get("/Api/CheckInfo.ashx?type=5&key="+$("#A_BindEmail_ctl00_M_code").val()+"&Email="+$("#nextEmail").text(),null,function(data)
                    {
                        if(data=="1")
                        {
                            $("#li_Select").removeClass(".first current");
                            ...
                            $("#step2").hide();
                            $("#step3").show();
                            $("#A_BindEmail_ctl00_hid_Email").val($("#nextEmail").text());
                        }else
                        {
                            $("#spanYZMIsSend").get(0).className = "onError1";
    ...
    <div class="ps_width clearfix" style="margin-left:5px;">
       ...
       <div class="form_top" style="display:none" id="step2">
            ...
            <div class="form_row">
               ...
               <input type="button"   id="J_ver_btn" class="btn btn-white vc_btn mr10 J_ftrack"  value="点此免费获取"   style="width:150px;"  />
                    ...
                    <input type="text" id="M_code" name="code" data-tip="验证码" disabled="disabled"  maxlength="8" class="intext intext_short nullv tov vfb" autocomplete="off" runat="server"  />
                    <div>
            ...
            <div id="J_phone_msg_row" class="form_row form_height_auto_row nice_info_row clearfix">
              ...
              <div class="form_row form_height_auto_row clearfix">
                ...
                <div class="form_right">
                    ...
                    href="javascript:void(0)" id="a2" class="J_ftrack btn btn-green" onclick="return  GetEmail()">
                        确认绑定
                    </a>
      ...
      <div id="step3" style="display:none;">
          ...
          <font  style="font-size:16px; font-family:微软雅黑; display:block; margin-bottom:20px;">
            ...
            <br />
         <asp:Button ID="btn_Next" runat="server" Text="确定"  data-tid="bindphone_uid_button068" data-tprefix="/virtual/ucenter/myfanli"  class="J_ftrack btn btn-green"  runat="server" OnClientClick="return BtnSubmit()" />
