<script type="text/javascript">
       ...
       $(function() {
            ...
            $("#J_ver_btn").click(function(){            
                ...
                $.get("/Api/CheckInfo.ashx?type=4&Email="+$("#A_CheckEmail_ctl00_nextEmail").text(),null,function(data)
                {
                    //alert("邮件已发送，请耐心等待......");
                    if(data != "1")
                    {
             ...
             $("#<%= M_code.ClientID %>").focus(function(){
                ...
                $("#<%= M_code.ClientID %>").blur(function(){
                    ...
                    {
                        $.get("/Api/CheckInfo.ashx?type=5&key="+$("#A_CheckEmail_ctl00_M_code").val()+"&Email="+$("#A_CheckEmail_ctl00_nextEmail").text(),null,function(data)
                        {
                            if(data =="1")
                            {
...
<div class="main-right" id="main-right">
 ...
 <div class="zhszmian1">
          ...
          <div class="form_row">
            ...
            <div class="form_row">
                ...
                <input type="button"   id="J_ver_btn" class="btn btn-white vc_btn mr10 J_ftrack"  value="点此免费获取"  style="width:150px;"   />
                    <input type="text" id="M_code" name="code" data-tip="验证码" maxlength="8" class="intext intext_short nullv tov vfb" autocomplete="off" runat="server" disabled="disabled">
                    <div>
            ...
            <div id="J_phone_msg_row" class="form_row form_height_auto_row nice_info_row clearfix">
              ...
              <div class="form_row form_height_auto_row clearfix">
                ...
                <div class="form_right">
                      <input type="button" class="querbtn" data-tid="bindphone_uid_button068" data-tprefix="/virtual/ucenter/myfanli" onclick="checkkey()" value="确定" />
    ...
    <div id="step3" style="display:none; line-height:20px;">
          ...
          <br />
                <input type="btn_Next" style="width:60px" class="J_ftrack btn btn-green" data-tid="bindphone_uid_button068" data-tprefix="/virtual/ucenter/myfanli" value="下一步"  onclick="goNext()"/>
          </center>
...
function  checkkey()
{
      ...
      $.get("/Api/CheckInfo.ashx?type=5&key="+$("#A_CheckEmail_ctl00_M_code").val()+"&Email="+$("#A_CheckEmail_ctl00_nextEmail").text(),null,function(data)
     {
        if(data=="1")
        {
           window.location.href="A_UpPayPwd.aspx?Email="+$("#A_CheckEmail_ctl00_nextEmail").text()+"&key="+$("#A_CheckEmail_ctl00_M_code").val();
        }
        else
        {
            $("#spanShowMsg").get(0).className="onError1";
