    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btn_Retrun"  Visible="false" runat="server" Text="安全管理" OnClientClick="return showLoction()" CssClass="querbtn"  PostBackUrl="/Main/Account/A_PwdSer.aspx"  />
            </td>
        </tr>
    </table>
</div>
