...
<div>
        <div class="left">
            ...
            <div id="Step2Container">
                ...
                <div class="uploaddiv">
                    <asp:Button ID="btn_Image" runat="server" Text="保存头像" CssClass="selpic"  />
                </div>
        ...
        <div class="right">
            ...
            <div id="Step1Container">
                ...
                <div id="uploadcontainer">
                    ...
                    <div class="uploaddiv">
                        <asp:Button ID="btnUpload" runat="server" Text="上 传" CssClass="xiug" style="border:none; color:#ffffff;" /></div>
                </div>
            </div>
        </div>
    </div>
