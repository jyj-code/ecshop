    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr id="tr_pwd1">
            ...
            <td style="width:150px;">
                <input type="password" class="textwb" id="Input_NewPayPwd" runat="server" maxlength="15" onblur="existepwd()" />
            </td>
            <td>
        ...
        <tr>
            ...
            <td  style="width:150px; ">
                <input type="password" class="textwb" id="Input_NewSecondPayPwd" runat="server" maxlength="15" onblur="existesurepwd()"  onkeydown="KeyEnter(event)"/>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:LinkButton ID="LinkButton_Save" runat="server" CssClass="J_ftrack btn btn-green" OnClientClick="return CheckSumbit()">确定</asp:LinkButton>
            </td>
        </tr>
    </table>
...
<script type="text/javascript" language="javascript">
    function KeyEnter(event)
    {
        if(event.keyCode==13)
        {alert(event.keyCode);
              document.getElementById("<%=LinkButton_Save.ClientID %>").click();
        }
    }
    $(function(){
