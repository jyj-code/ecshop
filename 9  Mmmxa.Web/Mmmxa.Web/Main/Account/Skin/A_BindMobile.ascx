            ...
            $("#<%= M_code.ClientID %>").focus(function(){
             ...
             $("#<%= M_code.ClientID %>").blur(function(){
                 if(this.value=="")
                 {
                  ...
                  {
                     $.get("/Api/CheckInfo.ashx?type=3&key="+$("#A_BindMobile_ctl00_M_code").val()+"&mobile="+$("#nextmobile").text(),null,function(data)
                    {
                        if(data=="1")
                        {                        
    ...
    <div class="ps_width clearfix" style="margin-left:5px;">
            ...
            <div class="form_row">
                ...
                <div>
                   ...
                   <td style="padding-left:8px;"><a onclick="reloadcode2()">看不清楚？</a></td>
                    ...
                    <input type="text" id="M_code" name="code" data-tip="验证码" disabled="disabled" maxlength="6" class="intext intext_short nullv tov vfb"  runat="server"  >
                    <div>
      ...
      <div id="step3" style="display:none">
          ...
          <font  style="font-size:16px; font-family:微软雅黑; display:block;margin-bottom:20px;margin-top:10px;  ">
           ...
           <br />
         <asp:Button ID="btn_Next" runat="server" Text="确定"  data-tid="bindphone_uid_button068" data-tprefix="/virtual/ucenter/myfanli"  class="J_ftrack btn btn-green" OnClientClick="return BtnSubmit()" />
