namespace ShopNum1.Interface
{
    ...
    public interface IShopNum1_Member_Action
    {
        ...
        DataTable GetMemberPassWord(string loginID, string pwd);
        ...
        DataTable LoginByEmail(string email, string pwd);
        DataTable LoginByMobile(string mobile, string pwd);
        ...
        int PreDepositsPay(string memLoginID, decimal shouldPay, decimal advancePayment, string orderNumber, string IsAllPay);
        int RefundUpdateAdvancePayment(string memloginid, string shopid, decimal payprice, decimal shopAdvancePayment, string orderguid, string productguid, int status);
        ...
        DataTable Search(string MemLoginID, string ZfbCode, string RealName, string IdentityCard, string ApplyDate1, string ApplyDate2, string IsAudit);
        DataTable Search1(string memLoginID, string name, string email, string regDate1, string regDate2, int sex, int isForbid, string AreaCode, string MemberType, string MemberRank, string CreditMoney, string Mobile);
        ...
        DataTable SearchIsAudit(string MemLoginID, string RealName, string IdentityCard, string StartTime, string EndTime, string IdentificationIsAudit);
        ...
        DataTable SearchPassMemberInfo(string MemLoginID, string RealName, string IdentityCard, string StartTime, string EndTime);
        ...
        int UpdateIdentificationIsAudit(string Guid, string IdentificationIsAudit, string strAuditFailedReason, string memLoginID);
        ...
        int UploadingCardPic(string MemLoginID, string IdentityCardImg, string IdentityCard, string RealName, string IdentificationTime);
        int UploadingCardPic(string MemLoginID, string IdentityCardImg, string IdentityCardBackImg, string IdentityCard, string RealName, string IdentificationTime);
    }
}
