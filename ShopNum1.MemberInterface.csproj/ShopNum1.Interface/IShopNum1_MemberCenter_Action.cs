namespace ShopNum1.Interface
{
    ...
    public interface IShopNum1_MemberCenter_Action
    {
        ...
        int CheckPassword(string memLoginID, string pwd);
        ...
        DataTable Search(string memLoginID, string realName, string email, string regDate1, string regDate2, decimal creditMoney1, decimal creditMoney2, int score1, int score2, int sex, int isForbid, string memberRankGuid, int isDeleted, string agentID);
