...
namespace ShopNum1.ShopWebControl
{
	...
	{
		private string string_0 = "ShopDomainCopyright.ascx";
		...
		{
			this.hyperLink_1.NavigateUrl = ShopSettings.GetValue("CopyrightLink");
			this.label_1.Text = ShopSettings.GetValue("Copyright");
		}
