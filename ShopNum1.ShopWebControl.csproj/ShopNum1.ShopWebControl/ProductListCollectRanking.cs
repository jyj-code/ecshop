...
namespace ShopNum1.ShopWebControl
{
	...
	{
		private string string_0 = "ProductListCollectRanking.ascx";
		...
		private void method_0()
		{
			...
			DataTable collectRankingProduct = shop_Product_Action.GetCollectRankingProduct(text.ToString(), this.MemLoginID);
			this.repeater_0.DataSource = collectRankingProduct;
