...
namespace ShopNum1.Payment.CCBPay
{
	public class CCBPayMent
	{
		public bool GetURLCCBPayMent(PayInfo payinfo, out string strUrl)
		{
			...
			string text2 = str + "&TYPE=1&PUB=cdb3a8ff352b02661e5ff96d020111&GATEWAY=&CLIENTIP=&REGINFO=&PROINFO=&REFERER=";
			string text3 = str + "&TYPE=1&GATEWAY=&CLIENTIP=&REGINFO=&PROINFO=&REFERER=";
			string text4 = CCBPayMent.ToMD5(text2.Trim()).ToLower().Trim();
		...
		public static string ToMD5(string string_0)
		{
