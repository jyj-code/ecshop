...
namespace ShopNum1.Payment
{
	public class Alipay2
	{
		...
		public bool CreatUrl(string gateway, string service, string partner, string sign_type, string out_trade_no, string subject, string body, string payment_type, string total_fee, string show_url, string seller_email, string string_0, string return_url, string _input_charset, string notify_url, string logistics_type, string logistics_fee, string logistics_payment, string logistics_type_1, string logistics_fee_1, string logistics_payment_1, string quantity, out string string_1)
		{
			bool result = true;
			try
			{
				...
				string[] array = Alipay2.BubbleSort(string_2);
				...
				string mD = Alipay2.GetMD5(stringBuilder.ToString(), _input_charset);
