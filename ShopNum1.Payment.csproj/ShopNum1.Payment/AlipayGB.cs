	...
	public class AlipayGB
	{
		...
		public bool CreatUrl(string gateway, string service, string partner, string sign_type, string out_trade_no, string subject, string body, string total_fee, string show_url, string seller_email, string string_0, string return_url, string _input_charset, string notify_url, string logistics_type, string logistics_fee, string logistics_payment, string quantity, string paytype, out string string_1)
		{
			...
			try
			{
				...
				string[] array = AlipayGB.BubbleSort(string_2);
				...
				string mD = AlipayGB.GetMD5(stringBuilder.ToString(), _input_charset);
