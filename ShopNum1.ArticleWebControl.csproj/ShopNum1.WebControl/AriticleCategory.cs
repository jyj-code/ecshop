...
{
	[ParseChildren(true)]
	public class AriticleCategory : BaseWebControl
	{
		public int int_0 = 0;
		private string string_0 = "AriticleCategory.ascx";
		...
		private void repeater_0_ItemDataBound(object sender, RepeaterItemEventArgs e)
		{
			...
			DataRow[] array = ShopNum1_ArticleCategory_Action.ArticleCategoryTable.Select("FatherID=" + hiddenField.Value);
