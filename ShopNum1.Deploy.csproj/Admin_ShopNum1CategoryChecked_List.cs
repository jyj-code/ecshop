...
public class Admin_ShopNum1CategoryChecked_List : PageBase, IRequiresSessionState
{
	...
	{
		ShopNum1_CategoryChecked_Action shopNum1_CategoryChecked_Action = (ShopNum1_CategoryChecked_Action)LogicFactory.CreateShopNum1_CategoryChecked_Action();
		if (shopNum1_CategoryChecked_Action.Update(this.CheckGuid.Value, "2") > 0)
		{
			this.BindGrid();
	...
	protected void ButtonDeleteBylink_Click(object sender, EventArgs e)
	{
		...
		ShopNum1_CategoryChecked_Action shopNum1_CategoryChecked_Action = (ShopNum1_CategoryChecked_Action)LogicFactory.CreateShopNum1_CategoryChecked_Action();
		int num = shopNum1_CategoryChecked_Action.Delete(guids);
		if (num > 0)
		{
			this.BindGrid();
			this.MessageShow1.ShowMessage("DelYes");
