...
public class Agent_PaymentStatistics_Report : PageBase, IRequiresSessionState
{
	...
	private void method_5()
	{
		...
		DataTable dataTable = shopNum1_ExtendOrderStatistics_Action.SearchPaymentStatistics();
