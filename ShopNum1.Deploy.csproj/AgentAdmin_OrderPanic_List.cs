...
public class AgentAdmin_OrderPanic_List : PageBase, IRequiresSessionState
{
	...
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=1");
	}
	protected void LinkButtonPayment_Click(object sender, EventArgs e)
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=3&status=1");
	}
	protected void LinkButtonNopayment_Click(object sender, EventArgs e)
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=2&status=0");
	}
	protected void LinkButtonSend_Click(object sender, EventArgs e)
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=4&status=2");
	}
	protected void LinkButtonComplete_Click(object sender, EventArgs e)
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=5&status=3");
	}
	protected void LinkButtonRefund_Click(object sender, EventArgs e)
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=6&status=6");
	}
	protected void LinkButtonReturnGoods_Click(object sender, EventArgs e)
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=7&status=5");
	}
	protected void LinkButtonCanel_Click(object sender, EventArgs e)
	{
		base.Response.Redirect("OrderPanic_List.aspx?style=8&status=4");
	}
