...
public class PayReturn_unionpay_unionpay_receive : Page, IRequiresSessionState
{
	...
	private bool method_0(string string_0)
	{
		...
		{
			string nameById = Common.GetNameById("advancepayment", "shopnum1_member", " and memloginid='" + base.Request.QueryString["sendmoney"].ToString() + "'");
			if (nameById != "")
			{
