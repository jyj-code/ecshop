...
public class Admin_CategoryAdBuyAudit_List : PageBase, IRequiresSessionState
{
	...
	protected System.Web.UI.WebControls.DropDownList DropDownListIsPayMent;
	...
	{
		base.Response.Redirect("CategoryAdBuy_SearchDetail.aspx?guid=" + this.CheckGuid.Value + "&&type=Audit");
	}
	protected void ButtonDeleteBylink_Click(object sender, EventArgs e)
	{
		...
		ShopNum1_CategoryAdPayMent_Action shopNum1_CategoryAdPayMent_Action = (ShopNum1_CategoryAdPayMent_Action)LogicFactory.CreateShopNum1_CategoryAdPayMent_Action();
		int num = shopNum1_CategoryAdPayMent_Action.Delete(string_);
		if (num > 0)
		{
			this.BindGrid();
			this.MessageShow.ShowMessage("DelYes");
