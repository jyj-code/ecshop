...
public class AgentAdmin_ShopChartArea : PageBase, IRequiresSessionState
{
		...
		if (dataTable != null && dataTable.Rows.Count > 0)
		{
			...
			try
			{
				while (enumerator.MoveNext())
				{
					...
					string value = shopNum1_ShopInfoList_Action.GetShopCountByCode(code, base.SubstationID).ToString();
