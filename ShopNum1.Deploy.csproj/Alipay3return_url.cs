...
public class Alipay3return_url : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		{
			Alipay3Notify alipay3Notify = new Alipay3Notify(requestGet, base.Request.QueryString["notify_id"], partner, string_, input_charset, sign_type, transport);
