...
public class AgentAdmin_UserDefinedColumn_Operate : PageBase, IRequiresSessionState
{
	...
	protected void GetOrderID()
	{
		try
		{
			string nameById = Common.GetNameById("max(OrderID)", "ShopNum1_UserDefinedColumn", "   AND  SubstationID='" + base.SubstationID + "'    ");
	...
	protected void Add()
	{
		...
		shopNum1_UserDefinedColumn.SubstationID = base.SubstationID;
		ShopNum1_UserDefinedColumn_Action shopNum1_UserDefinedColumn_Action = (ShopNum1_UserDefinedColumn_Action)LogicFactory.CreateShopNum1_UserDefinedColumn_Action();
