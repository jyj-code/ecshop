...
public class Admin_VideoCategory_Operate : PageBase, IRequiresSessionState
{
	...
	protected void ButtonConfirm_Click(object sender, EventArgs e)
	{
		...
		try
		{
			if (this.DropDownListFatherID.SelectedValue != "0")
			{
				value = Common.GetNameById("CategoryLevel", "ShopNum1_VideoCategory", "   and   ID='" + this.DropDownListFatherID.SelectedValue + "'     ");
			}
		}
		catch (Exception)
		{
