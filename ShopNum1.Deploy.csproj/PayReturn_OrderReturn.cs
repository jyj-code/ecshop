...
public class PayReturn_OrderReturn : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (flag)
		{
			...
			else
			{
				...
				{
					shopNum1_OrderInfo_Action.SetPaymentStatus2(guid, 1, 1, 0, DateTime.Now, Convert.ToDecimal(text2), Convert.ToDecimal(value));
