...
public class Main_Admin_MobilePayment_List : PageBase, IRequiresSessionState
{
	...
	{
		base.Response.Redirect("MobilePayment_Operate.aspx?type=mobile&guid=" + this.CheckGuid.Value.ToString().Replace("'", ""));
	}
	protected void ButtonDelete_Click(object sender, EventArgs e)
	{
		...
		int num = shopNum1_Payment_Action.DeleteMobile(this.CheckGuid.Value.ToString());
		if (num > 0)
		{
	...
	protected void ButtonDeleteBylink_Click(object sender, EventArgs e)
	{
		...
		int num = shopNum1_Payment_Action.DeleteMobile(guids);
		if (num > 0)
		{
			base.OperateLog(new ShopNum1_OperateLog
			{
