...
public class AgentAdmin_ShopCategoryAply_Audit : PageBase, IRequiresSessionState
{
	...
	private DataTable method_5(string string_5, string string_6, string string_7, string string_8, string string_9, string string_10, string string_11)
	{
		...
		{
			text = text + " AND B.SubstationID ='" + string_11.Trim() + "'";
		}
	...
	private void method_6()
	{
		...
		this.Num1GridViewShow.DataSource = this.method_5("", "", "", "", "", "", base.SubstationID).DefaultView;
