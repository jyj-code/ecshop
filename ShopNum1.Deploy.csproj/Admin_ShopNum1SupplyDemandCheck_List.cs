...
public class Admin_ShopNum1SupplyDemandCheck_List : PageBase, IRequiresSessionState
{
	...
	protected HiddenField CheckAudit;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			...
			this.SetCode();
			if (Common.ReqStr("isAudit") != "")
			{
				this.CheckAudit.Value = Common.ReqStr("isAudit");
			}
			this.BindGrid();
		}
	}
