...
public class Main_Admin_Theme_ActivityOperate : PageBase, IRequiresSessionState
{
	...
	protected HtmlTableRow showUrl;
	...
	private void method_5()
	{
		try
		{
			...
			{
				string text = Common.ReqStr("update");
				this.ThemUrl = "ThemesProduct.html?ThemeGuid=" + text;
				this.showUrl.Visible = true;
				DataTable themeActivtyByGuid = this.shopNum1_Activity_Action_0.GetThemeActivtyByGuid(text);
	...
	protected void btnSub_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("活动说明输入字符不能超过200个！");
		}
		else
		{
