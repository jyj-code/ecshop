...
public class Admin_SubstationManage_UserManage : PageBase, IRequiresSessionState
{
	private int int_0;
	protected HtmlLink sizestylesheet;
	protected HtmlHead Head1;
	protected Label LabelSubName;
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (this.Page.Request.QueryString["Guid"] != null)
		{
			...
			DataTable dataTable = shopNum1_SubstationManage_Action.Search(this.Page.Request.QueryString["Guid"].ToString().Replace("'", ""));
			if (dataTable != null && dataTable.Rows.Count > 0)
			{
				this.HiddenFieldSubstationID.Value = dataTable.Rows[0]["SubstationID"].ToString();
				this.LabelSubName.Text = dataTable.Rows[0]["Name"].ToString();
			}
		}
		else
		{
			this.Page.Response.Redirect("SubstationManage_List.aspx");
		}
		base.CheckLogin();
	...
	{
		ShopNum1_Dept_Action shopNum1_Dept_Action = (ShopNum1_Dept_Action)ShopNum1.Factory.LogicFactory.CreateShopNum1_Dept_Action();
	...
	{
		ShopNum1_Group_Action shopNum1_Group_Action = (ShopNum1_Group_Action)ShopNum1.Factory.LogicFactory.CreateShopNum1_Group_Action();
