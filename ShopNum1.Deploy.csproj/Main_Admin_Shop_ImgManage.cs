...
public class Main_Admin_Shop_ImgManage : PageBase, IRequiresSessionState
{
	...
	protected void BindImage()
	{
		...
		DataSet dataSet2 = shop_Image_Action.MangeShopImg(this.strPageSize, pageList.PageID.ToString(), this.method_5(), "1");
