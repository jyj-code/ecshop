...
public class AgentAdmin_Article_Operate : PageBase, IRequiresSessionState
{
	...
	protected AgentAdmin_UserControl_ArticleRelateArticleSelect ArticleRelateArticleSelect1;
	...
	protected void GetEditInfo()
	{
		...
		DropDownList arg_2A8_0 = (DropDownList)this.ArticleRelateArticleSelect1.FindControl("DropDownListRelatedArticleIsBoth");
