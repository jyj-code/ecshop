...
public class Admin_Email_List : PageBase, IRequiresSessionState
{
	...
	protected Localize LocalizeTypeName;
	protected System.Web.UI.WebControls.DropDownList DropDownListTypeName;
	...
	protected void ButtonAdd_Click(object sender, EventArgs e)
	{
		...
		base.Response.Redirect("Email_Operate.aspx?guid=" + this.CheckGuid.Value);
	}
	...
	protected void ButtonDelete_Click(object sender, EventArgs e)
	{
		...
		int num = shopNum1_Email_Action.Delete(this.CheckGuid.Value.ToString());
		if (num > 0)
		{
			this.BindGrid();
	...
	protected void ButtonDeleteBylink_Click(object sender, EventArgs e)
	{
		...
		ShopNum1_Email_Action shopNum1_Email_Action = (ShopNum1_Email_Action)LogicFactory.CreateShopNum1_Email_Action();
		int num = shopNum1_Email_Action.Delete("'" + commandArgument + "'");
		if (num > 0)
		{
			this.BindGrid();
			this.MessageShow.ShowMessage("DelYes");
