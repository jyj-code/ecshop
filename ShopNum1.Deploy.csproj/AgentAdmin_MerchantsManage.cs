...
public class AgentAdmin_MerchantsManage : PageBase, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!this.Page.IsPostBack)
		{
			try
			{
				string path = HttpContext.Current.Server.MapPath("~/City/" + base.SubstationID + "/Themes/Skin_Default/MerchantsIn.html");
				if (File.Exists(path))
				{
