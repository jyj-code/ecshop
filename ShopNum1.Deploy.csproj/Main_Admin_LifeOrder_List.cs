...
public class Main_Admin_LifeOrder_List : PageBase, IRequiresSessionState
{
	...
	private string method_5()
	{
		...
		string text12 = Common.ReqStr("sub");
		...
		if (text12 != "-1" && Operator.FormatToEmpty(text12) != string.Empty)
		{
