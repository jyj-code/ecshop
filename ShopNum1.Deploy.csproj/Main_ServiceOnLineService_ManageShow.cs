...
public class Main_ServiceOnLineService_ManageShow : PageBase, IRequiresSessionState
{
	...
	private void method_5()
	{
		...
		string value = shopSettings.GetValue(this.Page.Server.MapPath(Globals.ApplicationPath + "/Settings/ShopSetting.xml"), "ShowCustomer");
		string value2 = shopSettings.GetValue(this.Page.Server.MapPath(Globals.ApplicationPath + "/Settings/ShopSetting.xml"), "IsOpenPhone");
		string value3 = shopSettings.GetValue(this.Page.Server.MapPath(Globals.ApplicationPath + "/Settings/ShopSetting.xml"), "ServerPhone");
		if (value == "1")
		{
