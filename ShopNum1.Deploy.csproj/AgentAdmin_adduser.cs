...
public class AgentAdmin_adduser : PageBase, IRequiresSessionState
{
	...
	private void method_5()
	{
		...
		DataView defaultView = shopNum1_Group_Action.Search(0, base.SubstationID).DefaultView;
	...
	protected void ButtonConfirm_Click(object sender, EventArgs e)
	{
		...
		{
			if (string.IsNullOrEmpty(this.TextBoxPassword1.Text))
			{
			...
			else
			{
				...
				else
				{
					...
					shopNum1_User.SubstationID = base.SubstationID;
