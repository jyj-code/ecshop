...
public class Main_Admin_ShopVedioChecked_List : PageBase, IRequiresSessionState
{
	...
	{
		ShopNum1_Vedio_List_Action shopNum1_Vedio_List_Action = (ShopNum1_Vedio_List_Action)ShopNum1.Factory.LogicFactory.CreateShopNum1_Vedio_List_Action();
