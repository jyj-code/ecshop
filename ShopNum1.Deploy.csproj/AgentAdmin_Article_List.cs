...
public class AgentAdmin_Article_List : PageBase, IRequiresSessionState
{
	...
	{
		ShopNum1_Article_Action shopNum1_Article_Action = (ShopNum1_Article_Action)ShopNum1.Factory.LogicFactory.CreateShopNum1_Article_Action();
	...
	protected void BindArticleCategory()
	{
		...
		ShopNum1_ArticleCategory_Action shopNum1_ArticleCategory_Action = (ShopNum1_ArticleCategory_Action)ShopNum1.Factory.LogicFactory.CreateShopNum1_ArticleCategory_Action();
	...
	public string GetUrl(string pagename, string value)
	{
		...
		try
		{
			text = shopNum1_SubstationManage_Action.GetDomainNameBySubstationID(base.SubstationID);
		}
		catch (Exception)
		{
			text = "public";
