...
public class AgentAdmin_Image_List_Select : PageBase, IRequiresSessionState
{
	...
	protected void BindImage(string strImageType)
	{
		...
		DataTable dataTable2 = shopNum1_Image_Action.SearchImageByType(this.string_6, this.string_5, 0, this.string_7, this.ShowCount.ToString(), this.int_0.ToString(), "0");
