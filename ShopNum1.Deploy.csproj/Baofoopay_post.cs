...
using System.Web.UI;
public class Baofoopay_post : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (this.Page.Request.QueryString["OrderNumber"] != null)
		{
			...
			{
				this.strOrderMoney = (Convert.ToDouble(Common.ReqStr("price").ToString()) * 100.0).ToString();
				this.strProductName = "";
				this.strAmount = "1";
				this.strProductLogo = "";
				this.strUsername = "";
	...
	private string method_0(string string_0, string string_1, string string_2, string string_3, string string_4, string string_5, string string_6, string string_7, string string_8)
	{
		...
		return Baofoo.Md5Encrypt(strToBeEncrypt);
	}
