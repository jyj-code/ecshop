...
public class Main_Admin_ShopSales_Report : PageBase, IRequiresSessionState
{
	...
	private void method_5()
	{
		...
		DataTable dataTable = shopNum1_ShopInfoList_Action.SearchShopSalesClickCount(this.Page.Request.QueryString["shophost"].ToString(), this.Page.Request.QueryString["shopname"].ToString(), startdate, enddate);
