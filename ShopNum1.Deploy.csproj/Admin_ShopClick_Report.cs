...
public class Admin_ShopClick_Report : PageBase, IRequiresSessionState
{
	...
	private void method_5()
	{
		...
		DataTable dataTable = shopNum1_ShopInfoList_Action.SearchShopClickCount(this.Page.Request.QueryString["hname"].ToString(), this.Page.Request.QueryString["sname"].ToString(), startdate, enddate);
