...
public class AgentAdmin_Group_ActivityList : PageBase, IRequiresSessionState
{
	...
	private void method_5()
	{
		...
		DataTable dataTable = this.shopNum1_Activity_Action_0.SelectActivity(text2, text3, " AND TYPE=1  AND  SubstationID='" + base.SubstationID + "'   ", "0");
		...
		this.dt = this.shopNum1_Activity_Action_0.SelectActivity(text2, text3, " AND TYPE=1    AND  SubstationID='" + base.SubstationID + "'     ", "1");
	}
}
