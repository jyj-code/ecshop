...
public class Admin_Image_List : PageBase, IRequiresSessionState
{
	...
	protected void BindImage()
	{
		...
		DataTable dataSource = shopNum1_Image_Action.SearchImageByType(this.string_7, this.string_6, 0, this.string_8, this.ShowCount.ToString(), pageList.PageID.ToString(), "0");
