...
public class AgentAdmin_Prouduct_PanicChecked_List : PageBase, IRequiresSessionState
{
	...
	private void method_6()
	{
		...
		listItem4.Text = "已上架";
		listItem4.Value = "2";
		this.DropDownListIsSaled.Items.Add(listItem4);
	}
	...
	{
		base.Response.Redirect("ProductSearchDetal.aspx?guid=" + this.CheckGuid.Value.Replace("'", "") + "&Type=Panic&Back=4");
	}
	...
	protected void ButtonDeleteBylink_Click(object sender, EventArgs e)
	{
		...
		int num = shopNum1_ProuductChecked_Action.Delete(guids);
		if (num > 0)
		{
			this.BindGrid();
			this.MessageShow.ShowMessage("DelYes");
