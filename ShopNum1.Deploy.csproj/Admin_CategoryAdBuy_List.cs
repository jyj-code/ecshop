...
public class Admin_CategoryAdBuy_List : PageBase, IRequiresSessionState
{
	...
	protected System.Web.UI.WebControls.DropDownList DropDownListIsEffective;
	...
	private void method_5()
	{
		try
		{
			...
			shopNum1_CategoryAdPayMent_Action.UpdateIsEffective(DateTime.Now.ToString());
		}
		catch
		{
		}
	...
	{
		ShopNum1_CategoryAdPayMent_Action shopNum1_CategoryAdPayMent_Action = (ShopNum1_CategoryAdPayMent_Action)LogicFactory.CreateShopNum1_CategoryAdPayMent_Action();
		int num = shopNum1_CategoryAdPayMent_Action.Delete(this.CheckGuid.Value);
		if (num > 0)
		{
			this.BindGrid();
	...
	protected void DropDownListCategory1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		{
			this.method_6(this.DropDownListCategory1.SelectedValue.Split(new char[]
			{
				'/'
	...
	protected void DropDownListCategory2_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		{
			this.method_6(this.DropDownListCategory2.SelectedValue.Split(new char[]
			{
				'/'
	...
	protected void DropDownListAdPageName_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		if (!(this.DropDownListAdPageName.SelectedValue == "-1"))
		{
			...
			if (this.DropDownListAdPageName.SelectedValue == "1")
			{
				this.method_6("0", this.DropDownListCategory1);
			}
	...
	public string IsPayMent(object object_0)
	{
		string a = object_0.ToString();
		string result;
		if (a == "1")
	...
	public string IsAudit(object object_0)
	{
		string a = object_0.ToString();
		string result;
		if (a == "1")
	...
	{
		base.Response.Redirect("CategoryAdBuy_SearchDetail.aspx?guid=" + this.CheckGuid.Value + "&&type=List");
	}
	public string GetImageStatus(string EndTime)
	{
		string result;
