...
public class PayReturn_unionpay_NetPaySubmit : Page, IRequiresSessionState
{
	protected TextBox MerId;
	protected TextBox Version;
	protected TextBox OrdID;
	protected TextBox TransAmt;
	protected TextBox CuryId;
	protected TextBox TransDate;
	protected TextBox TransType;
	protected TextBox BgRetUrl;
	protected TextBox PageRetUrl;
	protected TextBox GateId;
	protected TextBox Priv1;
	protected TextBox ChkValue;
