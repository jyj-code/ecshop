...
public class AgentAdminProuduct_List : PageBase, IRequiresSessionState
{
	...
	protected void BindGrid()
	{
		...
		DataTable dataTable = shopNum1_ProuductChecked_Action.V8_2_SearchPerPageNew1("3", text.ToString(), text3, this.TextBoxName.Text, this.HiddenFieldCode.Value, this.TextBoxPrice1.Text, this.TextBoxPrice2.Text, this.DropDownListIsSaled.SelectedValue, "1", this.TextBoxShopID.Text, this.TextBoxShopName.Text, this.DropDownListIsSell.SelectedValue, this.DropDownListIsShopNew.SelectedValue, this.DropDownListIsShopHot.SelectedValue, this.DropDownListIsShopGood.SelectedValue, this.DropDownListIsShopRecommend.SelectedValue, base.SubstationID);
		...
		this.dt_ProductList = shopNum1_ProuductChecked_Action.V8_2_SearchPerPageNew1("2", text.ToString(), pageList.PageID.ToString(), this.TextBoxName.Text, this.HiddenFieldCode.Value, this.TextBoxPrice1.Text, this.TextBoxPrice2.Text, this.DropDownListIsSaled.SelectedValue, "1", this.TextBoxShopID.Text, this.TextBoxShopName.Text, this.DropDownListIsSell.SelectedValue, this.DropDownListIsShopNew.SelectedValue, this.DropDownListIsShopHot.SelectedValue, this.DropDownListIsShopGood.SelectedValue, this.DropDownListIsShopRecommend.SelectedValue, base.SubstationID);
