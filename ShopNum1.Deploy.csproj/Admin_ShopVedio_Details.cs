...
public class Admin_ShopVedio_Details : PageBase, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (shopVideoByGuid != null && shopVideoByGuid.Rows.Count > 0)
		{
			...
			if (shopVideoByGuid.Rows[0]["isAudit"].ToString() == "1" || shopVideoByGuid.Rows[0]["isAudit"].ToString() == "2")
			{
