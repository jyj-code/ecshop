...
public class AgentAdmin_LifeOrder_List : PageBase, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		{
			this.PageSize = Convert.ToInt32(Common.ReqStr("pagesize"));
		}
	...
	protected void BindGrid(string strcondition)
	{
		...
		DataTable dataTable = shopNum1_OrderInfo_Action.SelectList(this.PageSize.ToString(), this.string_5, strcondition, "0", "CreateTime", "desc");
		...
		this.dt_OrderList = shopNum1_OrderInfo_Action.SelectList(this.PageSize.ToString(), pageList.PageID.ToString(), strcondition, "1", "CreateTime", "desc");
