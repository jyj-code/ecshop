...
public class Admin_Link_Operate : PageBase, IRequiresSessionState
{
	...
	protected void Edit()
	{
		...
		shopNum1_Link.CreateTime = Convert.ToDateTime(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
		shopNum1_Link.ModifyTime = Convert.ToDateTime(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
	...
	protected void Add()
	{
		...
		shopNum1_Link.IsDeleted = 0;
		shopNum1_Link.OrderID = Convert.ToInt32(this.textBoxOrderID.Text.Trim());
		shopNum1_Link.SubstationID = "all";
		if (this.CheckBoxIsShow.Checked)
		{
			shopNum1_Link.IsShow = 1;
		}
