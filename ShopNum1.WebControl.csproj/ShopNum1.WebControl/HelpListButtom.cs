...
{
	[ParseChildren(true)]
	public class HelpListButtom : BaseWebControl
	{
		private string string_0 = "HelpListButtom.ascx";
		...
		private void repeater_0_ItemDataBound(object sender, RepeaterItemEventArgs e)
		{
			...
			DataTable dataTable = shopNum1_Help_Action.Search(hiddenField.Value, 7, 0);
