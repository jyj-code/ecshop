...
{
	[ParseChildren(true)]
	public class CategoryInfoCategory : BaseWebControl
	{
		private string string_0 = "CategoryInfoCategory.ascx";
		...
		private void repeater_0_ItemDataBound(object sender, RepeaterItemEventArgs e)
		{
			if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
			{
				...
				DataRow[] array = ShopNum1_CategoryChecked_Action.CategoryTable.Select("FatherID=" + hiddenField.Value);
		...
		{
			DataRow[] array = ShopNum1_CategoryChecked_Action.CategoryTable.Select("FatherID=0");
			if (array != null && array.Length > 0)
			{
