...
{
	[ParseChildren(true)]
	public class SupplyDemandCategoryAd : BaseWebControl
	{
		private string string_0 = "SupplyDemandCategoryAd.ascx";
		...
		protected override void InitializeSkin(System.Web.UI.Control skin)
		{
			...
			DataTable dataTable = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, categorycode, "3");
			...
			{
				DataTable dataTable2 = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, "3");
