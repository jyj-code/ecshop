...
{
	[ParseChildren(true)]
	public class BrandAd : BaseWebControl
	{
		private string string_0 = "BrandAd.ascx";
		...
		{
			string categorycode = (ShopNum1.Common.Common.ReqStr("code") == null) ? "-1" : ShopNum1.Common.Common.ReqStr("code");
			...
			DataTable dataTable = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, categorycode, "6");
			...
			{
				DataTable dataTable2 = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, "6");
