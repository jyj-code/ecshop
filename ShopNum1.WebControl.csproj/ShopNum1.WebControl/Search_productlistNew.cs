...
namespace ShopNum1.WebControl
{
	...
	{
		private string string_0 = "Search_productlistNew.ascx";
		...
		private string string_2 = GetPageName.RetDomainUrl("ProductListPromotion");
		...
		protected override void InitializeSkin(System.Web.UI.Control skin)
		{
			if (this.Page.Request.QueryString["SubstationID"] != null && !string.IsNullOrEmpty(this.Page.Request.QueryString["SubstationID"].ToString()))
			{
				...
				this.string_2 = string.Concat(new string[]
				{
					...
					"/Search_productlist",
					Search_productlistNew.GetOverrideUrlName()
				});
			}
			this.strStartPrice = ShopNum1.Common.Common.ReqStr("minprice");
			this.strEndPrice = ShopNum1.Common.Common.ReqStr("maxprice");
			if (this.Page.Request.QueryString["IsshopNew"] != null)
			{
				this.IsshopNew = Convert.ToInt32(this.Page.Request.QueryString["IsshopNew"].ToString());
			}
			if (this.Page.Request.QueryString["IsshopHot"] != null)
			{
				this.IsshopHot = Convert.ToInt32(this.Page.Request.QueryString["IsshopHot"].ToString());
			}
			if (this.Page.Request.QueryString["IsShopGood"] != null)
			{
				this.IsShopGood = Convert.ToInt32(this.Page.Request.QueryString["IsShopGood"].ToString());
			}
			if (this.Page.Request.QueryString["IsShopRecommend"] != null)
			{
				this.IsShopRecommend = Convert.ToInt32(this.Page.Request.QueryString["IsShopRecommend"].ToString());
			}
			...
			this.linkButton_13 = (LinkButton)skin.FindControl("LinkButtonStatus");
			this.linkButton_14 = (LinkButton)skin.FindControl("LinkButtonNew");
			this.linkButton_14.Click += new EventHandler(this.linkButton_14_Click);
			this.linkButton_15 = (LinkButton)skin.FindControl("LinkButtonHot");
			this.linkButton_15.Click += new EventHandler(this.linkButton_15_Click);
			this.linkButton_16 = (LinkButton)skin.FindControl("LinkButtonGood");
			this.linkButton_16.Click += new EventHandler(this.linkButton_16_Click);
			this.linkButton_17 = (LinkButton)skin.FindControl("LinkButtonRecommend");
			...
			this.string_4 = ((ShopNum1.Common.Common.ReqStr("search") == "") ? "-1" : ShopNum1.Common.Common.ReqStr("search"));
			...
			this.string_5 = ((ShopNum1.Common.Common.ReqStr("sort") == "") ? "desc" : ShopNum1.Common.Common.ReqStr("sort"));
			...
			{
				this.method_1();
				this.method_0(ShopNum1.Common.Common.ReqStr("ordername"), ShopNum1.Common.Common.ReqStr("sort"));
		...
		private void method_0(string string_11, string string_12)
		{
			...
			if (this.IsshopNew == 1)
			{
				this.linkButton_13.Text = "新品";
			}
			if (this.IsshopHot == 1)
			{
				this.linkButton_13.Text = "热卖";
			}
			if (this.IsShopGood == 1)
			{
				this.linkButton_13.Text = "精品";
			}
			if (this.IsShopRecommend == 1)
			{
				this.linkButton_13.Text = "推荐";
			}
		}
		...
		private void method_1()
		{
			...
			DataSet furnitureProduct;
			if (this.string_1 == "all")
			{
				furnitureProduct = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct2(this.addcode, this.string_7, this.string_3, this.string_6, this.string_5, this.strStartPrice, this.strEndPrice, this.string_4, this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "1", this.dictionary_0, this.IsshopNew, this.IsshopHot, this.IsShopGood, this.IsShopRecommend);
			}
			else
			{
				furnitureProduct = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct2(this.addcode, this.string_7, this.string_3, this.string_6, this.string_5, this.strStartPrice, this.strEndPrice, this.string_4, this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "1", this.dictionary_0, this.IsshopNew, this.IsshopHot, this.IsShopGood, this.IsShopRecommend, this.string_1);
			}
			...
			PageListBll pageListBll = new PageListBll("ProductListPromotion", true);
			...
			DataSet furnitureProduct2;
			if (this.string_1 == "all")
			{
				furnitureProduct2 = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct2(this.addcode, this.string_7, this.string_3, this.string_6, this.string_5, this.strStartPrice, this.strEndPrice, this.string_4, this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "0", this.dictionary_0, this.IsshopNew, this.IsshopHot, this.IsShopGood, this.IsShopRecommend);
			}
			else
			{
				furnitureProduct2 = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct2(this.addcode, this.string_7, this.string_3, this.string_6, this.string_5, this.strStartPrice, this.strEndPrice, this.string_4, this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "0", this.dictionary_0, this.IsshopNew, this.IsshopHot, this.IsShopGood, this.IsShopRecommend, this.string_1);
			}
			if (furnitureProduct2 != null && furnitureProduct2.Tables[0].Rows.Count > 0)
			{
				...
				this.repeater_0.DataSource = furnitureProduct2.Tables[0];
