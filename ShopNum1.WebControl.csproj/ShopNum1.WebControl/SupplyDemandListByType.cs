...
namespace ShopNum1.WebControl
{
	...
	public class SupplyDemandListByType : BaseWebControl
	{
		...
		private string string_0 = "SupplyDemandListByType.ascx";
		...
		public void BindData()
		{
			...
			DataTable dataSource = shopNum1_SupplyDemandCheck_Action.SearchByType(this.Code, this.ShowCount.ToString());
