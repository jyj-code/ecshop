...
namespace ShopNum1.WebControl
{
	...
	{
		private string string_0 = "ProductSearch3.ascx";
		...
		private string string_1 = GetPageName.RetDomainUrl("ProductListSearch");
		...
		protected override void InitializeSkin(System.Web.UI.Control skin)
		{
			...
			this.strName = ((this.Page.Request.QueryString["Name"] == null) ? "" : this.Page.Request.QueryString["Name"].ToString());
		...
		private void method_1()
		{
			...
			DataSet furnitureProduct = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct1(this.addcode, this.string_6, this.string_2, this.string_5, this.string_4, this.strStartPrice, this.strEndPrice, "", this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "1", this.dictionary_0, this.strName);
			...
			DataSet furnitureProduct2 = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct1(this.addcode, this.string_6, this.string_2, this.string_5, this.string_4, this.strStartPrice, this.strEndPrice, "", this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "0", this.dictionary_0, this.strName);
