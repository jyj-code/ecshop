...
{
	public class ShopSearch1 : BaseWebControl
	{
		private string string_0 = "ShopSearch1.ascx";
		...
		protected override void InitializeSkin(System.Web.UI.Control skin)
		{
			...
			this.dropDownList_0 = (DropDownList)skin.FindControl("DropDownListShopCategoryCode1");
			this.dropDownList_0.SelectedIndexChanged += new EventHandler(this.DropDownListShopCategoryCode1_SelectedIndexChanged);
			this.dropDownList_1 = (DropDownList)skin.FindControl("DropDownListShopCategoryCode2");
			this.dropDownList_1.SelectedIndexChanged += new EventHandler(this.DropDownListShopCategoryCode2_SelectedIndexChanged);
			this.dropDownList_2 = (DropDownList)skin.FindControl("DropDownListShopCategoryCode3");
			this.dropDownList_3 = (DropDownList)skin.FindControl("DropDownListRegionCode1");
			this.dropDownList_3.SelectedIndexChanged += new EventHandler(this.DropDownListRegionCode1_SelectedIndexChanged);
			this.dropDownList_4 = (DropDownList)skin.FindControl("DropDownListRegionCode2");
			this.dropDownList_4.SelectedIndexChanged += new EventHandler(this.DropDownListRegionCode2_SelectedIndexChanged);
			this.dropDownList_5 = (DropDownList)skin.FindControl("DropDownListRegionCode3");
			...
			if (ShopNum1.Common.Common.ReqStr("code") != "")
			{
				...
				if (text.Length >= 9)
				{
					for (int i = 0; i < this.dropDownList_2.Items.Count; i++)
					{
						...
						{
							this.dropDownList_2.Items[i].Selected = true;
							break;
						}
					}
				}
		...
		{
			this.label_0.Text = this.textBox_2.Text;
			this.BindData();
		}
		...
		protected void BindData()
		{
			...
			if (ShopNum1.Common.Common.ReqStr("code") != "" && !this.bool_0)
			{
				shopcategoryid = ShopNum1.Common.Common.ReqStr("code");
			}
			else
			{
			...
			string name;
			if (ShopNum1.Common.Common.ReqStr("search") != "" && !this.bool_0)
			{
				name = this.Page.Server.UrlDecode(ShopNum1.Common.Common.ReqStr("search"));
			}
			else
			{
		...
		protected void DropDownListShopCategoryCode1Bind()
		{
			...
			{
				this.dropDownList_0.Items.Add(new ListItem(list.Rows[i]["Name"].ToString(), list.Rows[i]["Code"].ToString() + "/" + list.Rows[i]["ID"].ToString()));
			}
			this.DropDownListShopCategoryCode1_SelectedIndexChanged(null, null);
		}
		protected void DropDownListShopCategoryCode1_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			{
				ShopNum1_ShopCategory_Action shopNum1_ShopCategory_Action = (ShopNum1_ShopCategory_Action)LogicFactory.CreateShopNum1_ShopCategory_Action();
				DataTable list = shopNum1_ShopCategory_Action.GetList(this.dropDownList_0.SelectedValue.Split(new char[]
				{
					'/'
				})[1]);
				for (int i = 0; i < list.Rows.Count; i++)
				{
					this.dropDownList_1.Items.Add(new ListItem(list.Rows[i]["Name"].ToString(), list.Rows[i]["Code"].ToString() + "/" + list.Rows[i]["ID"].ToString()));
				}
			}
			this.DropDownListShopCategoryCode2_SelectedIndexChanged(null, null);
		}
		protected void DropDownListShopCategoryCode2_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			{
				ShopNum1_ShopCategory_Action shopNum1_ShopCategory_Action = (ShopNum1_ShopCategory_Action)LogicFactory.CreateShopNum1_ShopCategory_Action();
				DataTable list = shopNum1_ShopCategory_Action.GetList(this.dropDownList_1.SelectedValue.Split(new char[]
				{
					'/'
				})[1]);
				for (int i = 0; i < list.Rows.Count; i++)
				{
					this.dropDownList_2.Items.Add(new ListItem(list.Rows[i]["Name"].ToString(), list.Rows[i]["Code"].ToString() + "/" + list.Rows[i]["ID"].ToString()));
				}
			}
		}
		protected void DropDownListRegionCode1Bind()
		{
			...
			this.dropDownList_3.Items.Add(new ListItem("—省级—", "-1"));
		...
		protected void DropDownListRegionCode1_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			this.dropDownList_4.Items.Add(new ListItem("—市级—", "-1"));
		...
		protected void DropDownListRegionCode2_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			this.dropDownList_5.Items.Add(new ListItem("—县级—", "-1"));
