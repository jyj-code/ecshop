...
{
	[ParseChildren(true)]
	public class ArticleCategoryAd : BaseWebControl
	{
		private string string_0 = "ArticleCategoryAd.ascx";
		...
		protected override void InitializeSkin(System.Web.UI.Control skin)
		{
			...
			DataTable dataTable = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, categorycode, "5");
			...
			{
				DataTable dataTable2 = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, "5");
