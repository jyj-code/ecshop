...
{
	[ParseChildren(true)]
	public class DeShopEspecialSearch : BaseWebControl
	{
		private string string_0 = "DeShopEspeciallySearch.ascx";
		...
		private void method_0()
		{
			...
			DataTable dataTable = shopNum1_ShopInfoList_Action.SearchEspecialShopList(value, this.ShopType);
			if (dataTable != null && dataTable.Rows.Count > 0)
			{
