...
{
	[ParseChildren(true)]
	public class CategoryInfoAd : BaseWebControl
	{
		private string string_0 = "CategoryInfoAd.ascx";
		...
		protected override void InitializeSkin(System.Web.UI.Control skin)
		{
			...
			DataTable dataTable = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, categorycode, "2");
			...
			{
				DataTable dataTable2 = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, "2");
