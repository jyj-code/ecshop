...
namespace ShopNum1.WebControl
{
	...
	{
		private string string_0 = "ProductSearch.ascx";
		...
		private string string_1 = GetPageName.RetDomainUrl("Search_product");
		...
		{
			this.strStartPrice = ((this.Page.Request.QueryString["minprice"] == null) ? "0" : this.Page.Request.QueryString["minprice"].ToString());
			this.strEndPrice = ((this.Page.Request.QueryString["maxprice"] == null) ? "0" : this.Page.Request.QueryString["maxprice"].ToString());
			...
			if (this.strStartPrice != "0")
			{
				this.textBox_1.Text = this.strStartPrice;
			}
			if (this.strEndPrice != "0")
			{
			...
			this.strStartPrice = ((ShopNum1.Common.Common.ReqStr("minprice") == "") ? "" : ShopNum1.Common.Common.ReqStr("minprice"));
			this.strEndPrice = ((ShopNum1.Common.Common.ReqStr("maxprice") == "") ? "" : ShopNum1.Common.Common.ReqStr("maxprice"));
			this.string_2 = ((ShopNum1.Common.Common.ReqStr("code") == "") ? "-1" : ShopNum1.Common.Common.ReqStr("code"));
			this.string_3 = ((ShopNum1.Common.Common.ReqStr("productName") == "") ? "-1" : ShopNum1.Common.Common.ReqStr("productName"));
			...
			this.style = ((ShopNum1.Common.Common.ReqStr("style") == "") ? "list" : ShopNum1.Common.Common.ReqStr("style"));
			...
			if (!this.Page.IsPostBack)
			{
				...
				{
					this.hiddenField_1.Value = this.string_6;
				}
				else
				{
		...
		private void method_1()
		{
			...
			DataSet furnitureProduct = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct(this.addcode, this.string_6, this.string_2, this.string_5, this.string_4, this.strStartPrice, this.strEndPrice, "", this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "1", this.dictionary_0);
			...
			PageListBll pageListBll = new PageListBll("search_product", true);
			...
			DataSet furnitureProduct2 = this.shopNum1_ProuductChecked_Action_0.GetFurnitureProduct(this.addcode, this.string_6, this.string_2, this.string_5, this.string_4, this.strStartPrice, this.strEndPrice, "", this.brandguid, this.ShowCount.ToString(), this.int_0.ToString(), "0", this.dictionary_0);
			...
			{
				string url = GetPageName.AgentRetUrl("ProductSearchNofind", this.string_3, "search");
