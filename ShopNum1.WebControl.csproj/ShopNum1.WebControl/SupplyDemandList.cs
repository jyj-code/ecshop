...
{
	[ParseChildren(true)]
	public class SupplyDemandList : BaseWebControl
	{
		private string string_0 = "SupplyDemandList.ascx";
		...
		private void method_0()
		{
			...
			DataTable dataTable = shopNum1_SupplyDemandCheck_Action.Search(0, 0, this.ShowCountOne);
		...
		private void repeater_0_ItemDataBound(object sender, RepeaterItemEventArgs e)
		{
			if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
			{
				...
				ShopNum1_SupplyDemandCheck_Action shopNum1_SupplyDemandCheck_Action = (ShopNum1_SupplyDemandCheck_Action)LogicFactory.CreateShopNum1_SupplyDemandCheck_Action();
				DataTable dataTable = shopNum1_SupplyDemandCheck_Action.Search(Convert.ToInt32(hiddenField.Value), 0, this.ShowCountTwo);
				if (dataTable != null && dataTable.Rows.Count > 0)
				{
