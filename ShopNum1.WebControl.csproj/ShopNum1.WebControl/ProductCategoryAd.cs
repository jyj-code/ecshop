...
{
	[ParseChildren(true)]
	public class ProductCategoryAd : BaseWebControl
	{
		private string string_0 = "ProductCategoryAd.ascx";
		...
		protected override void InitializeSkin(System.Web.UI.Control skin)
		{
			...
			DataTable dataTable = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, categorycode, "1");
			...
			{
				DataTable dataTable2 = shopNum1_CategoryAdPayMent_Action.SearchAdInfo(this.AdID, "1");
